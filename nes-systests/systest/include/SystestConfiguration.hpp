...
public:
    ...
    Configurations::SequenceOption<Configurations::StringOption> testGroups = {"testGroup", "test group to run"};
    Configurations::SequenceOption<Configurations::StringOption> excludeGroups = {"testGroup", "test group to exclude"};
