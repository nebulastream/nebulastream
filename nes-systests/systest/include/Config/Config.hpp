...
{
    /// Directories to lookup test files in. Default replaced when directories are passed via -t/--testLocations.
    std::vector<std::string> testsDiscoverDirs = {TEST_DISCOVER_DIR};
