...
/// Hands out query numbers and rejects a test file whose query count and result count drift apart.
...
/// Parses a dialect of the sqllogictest format and reports each section it reads to a callback.
...
public:
    ...
    /// Fills the line buffer the parser reads from, dropping comments and applying the registered substitution rules.
    ...
    /// Registers the callback the parser reports the matching section to.
