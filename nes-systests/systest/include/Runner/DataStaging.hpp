...
/// Writes the rows the rewriter planned to the file the physical source reads, creating the parent directory first.
void writeInlineData(const InlineData& data);

/// A data server for one source, and the source options for the endpoint it bound.
