...
/// One explain check: the plan the optimizer printed, and the lines the test expects.
...
/// Compares the plan an EXPLAIN printed against the expected lines, in order.
...
[[nodiscard]] Verdict checkExplain(const ExplainCheck& check);
