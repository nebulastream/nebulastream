...
struct SystestQuery
{
    ...
    /// The prefix that qualifying put in front of every catalog-visible name, which the EXPLAIN check strips from the
    /// printed plan so it reads as the test wrote it.
