...
public:
    ...
    struct Settings
    {
        ...
        Bridge::WorkerMode mode = Bridge::WorkerMode::Embedded;
    ...
    Cluster(const Bridge::Coordinator& coordinator, const Settings& settings);
    ...
    [[nodiscard]] bool runsInThisProcess() const { return mode == Bridge::WorkerMode::Embedded; }
...
private:
    ...
    std::reference_wrapper<const Bridge::Coordinator> coordinator;
