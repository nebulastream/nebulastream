...
{
public:
    explicit Schedule(const std::vector<std::reference_wrapper<const RewrittenTest>>& tests);
...
private:
    ...
    {
    public:
        File(size_t runnable, size_t offset, const RewrittenTest& test);
    ...
    private:
        ...
        std::reference_wrapper<const RewrittenTest> test;
        size_t runnable;
        size_t offset;
        size_t cursor = 0;
