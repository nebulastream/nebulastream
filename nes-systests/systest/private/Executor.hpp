...
private:
    ...
    [[nodiscard]] static ExecutorResult runRounds(TestRunner& runner, const RunPolicy& plan, PreparedRun prepared);

    /// Turns the checked queries into the tally and the failure list that the invocation prints.
