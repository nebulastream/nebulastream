...
/// The field names below are the JSON keys. The first keeps the historical spelling with a space, which readers of this
/// file expect and a C++ identifier cannot contain.
struct BenchmarkRow
{
...
private:
    /// The rows, in the order in which the queries were first measured.
