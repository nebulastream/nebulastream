...
// {
// public:
//     MOCK_METHOD((std::expected<Distributed::QueryId, Exception>), registerQuery, (const QueryPlanner::FinalizedLogicalPlan&), (override));
//     MOCK_METHOD(void, startQuery, (const Distributed::QueryId&), (override));
//     MOCK_METHOD(void, stopQuery, (const Distributed::QueryId&), (override));
//     MOCK_METHOD(void, unregisterQuery, (const Distributed::QueryId&), (override));
//     MOCK_METHOD(std::vector<QuerySummary>, waitForQueryTermination, (const Distributed::QueryId&), (override));
//     MOCK_METHOD(std::vector<std::vector<QuerySummary>>, finishedQueries, (), (override));
// };
//
