...
public:
    explicit SystestTopology(const std::vector<CLI::WorkerConfig>& cluster) : workerCatalog{std::make_shared<WorkerCatalog>(WorkerCatalog::from(
        cluster | std::views::transform([](const auto& config) {
