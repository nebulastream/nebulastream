...
#include "../../kubernetes/include/K8sQueryBuilder.hpp"
#include "../../kubernetes/include/K8sTopologyBuilder.hpp"
...
{
    K8sYAMLSubmitter yamlSubmitter("default");
    std::queue<SystestQuery> pending;
    for (auto it = queries.rbegin(); it != queries.rend(); ++it)
    {
        // std::cout << "Topology\n" << K8sTopologyBuilder::toYamlString(*it) << "\n" << std::endl;
        pending.push(*it);
    }
