...
def main() -> int:
    ...
    cold_log, cold_query_count = run_phase("cold", 1729, systest, corpus, data, run_root)
    module_count = validate_reports("cold", cold_log)
    validate_artifacts(run_root / "cache")

    warm_log, warm_query_count = run_phase("warm", 8675309, systest, corpus, data, run_root)
