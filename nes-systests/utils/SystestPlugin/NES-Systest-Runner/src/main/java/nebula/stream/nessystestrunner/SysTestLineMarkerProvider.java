...
public class SysTestLineMarkerProvider implements LineMarkerProvider  {
    ...
    /// The Plugin affects all files of type '.test'
    ...
    public void collectSlowLineMarkers(@NotNull List<? extends PsiElement> elements,
        ...
        String testPathRunAll = file.getVirtualFile().getPath();
        ...
        if (firstElement != null) {
            ...
            LineMarkerInfo<PsiElement> firstLineMarkerInfo = new LineMarkerInfo<>(
                    ...
                    (e, elt) -> { runSysTest(elt.getProject(), testPathRunAll, null); },
            ...
            LineMarkerInfo<PsiElement> firstLineMarkerInfoDebug = new LineMarkerInfo<>(
                    ...
                    (e, elt) -> { runSysTest(elt.getProject(), testPathRunAll, "--debug"); },
        ...
        while (matcher.find()) {
            ...
            LineMarkerInfo<PsiElement> lineMarkerInfo = new LineMarkerInfo<>(
                    ...
                    (e, elt) -> { runSysTest(elt.getProject(), testPath, null); },
                    GutterIconRenderer.Alignment.CENTER
            );
            ...
            LineMarkerInfo<PsiElement> lineMarkerInfoDebug = new LineMarkerInfo<>(
                    ...
                    (e, elt) -> { runSysTest(elt.getProject(), testPath, "--debug"); },
                    GutterIconRenderer.Alignment.LEFT
            );
    ...
    public static void runSysTest(Project project, String testPath, String parameters) {
