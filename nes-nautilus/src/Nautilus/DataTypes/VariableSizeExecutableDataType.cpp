...
void VariableSizeExecutableDataType::writeToMemRefVal(const MemRefVal& memRef) {
    NES_THROW_RUNTIME_ERROR("Can not write a variable length data type to a MemRefVal. At least, we do not define it for now!");
}
