...
namespace NES
{
VarVal UINTLazyValueRepresentation::eqImpl(const nautilus::val<bool>& rhs) const
{
...
VarVal UINTLazyValueRepresentation::eqImpl(const VariableSizedData& rhs) const
{
    VarVal result = nautilus::val<bool>{false};
...
VarVal UINTLazyValueRepresentation::eqImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    VarVal result = nautilus::val<bool>{false};
...
VarVal UINTLazyValueRepresentation::neqImpl(const nautilus::val<bool>& rhs) const
{
    return !eqImpl(rhs);
}

VarVal UINTLazyValueRepresentation::neqImpl(const VariableSizedData& rhs) const
{
    return !eqImpl(rhs);
}

VarVal UINTLazyValueRepresentation::neqImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    return !eqImpl(rhs);
}

VarVal UINTLazyValueRepresentation::ltImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    VarVal result = nautilus::val<bool>{false};
    const auto lhsContent = getContent();
    auto rhsContent = rhs->getContent();
    switch (rhs->getType())
    {
        ...
        case DataType::Type::INT64: {
            /// Can be solved lazy if the lhs type is not UINT64
            if (type == DataType::Type::UINT64)
            {
                result = LazyValueRepresentation::operator<(rhs);
            }
            else
        ...
        case DataType::Type::INT32: {
            /// May only be performed if the lhs type is 16bytes or less
            if (type == DataType::Type::UINT64 || type == DataType::Type::UINT32)
            {
                result = LazyValueRepresentation::operator<(rhs);
            }
            else
...
VarVal UINTLazyValueRepresentation::leImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    return eqImpl(rhs) || ltImpl(rhs);
}

VarVal UINTLazyValueRepresentation::gtImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    return !leImpl(rhs);
}

VarVal UINTLazyValueRepresentation::geImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const
{
    return !ltImpl(rhs);
}
    ...
    return other.customVisit(
        [&]<typename T>(const T& val) -> VarVal
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::eqImpl);
                          })
            {
...
VarVal UINTLazyValueRepresentation::operator!=(const VarVal& other) const
{
    return other.customVisit(
        ...
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::neqImpl);
                          })
            {
...
VarVal UINTLazyValueRepresentation::operator<(const VarVal& other) const
{
    return other.customVisit(
        ...
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::ltImpl);
                          })
            {
...
VarVal UINTLazyValueRepresentation::operator<=(const VarVal& other) const
{
    return other.customVisit(
        ...
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::leImpl);
                          })
            {
...
VarVal UINTLazyValueRepresentation::operator>(const VarVal& other) const
{
    return other.customVisit(
        ...
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::gtImpl);
                          })
            {
...
VarVal UINTLazyValueRepresentation::operator>=(const VarVal& other) const
{
    return other.customVisit(
        ...
        {
            if constexpr (requires {
                              static_cast<VarVal (UINTLazyValueRepresentation::*)(const T&) const>(&UINTLazyValueRepresentation::geImpl);
                          })
            {
...
{
    return std::make_shared<UINTLazyValueRepresentation>(args.valueAddress, args.size, args.type);
}
