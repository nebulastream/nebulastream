...
NautilusBuffer NautilusBuffer::load(const nautilus::val<const TupleBuffer*>& originalBuffer)
{
...
NautilusBuffer NautilusBuffer::getChild(const nautilus::val<size_t>& index)
{
...
NautilusBorrowedBuffer NautilusBorrowedBuffer::load(const nautilus::val<TupleBuffer*>& originalBuffer)
{
...
NautilusBuffer NautilusBorrowedBuffer::getChild(const nautilus::val<size_t>& index)
{
    NautilusBuffer child;
    nautilus::invoke(
