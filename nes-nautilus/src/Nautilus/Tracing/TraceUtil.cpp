...
void traceBinaryOperation(
    const Nautilus::Tracing::OpCode & op,
...
void traceUnaryOperation(
    const Nautilus::Tracing::OpCode & op, const Nautilus::Tracing::ValueRef & resultRef, const Nautilus::Tracing::ValueRef & inputRef)
{
    if (auto ctx = Tracing::TraceContext::getIfActive())
    {
