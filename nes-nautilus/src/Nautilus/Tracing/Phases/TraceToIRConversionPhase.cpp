...
NES::Nautilus::IR::BasicBlockPtr TraceToIRConversionPhase::IRConversionContext::processBlock(int32_t scope, Block& block)
{
    ...
    NES::Nautilus::IR::BasicBlockPtr irBasicBlock = std::make_shared<NES::Nautilus::IR::BasicBlock>(
        std::to_string(block.blockId),
        scope,
...
void TraceToIRConversionPhase::IRConversionContext::processOperation(
    int32_t scope, ValueFrame& frame, Block& currentBlock, NES::Nautilus::IR::BasicBlockPtr& currentIrBlock, TraceOperation& operation)
{
    switch (operation.op)
    {
        case OpCode::ADD: {
...
void TraceToIRConversionPhase::IRConversionContext::processJMP(
    int32_t scope, ValueFrame& frame, NES::Nautilus::IR::BasicBlockPtr& block, TraceOperation& operation)
{
...
void TraceToIRConversionPhase::IRConversionContext::processCMP(
    int32_t scope, ValueFrame& frame, Block&, NES::Nautilus::IR::BasicBlockPtr& currentIrBlock, TraceOperation& operation)
{
...
void TraceToIRConversionPhase::IRConversionContext::createBlockArguments(
    ValueFrame& frame, NES::Nautilus::IR::Operations::BasicBlockInvocation& blockInvocation, BlockRef val)
{
    for (auto& arg : val.arguments)
    {
    ...
    int32_t, ValueFrame& frame, NES::Nautilus::IR::BasicBlockPtr& currentBlock, TraceOperation& operation)
{
    ...
    auto compareOperation = std::make_shared<NES::Nautilus::IR::Operations::CompareOperation>(
        resultIdentifier, leftInput, rightInput, NES::Nautilus::IR::Operations::CompareOperation::Comparator::LT);
    ...
    int32_t, ValueFrame& frame, NES::Nautilus::IR::BasicBlockPtr& currentBlock, TraceOperation& operation)
{
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto compareOperation = std::make_shared<NES::Nautilus::IR::Operations::CompareOperation>(
        resultIdentifier, leftInput, rightInput, NES::Nautilus::IR::Operations::CompareOperation::Comparator::GT);
    frame.setValue(resultIdentifier, compareOperation);
    currentBlock->addOperation(compareOperation);
}
    ...
    int32_t, ValueFrame& frame, NES::Nautilus::IR::BasicBlockPtr& currentBlock, TraceOperation& operation)
{
    ...
    auto resultIdentifier = createValueIdentifier(operation.result);
    auto compareOperation = std::make_shared<NES::Nautilus::IR::Operations::CompareOperation>(
        resultIdentifier, leftInput, rightInput, NES::Nautilus::IR::Operations::CompareOperation::Comparator::EQ);
    frame.setValue(resultIdentifier, compareOperation);
    currentBlock->addOperation(compareOperation);
}
...
void TraceToIRConversionPhase::IRConversionContext::processConst(
    int32_t, TraceToIRConversionPhase::ValueFrame& frame, NES::Nautilus::IR::BasicBlockPtr& currentBlock, TraceOperation& operation)
{
    ...
    {
        constOperation = std::make_shared<NES::Nautilus::IR::Operations::ConstFloatOperation>(
    ...
    else if (Identifier::isIdentifier(*valueRef.value))
    {
        ...
        constOperation = std::make_shared<IR::Operations::ConstIntOperation>(
            resultIdentifier, identifier->getUnderlyingRawValue(), identifier->getType());
    }
    else
    {
