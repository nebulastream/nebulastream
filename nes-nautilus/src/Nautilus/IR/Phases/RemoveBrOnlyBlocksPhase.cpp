...
void inline addPredecessorToBlock(
    IR::BasicBlockPtr currentBlock, std::stack<IR::BasicBlockPtr>& candidates, std::unordered_set<std::string> newBlocks)
{
...
void RemoveBrOnlyBlocksPhase::RemoveBrOnlyBlocksPhaseContext::processPotentialBrOnlyBlock(
    IR::BasicBlockPtr currentBlock, std::stack<IR::BasicBlockPtr>& newBlocks, std::unordered_set<std::string> visitedBlocks)
{
