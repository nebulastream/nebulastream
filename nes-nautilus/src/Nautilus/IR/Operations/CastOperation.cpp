...
CastOperation::CastOperation(OperationIdentifier identifier, OperationPtr input,
                             Types::StampPtr targetStamp)
...
std::string CastOperation::toString() {
  return identifier + " = " + getInput()->getIdentifier() + " cast_to " +
         getStamp()->toString();
}
