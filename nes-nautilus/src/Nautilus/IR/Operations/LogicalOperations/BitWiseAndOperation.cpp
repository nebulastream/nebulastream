...
BitWiseAndOperation::BitWiseAndOperation(OperationIdentifier identifier, Operation& leftInput, Operation& rightInput)
...
std::string BitWiseAndOperation::toString() const {
...
const Operation& BitWiseAndOperation::getLeftInput() const { return leftInput; }
const Operation& BitWiseAndOperation::getRightInput() const { return rightInput; }
}// namespace NES::Nautilus::IR::Operations