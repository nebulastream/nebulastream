...
ProxyCallOperation::ProxyCallOperation(
    ...
    : Operation(Operation::OperationType::ProxyCallOp, identifier, resultType),
      proxyCallType(proxyCallType), inputArguments(std::move(inputArguments)) {}
...
ProxyCallOperation::ProxyCallOperation(
    ...
    : Operation(Operation::OperationType::ProxyCallOp, identifier, resultType),
      proxyCallType(proxyCallType), mangedFunctionSymbol(functionSymbol),
      functionPtr(functionPtr), inputArguments(std::move(inputArguments)) {}
