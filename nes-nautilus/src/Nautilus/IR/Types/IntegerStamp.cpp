...
IntegerStamp::IntegerStamp(BitWidth bitWidth, SignednessSemantics signedness) : Stamp(&type), bitWidth(bitWidth), signedness(signedness)
{
}
...
IntegerStamp::BitWidth IntegerStamp::getBitWidth() const
{
    return bitWidth;
}
