...
BasicBlock::BasicBlock(
    ...
    : identifier(std::move(identifier)), scopeLevel(scopeLevel),
      numLoopBackEdges(0), operations(std::move(operations)),
...
[[nodiscard]] Operations::OperationPtr
BasicBlock::getOperationAt(size_t index) {
...
std::shared_ptr<BasicBlock>
BasicBlock::addLoopHeadBlock(BasicBlockPtr loopHeadBlock) {
...
std::shared_ptr<BasicBlock>
BasicBlock::addNextBlock(std::shared_ptr<BasicBlock> nextBlock) {
...
std::shared_ptr<BasicBlock>
BasicBlock::addTrueBlock(std::shared_ptr<BasicBlock> thenBlock) {
...
std::shared_ptr<BasicBlock>
BasicBlock::addFalseBlock(std::shared_ptr<BasicBlock> elseBlock) {
  std::static_pointer_cast<Operations::IfOperation>(this->operations.back())
...
BasicBlock::getNextBlocks() {
  ...
  if (operations.back()->getOperationType() ==
    ...
    NES_ERROR("BasicBlock::getNextBlocks: Tried to get next block for "
