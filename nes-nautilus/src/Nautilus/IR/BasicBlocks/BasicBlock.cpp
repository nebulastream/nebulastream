...
std::string BasicBlock::getIdentifier()
{
    return identifier;
}
...
uint32_t BasicBlock::getScopeLevel()
{
    return scopeLevel;
}
...
[[nodiscard]] Operations::OperationPtr BasicBlock::getOperationAt(size_t index)
{
...
std::vector<std::shared_ptr<Operations::BasicBlockArgument>> BasicBlock::getArguments()
{
    return arguments;
}
