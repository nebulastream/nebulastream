...
void PagedVectorRef::writeRecord(const Record& record, nautilus::val<Memory::AbstractBufferProvider*> provider) const
{
    ...
    memoryProvider->writeRecord(numTuplesOnPage, recordBuffer, record, provider);
