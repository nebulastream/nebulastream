...
HashFunction::HashValue H3Hash::calculateWithState(
    HashFunction::HashValue& hash, Value<>& value, Value<MemRef>& state) {
...
HashFunction::HashValue H3Hash::calculate(HashFunction::HashValue&, Value<>&) {
  NES_THROW_RUNTIME_ERROR(
      "Wrong function call! Please use calculateWithState() as H3 requires a "
      "seed vector");
}
