...
ChainedHashMapRef::EntryRef ChainedHashMapRef::findOrCreate(
    const Value<UInt64> & hash, const std::vector<Value<>> & keys, const std::function<void(EntryRef &)> & onInsert)
{
    // find entry
...
ChainedHashMapRef::EntryIterator::EntryIterator(
    ChainedHashMapRef & hashTableRef, const Value<UInt64> & entriesPerPage, const Value<UInt64> & currentIndex)
...
ChainedHashMapRef::KeyEntryIterator::KeyEntryIterator(
    ChainedHashMapRef & hashTableRef, const Value<UInt64> & hash, const std::vector<Value<>> & keys, const Value<UInt64> & currentIndex)
...
ChainedHashMapRef::EntryRef ChainedHashMapRef::KeyEntryIterator::operator*() const
{
    return currentEntry;
}
} // namespace NES::Nautilus::Interface
