...
ChainedHashMap::ChainedHashMap(
    uint64_t keySize, uint64_t valueSize, uint64_t nrEntries, std::unique_ptr<std::pmr::memory_resource> allocator, size_t pageSize)
...
uint64_t ChainedHashMap::getCurrentSize() const
{
    return currentSize;
}
