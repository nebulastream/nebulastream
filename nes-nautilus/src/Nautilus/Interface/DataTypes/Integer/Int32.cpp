...
Nautilus::IR::Types::StampPtr Int32::getType() const
{
    return Nautilus::IR::Types::StampFactory::createInt32Stamp();
}
std::shared_ptr<Any> Int32::copy()
{
