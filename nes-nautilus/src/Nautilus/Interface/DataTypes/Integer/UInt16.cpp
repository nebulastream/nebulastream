...
Nautilus::IR::Types::StampPtr UInt16::getType() const
{
    return Nautilus::IR::Types::StampFactory::createUInt16Stamp();
}
std::shared_ptr<Any> UInt16::copy()
{
...
int64_t UInt16::getRawInt() const
{
    return value;
}
