...
Nautilus::IR::Types::StampPtr UInt8::getType() const
{
    return Nautilus::IR::Types::StampFactory::createUInt8Stamp();
}
std::shared_ptr<Any> UInt8::copy()
{
