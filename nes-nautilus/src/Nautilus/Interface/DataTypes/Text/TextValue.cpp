...
char* TextValue::str() {
  return reinterpret_cast<char*>(this) + DATA_FIELD_OFFSET;
}
...
TextValue* TextValue::create(Runtime::TupleBuffer& buffer,
...
TextValue::~TextValue() {
  ...
  // In the following, we recycle the tuple buffer and return it to the buffer
  // pool.
