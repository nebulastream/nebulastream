...
public:
    ...
    std::optional<Value<>> performBinaryOperationAndCast(
        const Value<>& left, const Value<>& right, std::function<Value<>(const TimeStamp& left, const TimeStamp& right)> function) const
    {
    ...
    std::optional<Value<>> Equals(const Value<>& left, const Value<>& right) const override
    {
        return performBinaryOperationAndCast(
            left,
            right,
            [](const TimeStamp& left, const TimeStamp& right)
            {
