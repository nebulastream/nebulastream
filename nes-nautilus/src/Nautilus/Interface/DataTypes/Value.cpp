        ...
        function)
{
    ...
    NES_THROW_RUNTIME_ERROR(
        "No plugin registered that can handle this operation between " << left->toString() << " and " << right->toString());
}
...
Value<> BitWiseAndOp(const Value<>& leftExp, const Value<>& rightExp)
{
    return evalWithCast(
        ...
        [](std::unique_ptr<InvocationPlugin>& plugin, const Value<>& left, const Value<>& right)
        {
            ...
            if (result.has_value())
            {
                Tracing::TraceUtil::traceBinaryOperation(Nautilus::Tracing::OpCode::BITWISE_AND, result.value().ref, left.ref, right.ref);
            }
            return result;
        });
}
...
Value<> BitWiseOrOp(const Value<>& leftExp, const Value<>& rightExp)
{
    return evalWithCast(
        ...
        [](std::unique_ptr<InvocationPlugin>& plugin, const Value<>& left, const Value<>& right)
        {
            ...
            if (result.has_value())
            {
                Tracing::TraceUtil::traceBinaryOperation(Nautilus::Tracing::OpCode::BITWISE_OR, result.value().ref, left.ref, right.ref);
            }
            return result;
        });
}
...
Value<> BitWiseXorOp(const Value<>& leftExp, const Value<>& rightExp)
{
    return evalWithCast(
        ...
        [](std::unique_ptr<InvocationPlugin>& plugin, const Value<>& left, const Value<>& right)
        {
            ...
            if (result.has_value())
            {
                Tracing::TraceUtil::traceBinaryOperation(Nautilus::Tracing::OpCode::BITWISE_XOR, result.value().ref, left.ref, right.ref);
            }
            return result;
        });
}
        ...
        [](std::unique_ptr<InvocationPlugin>& plugin, const Value<>& left, const Value<>& right)
        {
            ...
            if (result.has_value())
            {
                Tracing::TraceUtil::traceBinaryOperation(
                    Nautilus::Tracing::OpCode::BITWISE_LEFT_SHIFT, result.value().ref, left.ref, right.ref);
            }
            return result;
        });
}
...
Value<> BitWiseRightShiftOp(const Value<>& leftExp, const Value<>& rightExp)
{
    return evalWithCast(
        ...
        [](std::unique_ptr<InvocationPlugin>& plugin, const Value<>& left, const Value<>& right)
        {
            ...
            {
                Tracing::TraceUtil::traceBinaryOperation(
                    Nautilus::Tracing::OpCode::BITWISE_RIGHT_SHIFT, result.value().ref, left.ref, right.ref);
            }
            return result;
        });
}
