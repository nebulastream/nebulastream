...
class FloatInvocationPlugin : public InvocationPlugin {
 public:
  ...
  std::optional<Value<>> performBinaryOperationAndCast(
      ...
      std::function<Value<>(const Any& left, const Any& right)> function)
      const {
  ...
  std::optional<Value<>> Add(const Value<>& left,
    ...
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().add(right.staticCast<Float>());
            auto resultValue = Value<>(std::move(result));
            return resultValue;
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().add(right.staticCast<Double>());
            auto resultValue = Value<>(std::move(result));
            return resultValue;
          }
  ...
  std::optional<Value<>> Sub(const Value<>& left,
                             const Value<>& right) const override {
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().sub(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().sub(right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  std::optional<Value<>> Mul(const Value<>& left,
    ...
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().mul(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().mul(right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  std::optional<Value<>> Div(const Value<>& left,
                             const Value<>& right) const override {
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().div(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().div(right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  std::optional<Value<>> Equals(const Value<>& left,
    ...
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().equals(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().equals(right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  std::optional<Value<>> LessThan(const Value<>& left,
    ...
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().lessThan(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result =
                left.staticCast<Double>().lessThan(right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  std::optional<Value<>> GreaterThan(const Value<>& left,
    ...
    return performBinaryOperationAndCast(
        left, right, [](const Any& left, const Any& right) {
          if (isa<Float>(left) && isa<Float>(right)) {
            auto result =
                left.staticCast<Float>().greaterThan(right.staticCast<Float>());
            return Value<>(std::move(result));
          } else if (isa<Double>(left) && isa<Double>(right)) {
            auto result = left.staticCast<Double>().greaterThan(
                right.staticCast<Double>());
            return Value<>(std::move(result));
          }
          NES_THROW_RUNTIME_ERROR("");
        });
  ...
  template <class T>
  std::optional<Value<>> castIntToValue(const Value<>& left,
                                        const TypeIdentifier* toType) const {
  ...
  std::optional<Value<>> CastTo(const Value<>& left,
                                const TypeIdentifier* toType) const override {
  ...
  bool IsCastable(const Value<>& value,
                  const TypeIdentifier* toType) const override {
    ...
    return (isa<UInt8>(value.getValue()) || isa<UInt16>(value.getValue()) ||
            isa<UInt32>(value.getValue()) || isa<UInt64>(value.getValue()) ||
            isa<Int8>(value.getValue()) || isa<Int16>(value.getValue()) ||
            isa<Int32>(value.getValue()) || isa<Int64>(value.getValue())) &&
           (toType->isType<Float>() || toType->isType<Double>());
  }
};

[[maybe_unused]] static InvocationPluginRegistry::Add<FloatInvocationPlugin>
    floatPlugin;
}  // namespace NES::Nautilus
