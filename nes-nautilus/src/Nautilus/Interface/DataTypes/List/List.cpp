...
List::ListValueIterator::ListValueIterator(List& listRef, Value<UInt32>& currentIndex) : list(listRef), currentIndex(currentIndex)
{
}

Value<> List::ListValueIterator::operator*()
{
    return list.read(currentIndex);
}
