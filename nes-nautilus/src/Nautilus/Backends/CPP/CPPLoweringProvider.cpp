...
std::stringstream CPPLoweringProvider::LoweringContext::process() {
    ...
    for (const auto& i : functionBasicBlock->getArguments()) {
        auto& argument = *i;
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::CompareOperation& cmpOp,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::LoadOperation& loadOp,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::StoreOperation& storeOp,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::IfOperation& ifOpt,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::BranchOperation& branchOp,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::Operation& opt, short blockIndex, RegisterFrame& frame) {
    switch (opt.getOperationType()) {
        ...
        case IR::Operations::Operation::OperationType::ReturnOp: {
            auto& returnOpt = dynamic_cast<const IR::Operations::ReturnOperation&>(opt);
        ...
        case IR::Operations::Operation::OperationType::NegateOp: {
            auto& call = dynamic_cast<const IR::Operations::NegateOperation&>(opt);
            process(call, blockIndex, frame);
            return;
        }
        case IR::Operations::Operation::OperationType::CastOp: {
            auto& cast = dynamic_cast<const IR::Operations::CastOperation&>(opt);
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::ProxyCallOperation& opt,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::NegateOperation& negateOperation,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
...
void CPPLoweringProvider::LoweringContext::process(const IR::Operations::CastOperation& castOp,
                                                   short blockIndex,
                                                   RegisterFrame& frame) {
