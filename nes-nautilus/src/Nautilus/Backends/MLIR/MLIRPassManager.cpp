 ...
 * supplied Enum.
 */
std::unique_ptr<mlir::Pass> getMLIRLoweringPass(
    MLIRPassManager::LoweringPass loweringPass) {
  switch (loweringPass) {
 ...
 * supplied Enum.
 */
std::unique_ptr<mlir::Pass> getMLIROptimizationPass(
    MLIRPassManager::OptimizationPass optimizationPass) {
...
int MLIRPassManager::lowerAndOptimizeMLIRModule(
