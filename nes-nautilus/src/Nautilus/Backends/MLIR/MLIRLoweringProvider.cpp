...
MLIRLoweringProvider::generateModuleFromIR(std::shared_ptr<IR::IRGraph> ir) {
...
void MLIRLoweringProvider::generateMLIR(
  ...
  case IR::Operations::Operation::OperationType::FunctionOp:
    generateMLIR(
        std::static_pointer_cast<IR::Operations::FunctionOperation>(operation),
        frame);
    break;
  ...
  case IR::Operations::Operation::OperationType::ConstIntOp:
    generateMLIR(
        std::static_pointer_cast<IR::Operations::ConstIntOperation>(operation),
        frame);
    break;
  case IR::Operations::Operation::OperationType::ConstFloatOp:
    generateMLIR(std::static_pointer_cast<IR::Operations::ConstFloatOperation>(
                     operation),
                 frame);
    break;
  ...
  case IR::Operations::Operation::OperationType::ProxyCallOp:
    generateMLIR(
        std::static_pointer_cast<IR::Operations::ProxyCallOperation>(operation),
        frame);
    break;
  ...
  case IR::Operations::Operation::OperationType::BitWiseAnd:
    generateMLIR(std::static_pointer_cast<IR::Operations::BitWiseAndOperation>(
                     operation),
                 frame);
    break;
  case IR::Operations::Operation::OperationType::BitWiseOr:
    generateMLIR(
        std::static_pointer_cast<IR::Operations::BitWiseOrOperation>(operation),
        frame);
    break;
  case IR::Operations::Operation::OperationType::BitWiseXor:
    generateMLIR(std::static_pointer_cast<IR::Operations::BitWiseXorOperation>(
                     operation),
                 frame);
    break;
