...
std::unique_ptr<flounder::Executable> FlounderLoweringProvider::lower(std::shared_ptr<IR::IRGraph> ir, const NES::DumpHelper& dumpHelper)
{
    flounder::Compiler compiler = flounder::Compiler{
...
FlounderLoweringProvider::LoweringContext::process(flounder::Compiler& compiler, const NES::DumpHelper& dumpHelper)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::FunctionOperation>& functionOperation)
{
...
void FlounderLoweringProvider::LoweringContext::processInline(const std::shared_ptr<IR::BasicBlock>& block, FlounderFrame& frame)
{
    for (const auto& operation : block->getOperations())
    {
        this->process(operation, frame);
...
flounder::VregInstruction FlounderLoweringProvider::LoweringContext::requestVreg(flounder::Register& reg, const IR::Types::StampPtr& stamp)
{
    if (stamp->isInteger())
    {
...
flounder::Register FlounderLoweringProvider::LoweringContext::createVreg(
    IR::Operations::OperationIdentifier id, IR::Types::StampPtr stamp, FlounderFrame& frame)
{
...
FlounderLoweringProvider::LoweringContext::processBlockInvocation(IR::Operations::BasicBlockInvocation& bi, FlounderFrame& frame)
{
    FlounderFrame blockFrame;
...
FlounderLoweringProvider::FlounderFrame
FlounderLoweringProvider::LoweringContext::processInlineBlockInvocation(IR::Operations::BasicBlockInvocation& bi, FlounderFrame& frame)
{
    FlounderFrame blockFrame;
    auto blockInputArguments = bi.getArguments();
    auto blockTargetArguments = bi.getBlock()->getArguments();
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::AddOperation>& addOpt, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::MulOperation>& mulOp, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::SubOperation>& subOp, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::LoadOperation>& opt, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::StoreOperation>& opt, FlounderFrame& frame)
{
    auto address = frame.getValue(opt->getAddress()->getIdentifier());
...
void FlounderLoweringProvider::LoweringContext::process(
    const std::shared_ptr<IR::Operations::BranchOperation>& branchOp, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::processCmp(
    const std::shared_ptr<IR::Operations::CompareOperation>& compOpt, FlounderFrame& frame, flounder::Label& falseCase)
{
...
void FlounderLoweringProvider::LoweringContext::process(std::shared_ptr<IR::Operations::IfOperation> ifOpt, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(
    const std::shared_ptr<IR::Operations::ProxyCallOperation>& opt, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::LoopOperation>& opt, FlounderFrame& frame)
{
...
void FlounderLoweringProvider::LoweringContext::process(const std::shared_ptr<IR::Operations::Operation>& opt, FlounderFrame& frame)
{
