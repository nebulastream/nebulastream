...
{
    return invoke(ProxyFunctions::NES_Memory_TupleBuffer_getNumberOfTuples, buffer.asArg());
}
...
NautilusBuffer& RecordBuffer::getBuffer()
{
    return buffer;
}

const NautilusBuffer& RecordBuffer::getBuffer() const
{
    return buffer;
}
