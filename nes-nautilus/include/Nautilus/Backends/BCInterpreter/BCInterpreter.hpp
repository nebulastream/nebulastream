...
/**
 * @brief Implements the interpreter for an specific executable bytecode
 * fragment
 */
...
public:
  ...
  std::unique_ptr<GenericInvocable>
  getGenericInvocable(const std::string &string) override;
