...
private:
  ...
  private:
    ...
    std::string process(const std::shared_ptr<IR::BasicBlock> &,
                        RegisterFrame &frame);
    ...
    template <class Type>
    void processConst(const std::shared_ptr<IR::Operations::Operation> &opt,
    ...
    void processBinary(const std::shared_ptr<IR::Operations::Operation> &o,
                       const std::string &operation, short blockIndex,
                       RegisterFrame &frame) {
      ...
      blocks[blockIndex] << resultVar << " = " << leftInput << operation
                         << rightInput << ";\n";
    }
  };
};
