...
public:
  ...
  mlir::OwningOpRef<mlir::ModuleOp>
      generateModuleFromIR(std::shared_ptr<IR::IRGraph>);
...
private:
  ...
  void generateMLIR(std::shared_ptr<IR::Operations::FunctionOperation> funcOp,
                    ValueFrame &frame);
  void
  generateMLIR(std::shared_ptr<IR::Operations::ConstIntOperation> constIntOp,
               ValueFrame &frame);
  void generateMLIR(
  ...
  void generateMLIR(std::shared_ptr<IR::Operations::ReturnOperation> returnOp,
                    ValueFrame &frame);
  void
  generateMLIR(std::shared_ptr<IR::Operations::ProxyCallOperation> proxyCallOp,
               ValueFrame &frame);
  void generateMLIR(std::shared_ptr<IR::Operations::OrOperation> yieldOperation,
                    ValueFrame &frame);
  void
  generateMLIR(std::shared_ptr<IR::Operations::AndOperation> yieldOperation,
               ValueFrame &frame);
  void
  generateMLIR(std::shared_ptr<IR::Operations::NegateOperation> yieldOperation,
               ValueFrame &frame);
  void generateMLIR(
  ...
  void generateMLIR(std::shared_ptr<IR::Operations::BitWiseRightShiftOperation>
                    ...
                    ValueFrame &frame);
  void
  generateMLIR(std::shared_ptr<IR::Operations::CastOperation> castOperation,
               ValueFrame &frame);
   ...
   */
  mlir::Block *
  generateBasicBlock(IR::Operations::BasicBlockInvocation &blockInvocation,
                     ValueFrame &frame);
  ...
  insertExternalFunction(const std::string &name, void *functionPtr,
  ...
  getMLIRType(std::vector<IR::Operations::OperationPtr> types);
   ...
   */
  ValueFrame
  createFrameFromParentBlock(ValueFrame &frame,
