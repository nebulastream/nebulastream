 ...
 private:
  ...
  class LoweringContext {
   public:
    ...
    void processInline(const std::shared_ptr<IR::BasicBlock>&,
                       FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::Operation>&,
                 FlounderFrame& frame);
    FlounderFrame processBlockInvocation(IR::Operations::BasicBlockInvocation&,
                                         FlounderFrame& frame);
    FlounderFrame processInlineBlockInvocation(
        IR::Operations::BasicBlockInvocation&, FlounderFrame& frame);
    flounder::Register createVreg(IR::Operations::OperationIdentifier id,
                                  IR::Types::StampPtr stamp,
                                  FlounderFrame& frame);
    flounder::VregInstruction requestVreg(flounder::Register& reg,
   ...
   private:
    ...
    void process(const std::shared_ptr<IR::Operations::AddOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::CastOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::MulOperation>& mulOp,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::SubOperation>& subOp,
                 FlounderFrame& frame);
    void process(std::shared_ptr<IR::Operations::IfOperation> opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::BranchOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::LoopOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::LoadOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::StoreOperation>& opt,
                 FlounderFrame& frame);
    void process(const std::shared_ptr<IR::Operations::ProxyCallOperation>& opt,
                 FlounderFrame& frame);
    void processAnd(const std::shared_ptr<IR::Operations::AndOperation>& opt,
                    FlounderFrame& frame, flounder::Label& trueCase,
    ...
    void processCmp(const std::shared_ptr<IR::Operations::Operation>& opt,
                    ...
                    flounder::Label& falseCase);
    void processCmp(
        const std::shared_ptr<IR::Operations::CompareOperation>& opt,
        FlounderFrame& frame, flounder::Label& falseCase);
  };
};
