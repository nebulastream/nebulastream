...
public:
  ...
  addLoopHeadBlock(std::shared_ptr<BasicBlock> loopHeadBlock);
  std::shared_ptr<BasicBlock>
  addNextBlock(std::shared_ptr<BasicBlock> nextBlock);
  void addNextBlock(std::shared_ptr<BasicBlock> nextBlock,
                    std::vector<Operations::OperationPtr> inputArguments);
  std::shared_ptr<BasicBlock>
  addTrueBlock(std::shared_ptr<BasicBlock> thenBlock);
  std::shared_ptr<BasicBlock>
  addFalseBlock(std::shared_ptr<BasicBlock> elseBlock);
  ...
  // void popOperation();
  void
  replaceTerminatorOperation(Operations::OperationPtr newTerminatorOperation);
