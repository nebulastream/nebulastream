...
#ifndef NES_NAUTILUS_INCLUDE_NAUTILUS_IR_OPERATIONS_CONSTFLOATOPERATION_HPP_
#define NES_NAUTILUS_INCLUDE_NAUTILUS_IR_OPERATIONS_CONSTFLOATOPERATION_HPP_
...
public:
  ...
  template <class T> T getFloatViaType();
