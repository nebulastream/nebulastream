...
#ifndef NES_NAUTILUS_INCLUDE_NAUTILUS_IR_OPERATIONS_LOGICALOPERATIONS_OROPERATION_HPP_
#define NES_NAUTILUS_INCLUDE_NAUTILUS_IR_OPERATIONS_LOGICALOPERATIONS_OROPERATION_HPP_
...
public:
  OrOperation(OperationIdentifier identifier, OperationPtr leftInput,
