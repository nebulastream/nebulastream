...
///
/// Remaining values of this datatype can be converted into the internal format, if an intermediate pipeline further downstream requires them to be represeted this way.
