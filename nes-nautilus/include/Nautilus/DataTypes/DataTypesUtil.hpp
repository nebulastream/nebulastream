...
inline std::unordered_map<PhysicalType::Type, std::function<VarVal(const VarVal&, const nautilus::val<int8_t*>&)>> storeValueFunctionMap = {
    ...
    {PhysicalType::Type::UNDEFINED, nullptr},
};
