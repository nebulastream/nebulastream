...
protected:
    ...
    explicit VarVal(const detail::var_val_t& t, const DataType::NULLABLE nullable, nautilus::val<bool> null)
        : value(t), null(std::move(null)), nullable(nullable)
    {
    }

    explicit VarVal(const detail::var_val_t& t) : value(t), null(std::move(false)), nullable(DataType::NULLABLE::NOT_NULLABLE) { }
