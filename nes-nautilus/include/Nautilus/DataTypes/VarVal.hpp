...
public:
    ...
    /// NOLINTBEGIN(fuchsia-default-arguments-declarations, google-explicit-constructor)
    template <typename T>
    explicit VarVal(
        const T value, const DataType::NULLABLE nullable = DataType::NULLABLE::NOT_NULLABLE, const nautilus::val<bool>& null = false)
    ...
    template <typename T>
    VarVal(
        const nautilus::val<T> value,
        const DataType::NULLABLE nullable = DataType::NULLABLE::NOT_NULLABLE,
        const nautilus::val<bool>& null = false)
    requires(detail::is_one_of<nautilus::val<T>, detail::var_val_t>::value)
    ...
    VarVal(const T value, const DataType::NULLABLE nullable = DataType::NULLABLE::NOT_NULLABLE, const nautilus::val<bool>& null = false)
        : value(value), null(null), nullable(nullable)
    {
    }

    /// NOLINTEND(fuchsia-default-arguments-declarations, google-explicit-constructor)
...
protected:
    ...
    /// NOLINTBEGIN(fuchsia-default-arguments-declarations, google-explicit-constructor)
    explicit VarVal(
        const detail::var_val_t& t, const DataType::NULLABLE nullable = DataType::NULLABLE::NOT_NULLABLE, nautilus::val<bool> null = false)
