 ...
 * This implementations is based on the hash functions of
 * https://github.com/martinus/robin-hood-hashing/ and duckdb.
 */
class MurMur3HashFunction : public HashFunction {
 public:
  ...
  /**
   * @brief Calculates the hash of value and xor-es it with hash (passes the
   * value over to calculate(hash, value) after hash init())
   * @param value
   * @return HashValue
   */
