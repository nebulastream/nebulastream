...
public:
    ...
    void writeRecord(nautilus::val<uint64_t>& recordIndex, const RecordBuffer& recordBuffer, const Record& rec, nautilus::val<Memory::AbstractBufferProvider*> bufferProvider) const override;
