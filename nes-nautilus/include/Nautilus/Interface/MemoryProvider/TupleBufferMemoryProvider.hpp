...
public:
    ...
    virtual Memory::MemoryLayouts::MemoryLayout& getMemoryLayout() = 0;
...
protected:
    ...
    static VarVal
    loadValue(const PhysicalType& type, const RecordBuffer& recordBuffer, const nautilus::val<int8_t*>& fieldReference);
