...
class ColumnTupleBufferRef final : public TupleBufferRef
{
    ...
    explicit ColumnTupleBufferRef(std::vector<Field> fields, uint64_t tupleSize, uint64_t bufferSize, uint64_t headerSize);
...
public:
    ...
    Record readRecord(
        ...
        nautilus::val<uint64_t> headerSize) const override;
