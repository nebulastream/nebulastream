...
/**
 * @brief This is a nautilus wrapper for Fixed2DArray. It wraps a memref to the
 * underlying fixed array and provides access methods
 */
class Fixed2DArrayRef {
 public:
   ...
   * @param entrySize
   */
  explicit Fixed2DArrayRef(const Value<MemRef>& fixed2DArrayRef,
                           const uint64_t& entrySize, const uint64_t& numCols);
