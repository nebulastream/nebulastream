...
public:
  ...
  /**
   * @brief Creates a PageVectorVarSizedRefIter that points to the first entry
   * in the PagedVectorVarSizedRef
   * @return PagedVectorVarSizedRefIter
   */
  PagedVectorVarSizedRefIter begin();

  /**
   * @brief Creates a PageVectorVarSizedRefIter that points to the entry at the
   * given position in the PagedVectorVarSizedRef
   * @param pos
   * @return PagedVectorVarSizedRefIter
   */
  ...
  /**
   * @brief Creates a PageVectorVarSizedRefIter that points to the end of the
...
public:
   ...
   */
  explicit PagedVectorVarSizedRefIter(
      const PagedVectorVarSizedRef &pagedVectorVarSized);

  /**
   * @brief Dereference operator that returns the record at a given entry in the
   * ListRef
   * @return Record
   */
  Record operator*();
