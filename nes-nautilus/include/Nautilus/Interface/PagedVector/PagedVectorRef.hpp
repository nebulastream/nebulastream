...
public:
    ...
    virtual const std::vector<Schema::Field>& getFields() const = 0;
    virtual Schema::Field getFieldAt(uint64_t pos) const = 0;
...
public:
    ...
    const std::vector<Schema::Field>& getFields() const override { return schema.getFields(); }

    Schema::Field getFieldAt(uint64_t pos) const override;
