...
class Identifier : public TraceableType {
 public:
  ...
  virtual const std::shared_ptr<Boolean> lessThan(
      const Identifier& other) const = 0;
  virtual const std::shared_ptr<Boolean> greaterThan(
      const Identifier& other) const = 0;
