...
public:
  ...
  /**
   * @brief Compares two text object and returns true if both text objects are
   * equal.
   ...
   * @return location of first occurrence of search_text in Text, return 0 if no
   * match found.
   */
  ...
  /**
   * @brief  Extract a subText of length len from the startIndex.Note that the
   * start value of 1 refers to the first character of the Text
  ...
  /**
   * @brief Pads the string with the character from the right until it has count
   * characters.
  ...
  /**
   * @brief Pads the string with the character from the left until it has count
   * characters.
   * @param index as Value<Int32>, value as Value<Int8>
   * @return Value<Text>
   */
  ...
  /**
   * @brief Returns true or false depending on whether its pattern matches the
   * given string
  ...
  /**
   * @brief Returns true or false whether the string matches the supplied
   * pattern
   * @param compareText as Value<Text>
   * @param caseSensitive as Value<Boolean> true for case sensitive and false
   * for insensitive pattern matching
   * @return Value<Boolean> returns true if the string matches the supplied
   * pattern
   */
  const Value<Boolean> like(Value<Text> &compareText,
