...
public:
     ...
     */
    explicit RecordBuffer(const nautilus::val<Memory::PinnedBuffer*>& tupleBufferRef);
    ...
    const nautilus::val<Memory::PinnedBuffer*>& getReference() const;
...
private:
    nautilus::val<Memory::PinnedBuffer*> tupleBufferRef;
};
