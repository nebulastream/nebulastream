 ...
 *
 * The Dyncall class is a C++ wrapper for the dyncall C library, providing an
 * object-oriented interface for calling C functions at runtime. This allows for
 * easier integration and usage of the dyncall library within C++ projects.
 *
 * Example usage:
 * @code
...
public:
  ...
  /**
   * @brief Call a void function with the provided function pointer and the
  ...
  /**
   * @brief Call a function returning a boolean value with the provided function
   * pointer and the currently set arguments.
   * @param value Function pointer to the target function returning a boolean
   * value.
  ...
  /**
   * @brief Call a function returning an int8_t value with the provided function
   * pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an int8_t
   * value.
  ...
  /**
   * @brief Call a function returning an int16_t value with the provided
   * function pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an int16_t
   * value.
  ...
  /**
   * @brief Call a function returning an int32_t value with the provided
   * function pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an int32_t
   * value.
  ...
  /**
   * @brief Call a function returning an int64_t value with the provided
   * function pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an int64_t
   * value.
  ...
  /**
   * @brief Call a function returning an double value with the provided function
   * pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an double
   * value.
  ...
  /**
  @brief Call a function returning a float value with the provided function
  pointer and the currently set arguments.
  ...
  */
  ...
  /**
   * @brief Call a function returning an void* value with the provided function
   * pointer and the currently set arguments.
   * @param value Function pointer to the target function returning an void*
   * value.
