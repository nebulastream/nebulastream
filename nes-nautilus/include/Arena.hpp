...
struct ArenaRef
{
    ...
    nautilus::val<int8_t*> allocateMemory(const nautilus::val<size_t>& sizeInBytes) const;

    VariableSizedData allocateVariableSizedData(const nautilus::val<uint32_t>& sizeInBytes) const;
