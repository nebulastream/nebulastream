...
public:
    ...
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<int8_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<int16_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<int32_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<int64_t>& rhs) const;
