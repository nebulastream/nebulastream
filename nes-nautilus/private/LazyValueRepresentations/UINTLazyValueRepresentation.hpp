...
public:
    ...
    /// < Implementations
    [[nodiscard]] nautilus::val<bool> ltImpl(const std::shared_ptr<LazyValueRepresentation>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<uint8_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<uint16_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<uint32_t>& rhs) const;
    [[nodiscard]] nautilus::val<bool> ltImpl(const nautilus::val<uint64_t>& rhs) const;
