...
class LoopCompilationTest : public Testing::BaseUnitTest,
...
public:
  ...
  static void TearDownTestCase() {
    NES_DEBUG("Tear down TraceTest test class.");
  }
};
...
TEST_P(LoopCompilationTest, sumLoopTestSCF) {
  auto execution =
      Nautilus::Tracing::traceFunctionWithReturn([]() { return sumLoop(10); });
...
TEST_P(LoopCompilationTest, ifSumLoopTest) {
  auto execution =
      Nautilus::Tracing::traceFunctionWithReturn([]() { return ifSumLoop(); });
...
INSTANTIATE_TEST_CASE_P(
    testLoopCompilation, LoopCompilationTest,
    ::testing::ValuesIn(
