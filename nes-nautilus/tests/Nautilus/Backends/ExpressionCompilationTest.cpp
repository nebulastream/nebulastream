 ...
 */
class ExpressionExecutionTest : public Testing::BaseUnitTest,
                                public AbstractCompilationBackendTest {
 public:
  /* Will be called before any test in this class are executed. */
  static void SetUpTestCase() {
    NES::Logger::setupLogging("ExpressionExecutionTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down ExpressionExecutionTest test class.");
  }
};
...
TEST_P(ExpressionExecutionTest, addI8Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt8Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int8AddExpression(tempx); });
...
TEST_P(ExpressionExecutionTest, addI16Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt16Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int16AddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, addI32Test) {
  Value<Int32> tempx = 0;
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt32Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int32AddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, addUI32Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt32Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return uint32AddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, addI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64AddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, modUI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createUInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return uint64ModExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, modI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64ModExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
  ASSERT_EQ(function(3), 3);
  ASSERT_EQ(function(14), 0);
...
TEST_P(ExpressionExecutionTest, bitWiseAndI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseAndExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
  ASSERT_EQ(function(3), 3);
...
TEST_P(ExpressionExecutionTest, BitWiseOrI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseOrExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
...
TEST_P(ExpressionExecutionTest, BitWiseXorI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseXorExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
  ASSERT_EQ(function(3), ((3_s64) ^ 7));
  ASSERT_EQ(function(14), ((14_s64) ^ 7));
...
TEST_P(ExpressionExecutionTest, BitWiseLeftShiftI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseLeftShiftExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
  ASSERT_EQ(function(3), ((3_s64) << 7));
  ASSERT_EQ(function(14), ((14_s64) << 7));
...
TEST_P(ExpressionExecutionTest, BitWiseRightShiftI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseRightShiftExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
...
TEST_P(ExpressionExecutionTest, BitWiseNotI64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt64Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return int64BitWiseNotExpression(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int64_t>("execute");
...
TEST_P(ExpressionExecutionTest, addFloatTest) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createFloatStamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return floatAddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, addDoubleTest) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createDoubleStamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return doubleAddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, castFloatToDoubleTest) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createFloatStamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return castFloatToDoubleAddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, castInt8ToInt64Test) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt8Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return castInt8ToInt64AddExpression(tempx); });
  auto engine = prepare(executionTrace);
...
TEST_P(ExpressionExecutionTest, castInt8ToInt64Test2) {
  ...
  tempx.ref = Nautilus::Tracing::ValueRef(
      INT32_MAX, 0, IR::Types::StampFactory::createInt8Stamp());
  auto executionTrace = Nautilus::Tracing::traceFunctionWithReturn(
      [tempx]() { return castInt8ToInt64AddExpression2(tempx); });
  auto engine = prepare(executionTrace);
  auto function = engine->getInvocableMember<int64_t, int8_t>("execute");
...
INSTANTIATE_TEST_CASE_P(
    testExpressions, ExpressionExecutionTest,
    ::testing::ValuesIn(
