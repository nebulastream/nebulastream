...
public:
    ...
    void runStoreTest(FixedPage& fixedPage, const std::vector<Item>& allItems, const uint64_t sizeOfRecord, const uint64_t maxItemsOnPage)
    {
    ...
    void runRetrieveTest(
        FixedPage& fixedPage, const std::vector<Item>& allItems, const uint64_t sizeOfRecord, const uint64_t expectedItemsOnPage)
    {
        auto fixedPageRef = FixedPageRef(Value<MemRef>((int8_t*)&fixedPage));
        auto pos = 0_u64;
     ...
     */
    template <typename Item>
    void createFixedPageAndRunTests(
        const uint64_t pageSize, const uint64_t sizeOfRecord, const std::vector<Item>& allItems, const uint64_t maxItemsOnPage)
    {
