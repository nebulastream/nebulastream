...
struct TestParams
{
    ...
    std::vector<UnboundSchema> keyDataTypes, valueDataTypes;
};
...
public:
    ...
    [[nodiscard]] nautilus::engine::CallableFunction<void, TupleBuffer*, Interface::HashMap*, AbstractBufferProvider*>
