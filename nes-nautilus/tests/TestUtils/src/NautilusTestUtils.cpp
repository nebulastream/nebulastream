                    ...
                    const auto pointerToVarSizedData = nautilus::invoke(
                        +[](TupleBuffer* inputBuffer, AbstractBufferProvider* bufferProviderVal, const uint64_t size)
                        {
                            ...
                            const auto combinedIdxOffset
                                = Nautilus::Interface::BufferRef::TupleBufferRef::writeVarSizedDataAndPrependLength(
                                    *inputBuffer, *bufferProviderVal, randomString);
                            return Nautilus::Interface::BufferRef::TupleBufferRef::loadAssociatedVarSizedValue(
                                *inputBuffer, combinedIdxOffset);
                        },
