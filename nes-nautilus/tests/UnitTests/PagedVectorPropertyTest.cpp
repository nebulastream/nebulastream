...
static constexpr size_t MAX_FIELDS_INTERPRETER = 128;
static constexpr size_t MAX_FIELDS_COMPILER = 32;
...
void insertAndIterateProperty(ExecutionMode backend, size_t maxFields)
{
    ...
    NES_INFO("Property insertAndIterate: fields={}, N={}, pageSize={}, layout={}, backend={}",
             fieldTypes.size(), numberOfItems, pageSize, magic_enum::enum_name(layoutType), magic_enum::enum_name(backend));
    ...
    NES_INFO("insertAndIterate: PagedVector has {} entries, reference has {} entries",
             pagedVector.getTotalNumberOfEntries(), reference.size());
...
void insertAndReadByIndexProperty(ExecutionMode backend, size_t maxFields)
{
    ...
    NES_INFO("Property insertAndReadByIndex: fields={}, N={}, pageSize={}, layout={}, backend={}",
             fieldTypes.size(), numberOfItems, pageSize, magic_enum::enum_name(layoutType), magic_enum::enum_name(backend));
...
void concatProperty(ExecutionMode backend, size_t maxFields)
{
    ...
    NES_INFO("Property concat: fields={}, numVectors={}, pageSize={}, layout={}, backend={}",
             fieldTypes.size(), numVectors, pageSize, magic_enum::enum_name(layoutType), magic_enum::enum_name(backend));
    ...
    NES_INFO("concat: merged vector has {} entries, reference has {} entries",
             pagedVectors[0]->getTotalNumberOfEntries(), fullReference.size());
