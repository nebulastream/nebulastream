...
{
    {
        ...
        EXPECT_TRUE(
            nautilus::memcmp(
                varSizedData.getRawValueAs<VariableSizedData>().getContent(), variableSizedData.data() + sizeOfLengthInBytes, sizeInBytes)
            == 0);
    }
...
TEST_F(VariableSizedDataTest, CopyConstruction)
{
    ...
    EXPECT_TRUE(
        nautilus::memcmp(
            copiedVarSizedData.getRawValueAs<VariableSizedData>().getContent(), variableSizedData.data() + sizeOfLengthInBytes, sizeInBytes)
        == 0);
    ...
    EXPECT_TRUE(
        nautilus::memcmp(
            copiedVarSizedData2.getRawValueAs<VariableSizedData>().getContent(),
...
{
    {
        ...
        EXPECT_TRUE(
            nautilus::memcmp(
                movedVarSizedData.getRawValueAs<VariableSizedData>().getContent(),
                variableSizedData.data() + sizeOfLengthInBytes,
                sizeInBytes)
            == 0);
    }
