...
#   Add these two lines to your ~/.gdbinit (create it if it doesn't exist):
#
...
# Load the NES pretty printer from the scripts/ folder
python
import sys
sys.path.insert(0, '/tmp/nebulastream-public/scripts')
