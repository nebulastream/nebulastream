...
ExpressionNodePtr operator/(ExpressionNodePtr leftExp, ExpressionNodePtr rightExp);
ExpressionNodePtr operator%(ExpressionNodePtr leftExp, ExpressionNodePtr rightExp);
ExpressionNodePtr meosIntersetc(ExpressionNodePtr longitude, ExpressionNodePtr latitude, ExpressionNodePtr timestamp);
...
ExpressionNodePtr operator/(ExpressionItem leftExp, ExpressionItem rightExp);
ExpressionNodePtr operator%(ExpressionItem leftExp, ExpressionItem rightExp);
ExpressionNodePtr meosIntersetc(ExpressionItem longitude, ExpressionItem latitude, ExpressionItem timestamp);
