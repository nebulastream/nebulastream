...
public:
    ...
    void setFailureInjectionFlag();

    bool testFailureInjectionFlag();
    ...
    std::expected<LocalQueryStatusSnapshot, Exception> createProvisionalStatusSnapshot(bool completed) const;
