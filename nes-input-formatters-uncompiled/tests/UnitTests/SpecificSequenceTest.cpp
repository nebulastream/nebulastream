...
#include <UncompiledInputFormatterTestUtil.hpp>

/// NOLINTBEGIN(readability-magic-numbers)
namespace NES
{

/// Tests whether the UncompiledSequenceShredder can handle specific sequences of input data, e.g., a single tuple without tuple delimiters, or splitting
...
{
    using namespace UncompiledInputFormatterTestUtil;
