...
static inline const std::vector<T> transitions = {
    ...
    {State::BuildingPipeline, Event::EncounterCustomScan, State::BuildingPipeline, {appendDefaultEmitIfNeeded, createPipeline, registerHandler}},
    ...
    {State::BuildingPipeline, Event::ForceNewFlag, State::ForcePipelineBreak, {appendDefaultEmitIfNeeded, createPipeline, prependDefaultScan}},
