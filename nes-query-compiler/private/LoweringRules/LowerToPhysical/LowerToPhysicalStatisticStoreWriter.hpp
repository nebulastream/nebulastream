...
template <>
inline LoweringRuleFn makeLoweringRule<LowerToPhysicalStatisticStoreWriter>()
{
    return [](LoweringRuleRegistryArguments arguments) -> LoweringRuleRegistryReturnType
    { return std::make_unique<LowerToPhysicalStatisticStoreWriter>(std::move(arguments)); };
}
