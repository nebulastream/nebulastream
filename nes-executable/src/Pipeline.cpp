...
std::string OperatorPipeline::toString() const
{
    ...
    oss << "OperatorPipeline(id: " << id << ", providerType: " << providerTypeToString(providerType) << ", ";
...
{
    std::ostringstream oss;
    oss << "SourcePipeline(id: " << id << ", providerType: " << providerTypeToString(providerType) << ", ";
...
{
    std::ostringstream oss;
    oss << "SinkPipeline(id: " << id << ", providerType: " << providerTypeToString(providerType) << ", ";
