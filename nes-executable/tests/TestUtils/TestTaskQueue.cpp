...
bool TestPipelineExecutionContext::emitBuffer(const NES::Memory::TupleBuffer& resultBuffer, const ContinuationPolicy continuationPolicy)
{
    switch (continuationPolicy)
    {
        ...
        default:
            PRECONDITION(
                false, "Not supporting ContinuationPolicy {} in TestPipelineExecutionContext.", magic_enum::enum_name(continuationPolicy));
    }
    return true;
}
...
void TestPipelineStage::execute(const NES::Memory::TupleBuffer& tupleBuffer, NES::Runtime::Execution::PipelineExecutionContext& pec)
{
