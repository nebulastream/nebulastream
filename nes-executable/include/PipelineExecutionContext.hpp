...
public:
    ...
    virtual bool emitBuffer(const Memory::PinnedBuffer& buffer) { return emitBuffer(buffer, ContinuationPolicy::POSSIBLE); };
    ...
    /// Returns success, if the buffer was emitted successfully.
    virtual bool emitBuffer(const Memory::PinnedBuffer&, ContinuationPolicy) = 0;
