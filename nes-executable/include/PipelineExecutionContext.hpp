...
public:
    ...
    virtual void setRuntimeInputFormatterHandle(uint64_t runtimeInputFormatterKey, std::uintptr_t runtimeHandle) = 0;
    [[nodiscard]] virtual std::uintptr_t getRuntimeInputFormatterHandle(uint64_t runtimeInputFormatterKey) const = 0;
};
}
