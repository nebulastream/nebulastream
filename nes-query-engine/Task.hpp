...
public:
    ...
    struct OnComplete
    {
        ...
        explicit OnComplete(onComplete cb) : callback(std::move(cb)) { }
    };
    ...
    struct OnSuccess
    {
        ...
        explicit OnSuccess(onSuccess cb) : callback(std::move(cb)) { }
    };
    ...
    struct OnFailure
    {
        ...
        explicit OnFailure(onFailure cb) : callback(std::move(cb)) { }
    };
