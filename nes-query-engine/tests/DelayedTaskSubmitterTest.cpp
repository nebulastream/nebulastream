...
struct TestClock
{
    ...
    static void advance(duration advanceBy, bool doAnActualWait = true)
    {
...
TEST_F(DelayedTaskSubmitterTest, testBasicTaskSubmission)
{
    ...
    TestClock::advance(std::chrono::milliseconds(9));
...
TEST_F(DelayedTaskSubmitterTest, testMultipleTasksOrderedExecution)
{
    ...
    TestClock::advance(std::chrono::milliseconds(10));
    ASSERT_EQ(getSubmittedTaskCount(), 1);
    TestClock::advance(std::chrono::milliseconds(10));
...
TEST_F(DelayedTaskSubmitterTest, testStressRandomTasks)
{
    ...
    TestClock::advance(std::chrono::milliseconds(maxDelayMs));
