...
createSinkPipeline(PipelineId id, std::shared_ptr<Memory::AbstractBufferProvider> bm)
{
    ...
    auto pipeline = std::make_shared<Runtime::Execution::ExecutablePipeline>(
        id, std::move(stage), std::vector<std::shared_ptr<Runtime::Execution::ExecutablePipeline>>{});
...
createPipeline(PipelineId id, const std::vector<std::shared_ptr<Runtime::Execution::ExecutablePipeline>>& successors)
{
    ...
    auto pipeline = std::make_shared<Runtime::Execution::ExecutablePipeline>(id, std::move(stage), successors);
