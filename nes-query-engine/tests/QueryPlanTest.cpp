...
struct TestPipelineExecutionContext : PipelineExecutionContext
{
    ...
    MOCK_METHOD(void, setRuntimeInputFormatterHandle, (uint64_t, std::uintptr_t), (override));
    MOCK_METHOD(std::uintptr_t, getRuntimeInputFormatterHandle, (uint64_t), (const, override));
