...
TEST_F(QueryPlanTest, RunningQueryPlanDefaultDestructor)
{
    ...
    {
        auto runningQueryPlan = RunningQueryPlan::start(QueryId{1}, std::move(queryPlan), controller, emitter, listener);
    }
...
TEST_F(QueryPlanTest, RunningQueryPlanDispose)
{
    ...
    {
        auto runningQueryPlan = dropRef(RunningQueryPlan::start(QueryId{1}, std::move(queryPlan), controller, emitter, listener));
