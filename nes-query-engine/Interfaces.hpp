...
public:
    ...
    virtual bool emitWork(
        ...
        = 0;
    virtual void emitPipelineStart(LocalQueryId, const std::shared_ptr<RunningQueryPlanNode>&, BaseTask::onComplete, BaseTask::onFailure) = 0;
    virtual void emitPendingPipelineStop(LocalQueryId, std::shared_ptr<RunningQueryPlanNode>, BaseTask::onComplete, BaseTask::onFailure) = 0;
    virtual void emitPipelineStop(LocalQueryId, std::unique_ptr<RunningQueryPlanNode>, BaseTask::onComplete, BaseTask::onFailure) = 0;
};
}
