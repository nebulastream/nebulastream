...
public:
    ...
    virtual void emitWork(QueryId, std::weak_ptr<RunningQueryPlanNode>, Memory::TupleBuffer, onComplete = {}, onFailure = {}) = 0;
    virtual void emitSetup(QueryId, std::weak_ptr<RunningQueryPlanNode>, onComplete = {}, onFailure = {}) = 0;
    virtual void emitStop(QueryId, std::unique_ptr<RunningQueryPlanNode>, onComplete = {}, onFailure = {}) = 0;
};
}
