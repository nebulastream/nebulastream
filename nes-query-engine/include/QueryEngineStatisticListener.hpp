...
{
    TaskEmit(WorkerThreadId threadId, LocalQueryId queryId, PipelineId fromPipeline, PipelineId toPipeline, TaskId taskId, size_t numberOfTuples)
...
{
    PipelineStop(WorkerThreadId threadId, LocalQueryId queryId, PipelineId pipeline_id) : EventBase(threadId, queryId), pipelineId(pipeline_id)
    {
    }
