...
{
    std::vector<std::unique_ptr<OperatorHandler>>* operatorHandlers = nullptr;
    ...
    std::vector<std::unique_ptr<OperatorHandler>>& getOperatorHandlers() override
    {
        PRECONDITION(operatorHandlers, "OperatorHandlers were not set");
        return *operatorHandlers;
    }
    void setOperatorHandlers(std::vector<std::unique_ptr<OperatorHandler>>& handlers) override
    {
