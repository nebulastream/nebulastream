    ...
    WorkEmitter& emitter)
{
    ...
    return [&controller, successors = std::move(successors), source, &emitter, queryId, availableBuffer = std::move(availableBuffer)](
               ...
               Sources::SourceReturnType::SourceReturnType event,
               const std::stop_token& stopToken) -> Sources::SourceReturnType::EmitResult
    {
        return std::visit(
            Overloaded{
                    ...
                    {
                        {
                            ...
                            {
                                return Sources::SourceReturnType::EmitResult::STOP_REQUESTED;
                            }
                        }
