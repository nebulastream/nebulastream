...
namespace NES
{
NodeFunctionBinary::NodeFunctionBinary(DataTypePtr stamp, std::string name) : FunctionNode(std::move(stamp), std::move(name))
{
}

NodeFunctionBinary::NodeFunctionBinary(NodeFunctionBinary* other) : FunctionNode(other)
{
...
NodeFunctionPtr NodeFunctionBinary::getRight() const
{
    ...
    return children[1]->as<FunctionNode>();
}
