...
namespace NES
{
NodeFunctionUnary::NodeFunctionUnary(DataTypePtr stamp, std::string name) : FunctionNode(std::move(stamp), std::move(name))
{
}

NodeFunctionUnary::NodeFunctionUnary(NodeFunctionUnary* other) : FunctionNode(other)
{
}
