...
{
    if (NES::Util::instanceOf<LessEqualsFunctionNode>(rhs))
    {
        auto other = NES::Util::as<LessEqualsFunctionNode>(rhs);
...
bool LessEqualsFunctionNode::validateBeforeLowering() const
{
