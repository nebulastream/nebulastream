...
{
    if (NES::Util::instanceOf<LessFunctionNode>(rhs))
    {
        auto other = NES::Util::as<LessFunctionNode>(rhs);
...
{
    return LessFunctionNode::create(Util::as<FunctionNode>(children[0])->copy(), Util::as<FunctionNode>(children[1])->copy());
}
