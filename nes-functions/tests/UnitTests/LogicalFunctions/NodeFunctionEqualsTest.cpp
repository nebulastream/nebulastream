...
class NodeFunctionEqualsTest : public Testing::BaseUnitTest
{
public:
    static void SetUpTestCase()
    {
        Logger::setupLogging("NodeFunctionEqualsTest.log", LogLevel::LOG_DEBUG);
        NES_INFO("Setup NodeFunctionEqualsTest test class.");
    }
    void SetUp() override
    {
        BaseUnitTest::SetUp();
...
TEST_F(NodeFunctionEqualsTest, validateBeforeLoweringDifferentChildNumbers)
{
    {
        ...
        nodeFunctionEquals->removeChildren();
        EXPECT_FALSE(nodeFunctionEquals->validateBeforeLowering());
    }

    {
        ...
        const auto nodeFunctionEquals = NodeFunctionEquals::create(nodeFunctionReadLeft, nodeFunctionReadRight);
        nodeFunctionEquals->inferStamp(dummySchema);
        nodeFunctionEquals->removeChild(nodeFunctionReadLeft);
        EXPECT_FALSE(nodeFunctionEquals->validateBeforeLowering());
    }

    {
        ...
        const auto nodeFunctionEquals = NodeFunctionEquals::create(nodeFunctionReadLeft, nodeFunctionReadRight);
        nodeFunctionEquals->inferStamp(dummySchema);
        nodeFunctionEquals->removeChild(nodeFunctionReadRight);
        EXPECT_FALSE(nodeFunctionEquals->validateBeforeLowering());
    }

    {
        ...
        const auto nodeFunctionEquals = NodeFunctionEquals::create(nodeFunctionReadLeft, nodeFunctionReadRight);
        nodeFunctionEquals->inferStamp(dummySchema);
        EXPECT_TRUE(nodeFunctionEquals->validateBeforeLowering());
    }
}

TEST_F(NodeFunctionEqualsTest, validateBeforeLoweringDifferentDataTypes)
{
        ...
        = [&](const std::string& leftType, const std::string& rightType, const bool expectedValue)
    {
        ...
        const auto nodeFunctionEquals = NodeFunctionEquals::create(nodeFunctionReadLeft, nodeFunctionReadRight);
        nodeFunctionEquals->inferStamp(dummySchema);
        EXPECT_EQ(nodeFunctionEquals->validateBeforeLowering(), expectedValue);
    };
    ...
    testValidateBeforeLoweringDifferentDataTypes("text", "text", true);
