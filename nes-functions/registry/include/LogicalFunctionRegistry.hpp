...
using LogicalFunctionRegistryReturnType = std::shared_ptr<NodeFunction>;
struct LogicalFunctionRegistryArguments
{
    std::vector<LogicalFunctionRegistryReturnType> childFunctions;
};
...
#define INCLUDED_FROM_REGISTRY_FUNCTION_LOGICAL
#include <LogicalFunctionGeneratedRegistrar.inc>
#undef INCLUDED_FROM_REGISTRY_FUNCTION_LOGICAL
