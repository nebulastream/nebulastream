 ...
 */
class AbsFunctionNode final : public ArithmeticalUnaryFunctionNode
{
public:
    explicit AbsFunctionNode(DataTypePtr stamp);
    ~AbsFunctionNode() noexcept override = default;
    /**
     * @brief Create a new ABS function
     */
...
private:
    explicit AbsFunctionNode(AbsFunctionNode* other);
};
