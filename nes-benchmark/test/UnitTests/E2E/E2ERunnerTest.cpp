...
/**
 * @brief Testing if a yaml file with concurrent queries can be run without any
 * error
 */
...
/**
 * @brief Testing if a yaml file with multiple sources can be run without any
 * error
...
/**
 * @brief Testing if a yaml file with multiple physical and logical sources can
 * be run without any error
 * TODO enable this with issue #3941
 */
