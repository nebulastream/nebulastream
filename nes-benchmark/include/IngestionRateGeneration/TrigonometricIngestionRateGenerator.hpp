...
/**
 * @brief As we still build on with libstdc++, this is how we get the numerical
 * value of pi
 * @return pi
 */
 ...
 * generation of sine and cosine distributed ingestion rates.
 */
class TrigonometricIngestionRateGenerator : public IngestionRateGenerator {
 public:
   ...
   * values that are distributed according to ingestionRateDistribution
 ...
 private:
  /**
   * @brief calculates the sine of x. Sine has a period length of
   * ingestionRateInBuffers divided by numberOfPeriods
   * @param xValue
   * @return value
   */
  ...
  /**
   * @brief calculates the cosine of x. Cosine has a period length of
   * ingestionRateInBuffers divided by numberOfPeriods
   * @param xValue
   * @return value
   */
