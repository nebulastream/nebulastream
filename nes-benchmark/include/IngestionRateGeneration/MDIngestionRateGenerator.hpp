...
/**
 * @brief The following arrays are values for the ingestion rate distributions M1, M2, D1 and D2
 */
uint64_t constexpr m1Values[] = {35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000,35000};
uint64_t constexpr m2Values[] = {10000,20000,30000,40000,50000,60000,70000,80000,90000,100000,90000,80000,70000,60000,50000,40000,30000,20000};
uint64_t constexpr d1Values[] = {10000,20000,30000,40000,50000,60000,70000,80000,90000,100000,90000,80000,70000,60000,50000,40000,30000,20000,30000,40000,50000,60000,70000,80000,90000,100000,90000,80000,70000,60000};
uint64_t constexpr d2Values[] = {100000,90000,80000,70000,60000,50000,40000,30000,20000,10000,20000,30000,40000,50000,60000,70000,80000,90000,100000,90000,80000,70000,60000,50000,40000,30000,20000,30000,40000,50000};
