...
/**
 * @brief This class inherits from DataProvider. The internal provider ingests
 * the generated data as quickly as possible.
 */
class InternalProvider : public DataProvider, public Runtime::BufferRecycler {
 public:
   ...
   */
  std::optional<Runtime::TupleBuffer> readNextBuffer(
      uint64_t sourceId) override;
