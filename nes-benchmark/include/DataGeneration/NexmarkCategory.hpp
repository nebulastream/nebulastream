...
#ifndef NES_NEXMARKCATEGORY_HPP
#define NES_NEXMARKCATEGORY_HPP

#include <DataGeneration/DataGenerator.hpp>

namespace NES::Benchmark::DataGeneration {
class NexmarkCategory : public DataGenerator {
  public:
    /**
         ...
         * @param maxValue
         */
    explicit NexmarkCategory(uint64_t minValue, uint64_t maxValue);
