...
#ifndef NES_NEXMARKAUCTION_HPP
#define NES_NEXMARKAUCTION_HPP

#include <DataGeneration/DataGenerator.hpp>

namespace NES::Benchmark::DataGeneration {
class NexmarkAuction : public DataGenerator {
  public:
    /**
         ...
         * @param maxValue
         */
    explicit NexmarkAuction(uint64_t minValue, uint64_t maxValue);
