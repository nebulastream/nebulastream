...
#ifndef NES_NEXMARKPERSON_HPP
#define NES_NEXMARKPERSON_HPP

#include <DataGeneration/DataGenerator.hpp>

namespace NES::Benchmark::DataGeneration {
class NexmarkPerson : public DataGenerator {
  public:
    /**
         ...
         * @param maxValue
         */
    explicit NexmarkPerson(uint64_t minValue, uint64_t maxValue);
