 ...
 */
static double BM_TestMassiveSending(
    uint64_t bufferSize, uint64_t buffersManaged, uint64_t numSenderThreads,
...
int main(int argc, char** argv) {
  ...
  benchmarkFile.open(
      benchmarkFolderName + "/" + (benchmarkName) + "_results.csv",
      std::ios_base::app);
