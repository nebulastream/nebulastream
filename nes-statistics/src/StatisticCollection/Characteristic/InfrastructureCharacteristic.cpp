...
WorkerId InfrastructureStatistic::getNodeId() const
{
    return nodeId;
}

InfrastructureStatistic::InfrastructureStatistic(const MetricPtr type, const WorkerId nodeId) : Characteristic(type), nodeId(nodeId)
{
}
