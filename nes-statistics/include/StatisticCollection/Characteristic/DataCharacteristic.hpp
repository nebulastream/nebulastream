...
/**
 * @brief Represents a data characteristic that results in collecting statistics
 * over a given logical stream and all or a subset of the physical source
 */
...
public:
   ...
   * @param physicalSourceName: Physical source name to collect the statistics
   * over
...
private:
   ...
   * @param logicalSourceName: Logical source name to collect the statistics
   * from
   * @param physicalSourceNames: Physical source name to collect the statistics
   * from
   */
  DataCharacteristic(MetricPtr type, std::string logicalSourceName,
                     const std::string &physicalSourceName);
