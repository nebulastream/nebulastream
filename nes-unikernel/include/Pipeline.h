...
using SubQueryPlan7 = SubQuery<UnikernelSink<SinkConfig7>,
                               PipelineJoin<Stage<4>,
                                            PipelineJoin<Stage<5>,
                                                         Pipeline<Stage<6>, UnikernelSource<SourceConfig29>>,
                                                         Pipeline<Stage<8>, UnikernelSource<SourceConfig13>>>,
                                            Pipeline<Stage<10>, UnikernelSource<SourceConfig17>>>>;
