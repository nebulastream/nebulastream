...
uint64_t var_0_21;
uint8_t* var_0_22;
NES::NESStrongType<unsigned int, NES::WorkerThreadId_, 4294967295, 0> var_0_23 = NES::INVALID<NES::NESStrongType<unsigned int, NES::WorkerThreadId_, 4294967295, 0>>;
uint8_t* var_0_24;
uint64_t var_0_25;
uint64_t var_0_26;
uint8_t* var_0_27;
...
var_0_23 = getWorkerThreadIdProxy(var_0_124);
...
static NES::Runtime::Execution::Operators::KeyedSlicePreAggregationHandler handler0(uint64_t(10000), uint64_t(2000), std::vector<NES::OriginId>{NES::OriginId(4)});
switch(index) {
case 0:
	return &handler0;
default:
