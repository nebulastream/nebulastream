...
struct SourceConfig35 {
    ...
    constexpr static SharedQueryId QueryId = NES::SharedQueryId(0);
    constexpr static OperatorId UpstreamNodeId = NES::OperatorId(9);
    constexpr static OperatorId OperatorId = NES::OperatorId(9);
    constexpr static OriginId OriginId = NES::OriginId(1);
