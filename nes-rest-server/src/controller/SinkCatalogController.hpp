...
public:
     ...
     */
    SinkCatalogController(const std::shared_ptr<ObjectMapper>& objectMapper, const std::shared_ptr<std::unordered_map<std::string, NES::SERVER::Sink>> sinkCatalog)
...
private:
    std::shared_ptr<std::unordered_map<std::string, NES::SERVER::Sink>> sinkCatalog;
