...
void run(int port, std::shared_ptr<NES::SourceCatalog> sourceCatalog, std::shared_ptr<std::map<size_t, std::string>> queryCatalog, std::shared_ptr<std::unordered_map<std::string, NES::SERVER::Sink>> sinkCatalog)
{
...
int main(int argc, char* argv[]) {
    ...
    auto sinkCatalog = std::make_shared<std::unordered_map<std::string, NES::SERVER::Sink>>();
