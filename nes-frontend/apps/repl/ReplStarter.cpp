...
int main(int argc, char** argv)
{
    CPPTRACE_TRY
    {
        ...
        /// Derive a routable WorkerId from the gRPC bind address.
        ...
        const auto connectionAddr = singleNodeWorkerConfig.connection.getValue();
        const NES::WorkerConfig workerConfig{
            .host = NES::WorkerId(grpcAddr),
            .connection = connectionAddr,
            .capacity = 10000,
            .downstream = {},
            .config = singleNodeWorkerConfig,
        };
        workerCatalog->addWorker(workerConfig.host, workerConfig.connection, workerConfig.capacity, workerConfig.downstream);
