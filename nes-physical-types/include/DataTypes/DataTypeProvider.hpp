...
std::optional<DataType> tryProvideDataType(const std::string& type, Nullable isNullable);
...
DataType provideDataType(const std::string& type, Nullable isNullable);
DataType provideDataType(DataType::Type type);
DataType provideDataType(DataType::Type type, Nullable isNullable);
