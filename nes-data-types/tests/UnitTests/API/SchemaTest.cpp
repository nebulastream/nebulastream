...
{
    const auto field1 = AttributeField("bidbid$start", DataTypeProvider::provideBasicType(BasicType::UINT64));
    const auto field2 = AttributeField("bidbid$end", DataTypeProvider::provideBasicType(BasicType::UINT64));
    const auto field3 = AttributeField("bid$start", DataTypeProvider::provideBasicType(BasicType::UINT64));
    const auto field4 = AttributeField("auction$id", DataTypeProvider::provideBasicType(BasicType::UINT64));
    const auto field5 = AttributeField("auction$initialbid", DataTypeProvider::provideBasicType(BasicType::UINT64));

    const auto schemaUnderTest = Schema().addField(field1).addField(field2).addField(field3).addField(field4).addField(field5);
