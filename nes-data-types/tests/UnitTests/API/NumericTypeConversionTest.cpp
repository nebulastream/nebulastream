...
struct TypeConversionTestInput
{
    DataType::Type left;
    DataType::Type right;
    Nullable leftIsNullable;
    Nullable rightIsNullable;
...
TEST_P(NumericTypeConversionTest, SimpleTest)
{
    ...
    auto join = [](const DataType::Type left,
                   ...
                   const Nullable leftIsNullable,
                   const Nullable rightIsNullable)
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values<TypeConversionTestInput>(
        TypeConversionTestInput{
            ...
            Nullable::IS_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::INT32, Nullable::IS_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::UINT16,
            Nullable::NOT_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::INT32, Nullable::NOT_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::UINT32,
            Nullable::IS_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::UINT32, Nullable::IS_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::UINT64,
            Nullable::IS_NULLABLE,
            Nullable::IS_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::UINT64, Nullable::IS_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::INT8,
            Nullable::IS_NULLABLE,
        ...
        TypeConversionTestInput{
            ...
            Nullable::IS_NULLABLE,
            Nullable::IS_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::INT64, Nullable::IS_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::FLOAT32,
            Nullable::NOT_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::FLOAT32, Nullable::NOT_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT8,
            DataType::Type::FLOAT64,
            Nullable::IS_NULLABLE,
            Nullable::IS_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::FLOAT64, Nullable::IS_NULLABLE)},
        ...
        TypeConversionTestInput{
            ...
            Nullable::NOT_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::INT64, Nullable::NOT_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT16,
            DataType::Type::FLOAT32,
            Nullable::NOT_NULLABLE,
        ...
        TypeConversionTestInput{
            ...
            Nullable::NOT_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::UINT64, Nullable::NOT_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::UINT32,
            DataType::Type::INT16,
            Nullable::IS_NULLABLE,
        ...
        TypeConversionTestInput{
            ...
            Nullable::IS_NULLABLE,
            Nullable::IS_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::FLOAT32, Nullable::IS_NULLABLE)},
        TypeConversionTestInput{
            DataType::Type::INT32,
            DataType::Type::FLOAT64,
            Nullable::IS_NULLABLE,
        ...
        TypeConversionTestInput{
            ...
            Nullable::NOT_NULLABLE,
            Nullable::NOT_NULLABLE,
            DataTypeProvider::provideDataType(DataType::Type::FLOAT64, Nullable::NOT_NULLABLE)}),
