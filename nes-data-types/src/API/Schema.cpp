...
std::string Schema::getQualifierNameForSystemGeneratedFields() const {
  ...
  NES_ERROR(
      "Schema::getQualifierNameForSystemGeneratedFields: a schema is not "
  ...
  if (fieldNodeType == "CHAR") {
    if (fieldNodeLength.empty() || fieldNodeLength == "\n" ||
      ...
      NES_THROW_RUNTIME_ERROR(
          "Found Invalid Logical Source Configuration. Please define Schema "
...
SchemaPtr Schema::createFromSchemaType(
