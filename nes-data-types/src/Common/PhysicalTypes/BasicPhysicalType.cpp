...
std::string BasicPhysicalType::convertRawToString(
  ...
  switch (nativeType) {
    ...
    case TEXT: {
      NES_DEBUG(
          "BasicPhysicalType::convertRawToString(): TEXT conversion to string "
...
std::string BasicPhysicalType::convertRawToStringWithoutFill(
  ...
  switch (nativeType) {
    ...
    case BOOLEAN:
      return std::to_string(*reinterpret_cast<bool const*>(data));
    case TEXT: {
      return "BasicPhysicalType::convertRawToString(): TEXT conversion to "
