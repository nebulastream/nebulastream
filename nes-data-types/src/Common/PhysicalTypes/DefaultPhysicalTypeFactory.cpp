...
PhysicalTypePtr DefaultPhysicalTypeFactory::getPhysicalType(
...
PhysicalTypePtr DefaultPhysicalTypeFactory::getPhysicalType(
    const ArrayPtr& arrayType) const {
