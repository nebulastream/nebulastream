...
/**
 * @brief The BasicPhysicalType represents nes data types, which can be directly
 * mapped to a native c++ type.
 */
class BasicPhysicalType final : public PhysicalType {
 public:
   ...
   * @return string
   */
  std::string convertRawToStringWithoutFill(
      void const* rawData) const noexcept override;
