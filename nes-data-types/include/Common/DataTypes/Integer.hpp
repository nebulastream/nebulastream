 ...
 * The internal Integer type is parameterised by its bit size, and its lower and
 * upper bound Integer(bitSize, lowerBound, upperBound)
 */
...
public:
   ...
   * Undefined. For integers, we can join with all numeric data types.
