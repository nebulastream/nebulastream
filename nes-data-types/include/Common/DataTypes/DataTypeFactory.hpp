...
public:
   ...
   */
  static ValueTypePtr
  createArrayValueWithContainedType(const DataTypePtr &type,
   ...
   */
  static ValueTypePtr
  createArrayValueFromContainerType(const std::shared_ptr<ArrayType> &type,
                                    std::vector<std::string> &&values) noexcept;
   ...
   */
  static ValueTypePtr
  createFixedCharValue(std::vector<std::string> &&values) noexcept;
