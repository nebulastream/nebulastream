...
public:
     ...
     */
    static std::shared_ptr<SerializableSchema> serializeSchema(const Schema& schema, SerializableSchema* serializedSchema);
    static void serializeSchemaIdentifier(const Schema::Identifier&, SchemaIdentifier& identifier);
    ...
    */
    ...
    static Schema::Identifier deserializeSchemaIdentifier(const SchemaIdentifier& identifier);
};
}
