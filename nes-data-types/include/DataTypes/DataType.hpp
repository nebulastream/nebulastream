...
namespace NES
{
// Todo: use an enum-tagged variant and visitor pattern?
// -> would only seem helpful if there was more type-specific functionality
// -> the benefit would be that the outside would never need to do any enum/type checking, but could simply call the
//    interface functions
struct PhysicalType
{
