...
private:
    ...
    /// UNUSED during the "naive" implementation
    [[maybe_unused]] OperatorHandlerId operatorHandlerId;
    [[maybe_unused]] std::vector<DeltaFieldLayoutEntry> deltaFieldLayout;
    [[maybe_unused]] size_t deltaFieldsEntrySize;
    [[maybe_unused]] std::vector<DeltaFieldLayoutEntry> fullRecordLayout;
