...
{
public:
    explicit WindowProbePhysicalOperator(std::vector<std::unique_ptr<TupleBufferMemoryProvider>> memoryProvider, uint64_t operatorHandlerIndex, std::string windowStartFieldName, std::string windowEndFieldName);
