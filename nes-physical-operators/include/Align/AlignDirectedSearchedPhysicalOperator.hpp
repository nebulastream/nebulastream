...
class AlignDirectedSearchedPhysicalOperator final : public PhysicalOperatorConcept
{
public:
    AlignDirectedSearchedPhysicalOperator(
    ...
    AlignDirectedSearchedPhysicalOperator(const AlignDirectedSearchedPhysicalOperator& other);
