...
class AlignDirectedDrivingPhysicalOperator final : public PhysicalOperatorConcept
{
public:
    AlignDirectedDrivingPhysicalOperator(
    ...
    AlignDirectedDrivingPhysicalOperator(const AlignDirectedDrivingPhysicalOperator& other);
