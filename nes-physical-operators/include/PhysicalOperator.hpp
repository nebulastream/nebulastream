...
public:
    ...
    [[nodiscard]] const std::optional<PhysicalSchema>& getInputSchema() const;
    [[nodiscard]] const std::optional<PhysicalSchema>& getOutputSchema() const;
...
private:
    ...
    std::optional<PhysicalSchema> inputSchema;
    std::optional<PhysicalSchema> outputSchema;
    std::vector<std::shared_ptr<PhysicalOperatorWrapper>> children;
