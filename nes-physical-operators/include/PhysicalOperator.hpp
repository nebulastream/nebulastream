...
public:
    ...
    PhysicalOperatorWrapper(PhysicalOperator physicalOperator, std::optional<Schema<QualifiedUnboundField, Ordered>> inputSchema, MemoryLayoutType inputMemoryLayoutType, PipelineLocation pipelineLocation);
