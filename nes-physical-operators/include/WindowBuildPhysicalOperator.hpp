...
class WindowBuildPhysicalOperator
{
public:
    ...
    [[nodiscard]] WindowBuildPhysicalOperator withChild(PhysicalOperator newChild) const;
...
static_assert(PhysicalOperatorConcept<WindowBuildPhysicalOperator>);
