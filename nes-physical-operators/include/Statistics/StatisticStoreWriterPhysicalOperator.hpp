...
/// the statistic metadata record [statisticId, statisticStart, statisticEnd, statisticNumberOfSeenTuples].
...
public:
    struct FieldIdentifiers
    {
        ...
        Record::RecordFieldIdentifier inputNumberOfSeenTuples;
    ...
    StatisticStoreWriterPhysicalOperator(
        OperatorHandlerId operatorHandlerId, StatisticId statisticId, StatisticType statisticType, FieldIdentifiers fieldIdentifiers);
