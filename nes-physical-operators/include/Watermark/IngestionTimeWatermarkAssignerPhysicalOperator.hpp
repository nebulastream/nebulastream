...
public:
    ...
    bool operator==(const IngestionTimeWatermarkAssignerPhysicalOperator& other) const { return id == other.id; }
...
static_assert(PhysicalOperatorConcept<IngestionTimeWatermarkAssignerPhysicalOperator>);
