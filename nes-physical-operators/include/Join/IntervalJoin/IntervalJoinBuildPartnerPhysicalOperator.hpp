...
/// Partner-side (right input) build operator: registers/notifies/terminates against the handler's
/// partner store. execute() is inherited from IntervalJoinBuildPhysicalOperator.
