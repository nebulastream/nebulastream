...
struct JoinSchema
{
    JoinSchema(PhysicalSchema leftSchema, PhysicalSchema rightSchema, PhysicalSchema joinSchema)
        : leftSchema(std::move(leftSchema)), rightSchema(std::move(rightSchema)), joinSchema(std::move(joinSchema))
    {
    }

    PhysicalSchema leftSchema;
    PhysicalSchema rightSchema;
    PhysicalSchema joinSchema;
};
}
