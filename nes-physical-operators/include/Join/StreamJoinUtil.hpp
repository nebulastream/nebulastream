...
struct JoinSchema
{
    JoinSchema(UnboundSchema leftSchema, UnboundSchema rightSchema, UnboundSchema joinSchema)
        : leftSchema(std::move(leftSchema)), rightSchema(std::move(rightSchema)), joinSchema(std::move(joinSchema))
    {
    }

    UnboundSchema leftSchema;
    UnboundSchema rightSchema;
    UnboundSchema joinSchema;
};
}
