...
struct JoinSchema
{
    JoinSchema(Schema<QualifiedUnboundField, Ordered> leftSchema, Schema<QualifiedUnboundField, Ordered> rightSchema, Schema<QualifiedUnboundField, Ordered> joinSchema)
