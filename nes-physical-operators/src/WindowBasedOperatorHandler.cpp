...
WindowBasedOperatorHandler::WindowBasedOperatorHandler(
    const std::vector<OriginId>& inputOrigins, const OriginId outputOriginId, bool sequentialProcessing)
    : numberOfWorkerThreads(0), sequentialProcessing(sequentialProcessing), outputOriginId(outputOriginId), inputOrigins(inputOrigins)
{
}
