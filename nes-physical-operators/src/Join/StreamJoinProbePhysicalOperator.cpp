    ...
    const std::vector<Record::RecordFieldIdentifier>& projectionsInner) const
{
    ...
    joinedRecord.write(convertLegacyIdList(windowMetaData.windowStartFieldName), windowStart.convertToValue());
    joinedRecord.write(convertLegacyIdList(windowMetaData.windowEndFieldName), windowEnd.convertToValue());
