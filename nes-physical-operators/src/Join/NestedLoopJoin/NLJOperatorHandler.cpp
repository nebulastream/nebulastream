...
NLJOperatorHandler::getCreateNewSlicesFunction(const CreateNewSlicesArguments& args) const
{
    ...
    return std::function(
        [numberOfWorkerThreads = numberOfWorkerThreads,
         ...
         tupleSizeRight = nljArgs.tupleSizeRight](SliceStart s, SliceEnd e) -> std::vector<std::shared_ptr<Slice>>
        { return {std::make_shared<NLJSlice>(*bufferProvider, s, e, numberOfWorkerThreads, tupleSizeLeft, tupleSizeRight)}; });
}
