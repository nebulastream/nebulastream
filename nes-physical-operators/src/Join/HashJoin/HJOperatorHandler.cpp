...
void HJOperatorHandler::setNautilusCleanupExec(std::shared_ptr<NautilusCleanupExec> nautilusCleanupExec, const JoinBuildSideType& buildSide)
{
    switch (buildSide)
    {
...
std::shared_ptr<HJOperatorHandler::NautilusCleanupExec> HJOperatorHandler::getNautilusCleanupExec(const JoinBuildSideType& buildSide) const
{
    switch (buildSide)
    {
        case JoinBuildSideType::Right:
