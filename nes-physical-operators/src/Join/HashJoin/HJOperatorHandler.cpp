...
HJOperatorHandler::getCreateNewSlicesFunction(const CreateNewSlicesArguments& newSlicesArguments) const
{
    ...
    newHashMapArgs.numberOfBuckets = std::clamp(rollingAverageNumberOfKeys.getAverage(), 1.0, maxNumberOfBuckets);
    return std::function(
