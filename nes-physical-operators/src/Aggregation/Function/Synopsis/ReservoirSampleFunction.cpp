...
#include <Aggregation/Function/Synopsis/ReservoirSampleFunction.hpp>

#include <random>
#include <Aggregation/Function/Synopsis/SampleFunction.hpp>
    ...
    const nautilus::val<AggregationState*>& aggregationState, PipelineMemoryProvider& pipelineMemoryProvider, const Record& record)
{
    ...
    auto currRecordIdx = Util::readValueFromMemRef<uint64_t>(curRecordIdxPtr);
    auto sampleDataSize = Util::readValueFromMemRef<uint64_t>(sampleDataSizePtr);
    ...
    PipelineMemoryProvider&)
{
    ...
    auto currRecordIdx1 = Util::readValueFromMemRef<uint64_t>(curRecordIdxPtr1);
    auto sampleDataSize1 = Util::readValueFromMemRef<uint64_t>(sampleDataSizePtr1);
    ...
    auto currRecordIdx2 = Util::readValueFromMemRef<uint64_t>(curRecordIdxPtr2);
    auto sampleDataSize2 = Util::readValueFromMemRef<uint64_t>(sampleDataSizePtr2);
