...
WindowBuildPhysicalOperator::WindowBuildPhysicalOperator(OperatorHandlerId operatorHandlerIndex, std::unique_ptr<TimeFunction> timeFunction)
...
WindowBuildPhysicalOperator::WindowBuildPhysicalOperator(const WindowBuildPhysicalOperator& other)
    ...
    , child(other.child)
    , operatorHandlerIndex(other.operatorHandlerIndex)
