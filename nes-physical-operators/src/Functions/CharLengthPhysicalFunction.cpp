...
VarVal CharLengthPhysicalFunction::execute(const Record& record, ArenaRef& arena) const
{
    ...
    constexpr auto utf8ContinuationMask = static_cast<int8_t>(0xC0);
    constexpr auto utf8ContinuationPattern = static_cast<int8_t>(0x80);
    ...
    for (nautilus::val<uint64_t> i = 0; i < size; i = i + nautilus::val<uint64_t>(1))
    {
        ...
        const auto isLeading = (byte & nautilus::val<int8_t>(utf8ContinuationMask)) != nautilus::val<int8_t>(utf8ContinuationPattern);
