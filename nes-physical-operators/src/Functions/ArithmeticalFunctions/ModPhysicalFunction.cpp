...
PhysicalFunctionRegistryReturnType RegisterModPhysicalFunction(PhysicalFunctionRegistryArguments physicalFunctionRegistryArguments)
{
...
ADD_PLUGIN("Mod")
{
    PhysicalFunctionRegistry::registerPlugin("Mod", RegisterModPhysicalFunction);
}
}
