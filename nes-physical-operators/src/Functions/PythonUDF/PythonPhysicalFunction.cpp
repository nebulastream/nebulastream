    ...
    const std::vector<std::string>& importPaths)
{
    ...
    try
    {
        /// No built-in Codon extension plugins are preloaded here; a deployment can call loadCodonPlugin(...)
        /// at worker startup to make additional native symbols/modules available to inline Python UDFs.
