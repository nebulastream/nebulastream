...
LessPhysicalFunction::LessPhysicalFunction(
...
PhysicalFunctionRegistryReturnType PhysicalFunctionGeneratedRegistrar::RegisterLessPhysicalFunction(
    PhysicalFunctionRegistryArguments PhysicalFunctionRegistryArguments)
{
    ...
    return std::make_unique<LessPhysicalFunction>(
