...
IREEInferenceOperatorHandler::IREEInferenceOperatorHandler(NES::Model model) : model(std::move(model))
{
}
...
const NES::Model& IREEInferenceOperatorHandler::getModel() const
{
    return model;
}
