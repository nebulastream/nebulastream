...
QueryState SharedQueryCatalogEntry::getQueryState() const
{
    return queryState;
}
...
void SharedQueryCatalogEntry::setTerminationReason(std::string terminationReason)
{
...
DecomposedQueryPlanMetaDataPtr SharedQueryCatalogEntry::getDecomposedQueryPlanMetaData(DecomposedQueryPlanId decomposedQueryPlanId)
{
    ...
    QueryState decomposedQueryPlanState)
{
    auto decomposedQueryPlanMetaDatum
        = DecomposedQueryPlanMetaData::create(decomposedQueryPlanId, decomposedQueryPlanVersion, decomposedQueryPlanState, workerId);
