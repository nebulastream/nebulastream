...
std::vector<TopologyNodePtr> PathFinder::mergeSubGraphs(const std::vector<TopologyNodePtr>& startNodes) {
...
std::optional<TopologyNodePtr> PathFinder::findAllPathBetween(const TopologyNodePtr& startNode,
...
TopologyNodePtr PathFinder::find(TopologyNodePtr testNode,
