...
public:
  static void SetUpTestCase() {
    ...
    NES::Logger::setupLogging("TopologyIteratorTest.log",
  ...
  void SetUp() override {
    ...
    rootNode = TopologyNode::create(INVALID_WORKER_NODE_ID, "localhost", 4000,
                                    5000, 4, properties);
    mid1 = TopologyNode::create(WorkerId(1), "localhost", 4001, 5001, 4,
                                properties);
    mid2 = TopologyNode::create(WorkerId(2), "localhost", 4002, 5002, 4,
                                properties);
    mid3 = TopologyNode::create(WorkerId(3), "localhost", 4003, 5003, 4,
                                properties);
    src1 = TopologyNode::create(WorkerId(4), "localhost", 4004, 5004, 4,
                                properties);
    src2 = TopologyNode::create(WorkerId(5), "localhost", 4005, 5005, 4,
                                properties);
    src3 = TopologyNode::create(WorkerId(6), "localhost", 4006, 5006, 4,
                                properties);
    src4 = TopologyNode::create(WorkerId(7), "localhost", 4007, 5007, 4,
                                properties);
  }
...
TEST_F(TopologyIteratorTest, testLinearTopology) {
  ...
  topology->registerWorker(rootWorkerId, "localhost", 4000, 5000, 4, properties,
                           0, 0);
  WorkerId middleNodeId = WorkerId(2);
  topology->registerWorker(middleNodeId, "localhost", 4001, 5001, 4, properties,
                           0, 0);
  WorkerId srcNodeId = WorkerId(3);
  topology->registerWorker(srcNodeId, "localhost", 4004, 5004, 4, properties, 0,
                           0);
  ...
  NES_DEBUG("TopologyIteratorTest::testLinearTopology topology: {}",
            topology->toString());

  auto rootLockedTopologyNode = topology->lockTopologyNode(rootWorkerId);

  auto bfIterator =
      BreadthFirstNodeIterator(rootLockedTopologyNode->operator*()).begin();
  ...
  auto dfIterator =
      DepthFirstNodeIterator(rootLockedTopologyNode->operator*()).begin();
...
TEST_F(TopologyIteratorTest, testMultipleSources) {
  ...
  topology->registerWorker(middleNodeId1, "localhost", 4001, 5001, 4,
                           properties, 0, 0);
  WorkerId srcNodeId1 = WorkerId(3);
  topology->registerWorker(srcNodeId1, "localhost", 4004, 5004, 4, properties,
                           0, 0);
  WorkerId srcNodeId2 = WorkerId(4);
  topology->registerWorker(srcNodeId2, "localhost", 4004, 5004, 4, properties,
                           0, 0);
...
TEST_F(TopologyIteratorTest, testTopologyWithDiffernetDepths) {
  ...
  topology->registerWorker(middleNodeId2, "localhost", 4001, 5001, 4,
                           properties, 0, 0);
...
TEST_F(TopologyIteratorTest, testBranchedAndMergedTopology) {
  ...
  topology->registerWorker(middleNodeId3, "localhost", 4001, 5001, 4,
                           properties, 0, 0);
  WorkerId srcNodeId1 = WorkerId(5);
  topology->registerWorker(srcNodeId1, "localhost", 4004, 5004, 4, properties,
                           0, 0);
...
TEST_F(TopologyIteratorTest, testWithHiearchicalTopology) {
  ...
  topology->registerWorker(srcNodeId3, "localhost", 4004, 5004, 4, properties,
                           0, 0);
  WorkerId srcNodeId4 = WorkerId(7);
  topology->registerWorker(srcNodeId4, "localhost", 4004, 5004, 4, properties,
                           0, 0);
