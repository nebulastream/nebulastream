...
public:
  ...
  registerPhysicalSource(const std::string &physicalSourceName,
  ...
  getPhysicalSources(const std::string &logicalSourceName);
   ...
   */
  bool
  addKeyDistributionEntry(const Catalogs::Source::SourceCatalogEntryPtr &entry,
