...
class Topology {
 public:
  ...
  WorkerId registerWorkerAsRoot(
      WorkerId newRootWorkerId, const std::string& address,
   ...
   * subgraph.
   */
  std::optional<TopologyNodePtr> findAllPathBetween(
      WorkerId sourceTopologyNodeId, WorkerId destinationTopologyNodeId);
   ...
   */
  std::vector<TopologyNodePtr> findPathBetween(
 ...
 private:
   ...
   */
  static std::vector<TopologyNodePtr> mergeSubGraphs(
