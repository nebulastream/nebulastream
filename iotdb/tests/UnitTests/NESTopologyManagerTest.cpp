...
TEST_F(NesTopologyManagerTest, create_existing_link) {
    ...
    auto node_1 = NESTopologyManager::getInstance().createNESWorkerNode(2,
                                                                        "localhost", CPUCapacity::MEDIUM);
    auto link = NESTopologyManager::getInstance().createNESTopologyLink(node_0, node_1, 1, 1);
    EXPECT_EQ(
        link,
        NESTopologyManager::getInstance().createNESTopologyLink(node_0, node_1, 1, 1));
}
...
TEST_F(NesTopologyManagerTest, remove_non_existing_link) {
    ...
    link = NESTopologyManager::getInstance().createNESTopologyLink(node_0, node_1, 1, 1);
