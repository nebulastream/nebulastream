...
int main(int argc, const char* argv[])
{
    ...
    desc.add_options()("help", "Print help messages")(
        "numBuffers", po::value<size_t>(&numBuffers)->default_value(numBuffers), "The number of buffers")(
        "numThreads", po::value<size_t>(&numThreads)->default_value(numThreads), "The number of threads")(
        "numCampaings", po::value<size_t>(&numCampaings)->default_value(numCampaings), "The number of campaings")(
        "numSources", po::value<size_t>(&numSources)->default_value(numSources), "The number of sources")(
        "bufferSizeInByte", po::value<size_t>(&bufferSizeInByte)->default_value(bufferSizeInByte),
        "Buffersize in Byte");
