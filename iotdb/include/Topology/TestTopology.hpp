...
void createExampleTopology() {
  ...
  const NESTopologyCoordinatorNodePtr &sinkNode =
      NESTopologyManager::getInstance().createNESCoordinatorNode(0,
  ...
  StreamCatalog::instance().addLogicalStream("humidity1",
                                             std::make_shared<Schema>(schema));
  StreamCatalogEntryPtr e2 = std::make_shared<StreamCatalogEntry>("", "",
                                                                  sensorNode2,
                                                                  "humidity1");
  ...
  StreamCatalog::instance().addLogicalStream("temperature2",
                                             std::make_shared<Schema>(schema));
  StreamCatalogEntryPtr e3 = std::make_shared<StreamCatalogEntry>(
      "", "", sensorNode3, "temperature2");
  ...
  StreamCatalog::instance().addLogicalStream("humidity2",
                                             std::make_shared<Schema>(schema));
  StreamCatalogEntryPtr e4 = std::make_shared<StreamCatalogEntry>("", "",
                                                                  sensorNode4,
                                                                  "humidity2");
