...
class InputQuery {
   ...
   * @return this object
   */
    InputQuery& writeToKafka(const std::string& brokers, const std::string& topic, const size_t kafkaProducerTimeout);
     ...
     * @return this object
     */
    InputQuery& writeToKafka(const std::string& topic, const cppkafka::Configuration& config);
