...
class ExecutionGraph {
   ...
   */
    const executionVertex_t getVertex(int searchId) const;
   ...
   */
    bool hasVertex(int searchId) const;
   ...
   * @return bool indicating success
   */
    bool removeVertex(int searchId);
   ...
   */
    const ExecutionNodePtr getNode(int searchId) const;
   ...
   * @bool indicating existence
   */
    bool hasEdge(int searchId) const;
   ...
   * @return
   */
    const vector<ExecutionEdge> getAllEdgesToNode(
        ExecutionNodePtr destNode) const;
   ...
   */
    const vector<ExecutionEdge> getAllEdgesFromNode(
   ...
   */
    const ExecutionEdge* getEdge(int searchId) const;
};
