...
YSBWindow::YSBWindow(size_t pcampaignCnt, size_t windowSizeInSec): Window(nullptr),
...
YSBWindow::YSBWindow(): Window(nullptr), mutex(), currentWindow(0),lastChangeTimeStamp(time(NULL)), windowSizeInSec(1), campaignCnt(1)
{
