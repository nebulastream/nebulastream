...
ExpressionNodePtr Constant::createExpressionNode() {
    return ConstantValueExpressionNode::create(value);
}

ExpressionItem Field(std::string fieldName) {
    return ExpressionItem(FieldReadExpressionNode::create(std::move(fieldName)));
}

ExpressionItem Field(std::string fieldName, BasicType type) {
    return ExpressionItem(FieldReadExpressionNode::create(createDataType(type), std::move(fieldName)));
}

ExpressionNodePtr operator*(Constant value) {
    return value.createExpressionNode();
}
...
ExpressionNodePtr operator<=(ExpressionNodePtr leftExp, ExpressionNodePtr rightExp) {
    return LessThenExpressionNode::create(leftExp, rightExp);
}
...
ExpressionNodePtr operator||(Constant leftExp, ExpressionNodePtr rightExp) {
    return leftExp.createExpressionNode() || rightExp;
}
...
ExpressionNodePtr operator||(ExpressionNodePtr leftExp, Constant rightExp) {
    return leftExp || rightExp.createExpressionNode();
}
...
ExpressionNodePtr operator||(Constant leftExp, Constant rightExp) {
    return leftExp.createExpressionNode() || rightExp.createExpressionNode();
}
...
ExpressionNodePtr operator!(Constant leftExp) {
    return !leftExp.createExpressionNode();
}
}