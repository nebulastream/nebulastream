...
behavior ActorWorker::unconnected() {
  return {
 ...
 */
void ActorWorker::connecting(const std::string &host, uint16_t port) {
 ...
 */
behavior ActorWorker::running(const actor &coordinator) {
