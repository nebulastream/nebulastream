...
AggregationOperator::AggregationOperator(const AggregationOperator& other)
...
const OperatorPtr AggregationOperator::copy() const{
  return std::make_shared<AggregationOperator>(*this);
}
...
OperatorType AggregationOperator::getOperatorType() const{
