...
void generateTuple(ysbRecord* data, size_t campaingOffset, uint64_t campaign_lsb, uint64_t campaign_msb,
                   size_t event_id)
{
...
void generate(ysbRecord* data, size_t generated_tuples_this_pass, size_t campaingCnt)
{
    ...
    for (size_t u = 0; u < generated_tuples_this_pass; u++) {
        generateTuple(&data[u], /**campaingOffset*/ randomNumbers[u % randomCnt], campaign_lsb, campaign_msb,
                      /**eventID*/ u);
    }
}
