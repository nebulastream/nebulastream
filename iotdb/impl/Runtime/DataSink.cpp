...
DataSink::DataSink(const Schema& _schema) : schema(_schema), processedBuffer(0)
{
...
const DataSinkPtr createYSBPrintSink(const Schema& schema) { return std::make_shared<YSBPrintSink>(schema); }
