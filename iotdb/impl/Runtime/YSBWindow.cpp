...
YSBWindow::YSBWindow(size_t pCampaignCnt)
    : windowSizeInSec(1), campaignCnt(pCampaignCnt), currentWindow(0), lastTimestamp(time(nullptr))
{
}

YSBWindow::YSBWindow(size_t pWindowSizeInSec, size_t pCampaignCnt)
