...
BufferManager::BufferManager()
  ...
  fixSizeBufferPool = new BlockingQueue<TupleBufferPtr>(initalBufferCnt);
...
size_t BufferManager::getNumberOfFixBuffers() {
  return fixSizeBufferPool->getCapacity();
}
