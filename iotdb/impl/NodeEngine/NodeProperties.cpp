...
std::string NodeProperties::getCpuStats() { return _cpus.dump(); }
std::string NodeProperties::getNetworkStats() { return _nets.dump(); }
std::string NodeProperties::getMemStats() { return _mem.dump(); }

std::string NodeProperties::getFsStats() { return _fs.dump(); }
