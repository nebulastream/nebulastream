...
Reflected Reflector<UdfDescriptor>::operator()(const UdfDescriptor& descriptor, const ReflectionContext& context) const
{
    return context.reflect(detail::ReflectedUdfDescriptor{
