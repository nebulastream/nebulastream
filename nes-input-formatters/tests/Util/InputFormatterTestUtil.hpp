...
std::shared_ptr<InputFormatters::InputFormatterTaskPipeline> createInputFormatterTask(const Schema& schema, std::string formatterType, const std::string& fieldDelimiter = "|", const std::string& sequenceShredderImpl = "SequenceShredder");
