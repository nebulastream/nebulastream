...
public:
    ...
    virtual void flushFinalTuple(OriginId originId, NES::Runtime::Execution::PipelineExecutionContext& pipelineExecutionContext, SequenceShredder& sequenceShredder) = 0;
