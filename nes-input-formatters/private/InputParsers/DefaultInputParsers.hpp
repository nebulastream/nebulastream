...
{
public:
    explicit DefaultVARSIZEDInputParser() noexcept = default;
    [[nodiscard]] VarVal parseToVarVal(
        bool nullable,
        const nautilus::val<int8_t*>& fieldAddress,
        const nautilus::val<uint64_t>& fieldSize,
...
{
public:
    explicit QuotedVARSIZEDInputParser() noexcept = default;
    [[nodiscard]] VarVal parseToVarVal(
        bool nullable,
        const nautilus::val<int8_t*>& fieldAddress,
        const nautilus::val<uint64_t>& fieldSize,
...
class DefaultFIXEDSIZEDInputParser final : public InputParser
{
public:
    explicit DefaultFIXEDSIZEDInputParser() noexcept = default;
    VarVal parseToVarVal(
        bool nullable,
        const nautilus::val<int8_t*>& fieldAddress,
        const nautilus::val<uint64_t>& fieldSize,
        const std::vector<std::string>& nullValues) const override;
...
class DefaultSTRUCTInputParser final : public InputParser
{
public:
    explicit DefaultSTRUCTInputParser() noexcept = default;
    VarVal parseToVarVal(
        bool nullable,
        const nautilus::val<int8_t*>& fieldAddress,
        const nautilus::val<uint64_t>& fieldSize,
...
class DefaultUNDEFINEDInputParser final : public InputParser
{
public:
    explicit DefaultUNDEFINEDInputParser() noexcept = default;
    VarVal parseToVarVal(
        bool nullable,
        const nautilus::val<int8_t*>& fieldAddress,
        const nautilus::val<uint64_t>& fieldSize,
