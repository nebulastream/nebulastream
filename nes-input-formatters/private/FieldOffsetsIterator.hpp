...
private:
    ...
    /// Sets the first buffer as the current buffer. Adjusts the number of tuples of the first buffer. Determines if there is a child buffer.
    void getFirstFieldOffsets();
    /// Attempts to get the next child buffer.
