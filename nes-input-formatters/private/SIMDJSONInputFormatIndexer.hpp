...
public:
    ...
    void indexRawBuffer(SIMDJSONFIF& fieldIndexFunction, const RawTupleBuffer& rawBuffer, const SIMDJSONMetaData&) const;

    friend std::ostream& operator<<(std::ostream& os, const SIMDJSONInputFormatIndexer& SIMDJSONInputFormatIndexer);
};
