...
class SIMDJSONFIF final : public FieldIndexFunction<SIMDJSONFIF>
{
    ...
    applyHasNext(const nautilus::val<uint64_t>&, const nautilus::val<SIMDJSONFIF*>& fieldIndexFunction) const
    {
...
public:
    ...
    std::pair<bool, FieldIndex> indexJSON(const std::string_view jsonSV, size_t batchSize)
    {
