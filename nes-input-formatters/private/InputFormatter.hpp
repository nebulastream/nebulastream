...
public:
        ...
        const std::function<void(ExecutionContext& executionCtx, Record& record)>& executeChild) const
    {
        ...
        if (not(nautilus::val<bool>(
                *Nautilus::Util::getMemberWithOffset<bool>(indexPhaseResult, offsetof(IndexPhaseResult, hasTupleDelimiter)))))
        {
            return;
        }
...
private:
    ...
    {
        if (*Nautilus::Util::getMemberWithOffset<bool>(indexPhaseResult, offsetof(IndexPhaseResult, hasLeadingSpanningTupleBool)))
        {
            ...
            auto spanningRecordPtr
                = *Nautilus::Util::getMemberPtrWithOffset<int8_t>(indexPhaseResult, offsetof(IndexPhaseResult, leadingSpanningTuple));
    ...
    void parseTrailingRecord(
        ...
        const nautilus::val<IndexPhaseResult*>& indexPhaseResult) const
    {
        const nautilus::val<bool> hasTrailingST = nautilus::invoke(
        ...
        if (hasTrailingST)
        {
            ...
            auto spanningRecordPtr
                = *Nautilus::Util::getMemberPtrWithOffset<int8_t>(indexPhaseResult, offsetof(IndexPhaseResult, trailingSpanningTuple));
