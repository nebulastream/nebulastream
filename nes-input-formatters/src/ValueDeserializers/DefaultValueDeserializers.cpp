...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<bool> nVal = deserializedVal.getRawValueAs<nautilus::val<bool>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<bool>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<char> nVal = deserializedVal.getRawValueAs<nautilus::val<char>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<char>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<float> nVal = deserializedVal.getRawValueAs<nautilus::val<float>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<float>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<double> nVal = deserializedVal.getRawValueAs<nautilus::val<double>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<double>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<int8_t> nVal = deserializedVal.getRawValueAs<nautilus::val<int8_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<int8_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<int16_t> nVal = deserializedVal.getRawValueAs<nautilus::val<int16_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<int16_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<int32_t> nVal = deserializedVal.getRawValueAs<nautilus::val<int32_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<int32_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<int64_t> nVal = deserializedVal.getRawValueAs<nautilus::val<int64_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<int64_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<uint8_t> nVal = deserializedVal.getRawValueAs<nautilus::val<uint8_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<uint8_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<uint16_t> nVal = deserializedVal.getRawValueAs<nautilus::val<uint16_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<uint16_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<uint32_t> nVal = deserializedVal.getRawValueAs<nautilus::val<uint32_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<uint32_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const nautilus::val<uint64_t> nVal = deserializedVal.getRawValueAs<nautilus::val<uint64_t>>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<uint64_t>, bufferAddress, nVal);
}
...
{
    const VarVal deserializedVal = deserializeToVarVal(fieldAddress, fieldSize, nullValues, deserializerTypes, valueType, arena);
    const VariableSizedData nVal = deserializedVal.getRawValueAs<VariableSizedData>();
    nautilus::invoke(DefaultValueDeserializer::writeFlatValToBuffer<int8_t*>, bufferAddress, nVal.getContent());
    nautilus::invoke(
        DefaultValueDeserializer::writeFlatValToBuffer<uint64_t>, bufferAddress + nautilus::val<uint64_t>{sizeof(int8_t*)}, nVal.getSize());
}
