...
void CSVInputFormatIndexer::setupFieldAccessFunctionForBuffer(
...
{
    auto inputFormatter = std::make_unique<CSVInputFormatIndexer>(arguments.inputFormatIndexerConfig, arguments.getNumberOfFieldsInSchema());
