...
void SIMDJSONInputFormatIndexer::indexRawBuffer(
    SIMDJSONFIF& fieldIndexFunction, const RawTupleBuffer& rawBuffer, const SIMDJSONMetaData& metaData) const
{
...
InputFormatIndexerRegistryReturnType RegisterSIMDJSONInputFormatIndexer(InputFormatIndexerRegistryArguments arguments)
{
