    ...
    const QuotationType quotationType)
{
    switch (physicalType)
    {
        ...
        case DataType::Type::VARSIZED: {
            if (parseVarsized(record, fieldAddress, fieldSize, fieldName, quotationType))
            {
                return;
            }
            std::unreachable();
    ...
    const QuotationType quotationType)
{
    ...
    {
        parseVarsized(record, fieldAddress, fieldSize, fieldName, quotationType);
    }
    else
    {
