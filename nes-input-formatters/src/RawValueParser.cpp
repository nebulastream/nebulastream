    ...
    const bool isNullable)
{
    ...
    {
        return Nautilus::VarVal{nautilus::val<T>{0}, NES::Nautilus::VarVal::NULLABLE_ENUM::NULLABLE, true};
    }
    return Nautilus::VarVal{
        parseIntoNautilusRecord<T>(fieldAddress, fieldSize),
        isNullable ? NES::Nautilus::VarVal::NULLABLE_ENUM::NULLABLE : NES::Nautilus::VarVal::NULLABLE_ENUM::NOT_NULLABLE,
        isNull};
}
}
    ...
    ArenaRef& arenaRef)
{
    ...
    switch (dataType.type)
    {
        ...
        case DataType::Type::VARSIZED: {
            ...
            {
                case QuotationType::NONE: {
                    const auto nullableEnum = dataType.isNullable ? NES::Nautilus::VarVal::NULLABLE_ENUM::NULLABLE
                                                                  : NES::Nautilus::VarVal::NULLABLE_ENUM::NOT_NULLABLE;
                    ...
                    record.write(fieldName, Nautilus::VarVal{varSized, nullableEnum, isNull});
                    return;
                }
                case QuotationType::DOUBLE_QUOTE: {
                    const auto nullableEnum = dataType.isNullable ? NES::Nautilus::VarVal::NULLABLE_ENUM::NULLABLE
