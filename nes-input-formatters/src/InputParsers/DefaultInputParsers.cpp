    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    const auto parseResult = nautilus::invoke(
        ...
        fieldSize,
        nautilus::val<const std::vector<std::string>*>{&nullValues});
    nautilus::val<bool> nautilusValue = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<bool>, value));
    nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<bool>, isNull));
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<char> nautilusValue
        = *getMemberWithOffset<char>(parseResult, offsetof(DefaultInputParser::ParseResult<char>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<char>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<float> nautilusValue
        = *getMemberWithOffset<float>(parseResult, offsetof(DefaultInputParser::ParseResult<float>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<float>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<double> nautilusValue
        = *getMemberWithOffset<double>(parseResult, offsetof(DefaultInputParser::ParseResult<double>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<double>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<int8_t> nautilusValue
        = *getMemberWithOffset<int8_t>(parseResult, offsetof(DefaultInputParser::ParseResult<int8_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<int8_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<int16_t> nautilusValue
        = *getMemberWithOffset<int16_t>(parseResult, offsetof(DefaultInputParser::ParseResult<int16_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<int16_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<int32_t> nautilusValue
        = *getMemberWithOffset<int32_t>(parseResult, offsetof(DefaultInputParser::ParseResult<int32_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<int32_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<int64_t> nautilusValue
        = *getMemberWithOffset<int64_t>(parseResult, offsetof(DefaultInputParser::ParseResult<int64_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<int64_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<uint8_t> nautilusValue
        = *getMemberWithOffset<uint8_t>(parseResult, offsetof(DefaultInputParser::ParseResult<uint8_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<uint8_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<uint16_t> nautilusValue
        = *getMemberWithOffset<uint16_t>(parseResult, offsetof(DefaultInputParser::ParseResult<uint16_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<uint16_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<uint32_t> nautilusValue
        = *getMemberWithOffset<uint32_t>(parseResult, offsetof(DefaultInputParser::ParseResult<uint32_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<uint32_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
    ...
    const nautilus::val<int8_t*>& fieldAddress, const nautilus::val<uint64_t>& fieldSize, const std::vector<std::string>& nullValues) const
{
    ...
    const nautilus::val<uint64_t> nautilusValue
        = *getMemberWithOffset<uint64_t>(parseResult, offsetof(DefaultInputParser::ParseResult<uint64_t>, value));
    const nautilus::val<bool> isNull = *getMemberWithOffset<bool>(parseResult, offsetof(DefaultInputParser::ParseResult<uint64_t>, isNull));
    return VarVal{nautilusValue, true, isNull};
}
