...
VarVal DefaultFIXEDSIZEDInputParser::parseToVarVal(
    bool, const nautilus::val<int8_t*>&, const nautilus::val<uint64_t>&, const std::vector<std::string>&) const
{
    throw NotImplemented("Flat textual formatters do not support FIXEDSIZED arrays.");
}

VarVal DefaultSTRUCTInputParser::parseToVarVal(
    bool, const nautilus::val<int8_t*>&, const nautilus::val<uint64_t>&, const std::vector<std::string>&) const
{
    throw NotImplemented("Flat textual formatters do not support STRUCT types.");
}

VarVal DefaultUNDEFINEDInputParser::parseToVarVal(
    bool, const nautilus::val<int8_t*>&, const nautilus::val<uint64_t>&, const std::vector<std::string>&) const
{
    throw UnknownDataType("UNDEFINED does not have a default input parser implementation.");
}
...
InputParserRegistryReturnType InputParserGeneratedRegistrar::RegisterDefaultFIXEDSIZEDInputParser(InputParserRegistryArguments)
{
    return std::make_unique<DefaultFIXEDSIZEDInputParser>();
}

InputParserRegistryReturnType InputParserGeneratedRegistrar::RegisterDefaultSTRUCTInputParser(InputParserRegistryArguments)
{
    return std::make_unique<DefaultSTRUCTInputParser>();
}

InputParserRegistryReturnType InputParserGeneratedRegistrar::RegisterDefaultUNDEFINEDInputParser(InputParserRegistryArguments)
{
    return std::make_unique<DefaultUNDEFINEDInputParser>();
}
}
