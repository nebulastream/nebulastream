...
public:
    ...
    BlockingTCPSource(const TCPSource&) = delete;
    BlockingTCPSource& operator=(const TCPSource&) = delete;
    BlockingTCPSource(TCPSource&&) = delete;
    BlockingTCPSource& operator=(TCPSource&&) = delete;
