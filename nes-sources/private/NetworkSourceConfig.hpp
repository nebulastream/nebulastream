...
/// Lightweight config surface for the Network source plugin. Includes only
/// descriptor/validation types — no runtime headers — so NetworkSourceValidation.cpp
/// can compile into nes-sources-validation without dragging in the rust network
/// bindings. NetworkSource.hpp re-exports this for the runtime side.
