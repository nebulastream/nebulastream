...
TEST_F(SourceCatalogTest, AddRemovePhysicalSources)
{
    ...
    const auto sourceOpt = sourceCatalog.addLogicalSource("testSource", schema);
    ASSERT_TRUE(sourceOpt.has_value());
    const auto physical1Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", {{"file_path", "/dev/null"}}, {});
    const auto physical2Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", {{"file_path", "/dev/null"}}, {});
    ...
    const auto physical3Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", {{"file_path", "/dev/null"}}, {});
    ASSERT_TRUE(physical2Opt.has_value());
...
TEST_F(SourceCatalogTest, RemoveLogicalSource)
{
    ...
    const auto physical1Opt = sourceCatalog.addPhysicalSource(logicalSource, "File", {{"file_path", "/dev/null"}}, {});
    const auto physical2Opt = sourceCatalog.addPhysicalSource(logicalSource, "File", {{"file_path", "/dev/null"}}, {});
