...
TEST_F(SourceCatalogTest, AddRemovePhysicalSources)
{
    ...
    const auto sourceOpt = sourceCatalog.addLogicalSource("testSource", schema);
    ASSERT_TRUE(sourceOpt.has_value());
    const auto physical1Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
    const auto physical2Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
    ...
    const auto physical3Opt = sourceCatalog.addPhysicalSource(*sourceOpt, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
    ASSERT_TRUE(physical2Opt.has_value());
...
TEST_F(SourceCatalogTest, RemoveLogicalSource)
{
    ...
    const auto physical1Opt = sourceCatalog.addPhysicalSource(logicalSource, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
    const auto physical2Opt = sourceCatalog.addPhysicalSource(logicalSource, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
        ...
        for (int num : nums)
        {
            ...
            if (logicalSourceOpt.has_value())
            {
                auto physicalSourceOpt
                    = sourceCatalog.addPhysicalSource(*logicalSourceOpt, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
