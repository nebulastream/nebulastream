...
TEST_F(SourceCatalogTest, AddRemovePhysicalSources)
{
    ...
    const auto physical1Opt
        = sourceCatalog.addPhysicalSource(*sourceOpt, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
...
TEST_F(SourceCatalogTest, RemoveLogicalSource)
{
    ...
    const auto physical1Opt
        = sourceCatalog.addPhysicalSource(logicalSource, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
    const auto physical2Opt
        = sourceCatalog.addPhysicalSource(logicalSource, "File", "localhost", {{"file_path", "/dev/null"}}, ParserConfig{});
