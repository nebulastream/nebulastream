...
TEST_F(InProcessSourceTest, SourceEmitsWhatWasPushedIntoItsFeed)
{
    ...
    EXPECT_TRUE(feed->tryPush("TASK_START,1000,2,query-1,4,5,64"));
    EXPECT_TRUE(feed->tryPush("TASK_DONE,1001,2,query-1,4,5,0"));
    const std::string expected = "TASK_START,1000,2,query-1,4,5,64\nTASK_DONE,1001,2,query-1,4,5,0\n";
