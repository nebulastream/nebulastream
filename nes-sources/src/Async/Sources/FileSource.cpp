...
asio::awaitable<AsyncSource::InternalSourceResult, Executor> FileSource::fillBuffer(TupleBuffer& buffer)
{
...
SourceValidationRegistryReturnType RegisterFileSourceValidation(SourceValidationRegistryArguments arguments)
{
