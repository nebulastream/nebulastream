    ...
    const std::unordered_map<Identifier, std::string>& parserConfig)
{
    ...
    SourceDescriptor descriptor{
        id, logicalSource, sourceType.asCanonicalString(), std::move(host), std::move(descriptorConfigOpt.value()), parserConfigObject};
    ...
    std::unordered_map<Identifier, std::string> sourceConfigMap) const
{
    ...
    SourceDescriptor sourceDescriptor{physicalId, logicalSource, sourceType.asCanonicalString(), std::move(host), descriptorConfig.value(), parserConfig};
