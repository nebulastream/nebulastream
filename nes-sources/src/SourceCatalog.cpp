...
{
    std::unique_lock const lock(catalogMutex);
    ...
    const Sources::ParserConfig& parserConfig)
{
    ...
    Sources::SourceDescriptor descriptor{logicalSource, id, workerId,  sourceType, buffersInLocalPool, (std::move(descriptorConfig)), parserConfig};
