...
size_t BlockingTCPSource::fillTupleBuffer(NES::Memory::TupleBuffer& tupleBuffer, const std::stop_token&)
{
    try
    {
...
bool BlockingTCPSource::fillBuffer(NES::Memory::TupleBuffer& tupleBuffer, size_t& numReceivedBytes)
{
...
void BlockingTCPSource::close()
{
    ...
    {
        ::close(sockfd);
        NES_TRACE("BlockingTCPSource::close: connection closed.");
    }
}
...
SourceGeneratedRegistrar::RegisterBlockingTCPSource(const SourceRegistryArguments& sourceRegistryArguments)
{
