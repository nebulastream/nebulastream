...
SourceValidationGeneratedRegistrar::RegisterBlockingTCPSourceValidation(const SourceValidationRegistryArguments& sourceConfig)
{
    return BlockingTCPSource::validateAndFormat(sourceConfig.config);
}

SourceRegistryReturnType SourceGeneratedRegistrar::RegisterBlockingTCPSource(const SourceRegistryArguments& sourceRegistryArguments)
{
