...
// The factory .cpp file creates TokioSource internally and returns as std::unique_ptr<Source>.
using TokioSourceRegistryReturnType = std::unique_ptr<Source>;
...
#include <TokioSourceRegistrar.hpp>
