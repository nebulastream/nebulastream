...
{
public:
    CSVParser(uint64_t numberOfSchemaFields, std::vector<PhysicalTypePtr> physicalTypes, std::string delimiter);
    ...
    bool writeInputTupleToTupleBuffer(
        ...
        const Schema& schema,
        Memory::AbstractBufferProvider& bufferManager) override;
