...
public:
    ...
    [[nodiscard]] std::optional<LogicalSource>
    addLogicalSource(const std::string& logicalSourceName, const Schema& schema, SourceIngestionType sourceType = SourceIngestionType::Origin);
