...
OutputParserRegistryReturnType OutputParserGeneratedRegistrar::RegisterDefaultVARSIZEDOutputParser(OutputParserRegistryArguments args)
{
    return std::make_unique<DefaultVARSIZEDOutputParser>(args.quoted);
}
}
