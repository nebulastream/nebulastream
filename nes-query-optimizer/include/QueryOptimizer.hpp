...
public:
    explicit QueryOptimizer(
        ...
        const std::shared_ptr<const SemanticModelCatalog>& semanticModelCatalog)
        : ruleBasedOptimization(defaultQueryOptimization, sourceCatalog, sinkCatalog, modelCatalog, semanticModelCatalog)
