...
public:
    BottomUpOperatorPlacer(const std::shared_ptr<Catalog>& catalog, const NetworkTopology& topology) : catalog(catalog), topology(topology)
    {
    }
