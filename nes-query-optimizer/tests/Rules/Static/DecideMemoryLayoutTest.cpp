...
SourceDescriptor createTestSourceDescriptor(const PhysicalSourceId physicalSourceId, const LogicalSource& logicalSource)
{
...
SinkDescriptor createTestSinkDescriptor()
{
    ...
    return SinkDescriptor::createInline(INITIAL_SINK_ID, Identifier::parse("file"), std::nullopt, Host{"localhost"}, sinkConfig, {})
        .value();
}
}
