...
TEST_F(DecideJoinTypesTest, NonJoinPlanGetChoicelessTrait)
{
    ...
    auto selectionOp = SelectionLogicalOperator::create(selectionFn).withChildrenUnsafe({sourceOp});
    auto sinkOp = SinkLogicalOperator::create(sinkDescriptor).withChildrenUnsafe({selectionOp});
