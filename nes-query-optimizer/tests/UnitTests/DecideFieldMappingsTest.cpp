...
SinkDescriptor createTestSinkDescriptor(SinkCatalog& sinkCatalog)
{
    ...
    return sinkCatalog.addSinkDescriptor(Identifier::parse("testSink"), schema, Identifier::parse("file"), Host{"localhost"}, sinkConfig, {}).value();
}
...
SinkDescriptor createTestSinkDescriptorWithNewField(SinkCatalog& sinkCatalog)
{
    ...
    return sinkCatalog.addSinkDescriptor(Identifier::parse("testSinkWithNew"), schema, Identifier::parse("file"), Host{"localhost"}, sinkConfig, {}).value();
}
...
TEST_F(DecideFieldMappingsTest, TestNoCollisions)
{
    ...
    const LogicalPlan logicalPlan{QueryId::create(LocalQueryId{generateUUID()}, getNextDistributedQueryId()), {sinkOperator->withInferredSchema()}};
