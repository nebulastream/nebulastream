...
def handle_client(client_socket, client_address):
    ...
    try:
        ...
        writer.writerow([monotonic_counter, monotonic_counter, monotonic_counter])
        ...
        for i in range(0, 100000):
            ...
            output = io.StringIO()
            writer = csv.writer(output, quoting=csv.QUOTE_NONE, escapechar='\\')
            writer.writerow([monotonic_counter, f"{random_val:.4f}", monotonic_counter])
    ...
    try:
        ...
        while SERVER_RUNNING:
            try:
                ...
                # This will happen if no connection is made within the timeout period
                pass
            except OSError as e:
                if SERVER_RUNNING:
