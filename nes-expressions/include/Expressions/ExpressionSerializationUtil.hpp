...
public:
   ...
   */
  static SerializableExpression *
  serializeExpression(const ExpressionNodePtr &expressionNode,
  ...
  deserializeExpression(const SerializableExpression &serializedExpression);

private:
  static void
  serializeLogicalExpressions(const ExpressionNodePtr &expression,
                              SerializableExpression *serializedExpression);
