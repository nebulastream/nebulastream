...
SubExpressionNode::SubExpressionNode(DataTypePtr stamp)
    : ArithmeticalBinaryExpressionNode(std::move(stamp)){};

SubExpressionNode::SubExpressionNode(SubExpressionNode *other)
    : ArithmeticalBinaryExpressionNode(other) {}

ExpressionNodePtr SubExpressionNode::create(const ExpressionNodePtr &left,
...
ExpressionNodePtr SubExpressionNode::copy() {
  return SubExpressionNode::create(children[0]->as<ExpressionNode>()->copy(),
