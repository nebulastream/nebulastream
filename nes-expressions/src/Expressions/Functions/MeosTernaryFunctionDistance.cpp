...
*/
class MeosTernaryFunctionDistance : public TernaryLogicalFunction {
  public:
...
[[maybe_unused]] const static LogicalFunctionRegistry::Add<MeosTernaryFunctionDistance> MeosTernaryFunctionDistance("distancetpointstbox");
