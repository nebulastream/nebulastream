...
SerializableExpression* ExpressionSerializationUtil::serializeExpression(
  ...
  if (expression->instanceOf<LogicalExpressionNode>()) {
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize constant value expression "
        "node.");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize field access expression "
        "node.");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize field rename expression "
        "node.");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize field assignment expression "
        "node.");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize function logical expression "
        "to SerializableExpression_FunctionExpression");
...
ExpressionNodePtr ExpressionSerializationUtil::deserializeExpression(
  ...
  if (!expressionNodePtr) {
    if (serializedExpression.details()
      ...
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as Constant "
      ...
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as "
      ...
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as Field "
      ...
      // de-serialize field read expression node.
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as function "
          "expression node.");
      ...
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as When "
          "expression node.");
      auto serializedExpressionNode = SerializableExpression_WhenExpression();
      ...
      NES_TRACE(
          "ExpressionSerializationUtil:: de-serialize expression as Case "
          "expression node.");
      auto serializedExpressionNode = SerializableExpression_CaseExpression();
      serializedExpression.details().UnpackTo(&serializedExpressionNode);
      ...
      NES_FATAL_ERROR(
          "ExpressionSerializationUtil: could not de-serialize this "
          "expression");
    }
  }
  ...
  if (!expressionNodePtr) {
    NES_FATAL_ERROR(
        "ExpressionSerializationUtil:: fatal error during de-serialization. "
        "The expression node must not be null");
  }
  ...
  NES_DEBUG(
      "ExpressionSerializationUtil:: deserialized expression node to the "
      "following node: {}",
...
void ExpressionSerializationUtil::serializeArithmeticalExpressions(
  ...
  if (expression->instanceOf<AddExpressionNode>()) {
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize ADD arithmetical expression "
        "to SerializableExpression_AddExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize SUB arithmetical expression "
        "to SerializableExpression_SubExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize MUL arithmetical expression "
        "to SerializableExpression_MulExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize DIV arithmetical expression "
        "to SerializableExpression_DivExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize MODULO arithmetical "
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize POWER arithmetical expression "
        "to SerializableExpression_PowExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize ABS arithmetical expression "
        "to SerializableExpression_AbsExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize CEIL arithmetical expression "
        "to SerializableExpression_CeilExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize EXP arithmetical expression "
        "to SerializableExpression_ExpExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize FLOOR arithmetical expression "
        "to SerializableExpression_FloorExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize ROUND arithmetical expression "
        "to SerializableExpression_RoundExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize SQRT arithmetical expression "
        "to SerializableExpression_SqrtExpression");
    ...
    NES_FATAL_ERROR(
        "TranslateToLegacyPhase: No serialization implemented for this "
        "arithmetical expression node: {}",
        expression->toString());
    NES_NOT_IMPLEMENTED();
  }
}
...
void ExpressionSerializationUtil::serializeLogicalExpressions(
  ...
  if (expression->instanceOf<AndExpressionNode>()) {
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize AND logical expression to "
        "SerializableExpression_AndExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize OR logical expression to "
        "SerializableExpression_OrExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize Less logical expression to "
        "SerializableExpression_LessExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize Less Equals logical "
        "expression to "
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize Greater logical expression to "
        "SerializableExpression_GreaterExpression");
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize Greater Equals logical "
        "expression to "
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize Equals logical expression to "
        "SerializableExpression_EqualsExpression");
    ...
    // serialize negate expression node.
    NES_TRACE(
        "ExpressionSerializationUtil:: serialize negate logical expression to "
        "SerializableExpression_NegateExpression");
    ...
    NES_FATAL_ERROR(
        "ExpressionSerializationUtil: No serialization implemented for this "
...
ExpressionSerializationUtil::deserializeArithmeticalExpressions(
  ...
  if (serializedExpression.details()
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: de-serialize arithmetical expression as "
        "Add expression node.");
    auto serializedExpressionNode = SerializableExpression_AddExpression();
    serializedExpression.details().UnpackTo(&serializedExpressionNode);
    auto left = deserializeExpression(serializedExpressionNode.left());
...
ExpressionNodePtr ExpressionSerializationUtil::deserializeLogicalExpressions(
  ...
  if (serializedExpression.details()
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: de-serialize logical expression as AND "
        "expression node.");
  ...
  if (serializedExpression.details()
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: de-serialize logical expression as OR "
        "expression node.");
    auto serializedExpressionNode = SerializableExpression_OrExpression();
    serializedExpression.details().UnpackTo(&serializedExpressionNode);
    auto left = deserializeExpression(serializedExpressionNode.left());
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: de-serialize logical expression as LESS "
        "expression node.");
    auto serializedExpressionNode = SerializableExpression_LessExpression();
    serializedExpression.details().UnpackTo(&serializedExpressionNode);
    auto left = deserializeExpression(serializedExpressionNode.left());
    ...
    NES_TRACE(
        "ExpressionSerializationUtil:: de-serialize logical expression as "
        "Greater expression node.");
    auto serializedExpressionNode = SerializableExpression_GreaterExpression();
    serializedExpression.details().UnpackTo(&serializedExpressionNode);
    auto left = deserializeExpression(serializedExpressionNode.left());
    auto right = deserializeExpression(serializedExpressionNode.right());
