...
class ValueTest : public Testing::NESBaseTest {
  public:
    ...
    static void SetUpTestCase() {
        ...
        NES_INFO2("Setup ValueTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override { NES_INFO2("Setup ValueTest test case."); }

    /* Will be called before a test is executed. */
    void TearDown() override { NES_INFO2("Tear down ValueTest test case."); }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_INFO2("Tear down ValueTest test class."); }
};
