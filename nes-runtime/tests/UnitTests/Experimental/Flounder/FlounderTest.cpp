...
class FlounderTest : public Testing::NESBaseTest {
  public:
    ...
    static void SetUpTestCase() {
        ...
        NES_INFO2("Setup FlounderTest test class.");
    }

    /* Will be called before a test is executed. */
    void SetUp() override { NES_INFO2("Setup FlounderTest test case."); }

    /* Will be called before a test is executed. */
    void TearDown() override { NES_INFO2("Tear down FlounderTest test case."); }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_INFO2("Tear down FlounderTest test class."); }
};
...
TEST_F(FlounderTest, flounderGenTest) {
    ...
    NES_INFO2(" == Execute == ");
    NES_INFO2("return = {}", executable.execute<std::uint64_t>(argument));
