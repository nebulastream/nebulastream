...
class LevenshteinTest : public Testing::NESBaseTest {
  public:
    ...
    static void SetUpTestCase() {
        ...
        NES_INFO2("Setup LevenshteinTest test class.");
    }
    ...
    void SetUp() override {
        ...
        NES_DEBUG2("Setup LevenshteinTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_INFO2("Tear down LevenshteinTest class."); }
