...
class MatchingRegexTest : public Testing::NESBaseTest {
  public:
    /* Will be called before any test in this class are executed. */
    static void SetUpTestCase() {
        NES::Logger::setupLogging("MatchingRegexTest.log", NES::LogLevel::LOG_DEBUG);
        NES_INFO2("Setup MatchingRegexTest test class.");
    }
    ...
    void SetUp() override {
        ...
        NES_DEBUG2("Setup MatchingRegexTest test case.")
    }
    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_INFO2("Tear down MatchingRegexTest test class."); }
