...
class CbrtExpressionTest : public testing::Test {
  public:
    /* Will be called before any test in this class are executed. */
    static void SetUpTestCase() {
        NES::Logger::setupLogging("CbrtExpressionTest.log", NES::LogLevel::LOG_DEBUG);
        std::cout << "Setup CbrtExpressionTest test class." << std::endl;
    }
...
TEST_F(CbrtExpressionTest, evaluateCbrtExpressionInteger) {
    auto expression = BinaryExpressionWrapper<CbrtExpression>();
    // Int8
    {
