...
namespace NES::Runtime::Execution::Expressions {
        ...
        TEST_F(CeilExpressionTest, evaluateModExpressionInteger) {
        ...
        TEST_F(CeilExpressionTest, evaluateModExpressionFloat) {
            auto expression = UnaryExpressionWrapper<CeilExpression>();
            // Float
            {
...
*/
        TEST_F(CeilExpressionTest, evaluateModExpressionOnWrongType) {
            auto expression = UnaryExpressionWrapper<CeilExpression>();
