...
TEST_F(ThresholdWindowOperatorTest, thresholdWindowWithSumAggTest) {
    ...
    auto thresholdWindowOperator =
        std::make_shared<GlobalThresholdWindow>(greaterThanExpression,
    ...
    auto handler = std::make_shared<GlobalThresholdWindowOperatorHandler>(std::move(aggValues));
...
TEST_F(ThresholdWindowOperatorTest, thresholdWindowWithMultAggOnGenratingMultipleWindowsTest) {
    ...
    auto thresholdWindowOperator = std::make_shared<GlobalThresholdWindow>(
