...
TEST_P(KeyedTimeWindowPipelineTest, windowWithSum) {
    ...
    // Fill buffer
    dynamicBuffer[0]["k"].write<int64_t>(1_s64);
    dynamicBuffer[0]["v"].write<int64_t>(10_s64);
    dynamicBuffer[0]["ts"].write<int64_t>(1_s64);
    dynamicBuffer[1]["k"].write<int64_t>(2_s64);
    dynamicBuffer[1]["v"].write<int64_t>(20_s64);
    dynamicBuffer[1]["ts"].write<int64_t>(1_s64);
    dynamicBuffer[2]["k"].write<int64_t>(3_s64);
    dynamicBuffer[2]["v"].write<int64_t>(30_s64);
    dynamicBuffer[2]["ts"].write<int64_t>(2_s64);
    dynamicBuffer[3]["k"].write<int64_t>(1_s64);
    dynamicBuffer[3]["v"].write<int64_t>(40_s64);
...
TEST_P(KeyedTimeWindowPipelineTest, multiKeyWindowWithSum) {
    ...
    dynamicBuffer[0]["k2"].write<int64_t>(1_s64);
    dynamicBuffer[0]["v"].write<int64_t>(10_s64);
    dynamicBuffer[0]["ts"].write<int64_t>(1_s64);
    dynamicBuffer[1]["k1"].write<int64_t>(1_s64);
    dynamicBuffer[1]["k2"].write<int64_t>(2_s64);
    dynamicBuffer[1]["v"].write<int64_t>(20_s64);
    dynamicBuffer[1]["ts"].write<int64_t>(1_s64);
    dynamicBuffer[2]["k1"].write<int64_t>(2_s64);
    dynamicBuffer[2]["k2"].write<int64_t>(2_s64);
    dynamicBuffer[2]["v"].write<int64_t>(30_s64);
    dynamicBuffer[2]["ts"].write<int64_t>(2_s64);
    dynamicBuffer[3]["k1"].write<int64_t>(1_s64);
    dynamicBuffer[3]["k2"].write<int64_t>(2_s64);
    dynamicBuffer[3]["v"].write<int64_t>(40_s64);
    dynamicBuffer[3]["ts"].write<int64_t>(3_s64);
    dynamicBuffer.setNumberOfTuples(4);
    buffer.setWatermark(20);
