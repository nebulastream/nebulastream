...
class StructuredControlFlowTest : public testing::Test, public AbstractCompilationBackendTest {
  public:
    ...
    //todo: could create wrapper for hashmap -> but would require creating new class with member functions.
    ...
    bool checkIRForCorrectness(IR::BasicBlockPtr currentBlock, const std::unordered_map<std::string, CorrectBlockValuesPtr>& correctBlocks) {
        ...
        do {
            ...
            if(correctBlocks.contains(currentBlock->getIdentifier())) {
                ...
                backLinksAreCorrect = currentBlock->getBackLinks() == correctBlocks.at(currentBlock->getIdentifier())->correctNumberOfBackLinks;
...
TEST_P(StructuredControlFlowTest, DISABLED_1_threeIfOperationsOneNestedThreeMergeBlocks) {
...
TEST_P(StructuredControlFlowTest, DISABLED_2_doubleVerticalDiamondInTrueBranch) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_3_doubleHorizontalDiamondWithOneMergeBlockThatAlsoIsIfBlock) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_4_oneMergeBlockThatClosesOneIfAndBecomesMergeForTwo) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
    createCorrectBlock(correctBlocks, "0", 0, "9");
...
TEST_P(StructuredControlFlowTest, DISABLED_5_oneMergeBlockThatClosesOneIfAndBecomesMergeForTwoAndIsFollowedUpByLoopHeader) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
    createCorrectBlock(correctBlocks, "0", 0, "12");
    createCorrectBlock(correctBlocks, "1", 0, "12");
...
TEST_P(StructuredControlFlowTest, DISABLED_6_oneMergeBlockThatClosesOneIfAndBecomesMergeForTwoAndIsLoopHeader) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
    createCorrectBlock(correctBlocks, "0", 0, "12");
    createCorrectBlock(correctBlocks, "1", 0, "12");
    createCorrectBlock(correctBlocks, "4", 0, "12");
...
TEST_P(StructuredControlFlowTest, DISABLED_7_loopMergeBlockBeforeCorrespondingIfOperation) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_8_mergeLoopMergeBlockWithLoopFollowUp) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
    createCorrectBlock(correctBlocks, "0", 0, "12");
...
TEST_P(StructuredControlFlowTest, DISABLED_9_loopHeaderWithNineBackLinks) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_10_mergeLoopBlock) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_11_IfOperationFollowedByLoopWithDeeplyNestedIfOperationsWithSeveralNestedLoops) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_12_emptyIfElse) {
...
TEST_P(StructuredControlFlowTest, DISABLED_13_MergeBlockRightAfterBranchSwitch) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_14_StartBlockIsMergeBlock) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_15_correctMergeBlockForwardingAfterFindingMergeBlocks) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
TEST_P(StructuredControlFlowTest, DISABLED_16_OneMergeBlockThreeIfOperationsFalseBranchIntoTrueBranchIntoFalseBranch) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
//==----------------------------------------------------------------==//
// Todo breaks printing, addressed by #
...
TEST_P(StructuredControlFlowTest, DISABLED_17_InterruptedMergeBlockForwarding) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
...
// Todo breaks tracing, addressed by #
...
Value<> TracingBreaker_18() {
    ...
    if(agg < 350) {
        ...
        if(agg < 350) {
            if(agg < 350) { //todo the 'else' case of this if has no operations -> Block_9
                agg = agg + 1;
            } else {
                agg = agg + 2;
            }
...
TEST_P(StructuredControlFlowTest, DISABLED_18_TracingBreaker) {
    std::unordered_map<std::string, CorrectBlockValuesPtr> correctBlocks;
