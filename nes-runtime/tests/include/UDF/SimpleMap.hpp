...
*/
#ifndef NES_NES_RUNTIME_TESTS_INCLUDE_UDFS_SIMPLE_MAP_HPP_
#define NES_NES_RUNTIME_TESTS_INCLUDE_UDFS_SIMPLE_MAP_HPP_
...
class SimpleMap {
  public:
    static PipelinePlan getPipelinePlan(std::unique_ptr<NES::Runtime::Table>& table, Runtime::BufferManagerPtr bm) {
        ...
        auto handler = std::make_shared<Operators::JavaUDFOperatorHandler>("stream/nebula/IntegerMapFunction",
                                                                           "map",
                                                                           "java/lang/Integer",
                                                                           "java/lang/Integer",
                                                                           byteCodeList,
...
#endif//NES_NES_RUNTIME_TESTS_INCLUDE_UDFS_SIMPLE_MAP_HPP_
