...
public:
     ...
     */
    static void add(const char* str, uint32_t len) {
        uint32_t hash;
...
protected:
  static uint8_t b_; ///< register bit width
  static uint32_t m_; ///< register size
  static double alphaMM_; ///< alpha * m^2
    static std::vector<uint8_t> M_; ///< registers
};
} // namespace hll
