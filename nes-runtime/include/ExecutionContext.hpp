...
struct ExecutionContext final
{
    ...
    void setLocalOperatorState(const AbstractPhysicalOperator* op, std::unique_ptr<OperatorState> state);
    OperatorState* getLocalState(const AbstractPhysicalOperator* op);
    ...
    std::unordered_map<const AbstractPhysicalOperator*, std::unique_ptr<OperatorState>> localStateMap;
