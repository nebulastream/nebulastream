...
struct ExecutionContext final
{
    ...
    void setLocalOperatorState(const PhysicalOperator* op, std::unique_ptr<OperatorState> state);
    OperatorState* getLocalState(const PhysicalOperator* op);
    ...
    std::unordered_map<const PhysicalOperator*, std::unique_ptr<OperatorState>> localStateMap;
