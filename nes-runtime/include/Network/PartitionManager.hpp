...
public:
  ...
  getSubpartitionConsumerCounter(NesPartition partition);
  ...
  getConsumerRegistrationStatus(NesPartition partition) const;
   ...
   */
  std::optional<uint64_t>
  getSubpartitionProducerCounter(NesPartition partition);
   ...
   */
  PartitionRegistrationStatus
  getProducerRegistrationStatus(NesPartition partition) const;
   ...
   */
  bool
  addSubpartitionEventListener(NesPartition partition,
                               NodeLocation nodeLocation,
                               Runtime::RuntimeEventListenerPtr eventListener);
  ...
  getEventListener(NesPartition partition) const;
