...
/**
 * @brief This enum represent the life-cycle of a nes partition in the partition
 * manager: NotFound: partition was never registered in the current partition
 * manager. Deleted: partition was unregistered at some point in time (we keep
 * it for bookkeeping). Registered: partition was registered and alive (meaning
 * its ref cnt is greater than 0).
 */
