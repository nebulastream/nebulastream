...
public:
   ...
   */
  // Todo: In the scope of #4040 we decide whether writeData() should return an
  // ExecutionResult
  virtual bool writeData(Runtime::TupleBuffer &inputBuffer,
                         Runtime::WorkerContext &workerContext) = 0;
