...
public:
    ...
    * @return vector of Tuple buffer containing the content of the tuplebuffer
     */
    std::string
    getFormattedBuffer(const Memory::TupleBuffer& inputBuffer, std::shared_ptr<Memory::AbstractBufferProvider> bufferProvider) override;
