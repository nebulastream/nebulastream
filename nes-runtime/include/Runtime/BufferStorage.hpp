...
/**
 * @brief The Buffer Storage class stores tuples inside a queue and trims it
 * when the right acknowledgement is received
 */
...
public:
  ...
  /**
   * @brief Deletes all tuple buffers which watermark timestamp is smaller than
   * the given timestamp
   * @param NesPartition destination
