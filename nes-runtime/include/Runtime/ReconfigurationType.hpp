...
enum class ReconfigurationType : uint8_t {
  /// use Initialize for reconfiguration tasks that initialize a reconfigurable
  /// instance
  Initialize,
  /// use Destroy for reconfiguration tasks that cleans up a reconfigurable
  /// instance
  Destroy,
  ...
  /// Indicates that the version of the operator is updated due to
  /// reconfiguration as part of query redeployment
  UpdateVersion,
};
}
