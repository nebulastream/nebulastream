...
public:
   ...
   * @param noOverwrite If true, the value is only set, if the previous value
   * was 0 (if it was never set).
   */
   ...
   * was 0 (if it was never set).
   */
  void setTimestampFirstProcessedTask(uint64_t timestampFirstProcessedTask,
                                      bool noOverwrite);
