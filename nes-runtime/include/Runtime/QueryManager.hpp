...
public:
    ...
    */
     ...
     */
    virtual ExecutionResult processNextTask(bool running, WorkerContext& workerContext);
     ...
     */
    virtual void addWorkForNextPipeline(TupleBuffer& buffer, Execution::SuccessorExecutablePipeline executable, uint32_t queueId = 0);
...
public:
     ...
     * @return task count
     */
    virtual uint64_t getNumberOfTasksInWorkerQueues() const;
...
private:
    ...
    * @return bool indicating success
    */
    virtual bool startThreadPool(uint64_t numberOfBuffersPerWorker);
...
protected:
     ...
     */
    virtual ExecutionResult terminateLoop(WorkerContext&);
