...
//todo: avoid this include by using a pointer?
...
*/
    class WorkerContext {
      private:
        ...
        std::unordered_map<NES::OperatorId, Network::ConnectionThreadInfo> dataChannelFutures;
...
* @param channel the output channel
*/
        void storeNetworkChannelFuture(NES::OperatorId id, Network::ConnectionThreadInfo&& threadInfo);
