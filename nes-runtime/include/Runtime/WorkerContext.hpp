...
public:
  ...
  getTopTupleFromStorage(Network::NesPartition nesPartition);
  ...
  getAsyncConnectionResult(OperatorId operatorId);
  ...
  getEventOnlyNetworkChannel(OperatorId operatorId);
  ...
  waitForAsyncConnectionEventChannel(OperatorId operatorId);
