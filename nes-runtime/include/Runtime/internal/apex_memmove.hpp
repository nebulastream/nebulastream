...
//	FORCE `CDECL` calling convention on 32-bit builds on our function
//pointers, because we need it to match the original `std::memmove` definition;
//in-case the user specified a different default function calling convention! (I
//specified __fastcall as my default calling convention and got errors! So I
//needed to add this!)
