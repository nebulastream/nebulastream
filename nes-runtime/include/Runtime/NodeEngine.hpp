...
class NodeEngine
 ...
 public:
   ...
   */
  Execution::ExecutableQueryPlanStatus getQueryStatus(
   ...
   */
  std::shared_ptr<const Execution::ExecutableQueryPlan> getExecutableQueryPlan(
   ...
   */
  std::vector<DecomposedQueryPlanId> getDecomposedQueryIds(
      SharedQueryId sharedQueryId);
