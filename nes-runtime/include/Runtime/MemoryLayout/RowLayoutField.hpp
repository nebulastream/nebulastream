...
class RowLayoutField {
 public:
   ...
   */
  static inline RowLayoutField<T, boundaryChecks> create(
      uint64_t fieldIndex, std::shared_ptr<RowLayout> layout,
      TupleBuffer& buffer);
   ...
   */
  static inline RowLayoutField<T, boundaryChecks> create(
      const std::string& fieldName, std::shared_ptr<RowLayout> layout,
      TupleBuffer& buffer);
