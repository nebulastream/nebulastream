...
public:
    ...
    {
        PRECONDITION(!compiled, "registerExternalSymbol() must not be called after the module has been compiled");
        engine.registerExternalSymbol(symbolName, address);
    }
