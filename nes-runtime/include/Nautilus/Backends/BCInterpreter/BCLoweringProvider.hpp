...
#ifndef NES_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BC_BCLOWERINGPROVIDER_HPP_
#define NES_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BC_BCLOWERINGPROVIDER_HPP_
  ...
  private:
    ...
    class LoweringContext {
      ...
      private:
        ...
        bool processDynamicCall(const std::shared_ptr<IR::Operations::ProxyCallOperation>& opt, short block, RegisterFrame& frame);
        short getResultRegister(const std::shared_ptr<IR::Operations::Operation>& opt, RegisterFrame& frame);
    };
};
}// namespace NES::Nautilus::Backends::BC
#endif// NES_RUNTIME_INCLUDE_NAUTILUS_BACKENDS_BC_BCLOWERINGPROVIDER_HPP_
