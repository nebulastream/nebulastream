...
class BabelfishExecutable : public Executable {
  public:
     ...
     */
    explicit BabelfishExecutable(BabelfishCode code, jni::jclass entrypointClass, jni::jobject pipelineObject);
  ...
  private:
    BabelfishCode code;
    jni::jclass entrypointClass;
    jni::jobject pipelineObject;
};
}// namespace NES::Nautilus::Backends::Babelfish
