...
public:
   ...
   * @return
   */
  static bool validateFieldsInSchema(SchemaPtr metricSchema,
  ...
  toJson(std::unordered_map<MetricType, std::shared_ptr<Metric>> metrics);
   ...
   */
  static MetricCollectorPtr
  createCollectorFromCollectorType(MetricCollectorType type);
  ...
  getSchemaFromCollectorType(MetricCollectorType type);
