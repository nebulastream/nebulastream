...
/**
 * @brief Wrapper class to represent a tuple buffer with multiple CpuMetrics
 * objects.
 */
...
public:
  ...
  /**
   * @brief The number of CPU metrics contained in the wrapper. The number is
   * equivalent to the number of cores + 1.
   * @return Number of CPU metrics
   */
  [[nodiscard]] uint64_t size() const;

  /**
   * @brief The summarized stats over all CPU metrics. This metric is equivalent
   * to the 0th element of the list.
   * @return CPUMetrics
   */
