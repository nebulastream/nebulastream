...
class RegistrationMetrics {
 public:
   ...
   * @return the schema
   */
  static Configurations::SchemaTypePtr getSchemaType(
  ...
  uint64_t cpuCoreNum;
  uint64_t
      totalCPUJiffies;  // user+idle+system (This value can change everytime it
                        // is read via AbstractSystemResourcesReader)
  // Using 1.5 CPUs is equivalent to --cpu-period="100000" and
  // --cpu-quota="150000"
