...
/**
 * The metric collector class for CPU metrics. Metric collectors are required
 * for the integration with data sources.
 */
class CpuCollector : public MetricCollector {
 public:
  ...
  /**
   * @brief Read the CPU metrics based on the underlying utility systems reader
