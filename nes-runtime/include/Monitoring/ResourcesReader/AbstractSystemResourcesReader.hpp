...
public:
  ...
  AbstractSystemResourcesReader(const AbstractSystemResourcesReader &) =
      default;
  AbstractSystemResourcesReader(AbstractSystemResourcesReader &&) = default;
  //  -- Assignment --
  AbstractSystemResourcesReader &
  operator=(const AbstractSystemResourcesReader &) = default;
  AbstractSystemResourcesReader &
  operator=(AbstractSystemResourcesReader &&) = default;
  //  -- dtor --
