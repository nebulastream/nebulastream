...
public:
   ...
   * source
   * @param executableSuccessors the subsequent operators in the pipeline to
   * which the data is pushed
   */
  explicit MQTTSource(
  ...
  /**
   * @brief destructor of mqtt sink that disconnects the queue before
   * deconstruction
