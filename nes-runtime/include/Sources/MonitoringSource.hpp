...
/**
 * @brief this class provides a monitoring source to generate metrics based on a
...
class MonitoringSource : public DataSource {
 public:
  ...
  MonitoringSource(Monitoring::MetricCollectorPtr metricCollector,
                   ...
                   OriginId originId, StatisticId statisticId,
 ...
 public:
  static constexpr std::chrono::milliseconds DEFAULT_WAIT_TIME =
