 ...
 */
class StaticDataSource : public GeneratorSource,
                         public ::NES::Runtime::BufferRecycler {
public:
  /**
  ...
  /**
   * @brief overwrite DataSource::start(). Only start runningRoutine, if
   * lateStart==false.
   */
  bool start() final;
  ...
  /**
   * @brief API method called upon receiving an event. At startSourceEvent,
   * start source.
   * @param event
   */
  ...
  virtual void
  recyclePooledBuffer(::NES::Runtime::detail::MemorySegment *) override{};
   ...
   */
  virtual void
  recycleUnpooledBuffer(::NES::Runtime::detail::MemorySegment *) override{};
