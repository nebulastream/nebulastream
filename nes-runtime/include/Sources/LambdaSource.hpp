...
public:
   ...
   * @param numbersOfBufferToProduce the number of buffers to be produced by the
   * source
   ...
   * @param numSourceLocalBuffers numSourceLocalBuffers the number of buffers
   * allocated to a source
