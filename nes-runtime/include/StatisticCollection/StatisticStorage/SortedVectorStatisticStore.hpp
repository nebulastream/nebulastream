#ifndef NES_NES_COORDINATOR_INCLUDE_STATISTICCOLLECTION_STATISTICSTORAGE_SORTEDVECTORSTATISTICSTORE_HPP_
#define NES_NES_COORDINATOR_INCLUDE_STATISTICCOLLECTION_STATISTICSTORAGE_SORTEDVECTORSTATISTICSTORE_HPP_
 ...
 */
class SortedVectorStatisticStore : public AbstractStatisticStore {
  public:
    /**
     * @brief Creates a SortedVectorStatisticStore
     ...
     */
    virtual ~SortedVectorStatisticStore();
...
#endif//NES_NES_COORDINATOR_INCLUDE_STATISTICCOLLECTION_STATISTICSTORAGE_SORTEDVECTORSTATISTICSTORE_HPP_