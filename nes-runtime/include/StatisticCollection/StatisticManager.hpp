...
#ifndef NES_RUNTIME_INCLUDE_STATISTICCOLLECTION_STATISTICMANAGER_HPP_
#define NES_RUNTIME_INCLUDE_STATISTICCOLLECTION_STATISTICMANAGER_HPP_
...
public:
  ...
  getStatistics(const StatisticProbeRequest &probeRequest);
