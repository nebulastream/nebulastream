...
std::vector<uint64_t> NLJOperatorHandler::checkWindowsTrigger(uint64_t watermarkTs, uint64_t sequenceNumber, OriginId originId) {
    ...
    NES_DEBUG2("newGlobalWatermark {} watermarkTs {} sequenceNumber {} originId {}",
               newGlobalWatermark,
               watermarkTs,
               sequenceNumber,
               originId);
