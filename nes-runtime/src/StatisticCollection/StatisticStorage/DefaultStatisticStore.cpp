...
DefaultStatisticStore::getStatistics(const StatisticHash &statisticHash,
...
bool DefaultStatisticStore::insertStatistic(const StatisticHash &statisticHash,
...
std::vector<HashStatisticPair> DefaultStatisticStore::getAllStatistics() {
  ...
  for (const auto &[statisticHash, statisticVec] : *lockedKeyToStatisticMap) {
    std::transform(statisticVec.begin(), statisticVec.end(),
