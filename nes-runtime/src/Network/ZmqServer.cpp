  ...
  try {
    ...
    while (keepRunning) {
      ...
      case MessageType::ClientAnnouncement: {
        ...
        auto optRecvStatus =
            dispatcherSocket.recv(clientAnnouncementEnvelope, kZmqRecvDefault);
        ...
        std::visit(detail::overloaded{
                       ...
                       [this, &dispatcherSocket, &outIdentityEnvelope](
      ...
      case MessageType::DataBuffer: {
        ...
        NES_TRACE("ZmqServer({}:{}):  DataBuffer received from origin={} and "
                  ...
                  nesPartition->toString(), bufferHeader->payloadSize,
        ...
        for (uint32_t i = 0u, numOfChildren = bufferHeader->numOfChildren;
          ...
          auto childBuffer =
              bufferManager->getUnpooledBuffer(childBufferHeader->payloadSize);
        ...
        auto optRetSize = dispatcherSocket.recv(
            zmq::mutable_buffer(buffer.getBuffer(), bufferHeader->payloadSize),
            kZmqRecvDefault);
        NES_ASSERT2_FMT(optRetSize.has_value(), "Invalid recv size");
