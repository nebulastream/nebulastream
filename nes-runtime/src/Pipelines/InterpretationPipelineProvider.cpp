...
#include <Pipelines/InterpretationPipelineProvider.hpp>
    ...
    nautilus::engine::Options & options)
{
    ...
    return std::make_unique<CompiledExecutablePipelineStage>(std::move(pipeline), std::move(operatorHandlers), options);
}
