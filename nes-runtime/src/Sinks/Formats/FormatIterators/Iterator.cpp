    ...
    for (uint32_t fieldIndex = 0; fieldIndex < fieldNames.size(); fieldIndex++)
    {
        ...
        else if (physicalType->isBasicType())
        {
            ...
            switch (basicFieldType->nativeType)
            {
                ...
                case INT_8:
                    jsonObject[fieldName] = *reinterpret_cast<int8_t const*>(fieldData);
                    break;
                case INT_16:
                    jsonObject[fieldName] = *reinterpret_cast<int16_t const*>(fieldData);
                    break;
                case INT_32:
                    jsonObject[fieldName] = *reinterpret_cast<int32_t const*>(fieldData);
                    break;
                case INT_64:
                    jsonObject[fieldName] = *reinterpret_cast<int64_t const*>(fieldData);
                    break;
                case UINT_8:
                    jsonObject[fieldName] = *reinterpret_cast<uint8_t const*>(fieldData);
                    break;
                case UINT_16:
                    jsonObject[fieldName] = *reinterpret_cast<uint16_t const*>(fieldData);
                    break;
                case UINT_32:
                    jsonObject[fieldName] = *reinterpret_cast<uint32_t const*>(fieldData);
                    break;
                case UINT_64:
                    jsonObject[fieldName] = *reinterpret_cast<uint64_t const*>(fieldData);
                    break;
                case FLOAT:
                    jsonObject[fieldName] = *reinterpret_cast<float const*>(fieldData);
                    break;
                case DOUBLE:
                    jsonObject[fieldName] = *reinterpret_cast<double const*>(fieldData);
                    break;
                case BOOLEAN:
                    jsonObject[fieldName] = *reinterpret_cast<bool const*>(fieldData);
                    break;
                case CHAR:
