...
CsvFormat::CsvFormat(SchemaPtr schema) : SinkFormat(std::move(schema))
{
}

CsvFormat::CsvFormat(SchemaPtr schema, bool addTimestamp) : SinkFormat(std::move(schema), addTimestamp)
{
}
...
std::string CsvFormat::getFormattedBuffer(const Memory::TupleBuffer& inputBuffer, std::shared_ptr<Memory::AbstractBufferProvider>)
{
