...
AbstractStatisticFormat::AbstractStatisticFormat(
    const Schema& schema, Runtime::MemoryLayouts::MemoryLayoutPtr memoryLayout,
    ...
    : AbstractStatisticFormat(
          ...
          memoryLayout, postProcessingData, preProcessingData) {}
...
AbstractStatisticFormat::AbstractStatisticFormat(
    ...
    : memoryLayout(std::move(memoryLayout)),
      startTsFieldName(qualifierNameWithSeparator + BASE_FIELD_NAME_START),
      endTsFieldName(qualifierNameWithSeparator + BASE_FIELD_NAME_END),
      statisticHashFieldName(qualifierNameWithSeparator +
                             STATISTIC_HASH_FIELD_NAME),
      statisticTypeFieldName(qualifierNameWithSeparator +
                             STATISTIC_TYPE_FIELD_NAME),
      observedTuplesFieldName(qualifierNameWithSeparator +
                              OBSERVED_TUPLES_FIELD_NAME),
