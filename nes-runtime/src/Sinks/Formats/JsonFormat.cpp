...
JsonFormat::JsonFormat(SchemaPtr schema) : SinkFormat(std::move(schema))
{
}

std::string JsonFormat::getFormattedBuffer(const Memory::TupleBuffer&, std::shared_ptr<Memory::AbstractBufferProvider>)
{
    throw FunctionNotImplemented();
}
