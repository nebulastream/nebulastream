...
MonitoringPlan::MonitoringPlan(const std::set<MetricType> &metrics)
    : metricTypes(metrics) {
...
MonitoringPlanPtr MonitoringPlan::defaultPlan() {
  std::set<MetricType> metricTypes{
      MetricType::WrappedCpuMetrics, MetricType::DiskMetric,
      MetricType::MemoryMetric, MetricType::WrappedNetworkMetrics};
