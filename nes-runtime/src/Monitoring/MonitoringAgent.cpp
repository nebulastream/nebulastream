...
const std::vector<MetricPtr> MonitoringAgent::getMetricsFromPlan() const {
  ...
  if (enabled) {
    NES_DEBUG(
        "MonitoringAgent: Monitoring enabled, reading metrics for "
        "getMetricsFromPlan().");
    ...
    NES_WARNING(
        "MonitoringAgent: Monitoring disabled, getMetricsFromPlan() returns "
        "empty vector.");
  }
  return output;
}
...
RegistrationMetrics MonitoringAgent::getRegistrationMetrics() {
  ...
  NES_WARNING(
      "MonitoringAgent: Metrics disabled. Return empty metric object for "
      "registration.");
...
bool MonitoringAgent::addMonitoringStreams(
  ...
  if (enabled) {
    for (auto metricType : monitoringPlan->getMetricTypes()) {
      ...
      NES_INFO(
          "MonitoringAgent: Adding physical source to config {} _ph with wait "
          "time {}",
  ...
  NES_WARNING(
      "MonitoringAgent: Monitoring is disabled, registering of physical "
