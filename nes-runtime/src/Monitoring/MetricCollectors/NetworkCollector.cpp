...
NetworkCollector::NetworkCollector()
    : MetricCollector(), resourceReader(SystemResourcesReaderFactory::getSystemResourcesReader()), schema(NetworkMetrics::getSchema(""))
{
...
SchemaPtr NetworkCollector::getSchema()
{
    return schema;
}
