...
MemoryCollector::MemoryCollector()
    : MetricCollector(), resourceReader(SystemResourcesReaderFactory::getSystemResourcesReader()), schema(MemoryMetrics::getSchema(""))
{
...
SchemaPtr MemoryCollector::getSchema()
{
    return schema;
}
