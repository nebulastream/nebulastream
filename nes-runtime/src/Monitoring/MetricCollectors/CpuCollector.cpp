...
CpuCollector::CpuCollector()
    : MetricCollector(), resourceReader(SystemResourcesReaderFactory::getSystemResourcesReader()), schema(CpuMetrics::getSchema(""))
{
    NES_INFO("CpuCollector: Init CpuCollector with schema {}", schema->toString());
}

MetricCollectorType CpuCollector::getType()
{
...
SchemaPtr CpuCollector::getSchema()
{
    return schema;
}
