...
void SubOperation::setLeftInput(OperationPtr leftInput) {  this->leftInput = leftInput; }
void SubOperation::setRightInput(OperationPtr rightInput) { this->rightInput = rightInput; }
}// namespace NES::Nautilus::IR::Operations