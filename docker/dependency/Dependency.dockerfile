...
ADD https://github.com/nebulastream/clang-binaries/releases/download/vmlir-${LLVM_VERSION}-with-fix-173075/nes-llvm-${LLVM_VERSION}-with-fix-173075-${ARCH}-${SANITIZER}-${STDLIB}.tar.zstd llvm.tar.zstd
