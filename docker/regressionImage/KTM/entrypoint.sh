...
#
#  # Start the worker.
#  nesWorker --logLevel=LOG_ERROR --physicalSources.type=CSVSource --physicalSources.filePath=/resources/0917-619-30-s.csv --physicalSources.numberOfBuffersToProduce=1024 --physicalSources.physicalSourceName=can_bus_csv --physicalSources.logicalSourceName=can_bus --physicalSources.skipHeader=true --physicalSources.numberOfTuplesToProducePerBuffer=0 &
#  sleep 2s
#
#  # Execute a query.
