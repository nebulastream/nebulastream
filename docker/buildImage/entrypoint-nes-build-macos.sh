...
cmake --fresh -B "$build_dir/" -DJAVA_HOME="$JAVA_HOME" -DCMAKE_BUILD_TYPE=Release -DBoost_NO_SYSTEM_PATHS=TRUE -DNES_USE_CCACHE=1 -DNES_SELF_HOSTING=1 -DNES_ENABLE_EXPERIMENTAL_EXECUTION_ENGINE=1 -DNES_USE_ADAPTIVE=0  -DNES_USE_OPENCL=1 .
