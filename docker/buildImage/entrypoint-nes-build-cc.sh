...
then
    ...
    cmake -DCMAKE_BUILD_TYPE=Release -DNES_CODE_COVERAGE=ON -DBoost_NO_SYSTEM_PATHS=TRUE -DNES_SELF_HOSTING=1 -DNES_USE_OPC=1 -DNES_USE_MQTT=1 -DNES_TEST_PARALLELISM=$NesTestParallelism -DNES_USE_TF=1 -DNES_USE_S2=1 ..
