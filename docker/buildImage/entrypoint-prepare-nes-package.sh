...
then
    ...
    cmake -DCMAKE_BUILD_TYPE=Release -DNES_SELF_HOSTING=1 NES_ENABLES_TESTS=0 -DNES_USE_OPC=0 -DNES_ENABLE_EXPERIMENTAL_EXECUTION_ENGINE=1 -DNES_ENABLE_EXPERIMENTAL_EXECUTION_MLIR=1 -DNES_USE_MQTT=1 -DNES_USE_ADAPTIVE=0 -DNES_USE_TF=1 -DNES_USE_S2=1 ..
    make -j4
    cpack
else
    exec $@
