...
if [ $# -eq 0 ]; then
  ...
  cmake -B /build_dir -DCMAKE_BUILD_TYPE=Release -DBoost_NO_SYSTEM_PATHS=TRUE -DNES_SELF_HOSTING=1 -DNES_TEST_PARALLELISM=$NesTestParallelism -DNES_USE_OPENCL=1 -DCMAKE_EXPORT_COMPILE_COMMANDS=1 /nebulastream
