...
Nebulastream CI and provide a branch specific version of the development image. 
The development image with changed dependencies is available via:
...
![CLion Docker toolchain settings](/images/SetupDockerToolchainClion.png)
...
![CLion CMake profile settings](/images/SetupDockerCmakeClion.png)
...
of the [base.dockerfile](https://github.com/nebulastream/nebulastream/blob/main/docker/dependency/Base.dockerfile) to replicate on Ubuntu or Debian systems.
