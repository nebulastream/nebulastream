...
For file syntax, groups, in-test worker configuration, validation modes, and how to run them, see [How to Systest](#how-to-systest) below.
...
![Example Systest](https://raw.githubusercontent.com/nebulastream/nebulastream/main/docs/development/systest_testfile.png)

## Requirements
This document assumes that you already have a working development setup for the nebulastream repository, as described in [Build instructions]({{< ref "developer" >}}).

## Setup
1. To set up the syntax highlighting in CLion, follow the [Syntax Highlighting Documentation](https://github.com/nebulastream/nebulastream/blob/main/nes-systests/utils/SyntaxHighlighting/README.md).
2. To set up the Clion plugin for manually executing systests, follow the [Systest Plugin Documentation](https://github.com/nebulastream/nebulastream/blob/main/nes-systests/utils/SystestPlugin/README.md).
...
The systest framework supports configurable multi-worker topologies. By default, it uses the [2-node topology](https://github.com/nebulastream/nebulastream/blob/main/nes-systests/configs/topologies/two-node.yaml).
