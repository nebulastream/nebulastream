...
The arguments also carry `outputType`, the type inference settled on, which the physical function keeps so it can pin the type of whatever a branch returns.
