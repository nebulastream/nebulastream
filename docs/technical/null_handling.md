...
**CSV**: Empty fields are interpreted as NULL for nullable columns.
...
**JSON**: Both `null` values and missing keys produce NULL for nullable columns.
...
Projection passes NULL values through unchanged.
