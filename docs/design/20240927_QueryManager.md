...
The reference counting can happen implicitly, reducing the risk of leaking references.
...
For this, we expand the query engine interface to accept runtime and statistic listener, which allows complexity to shift into other components (**G1**).
