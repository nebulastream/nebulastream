...
public:
  Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
      const std::string &testType, const Query &leftQuery,
      const Query &rightQuery, const std::string &mergedQueryPlan)
      : testType(testType), leftQuery(leftQuery), rightQuery(rightQuery),
        mergedQueryPlan(mergedQueryPlan) {}
...
class Z3SignatureBasedBottomUpQueryContainmentRuleTest
    : public Testing::BaseUnitTest,
      public testing::WithParamInterface<
          std::vector<Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry>> {
    ...
    return std::vector<Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry>{
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                .joinWith(Query::from("solarPanels"))
                .where(Attribute("id1") == Attribute("id"))
                .window(SlidingWindow::of(EventTime(Attribute("ts")),
                                          Milliseconds(1000),
                                          Milliseconds(1000)))
                .sink(PrintSinkDescriptor::create()),
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                ...
                .project(Attribute("value"), Attribute("id1"),
            ...
            Query::from("windTurbines")
                ...
                .project(
                    ...
                    Attribute("windTurbines$ts"), Attribute("households$value"),
                    Attribute("households$id"), Attribute("households$value1"),
            ...
            Query::from("windTurbines")
                ...
                .joinWith(
                    Query::from("households")
                        ...
                        .byKey(Attribute("id"))
                        .apply(Sum(Attribute("value"))))
                .where(Attribute("windTurbines$id") ==
                       Attribute("households$id"))
                .window(
                    TumblingWindow::of(EventTime(Attribute("start")), Hours(1)))
                .sink(PrintSinkDescriptor::create()),
            Query::from("windTurbines")
                .unionWith(Query::from("solarPanels"))
                .window(TumblingWindow::of(EventTime(Attribute("ts")),
    ...
    return std::vector<Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry>{
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                ...
                .window(
                    TumblingWindow::of(EventTime(Attribute("ts")), Seconds(20)))
                .apply(Sum(Attribute("value1")))
                .sink(PrintSinkDescriptor::create()),
            Query::from("windTurbines")
                .window(
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                .window(SlidingWindow::of(EventTime(Attribute("ts")),
                                          Milliseconds(1000), Milliseconds(10)))
                .byKey(Attribute("id"))
                .apply(Sum(Attribute("value")))
                .sink(PrintSinkDescriptor::create()),
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                ...
                .project(
                    ...
                    Attribute("windTurbines$id1"),
                    Attribute("windTurbines$value1"),
                    Attribute("households$value"), Attribute("households$id"),
                    Attribute("households$value1"),
                    Attribute("windTurbines$ts"), Attribute("households$ts"))
                .sink(PrintSinkDescriptor::create()),
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                ...
                .where(Attribute("windTurbines$id") ==
                       Attribute("households$id"))
                .window(
                    TumblingWindow::of(EventTime(Attribute("ts")), Hours(1)))
                .window(TumblingWindow::of(EventTime(Attribute("ts")),
                                           Milliseconds(1000)))
                .byKey(Attribute("id"))
                .apply(Sum(Attribute("value")))
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            Query::from("windTurbines")
                ...
                .unionWith(
                    Query::from("solarPanels").filter(Attribute("value") < 10))
                .sink(PrintSinkDescriptor::create()),
            Query::from("windTurbines")
                .filter(Attribute("value") < 20)
                .unionWith(
                    Query::from("solarPanels").filter(Attribute("value") < 20))
                .sink(PrintSinkDescriptor::create()),
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            "SOURCE(391,households,LogicalSourceDescriptor("
            "households, ))\n"),
        // projection conditions differ too much for containment to be picked up
        // in the complete query bottom up approach would detect it, though
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            "TestMixedContainmentCases",
            Query::from("windTurbines")
                .unionWith(Query::from("solarPanels"))
  ...
  static auto createProjectionContainmentCases() {
    return std::vector<Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry>{
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
            ...
            "      PROJECTION(470, schema=windTurbines$value:INTEGER "
            "windTurbines$id1:INTEGER windTurbines$value1:INTEGER "
            "windTurbines$ts:INTEGER )\n"
            "        FILTER(469)\n"
            "          unionWith(479)\n"
            ...
            "      PROJECTION(472, schema=households$value:INTEGER "
            "households$id:INTEGER households$value1:(Float) "
            "households$ts:INTEGER )\n"
            "        SOURCE(480,households,LogicalSourceDescriptor(households, "
            "))\n"
            "SINK(486: {PrintSinkDescriptor()})\n"
            "  PROJECTION(485, schema=windTurbines$value:INTEGER "
            "windTurbines$id1:INTEGER households$value:INTEGER "
            "households$id:INTEGER windTurbines$ts:INTEGER "
            "households$ts:INTEGER )\n"
            "    FILTER(484)\n"
            "      Join(483)\n"
...
/**
 * @brief Test applying Z3SignatureBasedBottomUpQueryContainmentRuleTest on
 * Global query plan
 */
TEST_P(Z3SignatureBasedBottomUpQueryContainmentRuleTest,
       DISABLED_testMergingContainmentQueries) {
  ...
  for (const auto &containmentCase : containmentCases) {
    ...
    SinkLogicalOperatorPtr sinkOperator1 =
        queryPlanSQPQuery->getSinkOperators()[0];
    QueryId queryId1 = PlanIdGenerator::getNextQueryId();
    queryPlanSQPQuery->setQueryId(queryId1);
    SinkLogicalOperatorPtr sinkOperator2 =
        queryPlanNewQuery->getSinkOperators()[0];
    ...
    auto signatureBasedEqualQueryMergerRule =
        Optimizer::Z3SignatureBasedBottomUpQueryContainmentRule::create(context,
                                                                        true);
    signatureBasedEqualQueryMergerRule->apply(globalQueryPlan);

    // assert
    auto updatedSharedQMToDeploy =
    ...
    EXPECT_EQ(containmentCase.mergedQueryPlan,
...
INSTANTIATE_TEST_CASE_P(
    ...
    ::testing::Values(
        ...
        Z3SignatureBasedBottomUpQueryContainmentRuleTest::
            createMixedContainmentCases(),
        Z3SignatureBasedBottomUpQueryContainmentRuleTest::
            createProjectionContainmentCases()),
    [](const testing::TestParamInfo<
        Z3SignatureBasedBottomUpQueryContainmentRuleTest::ParamType> &info) {
