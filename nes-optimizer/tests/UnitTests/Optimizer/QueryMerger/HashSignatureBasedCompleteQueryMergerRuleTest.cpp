...
class HashSignatureBasedCompleteQueryMergerRuleTest
...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging(
        "HashSignatureBasedCompleteQueryMergerRuleTest.log",
...
TEST_F(HashSignatureBasedCompleteQueryMergerRuleTest, testMergingEqualQueries) {
  ...
  auto stringSignatureBasedEqualQueryMergerRule =
      Optimizer::HashSignatureBasedCompleteQueryMergerRule::create();
 ...
 */
TEST_F(
    HashSignatureBasedCompleteQueryMergerRuleTest,
