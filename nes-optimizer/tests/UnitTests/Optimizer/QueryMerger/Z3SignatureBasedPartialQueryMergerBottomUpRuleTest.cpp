...
class Z3SignatureBasedPartialQueryMergerBottomUpRuleTest
 ...
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging(
        "Z3SignatureBasedPartialQueryMergerBottomUpRuleTest.log",
        NES::LogLevel::LOG_DEBUG);
    NES_INFO(
        "Setup Z3SignatureBasedPartialQueryMergerBottomUpRuleTest test case.");
  }
 ...
 */
TEST_F(Z3SignatureBasedPartialQueryMergerBottomUpRuleTest,
       testMergingEqualQueries) {
  ...
  auto signatureBasedEqualQueryMergerRule =
      Optimizer::Z3SignatureBasedPartialQueryMergerBottomUpRule::create(
          context);
...
TEST_F(Z3SignatureBasedPartialQueryMergerBottomUpRuleTest,
       testMergingMoreThanTwoPartiallyEqualQueries) {
  auto topologySpecificReWrite =
      Optimizer::TopologySpecificQueryRewritePhase::create(
          Topology::create(), sourceCatalog,
          Configurations::OptimizerConfiguration(), statisticProbeHandler);
  ...
  for (const auto& upstreamOperator :
       changeLogEntries[0].second->upstreamOperators) {
