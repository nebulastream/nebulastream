...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("QuerySignatureUtilTests.log",
  ...
  void SetUp() override {
    ...
    schema = Schema::create()
                 ->addField("test$id", BasicType::UINT32)
                 ->addField("test$value", BasicType::UINT64);
  }
};

TEST_F(QuerySignatureUtilTests, testFiltersWithExactPredicates) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Predicate
  ...
  LogicalOperatorPtr sourceOperator =
      LogicalOperatorFactory::createSourceOperator(descriptor);

  // Create Filters
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createFilterOperator(predicate);
  ...
  LogicalOperatorPtr logicalOperator2 =
      LogicalOperatorFactory::createFilterOperator(predicate);
  ...
  // Assert
  auto signatureEqualityUtil =
      Optimizer::SignatureEqualityUtil::create(context.getContext());
...
TEST_F(QuerySignatureUtilTests, testFiltersWithEqualPredicates) {
  ...
  // Create Filters
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createFilterOperator(predicate1);
  logicalOperator1->addChild(sourceOperator);
  logicalOperator1->inferSchema();
  logicalOperator1->inferZ3Signature(context);
  auto sig1 = logicalOperator1->getZ3Signature();
  ...
  LogicalOperatorPtr logicalOperator2 =
      LogicalOperatorFactory::createFilterOperator(predicate2);
  logicalOperator2->addChild(sourceOperator);
  logicalOperator2->inferSchema();
  logicalOperator2->inferZ3Signature(context);
  auto sig2 = logicalOperator2->getZ3Signature();
...
TEST_F(QuerySignatureUtilTests, testFiltersWithMultipleExactPredicates) {
  ...
  // Define Predicate
  ExpressionNodePtr predicate1 =
      Attribute("value") == 40 && Attribute("id") >= 40;
  predicate1->inferStamp(schema);
...
TEST_F(QuerySignatureUtilTests, testFiltersWithMultipleEqualPredicates1) {
  ...
  ExpressionNodePtr predicate1 =
      Attribute("value") == 40 && Attribute("id") >= 40;
  predicate1->inferStamp(schema);
  ExpressionNodePtr predicate2 =
      Attribute("id") >= 40 && Attribute("value") == 40;
  predicate2->inferStamp(schema);
...
TEST_F(QuerySignatureUtilTests, testFiltersWithMultipleEqualPredicates2) {
  ...
  // Define Predicate
  ExpressionNodePtr predicate1 =
      Attribute("value") == 40 + 40 && Attribute("id") >= 40;
  predicate1->inferStamp(schema);
  ExpressionNodePtr predicate2 =
      Attribute("id") >= 40 && Attribute("value") == 80;
  predicate2->inferStamp(schema);
...
TEST_F(QuerySignatureUtilTests, testFiltersWithMultipleDifferentPredicates) {
  ...
  predicate1->inferStamp(schema);
  ExpressionNodePtr predicate2 =
      Attribute("id") >= 40 or Attribute("value") == 40;
  predicate2->inferStamp(schema);
...
TEST_F(QuerySignatureUtilTests, testMapWithExactExpression) {
  ...
  // Create Filters
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createMapOperator(expression);
  logicalOperator1->addChild(sourceOperator);
  logicalOperator1->inferSchema();
  logicalOperator1->inferZ3Signature(context);
  auto sig1 = logicalOperator1->getZ3Signature();
...
TEST_F(QuerySignatureUtilTests, testMapWithDifferentExpression) {
  ...
  // Create Filters
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createMapOperator(expression1);
  logicalOperator1->addChild(sourceOperator);
  logicalOperator1->inferSchema();
  logicalOperator1->inferZ3Signature(context);
  auto sig1 = logicalOperator1->getZ3Signature();
  ...
  LogicalOperatorPtr logicalOperator2 =
      LogicalOperatorFactory::createMapOperator(expression2);
  logicalOperator2->addChild(sourceOperator);
  logicalOperator2->inferSchema();
  logicalOperator2->inferZ3Signature(context);
  auto sig2 = logicalOperator2->getZ3Signature();
...
TEST_F(QuerySignatureUtilTests, testMultipleMapsWithDifferentOrder) {
  ...
  FieldAssignmentExpressionNodePtr expression2 = Attribute("value") =
  ...
  // Create map
  LogicalOperatorPtr logicalOperator11 =
      LogicalOperatorFactory::createMapOperator(expression1);
  logicalOperator11->addChild(sourceOperator);
  LogicalOperatorPtr logicalOperator12 =
      LogicalOperatorFactory::createMapOperator(expression2);
  ...
  LogicalOperatorPtr logicalOperator21 =
      LogicalOperatorFactory::createMapOperator(expression2);
  logicalOperator21->addChild(sourceOperator);
  LogicalOperatorPtr logicalOperator22 =
      LogicalOperatorFactory::createMapOperator(expression1);
...
TEST_F(QuerySignatureUtilTests, testSourceWithSameSourceName) {
  ...
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createSourceOperator(sourceDescriptor);
  logicalOperator1->inferSchema();
  logicalOperator1->inferZ3Signature(context);
  auto sig1 = logicalOperator1->getZ3Signature();
...
TEST_F(QuerySignatureUtilTests, testSourceWithDifferentSourceName) {
  ...
  // Create source
  LogicalOperatorPtr logicalOperator1 =
      LogicalOperatorFactory::createSourceOperator(sourceDescriptor1);
  logicalOperator1->inferSchema();
  logicalOperator1->inferZ3Signature(context);
  auto sig1 = logicalOperator1->getZ3Signature();

  LogicalOperatorPtr logicalOperator2 =
      LogicalOperatorFactory::createSourceOperator(sourceDescriptor2);
  logicalOperator2->inferSchema();
  logicalOperator2->inferZ3Signature(context);
  auto sig2 = logicalOperator2->getZ3Signature();
...
TEST_F(QuerySignatureUtilTests, testSignatureComputationForProjectOperators) {
  ...
  auto projectionOperator1 = LogicalOperatorFactory::createProjectionOperator(
      {FieldAccessExpressionNode::create("id"),
       FieldAccessExpressionNode::create("value")});
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForSameProjectOperatorsButDifferentSources) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForDifferenProjectOperators) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForWatermarkAssignerOperator) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForIngestionTimeWatermarkAssignerOperator) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForDifferentWatermarkAssignerOperator) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
...
TEST_F(
    QuerySignatureUtilTests,
    testSignatureComputationForWatermarkAssignerOperatorWithDifferentLateness) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
  ...
  auto watermarkOperator2 =
      LogicalOperatorFactory::createWatermarkAssignerOperator(
          Windowing::EventTimeWatermarkStrategyDescriptor::create(
              FieldAccessExpressionNode::create("id"),
              NES::API::Milliseconds(9), NES::API::Milliseconds()));
...
TEST_F(QuerySignatureUtilTests,
       testSignatureComputationForWatermarkAssignerOperatorWithDifferentField) {
  auto context =
      Optimizer::Z3QuerySignatureContext(std::make_shared<z3::context>());
  // Define Sources
  auto sourceDescriptor1 = LogicalSourceDescriptor::create("Car");
