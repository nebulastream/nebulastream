...
public:
  ...
  static void SetUpTestCase() {
    Logger::setupLogging("GlobalExecutionPlanTest.log",
...
/**
 * @brief This test is for validating different behaviour for an empty global
 * execution plan
 */
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * single execution node with one plan
 */
TEST_F(GlobalExecutionPlanTest,
       testGlobalExecutionPlanWithSingleExecutionNodeWithOnePlan) {
  ...
  topology->registerWorker(topologyNodeId, "localhost", 3200, 3300, 10,
                           properties, 0, 0);

  // create execution node

  NES_DEBUG("GlobalQueryPlanTest: Adding a query plan without to the global "
            "query plan");
  auto printSinkDescriptor = PrintSinkDescriptor::create();
  auto subQuery = Query::from("car");
  auto query =
      Query::from("truck").unionWith(subQuery).sink(printSinkDescriptor);
  auto plan = query.getQueryPlan();
  SharedQueryId sharedQueryId = PlanIdGenerator::getNextSharedQueryId();
  DecomposedQueryPlanId decomposedQueryPlanId =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan =
      DecomposedQueryPlan::create(decomposedQueryPlanId, sharedQueryId,
                                  topologyNodeId, plan->getRootOperators());
  decomposedQueryPlan->setState(QueryState::MARKED_FOR_DEPLOYMENT);

  auto topologyNode = topology->lockTopologyNode(topologyNodeId);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan);
  ...
  std::string expectedPlan =
      "ExecutionNode(id:" + topologyNodeId.toString() +
      ")\n"
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * single execution node with two plan
 */
TEST_F(GlobalExecutionPlanTest,
       testGlobalExecutionPlanWithSingleExecutionNodeWithTwoPlan) {
  ...
  SharedQueryId sharedQueryId = PlanIdGenerator::getNextSharedQueryId();
  DecomposedQueryPlanId decomposedQueryPlanId1 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan1 =
      DecomposedQueryPlan::create(decomposedQueryPlanId1, sharedQueryId,
                                  topologyNodeId, plan1->getRootOperators());
  decomposedQueryPlan1->setState(QueryState::MARKED_FOR_DEPLOYMENT);

  NES_DEBUG(
      "GlobalQueryPlanTest: Adding another query plan to the execution node");
  ...
  DecomposedQueryPlanId decomposedQueryPlanId2 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan2 =
      DecomposedQueryPlan::create(decomposedQueryPlanId2, sharedQueryId,
                                  topologyNodeId, plan2->getRootOperators());
  decomposedQueryPlan2->setState(QueryState::MARKED_FOR_DEPLOYMENT);

  // create execution node
  auto topologyNode = topology->lockTopologyNode(topologyNodeId);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan1);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan2);
  ...
  std::string expectedPlan =
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId1.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId2.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * single execution node with two plan for different shared queries
 */
TEST_F(
    GlobalExecutionPlanTest,
    testGlobalExecutionPlanWithSingleExecutionNodeWithTwoPlanForDifferentqueries) {
  ...
  DecomposedQueryPlanId decomposedQueryPlanId1 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan1 =
      DecomposedQueryPlan::create(decomposedQueryPlanId1, sharedQueryId1,
                                  topologyNodeId, plan1->getRootOperators());
  decomposedQueryPlan1->setState(QueryState::MARKED_FOR_DEPLOYMENT);
  ...
  DecomposedQueryPlanId decomposedQueryPlanId2 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan2 =
      DecomposedQueryPlan::create(decomposedQueryPlanId2, sharedQueryId2,
                                  topologyNodeId, plan2->getRootOperators());
  decomposedQueryPlan2->setState(QueryState::MARKED_FOR_DEPLOYMENT);
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * single execution node with 4 plan
 */
TEST_F(GlobalExecutionPlanTest,
       testGlobalExecutionPlanWithSingleExecutionNodeWithFourPlan) {
  ...
  SharedQueryId sharedQueryId1 = PlanIdGenerator::getNextSharedQueryId();
  DecomposedQueryPlanId decomposedQueryPlanId11 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan11 =
      DecomposedQueryPlan::create(decomposedQueryPlanId11, sharedQueryId1,
                                  topologyNodeId, plan11->getRootOperators());
  ...
  DecomposedQueryPlanId decomposedQueryPlanId12 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan12 =
      DecomposedQueryPlan::create(decomposedQueryPlanId12, sharedQueryId1,
                                  topologyNodeId, plan12->getRootOperators());
  ...
  SharedQueryId sharedQueryId2 = PlanIdGenerator::getNextSharedQueryId();
  DecomposedQueryPlanId decomposedQueryPlanId21 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan21 =
      DecomposedQueryPlan::create(decomposedQueryPlanId21, sharedQueryId2,
                                  topologyNodeId, plan21->getRootOperators());
  ...
  DecomposedQueryPlanId decomposedQueryPlanId22 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan22 =
      DecomposedQueryPlan::create(decomposedQueryPlanId22, sharedQueryId2,
                                  topologyNodeId, plan22->getRootOperators());
  decomposedQueryPlan22->setState(QueryState::MARKED_FOR_DEPLOYMENT);

  // create execution node
  auto topologyNode = topology->lockTopologyNode(topologyNodeId);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan11);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan12);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan21);
  globalExecutionPlan->addDecomposedQueryPlan(topologyNode,
                                              decomposedQueryPlan22);
  const std::string &actualPlan = globalExecutionPlan->getAsString();
  ...
  std::string expectedPlan =
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId1.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId11.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId1.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId12.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId2.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId21.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
      ...
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId2.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId22.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  " +
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * two execution nodes with one plan each
 */
TEST_F(GlobalExecutionPlanTest,
       testGlobalExecutionPlanWithTwoExecutionNodesEachWithOnePlan) {
  ...
  topology->registerWorker(node1Id, "localhost", 3200, 3300, 10, properties, 0,
                           0);
  // create execution node
  auto node2Id = WorkerId(2);
  topology->registerWorker(node2Id, "localhost", 3200, 3300, 10, properties, 0,
                           0);
  ...
  auto decomposedQueryPlan1 =
      DecomposedQueryPlan::create(decomposedQueryPlanId1, sharedQueryId1,
                                  node1Id, plan1->getRootOperators());
  decomposedQueryPlan1->setState(QueryState::MARKED_FOR_DEPLOYMENT);
  ...
  auto decomposedQueryPlan2 =
      DecomposedQueryPlan::create(decomposedQueryPlanId2, sharedQueryId2,
                                  node2Id, plan2->getRootOperators());
  decomposedQueryPlan2->setState(QueryState::MARKED_FOR_DEPLOYMENT);
  ...
  std::string expectedPlan =
      "ExecutionNode(id:" + node1Id.toString() +
      ")\n"
      "| QuerySubPlan(SharedQueryId:" +
      sharedQueryId1.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId1.toString() +
...
/**
 * @brief This test is for validating behaviour for a global execution plan with
 * nested execution node with one plan for different
 * queryIdAndCatalogEntryMapping
 */
TEST_F(GlobalExecutionPlanTest,
       testGlobalExecutionPlanWithTwoExecutionNodesEachWithOnePlanToString) {
  ...
  topology->registerWorker(node3Id, "localhost", 3200, 3300, 10, properties, 0,
                           0);
  auto node4Id = WorkerId(4);
  topology->registerWorker(node4Id, "localhost", 3200, 3300, 10, properties, 0,
                           0);
  ...
  DecomposedQueryPlanId decomposedQueryPlanId3 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan3 =
      DecomposedQueryPlan::create(decomposedQueryPlanId3, sharedQueryId3,
                                  node3Id, plan3->getRootOperators());
  decomposedQueryPlan3->setState(QueryState::MARKED_FOR_DEPLOYMENT);

  // create execution node 4
  // Add sub plan
  NES_DEBUG(
      "GlobalQueryPlanTest: Adding a query plan to the global query plan");
  ...
  DecomposedQueryPlanId decomposedQueryPlanId4 =
      PlanIdGenerator::getNextDecomposedQueryPlanId();
  auto decomposedQueryPlan4 =
      DecomposedQueryPlan::create(decomposedQueryPlanId4, sharedQueryId4,
                                  node4Id, plan4->getRootOperators());
  ...
  std::string expectedPlan =
      ...
      ")\n"
      "|  |  | QuerySubPlan(SharedQueryId:" +
      sharedQueryId3.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId3.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  |  |  " +
      ...
      ")\n"
      "|  |  |  | QuerySubPlan(SharedQueryId:" +
      sharedQueryId4.toString() +
      ", DecomposedQueryPlanId:" + decomposedQueryPlanId4.toString() +
      ", queryState:" +
      std::string(magic_enum::enum_name(QueryState::MARKED_FOR_DEPLOYMENT)) +
      ")\n"
      "|  |  |  |  " +
