...
class GlobalExecutionPlan {
 public:
   ...
   */
  DecomposedQueryPlanPtr getCopyOfDecomposedQueryPlan(
      WorkerId WorkerId, SharedQueryId sharedQueryId,
      DecomposedQueryPlanId decomposedQueryPlanId);
   ...
   */
  std::vector<DecomposedQueryPlanPtr> getCopyOfAllDecomposedQueryPlans(
      WorkerId WorkerId, SharedQueryId sharedQueryId);
   ...
   */
  std::vector<ExecutionNodeWLock> getLockedExecutionNodesHostingSharedQueryId(
