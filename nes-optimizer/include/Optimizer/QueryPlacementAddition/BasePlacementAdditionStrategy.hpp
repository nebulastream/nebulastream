...
protected:
  ...
  getTopologyNodesForChildrenOperators(const LogicalOperatorPtr &operatorNode);
...
private:
  ...
  createNetworkSinkOperator(SharedQueryId sharedQueryId,
   ...
   */
  static LogicalOperatorPtr
  createNetworkSourceOperator(SharedQueryId sharedQueryId,
                              SchemaPtr inputSchema, OperatorId operatorId,
...
private:
   ...
   */
  bool
  tryMergingNetworkSink(DecomposedQueryPlanVersion querySubPlanVersion,
