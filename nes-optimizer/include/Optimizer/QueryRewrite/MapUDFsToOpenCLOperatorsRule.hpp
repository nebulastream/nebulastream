...
/**
 * @brief: This rule converts a Map Java UDF into OpenCL operator such that it
 * can be accelerated over CPU or GPU. This rule is activated using elegant
 * configuration elegant.accelerateJavaUDFs = true.
 */
