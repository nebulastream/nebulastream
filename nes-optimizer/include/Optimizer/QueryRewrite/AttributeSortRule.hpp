...
private:
   ...
   */
  ExpressionNodePtr
  sortAttributesInArithmeticalExpressions(ExpressionNodePtr expression);
   ...
   */
  ExpressionNodePtr
  sortAttributesInLogicalExpressions(const ExpressionNodePtr &expression);
  ...
  fetchCommutativeFields(const ExpressionNodePtr &expression) {
   ...
   */
  bool
  replaceCommutativeExpressions(const ExpressionNodePtr &parentExpression,
   ...
   */
  static std::string
  fetchLeftMostConstantValueOrFieldName(ExpressionNodePtr expression);
};
} // namespace NES::Optimizer
