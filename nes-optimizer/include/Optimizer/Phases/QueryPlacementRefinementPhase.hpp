...
using QueryPlacementRefinementPhasePtr =
    std::shared_ptr<QueryPlacementRefinementPhase>;
...
class QueryPlacementRefinementPhase {
public:
  static QueryPlacementRefinementPhasePtr
  create(GlobalExecutionPlanPtr globalPlan);
