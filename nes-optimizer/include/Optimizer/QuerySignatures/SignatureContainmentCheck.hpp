...
public:
   ...
   */
  static SignatureContainmentCheckPtr
  create(const z3::ContextPtr &context, bool allowExhaustiveContainmentCheck);
  ...
  checkContainmentForBottomUpMerging(const LogicalOperatorPtr &leftSignature,
...
private:
  ...
  checkProjectionContainment(const QuerySignaturePtr &leftSignature,
   ...
   */
  ContainmentRelationship
  checkFilterContainment(const QuerySignaturePtr &leftSignature,
                         const QuerySignaturePtr &rightSignature);
   ...
   */
  ContainmentRelationship
  checkWindowContainment(const QuerySignaturePtr &leftSignature,
                         const QuerySignaturePtr &rightSignature);
