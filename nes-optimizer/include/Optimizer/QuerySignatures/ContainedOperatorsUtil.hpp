...
public:
    ...
    createContainedWindowOperator(const LogicalOperatorPtr& containedOperator, const LogicalOperatorPtr& containerOperator);
    /**
     ...
     */
    static LogicalOperatorPtr createContainedFilterOperators(const LogicalOperatorPtr& container, const LogicalOperatorPtr& containee);
    /**
