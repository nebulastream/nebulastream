...
public:
     ...
     */
    std::map<DecomposedQueryPlanId, DeploymentContextPtr> updateGlobalExecutionPlan(
...
private:
    ...
    updateExecutionNodes(SharedQueryId sharedQueryId, DecomposedQueryPlanVersion querySubPlanVersion);
