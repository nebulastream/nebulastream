...
public:
  ...
  createQuerySignatureForOperator(const z3::ContextPtr &context,
...
private:
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForSource(const z3::ContextPtr &context,
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForMap(const z3::ContextPtr &context,
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForFilter(const z3::ContextPtr &context,
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForWindow(const z3::ContextPtr &context,
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForJoin(const z3::ContextPtr &context,
   ...
   */
  static QuerySignaturePtr
  createQuerySignatureForUnion(const z3::ContextPtr &context,
