...
/**
 * @brief This class is responsible for creating the Query Plan Signature for
 * the input operator. The query plan is composed of the input operator and all
 * its upstream child operators.
 */
class QuerySignatureUtil {
 public:
   ...
   * @return the object representing signature created by the operator and its
   * children
   */
  static QuerySignaturePtr createQuerySignatureForOperator(
      const z3::ContextPtr& context, const OperatorPtr& operatorNode);
 ...
 private:
   ...
   */
  static QuerySignaturePtr createQuerySignatureForSource(
   ...
   */
  static QuerySignaturePtr createQuerySignatureForProject(
      const LogicalProjectionOperatorPtr& projectOperator);
   ...
   */
  static QuerySignaturePtr createQuerySignatureForMap(
      const z3::ContextPtr& context, const LogicalMapOperatorPtr& mapOperator);
   ...
   */
  static QuerySignaturePtr createQuerySignatureForFilter(
      const z3::ContextPtr& context,
   ...
   * @return Signature based on window operator and its children signatures
   */
  static QuerySignaturePtr createQuerySignatureForWindow(
      const z3::ContextPtr& context,
   ...
   */
  static QuerySignaturePtr createQuerySignatureForJoin(
      const z3::ContextPtr& context,
   ...
   */
  static QuerySignaturePtr createQuerySignatureForWatermark(
      const z3::ContextPtr& context,
   ...
   */
  static QuerySignaturePtr createQuerySignatureForUnion(
      const z3::ContextPtr& context,
      const LogicalUnionOperatorPtr& unionOperator);
  static QuerySignaturePtr createQuerySignatureForInferModel(
      const z3::ContextPtr& context,
