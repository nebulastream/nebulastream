...
DeploymentContext::create(const std::string &ipAddress, uint32_t grpcPort,
...
DeploymentContext::DeploymentContext(
    ...
    const DecomposedQueryPlanPtr &decomposedQueryPlan)
    : ipAddress(ipAddress), grpcPort(grpcPort), sharedQueryId(sharedQueryId),
      decomposedQueryPlanId(decomposedQueryPlanId),
      decomposedQueryPlanVersion(decomposedQueryPlanVersion),
      workerId(workerId), decomposedQueryState(decomposedQueryState),
...
DeploymentContext::getDecomposedQueryPlanVersion() const {
