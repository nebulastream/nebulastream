...
DataTypeToZ3ExprUtil::createForField(const std::string &fieldName,
...
Z3ExprAndFieldMapPtr
DataTypeToZ3ExprUtil::createForDataValue(const ValueTypePtr &valueType,
                                         const z3::ContextPtr &context) {
  ...
  if (valueTypeType->isUndefined()) {
    NES_THROW_RUNTIME_ERROR("Can't support creating Z3 expression for data "
                            "value of undefined type.");
