...
z3::ExprPtr QuerySignature::getConditions()
{
    return conditions;
}

const std::vector<std::string>& QuerySignature::getColumns()
{
    return columns;
}

const std::vector<std::map<std::string, z3::ExprPtr>>& QuerySignature::getWindowsExpressions()
{
