...
HashSignatureBasedPartialQueryMergerRule::areQueryPlansEqual(const QueryPlanPtr & targetQueryPlan, const QueryPlanPtr & hostQueryPlan)
{
    std::map<LogicalOperatorPtr, LogicalOperatorPtr> targetHostOperatorMap;
    NES_DEBUG("HashSignatureBasedPartialQueryMergerRule: check if the target and address query plans are syntactically equal or not");
...
std::map<LogicalOperatorPtr, LogicalOperatorPtr> HashSignatureBasedPartialQueryMergerRule::areOperatorEqual(
