...
bool Z3SignatureBasedPartialQueryMergerBottomUpRule::apply(GlobalQueryPlanPtr globalQueryPlan)
{
    ...
    NES_DEBUG("Z3SignatureBasedPartialQueryMergerBottomUpRule: Iterating over all Shared Query MetaData in the Global Query Plan");
...
Z3SignatureBasedPartialQueryMergerBottomUpRule::areQueryPlansEqual(const QueryPlanPtr& targetQueryPlan, const QueryPlanPtr& hostQueryPlan)
{
    ...
    {
        NES_WARNING("Z3SignatureBasedPartialQueryMergerBottomUpRule: Not matched as number of Sources in target and host query plans are "
                    "different.");
        return {};
    }
...
std::map<LogicalOperatorPtr, LogicalOperatorPtr> Z3SignatureBasedPartialQueryMergerBottomUpRule::areOperatorEqual(
    const LogicalOperatorPtr& targetOperator, const LogicalOperatorPtr& hostOperator)
{
    std::map<LogicalOperatorPtr, LogicalOperatorPtr> targetHostOperatorMap;
