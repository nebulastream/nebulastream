...
{
    NES_DEBUG(
        "Adding decomposed query plan {}-{} to the execution node with id  {}",
...
bool GlobalExecutionPlan::updateDecomposedQueryPlans(const WorkerId& workerId, std::vector<DecomposedQueryPlanPtr> decomposedQueryPlans)
{
