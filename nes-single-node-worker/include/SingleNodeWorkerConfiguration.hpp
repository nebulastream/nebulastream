...
{
public:
    ScalarOption<std::string> data = {"data", "Data-plane address. This is the {Hostname}:{PORT}"};
...
protected:
    std::vector<BaseOption*> getOptions() override { return {&workerConfiguration, &grpcAddressUri, &data, &enableGoogleEventTrace}; }
