...
TEST_F(SingleNodeIntegrationTest, DISABLED_TestQueryStatus)
{
    ...
    const std::vector expected = {Registered, Running, Stopped, Running, Stopped};
...
TEST_F(SingleNodeIntegrationTest, TestQueryStatusSimple)
{
    ...
    Configuration::SingleNodeWorkerConfiguration configuration{};
    configuration.workerConfiguration.queryOptimizer.nautilusBackend = Nautilus::Configurations::NautilusBackend::INTERPRETER;
