...
{
    const std::string statementString = "CREATE WORKER 'localhost:8080' AT 'localhost:9090' SET (32 AS `CAPACITY`, 'localhost2:9090' AS `DOWNSTREAM`, 'localhost1:9090' AS `DOWNSTREAM`)";
