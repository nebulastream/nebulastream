...
TEST_F(StatementBinderTest, InlineSinkQuery)
{
    ...
    const std::unordered_map<Identifier, std::string> expectedSinkConfig
        = {{Identifier::parse("file_path"), "out.csv"}, {Identifier::parse("input_format"), "CSV"}};
    ...
    const Schema<UnqualifiedUnboundField, Ordered> schema{
        ...
        UnqualifiedUnboundField{Identifier::parse("TEXT"), DataTypeProvider::provideDataType(DataType::Type::VARSIZED)}};
...
TEST_F(StatementBinderTest, BindQuotedIdentifiers)
{
    ...
    auto expectedSchema = Schema<QualifiedUnboundField, Ordered>{
        QualifiedUnboundField{Identifier::parse("testSource$attribute1"), DataType::Type::UINT32},
        QualifiedUnboundField{Identifier::parse("testSource$attribute2"), DataType::Type::VARSIZED}};
...
TEST_F(StatementBinderTest, BindCreateBindSource)
{
    ...
    ASSERT_EQ(sourceName.getRawValue(), Identifier::parse("TESTSOURCE"));
...
TEST_F(StatementBinderTest, ShowPhysicalSources)
{
    ...
    ASSERT_EQ(logicalSource3->getRawValue(), Identifier::parse("TESTSOURCE1"));
    ...
    ASSERT_EQ(logicalSource4->getRawValue(), Identifier::parse("TESTSOURCE2"));
