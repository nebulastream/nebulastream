 ...
 *
 *	pgquery::T_PGList: lists of pointers
 *		(in practice usually pointers to Nodes, but not always;
 *		declared as "void *" to minimize casting annoyances)
 *	pgquery::T_PGIntList: lists of integers
 *	pgquery::T_PGOidList: lists of Oids
 *
...
typedef struct PGList {
	PGNodeTag		type;			/* pgquery::T_PGList, pgquery::T_PGIntList, or pgquery::T_PGOidList */
	int			length;
	PGListCell   *head;
	PGListCell   *tail;
} PGList;
