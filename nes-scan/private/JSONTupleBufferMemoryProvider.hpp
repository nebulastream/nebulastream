...
class JSONTupleBufferMemoryProvider final : public TupleBufferMemoryProvider
{
    ...
    std::unique_ptr<JSONMetaData> metadata;
...
public:
    ...
    JSONTupleBufferMemoryProvider(ParserConfig config, std::shared_ptr<MemoryLayout> layout);
    ~JSONTupleBufferMemoryProvider() override = default;
