...
public:
    ...
    public:
            ...
            Arena& arenaRef)
        {
            ...
            if (spanningTuplePOD.leadingSpanningTupleSizeInBytes > 0)
            {
                ...
                processSpanningTuple<typename FormatterType::IndexerMetaData>(
                    leadingSpanningTupleBuffers, spanningTuplePOD.leadingSpanningTuplePtr, RawInputFormatScan.indexerMetaData);
                RawInputFormatScan.inputFormatIndexer.indexRawBuffer(
            ...
            if (spanningTuplePOD.trailingSpanningTupleSizeInBytes > 0)
            {
                ...
                processSpanningTuple<typename FormatterType::IndexerMetaData>(
                    trailingSpanningTupleBuffers, spanningTuplePOD.trailingSpanningTuplePtr, RawInputFormatScan.indexerMetaData);
                RawInputFormatScan.inputFormatIndexer.indexRawBuffer(
            ...
            const std::vector<StagedBuffer>& spanningTupleBuffers, RawInputFormatScan& RawInputFormatScan, Arena& arenaRef)
        {
            ...
            processSpanningTuple<typename FormatterType::IndexerMetaData>(
                spanningTupleBuffers, spanningTuplePOD.leadingSpanningTuplePtr, RawInputFormatScan.indexerMetaData);
            RawInputFormatScan.inputFormatIndexer.indexRawBuffer(
                spanningTuplePOD.leadingSpanningTupleFIF,
                RawTupleBuffer{
    ...
    void scanTask(ExecutionContext& executionCtx, Nautilus::RecordBuffer& recordBuffer, const PhysicalOperator& child)
    {
