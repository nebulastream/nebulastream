...
files = [
    "changingBufferSizeReadModifyWrite",
    "changingGlobalBufferCntReadModifyWrite",
    "changingLocalBufferSizeReadModifyWrite",
    "changingSourceCntReadModifyWrite",
    "changingWorkerCntReadModifyWrite",
    "changingThreadsAndSource_ReadModifyWrite",
    "scalingLargeReadModifyWrite"
]
...
df_changingBufferSize_pivot = pd.pivot_table(df["changingBufferSizeReadModifyWrite"], values='ThroughputInTupsPerSec',
...
df_changingBufferSize_pivot = pd.pivot_table(df["changingBufferSizeReadModifyWrite"], values='ThroughputInTasksPerSec',
                                             index=['BufferSizeInBytes'], columns='WorkerThreads',
                                             aggfunc=np.sum)
...
df_changingBufferSize_pivot = pd.pivot_table(df["changingBufferSizeReadModifyWrite"], values='AvgTaskProcessingTime',
                                             index=['BufferSizeInBytes'], columns='WorkerThreads',
                                             aggfunc=np.sum)
for i in range(len(df_changingBufferSize_pivot.columns)):
    col = df_changingBufferSize_pivot.columns[i]
...
df_changingBufferSize_pivot = pd.pivot_table(df["changingBufferSizeReadModifyWrite"], values='AvgQueueSize',
                                             index=['BufferSizeInBytes'], columns='WorkerThreads',
                                             aggfunc=np.sum)
for i in range(len(df_changingBufferSize_pivot.columns)):
    col = df_changingBufferSize_pivot.columns[i]
...
df_changingGlobalBufferCnt_pivot = pd.pivot_table(df["changingGlobalBufferCntReadModifyWrite"], values='ThroughputInTupsPerSec',
...
df_changingGlobalBufferCnt_pivot = pd.pivot_table(df["changingGlobalBufferCntReadModifyWrite"], values='ThroughputInTasksPerSec',
                                                  index=['NumberOfBuffersInGlobalBufferManager'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
for i in range(len(df_changingGlobalBufferCnt_pivot.columns)):
...
df_changingGlobalBufferCnt_pivot = pd.pivot_table(df["changingGlobalBufferCntReadModifyWrite"], values='ThroughputInMBPerSec',
                                                  index=['NumberOfBuffersInGlobalBufferManager'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
...
df_changingGlobalBufferCnt_pivot = pd.pivot_table(df["changingGlobalBufferCntReadModifyWrite"], values='AvgTaskProcessingTime',
                                                  index=['NumberOfBuffersInGlobalBufferManager'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
for i in range(len(df_changingGlobalBufferCnt_pivot.columns)):
...
df_changingGlobalBufferCnt_pivot = pd.pivot_table(df["changingGlobalBufferCntReadModifyWrite"], values='AvgQueueSize',
                                                  index=['NumberOfBuffersInGlobalBufferManager'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
for i in range(len(df_changingGlobalBufferCnt_pivot.columns)):
...
df_changingLocalBufferSize_pivot = pd.pivot_table(df["changingLocalBufferSizeReadModifyWrite"], values='ThroughputInTupsPerSec',
...
df_changingLocalBufferSize_pivot = pd.pivot_table(df["changingLocalBufferSizeReadModifyWrite"], values='ThroughputInTasksPerSec',
                                                  index=['NumberOfBuffersInSourceLocalBufferPool'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
for i in range(len(df_changingLocalBufferSize_pivot.columns)):
...
df_changingLocalBufferSize_pivot = pd.pivot_table(df["changingLocalBufferSizeReadModifyWrite"], values='ThroughputInMBPerSec',
                                                  index=['NumberOfBuffersInSourceLocalBufferPool'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
for i in range(len(df_changingLocalBufferSize_pivot.columns)):
...
df_changingLocalBufferSize_pivot = pd.pivot_table(df["changingLocalBufferSizeReadModifyWrite"], values='AvgTaskProcessingTime',
                                                  index=['NumberOfBuffersInSourceLocalBufferPool'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
...
df_changingLocalBufferSize_pivot = pd.pivot_table(df["changingLocalBufferSizeReadModifyWrite"], values='AvgQueueSize',
                                                  index=['NumberOfBuffersInSourceLocalBufferPool'],
                                                  columns='WorkerThreads',
                                                  aggfunc=np.sum)
...
df_changingSourceCnt_pivot = pd.pivot_table(df["changingSourceCntReadModifyWrite"], values='ThroughputInTupsPerSec',
                                            index=['SourceCnt'],
                                            columns='WorkerThreads',
                                            aggfunc=np.sum)
...
df_changingSourceCnt_pivot = pd.pivot_table(df["changingSourceCntReadModifyWrite"], values='ThroughputInTasksPerSec',
                                            index=['SourceCnt'],
                                            columns='WorkerThreads',
                                            aggfunc=np.sum)
...
df_changingSourceCnt_pivot = pd.pivot_table(df["changingSourceCntReadModifyWrite"], values='ThroughputInMBPerSec',
                                            index=['SourceCnt'],
                                            columns='WorkerThreads',
                                            aggfunc=np.sum)
for i in range(len(df_changingSourceCnt_pivot.columns)):
...
df_changingSourceCnt_pivot = pd.pivot_table(df["changingSourceCntReadModifyWrite"], values='AvgTaskProcessingTime',
                                            index=['SourceCnt'],
                                            columns='WorkerThreads',
                                            aggfunc=np.sum)
for i in range(len(df_changingSourceCnt_pivot.columns)):
...
df_changingSourceCnt_pivot = pd.pivot_table(df["changingSourceCntReadModifyWrite"], values='AvgQueueSize',
                                            index=['SourceCnt'],
                                            columns='WorkerThreads',
                                            aggfunc=np.sum)
for i in range(len(df_changingSourceCnt_pivot.columns)):
...
# ########################################## df_chaningWorkerCnt ##########################################################
df_chaningWorkerCnt_pivot = pd.pivot_table(df["changingWorkerCntReadModifyWrite"], values='ThroughputInTupsPerSec',
                                           index=['WorkerThreads'],
                                           columns='SourceCnt',
                                           aggfunc=np.sum)
...
df_chaningWorkerCnt_pivot = pd.pivot_table(df["changingWorkerCntReadModifyWrite"], values='ThroughputInTasksPerSec',
                                           index=['WorkerThreads'],
                                           columns='SourceCnt',
                                           aggfunc=np.sum)
...
df_chaningWorkerCnt_pivot = pd.pivot_table(df["changingWorkerCntReadModifyWrite"], values='ThroughputInMBPerSec',
                                           index=['WorkerThreads'],
                                           columns='SourceCnt',
                                           aggfunc=np.sum)
for i in range(len(df_chaningWorkerCnt_pivot.columns)):
...
df_chaningWorkerCnt_pivot = pd.pivot_table(df["changingWorkerCntReadModifyWrite"], values='AvgTaskProcessingTime',
                                           index=['WorkerThreads'],
                                           columns='SourceCnt',
                                           aggfunc=np.sum)
for i in range(len(df_chaningWorkerCnt_pivot.columns)):
...
df_chaningWorkerCnt_pivot = pd.pivot_table(df["changingWorkerCntReadModifyWrite"], values='AvgQueueSize',
                                           index=['WorkerThreads'],
                                           columns='SourceCnt',
                                           aggfunc=np.sum)
for i in range(len(df_chaningWorkerCnt_pivot.columns)):
...
############################################# df["changingThreadsAndSource_ReadModifyWrite"] #######################################################
df["changingThreadsAndSource_ReadModifyWrite"]["src"] = "W" + df["changingThreadsAndSource_ReadModifyWrite"]["WorkerThreads"].astype(str) + '/S' + \
                                           df["changingThreadsAndSource_ReadModifyWrite"]["SourceCnt"].astype(str)
fig.add_trace(
    go.Scatter(x=df["changingThreadsAndSource_ReadModifyWrite"]['src'],
               y=df["changingThreadsAndSource_ReadModifyWrite"]['ThroughputInTupsPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='red',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df["changingThreadsAndSource_ReadModifyWrite"]['src'],
               y=df["changingThreadsAndSource_ReadModifyWrite"]['ThroughputInTasksPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='red',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df["changingThreadsAndSource_ReadModifyWrite"]['src'], y=df["changingThreadsAndSource_ReadModifyWrite"]['ThroughputInMBPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
...
df["changingThreadsAndSource_ReadModifyWrite"]["src"] = "W" + df["changingThreadsAndSource_ReadModifyWrite"]["WorkerThreads"].astype(str) + '/S' + \
                                           df["changingThreadsAndSource_ReadModifyWrite"]["SourceCnt"].astype(str)
fig.add_trace(
    go.Scatter(x=df["changingThreadsAndSource_ReadModifyWrite"]['src'], y=df["changingThreadsAndSource_ReadModifyWrite"]['AvgTaskProcessingTime'],
               hoverinfo='x+y',
               mode='markers+lines',
...
df["changingThreadsAndSource_ReadModifyWrite"]["src"] = "W" + df["changingThreadsAndSource_ReadModifyWrite"]["WorkerThreads"].astype(str) + '/S' + \
                                           df["changingThreadsAndSource_ReadModifyWrite"]["SourceCnt"].astype(str)
fig.add_trace(
    go.Scatter(x=df["changingThreadsAndSource_ReadModifyWrite"]['src'], y=df["changingThreadsAndSource_ReadModifyWrite"]['AvgQueueSize'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
############################################# df["scalingLargeReadModifyWrite"] #######################################################
df["scalingLargeReadModifyWrite"]["src"] = "W" + df["scalingLargeReadModifyWrite"]["WorkerThreads"].astype(str) + '/S' + df["scalingLargeReadModifyWrite"]["SourceCnt"].astype(str)
fig.add_trace(
    go.Scatter(x=df["scalingLargeReadModifyWrite"]['src'],
               y=df["scalingLargeReadModifyWrite"]['ThroughputInTupsPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='red',
                         width=2),
...
df["scalingLargeReadModifyWrite"]["src"] = "W" + df["scalingLargeReadModifyWrite"][
    "WorkerThreads"].astype(str) + '/S' + df["scalingLargeReadModifyWrite"]["SourceCnt"].astype(str)
fig.add_trace(
    go.Scatter(x=df["scalingLargeReadModifyWrite"]['src'],
               y=df["scalingLargeReadModifyWrite"]['ThroughputInTasksPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='red',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df["scalingLargeReadModifyWrite"]['src'],
               y=df["scalingLargeReadModifyWrite"]['ThroughputInMBPerSec'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='blue',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df["scalingLargeReadModifyWrite"]['src'],
               y=df["scalingLargeReadModifyWrite"]['AvgTaskProcessingTime'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df["scalingLargeReadModifyWrite"]['src'],
               y=df["scalingLargeReadModifyWrite"]['AvgQueueSize'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
fig.update_layout(
    title={
        'text': "<b>NebulaStream Performance Numbers -- MemoryMode -- ReadModifyWriteWorkload </b><br>"
                "<span style=\"font-size:0.6em\" line-height=1em;margin=-4px>Default Config(GlobalBufferPool=16K, "
                "LocalBufferPool=1024, BufferSize=1MB, Threads=1, Source=1, TupleSize=24Byte, Query::from(input).map(Attribute(value) = Attribute(value) + 1).sink(NullOutputSinkDescriptor::create());"
                "<br>",
        'y': 0.98,
        'x': 0.5,
        'xanchor': 'center',
...
###############################################################
plotly.offline.plot(fig, filename='ReadModifyWriteWorkload.html')
