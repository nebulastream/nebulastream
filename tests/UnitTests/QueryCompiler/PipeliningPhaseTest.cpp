...
TEST_F(PipeliningPhaseTest, pipelineFilterQuery) {
    ...
    auto source =
        PhysicalSourceOperator::create(UtilityFunctions::getNextOperatorId(), SchemaPtr(), SchemaPtr(), SourceDescriptorPtr());
    auto filter = PhysicalFilterOperator::create(SchemaPtr(), SchemaPtr(), ExpressionNodePtr());
    auto sink =
        PhysicalSinkOperator::create(UtilityFunctions::getNextOperatorId(), SchemaPtr(), SchemaPtr(), SinkDescriptorPtr());
...
TEST_F(PipeliningPhaseTest, pipelineMultiplexQuery) {
    ...
    auto sink = PhysicalSinkOperator::create(UtilityFunctions::getNextOperatorId(), SchemaPtr(), SchemaPtr(), SinkDescriptorPtr());
...
TEST_F(PipeliningPhaseTest, pipelineDemultiplex) {
    ...
    auto sink1 = PhysicalSinkOperator::create(UtilityFunctions::getNextOperatorId(), SchemaPtr(), SchemaPtr(), SinkDescriptorPtr());
    auto sink2 = PhysicalSinkOperator::create(UtilityFunctions::getNextOperatorId(), SchemaPtr(), SchemaPtr(), SinkDescriptorPtr());
