...
TEST_F(OperatorCodeGenerationTest, codeGenerationCompleteWindowIngestionTime) {
    ...
    auto nextPipeline =
        NodeEngine::Execution::ExecutablePipeline::create(1, 0, stage2, executionContext, nullptr, input_schema, windowOutputSchema);
...
TEST_F(OperatorCodeGenerationTest, codeGenerationDistributedCombiner) {
    ...
    auto nextPipeline =
        NodeEngine::Execution::ExecutablePipeline::create(1, 0, stage2, executionContext, nullptr, schema, windowOutputSchema); //is here schema = input_schema?
    windowHandler->setup(executionContext);
