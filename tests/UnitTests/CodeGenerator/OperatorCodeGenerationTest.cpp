...
TEST_F(OperatorCodeGenerationTest, codeGenerationFilterPredicate) {
    ...
    /* generate code for writing result tuples to output buffer */
    codeGenerator->generateCodeForEmit(source->getSchema(), QueryCompilation::NO_OPTIMIZATION, true, context);
...
TEST_F(OperatorCodeGenerationTest, codeGenerationStringComparePredicateTest) {
    ...
    /* generate code for writing result tuples to output buffer */
    codeGenerator->generateCodeForEmit(inputSchema, QueryCompilation::NO_OPTIMIZATION, true, context);
...
TEST_F(OperatorCodeGenerationTest, codeGenerationMapPredicateTest) {
    ...
    /* generate code for writing result tuples to output buffer */
    codeGenerator->generateCodeForEmit(outputSchema, QueryCompilation::NO_OPTIMIZATION, true, context);
