 ...
 */
TEST_F(QueryMigrationPhaseTest, DISABLED_testFindNetworkSinks) {
...
TEST_F(QueryMigrationPhaseTest, DISABLED_testFindNetworkSinksSeveralQueryPlans) {
//    TopologyPtr topology = Topology::create();
//
//    TopologyNodePtr rootNode = TopologyNode::create(1, "localhost", 123, 124, 4);
//    topology->setAsRoot(rootNode);
...
TEST_F(QueryMigrationPhaseTest, DISABLED_testFindParentAndChildExecutionNodes) {
