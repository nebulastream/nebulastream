 ...
 */
TEST_F(MultipleWindowsTest, testWindowThreeLevel) {
    ...
    NES_DEBUG("MultipleWindowsTest: Start worker 2");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 2 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 3");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 3 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 4");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 4 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 5");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 5 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 6");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 6 started successfully");

    /**
     * Sensors
     */
    NES_DEBUG("MultipleWindowsTest: Start worker 7");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 7 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 8");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 8 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 9");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 9 started successfully");

    NES_DEBUG("MultipleWindowsTest: Start worker 10");
    ...
    NES_DEBUG("MultipleWindowsTest: Worker 10 started successfully");
