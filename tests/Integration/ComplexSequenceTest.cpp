...
TEST_F(ComplexSequenceTest, SN_MW_MJ) {
    ...
    std::string queryWithJoinOperator =
        R"(Query::from("window1")
            .joinWith(Query::from("window2"), Attribute("id1"), Attribute("id2"), TumblingWindow::of(EventTime(Attribute("timestamp")), Milliseconds(2000)))
            .joinWith(Query::from("window3"), Attribute("id1"), Attribute("id3"), TumblingWindow::of(EventTime(Attribute("timestamp")), Milliseconds(2000)))
            .windowByKey(Attribute("window1window2window3$key"), TumblingWindow::of(EventTime(Attribute("window1window2window3$start")), Seconds(1)), Sum(Attribute("window1window2$key")))
        )";
    TestHarness testHarness = TestHarness(queryWithJoinOperator, restPort, rpcPort);
...
//    testHarness.addMemorySource("window1", window1Schema, "window1", testHarness.getWorkerId(0));
//    testHarness.addMemorySource("window2", window2Schema, "window2", testHarness.getWorkerId(1));
//    testHarness.addMemorySource("window3", window3Schema, "window3", testHarness.getWorkerId(1));
//
...
//    testHarness.pushElement<Window2>({33, 3100}, 3);
//
//    testHarness.pushElement<Window3>({4, 1013}, 4);
//    testHarness.pushElement<Window3>({12, 1010}, 4);
//    testHarness.pushElement<Window3>({8, 1105}, 4);
//    testHarness.pushElement<Window3>({76, 1132}, 4);
//    testHarness.pushElement<Window3>({19, 2210}, 4);
//    testHarness.pushElement<Window3>({1, 2501}, 4);
//    testHarness.pushElement<Window3>({45, 3120}, 4);
//
//    struct Output {
//        uint64_t window1window2$start;
//        uint64_t window1window2$end;
