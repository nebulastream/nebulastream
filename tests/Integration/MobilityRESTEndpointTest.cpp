...
TEST_F(MobilityRESTEndpointTest, testGetGeoNodes) {
    ...
    const auto* expected =
        R"({"sinks":[{"id":"test_sink","latitude":1,"longitude":2,"rangeArea":1000}],"sources":[{"enabled":false,"hasRange":false,"id":"test_source","latitude":3,"longitude":4,"rangeArea":0}]})";
...
TEST_F(MobilityRESTEndpointTest, testGetGeoSource) {
    ...
    const auto* expected =
        R"({"enabled":false,"hasRange":false,"id":"test_source","latitude":3,"longitude":4,"rangeArea":0})";
...
TEST_F(MobilityRESTEndpointTest, testGetGeoSink) {
    ...
    const auto* expected =
        R"({"id":"test_sink","latitude":1,"longitude":2,"rangeArea":1000})";
    NES_DEBUG("getSource response: expected = " << expected);
