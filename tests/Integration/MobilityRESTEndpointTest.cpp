...
TEST_F(MobilityRESTEndpointTest, testGetGeoNodes) {
    ...
    const auto* expected =
        R"({"sinks":[{"id":"test_sink","latitude":1,"longitude":2}],"sources":[{"enabled":false,"hasRange":false,"id":"test_source","latitude":3,"longitude":4}]})";
...
TEST_F(MobilityRESTEndpointTest, testGetGeoSource) {
    ...
    const auto* expected =
        R"({"enabled":false,"hasRange":false,"id":"test_source","latitude":3,"longitude":4})";
