...
TEST_F(DeepHierarchyTopologyTest, testOutputAndAllSensors) {
    ...
    wrk2->replaceParent(crdTopologyNodeId, wrk1->getTopologyNodeId());
    ...
    wrk3->replaceParent(crdTopologyNodeId, wrk1->getTopologyNodeId());
    ...
    wrk4->replaceParent(crdTopologyNodeId, wrk1->getTopologyNodeId());
    NES_DEBUG("DeepTopologyHierarchyTest: Worker 2 started successfully");
    ...
    wrk5->replaceParent(crdTopologyNodeId, wrk1->getTopologyNodeId());
...
TEST_F(DeepHierarchyTopologyTest, testSimpleQueryWithTwoLevelTreeWithDefaultSourceAndAllSensors) {
    ...
    bool retStart5 = wrk5->start(/**blocking**/ false, /**withConnect**/ true);
    EXPECT_TRUE(retStart5);
    wrk5->replaceParent(crdTopologyNodeId, wrk4->getTopologyNodeId());
    ...
    wrk6->replaceParent(crdTopologyNodeId, wrk4->getTopologyNodeId());
    NES_DEBUG("DeepTopologyHierarchyTest: Worker 6 started successfully");
...
TEST_F(DeepHierarchyTopologyTest, testSimpleQueryWithThreeLevelTreeWithDefaultSourceAndWorker) {
    ...
    wrk7->replaceParent(crdTopologyNodeId, wrk5->getTopologyNodeId());
    ...
    wrk8->replaceParent(crdTopologyNodeId, wrk6->getTopologyNodeId());
    ...
    wrk9->replaceParent(crdTopologyNodeId, wrk2->getTopologyNodeId());
    ...
    wrk10->replaceParent(crdTopologyNodeId, wrk3->getTopologyNodeId());
