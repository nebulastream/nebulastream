...
TEST_F(MemorySourceIntegrationTest, testMemorySource) {
    ...
    AbstractPhysicalStreamConfigPtr conf = MemorySourceStreamConfig::create(
        "MemorySource", "memory_stream_0", "memory_stream", memArea, memAreaSize, buffersToExpect, 0, "frequency");
...
TEST_F(MemorySourceIntegrationTest, testMemorySourceFewTuples) {
    ...
    AbstractPhysicalStreamConfigPtr conf = MemorySourceStreamConfig::create("MemorySource", "memory_stream_0", "memory_stream",
                                                                            memArea, memAreaSize, 1, 0, "frequency");
    wrk1->registerPhysicalStream(conf);
...
TEST_F(MemorySourceIntegrationTest, testMemorySourceHalfFullBuffer) {
    ...
    AbstractPhysicalStreamConfigPtr conf = MemorySourceStreamConfig::create(
        "MemorySource", "memory_stream_0", "memory_stream", memArea, memAreaSize, buffersToExpect + 1, 0, "frequency");
    wrk1->registerPhysicalStream(conf);
