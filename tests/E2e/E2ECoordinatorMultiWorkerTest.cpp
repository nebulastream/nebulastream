    ...
    while (std::getline(ifs, line)) {
        ...
        if ((rowNumber > 3 && rowNumber < 6) || (rowNumber > 8 && rowNumber < 11)) {
            ...
            if (content.at(1) == "R2000073") {
                NES_INFO(
                    "E2ECoordinatorWorkerTest(testExecutingValidSimplePatternWithFileOutputTwoWorkerDifferentSource): content="
                    << content.at(2));
                NES_INFO("E2ECoordinatorWorkerTest(testExecutingValidSimplePatternWithFileOutputTwoWorkerDifferentSource): "
                         "expContent= 102.629631");
