...
namespace NES {
BasicBlock::BasicBlock(std::string identifier, int32_t scopeLevel, std::vector<OperationPtr> operations, std::vector<std::string> inputArgs, 
...
OperationPtr BasicBlock::getTerminatorOp() { return operations.back(); }
