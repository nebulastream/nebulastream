...
ValueRef TraceContext::createNextRef(IR::Operations::PrimitiveStamp type) { return ValueRef(executionTrace->getCurrentBlockIndex(), currentOperationCounter, type); }
