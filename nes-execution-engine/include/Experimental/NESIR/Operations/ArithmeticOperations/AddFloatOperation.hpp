...
class AddFloatOperation : public Operation {
  public:
    AddFloatOperation(std::string identifier, std::string leftArgName, std::string rightArgName);
    ~AddFloatOperation() override = default;
