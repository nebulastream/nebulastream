...
TEST_F(MLIR_IF_GenerationTest, testIfEquals) {
    ...
    // true case
    {
        // int64Const2 = 10
        // x = x + int64Const2
        auto x1 = std::make_shared<BasicBlockArgument>("x1", PrimitiveStamp::INT64);
        ...
        auto int64Const2 = std::make_shared<ConstIntOperation>("int64Const2", 10, 64);
...
TEST_F(MLIR_IF_GenerationTest, testNestedIfEquals) {
    ...
    auto x = std::make_shared<BasicBlockArgument>("x", PrimitiveStamp::INT64);
    auto y = std::make_shared<BasicBlockArgument>("y", PrimitiveStamp::INT64);
    ...
    // true case
    {
        ...
        // x = x + int64Const2
        auto x1 = std::make_shared<BasicBlockArgument>("x1", PrimitiveStamp::INT64);
        auto y1 = std::make_shared<BasicBlockArgument>("y1", PrimitiveStamp::INT64);
        ...
        auto x4 = std::make_shared<BasicBlockArgument>("x4", PrimitiveStamp::INT64);
        ...
        // true case
        {
            // int64Const2 = 10
            // x = x + int64Const2
            auto x5 = std::make_shared<BasicBlockArgument>("x5", PrimitiveStamp::INT64);
            ...
            auto int64Const4 = std::make_shared<ConstIntOperation>("int64Const4", 10, 64);
        ...
        // else case
        {
            auto x6 = std::make_shared<BasicBlockArgument>("x6", PrimitiveStamp::INT64);
