...
//     mlir::MLIRContext context;
//     std::string modulePath ="/home/alepping/MLIRCode/deviationLoop_loops_unoptimized.mlir";
//     mlir::OwningOpRef<mlir::ModuleOp> module = Backends::MLIR::MLIRUtility::loadMLIRModuleFromFilePath(modulePath, context);
...
//     const int NUM_ITERATIONS = 10; //Todo adapt for experiments
...
//         memPtr.ref = Tracing::ValueRef(INT32_MAX, 0, IR::Types::StampFactory::createAddressStamp());
//         auto size = Value<Int64>(0l);
//         size.ref = Tracing::ValueRef(INT32_MAX, 1, IR::Types::StampFactory::createInt64Stamp());
//         std::shared_ptr<Tracing::ExecutionTrace> executionTrace;
//         std::cout << "Creating Execution Trace.\n";
//         // executionTrace = Tracing::traceFunctionSymbolicallyWithReturn([]() {
//         executionTrace = Tracing::traceFunctionSymbolicallyWithReturn([&memPtr, &size]() {
//             return standardDeviationAggregation(memPtr, size);
//             // return standardDeviationAggregation();
//         });
//         std::cout << "Created Execution Trace.\n";
...
//         // Compile MLIR -> return function pointer
//         auto engine = Backends::MLIR::MLIRUtility::compileMLIRModuleToMachineCode(module); //Todo toggle inlining
...
//     // Todo handle testUtility Strings
//     char **langStrings  = new char*[lineitemStrings.size()];
...
//         auto size = Value<Int64>(0l);
//         size.ref = Tracing::ValueRef(INT32_MAX, 1, IR::Types::StampFactory::createInt64Stamp());
//         auto executionTrace = Tracing::traceFunctionSymbolically([&memPtr, &size]() {
...
//         // compile module
//         auto engine = Backends::MLIR::MLIRUtility::compileMLIRModuleToMachineCode(module); //Todo inlining
