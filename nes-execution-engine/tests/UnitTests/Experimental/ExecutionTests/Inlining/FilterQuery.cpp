...
class FilterQuery : public testing::Test {
  public:
    ...
    static void SetUpTestCase() {
        NES::Logger::setupLogging("FilterQuery.log", NES::LogLevel::LOG_DEBUG);
        std::cout << "Setup FilterQuery test class." << std::endl;
    }

    /* Will be called before a test is executed. */
    void SetUp() override { std::cout << "Setup FilterQuery test case." << std::endl; }

    /* Will be called before a test is executed. */
    void TearDown() override { std::cout << "Tear down FilterQuery test case." << std::endl; }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { std::cout << "Tear down FilterQuery test class." << std::endl; }
...
TEST_F(FilterQuery, filterBenchmark) {
    ...
    auto CONF = testUtility->getTestParamaterConfig("filter.csv");
