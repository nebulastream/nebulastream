...
TEST_F(RenameTest, DISABLED_testAttributeRenameAndProjection) {
  ...
  string query =
      "Query::from(\"default_logical\").project(Attribute(\"id\").as("
      "\"NewName\")).sink(FileSinkDescriptor::"
      "create(\""s +
  ...
  string expectedContent =
      "default_logical$NewName:INTEGER(32 bits)\n"
      "1\n"
      "1\n"
      "1\n"
      "1\n"
  ...
  NES_INFO("RenameTest (testDeployOneWorkerFileOutput): expContent={}",
           expectedContent);
...
TEST_F(RenameTest, DISABLED_testAttributeRenameAndFilter) {
  ...
  string expectedContent =
      "default_logical$NewName:INTEGER(32 "
...
TEST_F(RenameTest, DISABLED_testCentralWindowEventTime) {
  ...
  string query =
      "Query::from(\"window\")"
      ".project(Attribute(\"id\").as(\"newId\"), Attribute(\"timestamp\"), "
      "Attribute(\"value\").as(\"newValue\"))"
      ".window(TumblingWindow::of(EventTime(Attribute(\"timestamp\")), "
      "Seconds(1)))"
      ".byKey(Attribute(\"newId\")).apply(Sum(Attribute(\"newValue\"))).sink("
...
TEST_F(RenameTest, DISABLED_testJoinWithDifferentSourceTumblingWindow) {
  ...
  workerConfig1->coordinatorPort = port;
  CSVSourceTypePtr csvSourceType1 =
      CSVSourceType::create("window1", "test_stream");
  csvSourceType1->setFilePath(std::filesystem::path(TEST_DATA_DIRECTORY) /
                              "window.csv");
  csvSourceType1->setNumberOfTuplesToProducePerBuffer(3);
  ...
  CSVSourceTypePtr csvSourceType2 =
      CSVSourceType::create("window2", "test_stream");
  ...
  QueryId queryId = requestHandlerService->validateAndQueueAddQueryRequest(
      query, Optimizer::PlacementStrategy::TopDown);
  ...
  string expectedContent =
      "_$start:INTEGER(64 bits),_$end:INTEGER(64 bits),_$key:INTEGER(64 "
      "bits),window1$win1:INTEGER(64 "
      "bits),window1$id1New:INTEGER(64 bits),window1$timestamp:INTEGER(64 "
      "bits),"
      "window2$win2:INTEGER(64 bits),window2$id2New:INTEGER(64 "
      "bits),window2$timestamp:INTEGER(64 bits)\n"
