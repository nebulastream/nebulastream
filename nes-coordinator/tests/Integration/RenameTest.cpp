...
TEST_F(RenameTest, DISABLED_testAttributeRenameAndProjection) {
  ...
  string query = "Query::from(\"default_logical\").project(Attribute(\"id\")."
                 "as(\"NewName\")).sink(FileSinkDescriptor::"
                 "create(\""s +
...
TEST_F(RenameTest, DISABLED_testAttributeRenameAndFilter) {
  ...
  string expectedContent = "default_logical$NewName:INTEGER(32 "
