...
public:
        ...
        const std::string& expectedOutputCSV)
    {
        ...
        for (auto i = 0_u64; i < joinParams.inputSchemas.size(); ++i)
        {
            ...
            auto csvSourceType = TestUtils::createSourceTypeCSV({logicalSourceName, physicalSourceName, csvFileParams.inputCsvFiles[i]});
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceTumblingWindowOnCoodinatorSequential)
{
    ...
    // Expected output
    const auto expectedOutput = "12000, 13000, 12000, 13000, 12000, 13000, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000\n"
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceTumblingWindowOnCoodinatorNested)
{
    ...
    // Expected output
    const auto expectedOutput = "1000, 2000, 1000, 2000, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 1, 1300, 12, 1, 1300\n"
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceSlidingWindowOnCoodinatorSequential)
{
    ...
    // Expected output
    const auto expectedOutput = "500, 1500, 500, 1500,  500, 1500, 12, 1, 1001, 12, 5, 1011, 12, 1, 1300, 12, 1, 1300\n"
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceSlidingWindowOnCoodinatorNested)
{
    ...
    // Expected output
    const auto expectedOutput = "500, 1500, 500, 1500, 12, 1, 1001, 12, 5, 1011, 500, 1500, 12, 1, 1300, 12, 1, 1300\n"
