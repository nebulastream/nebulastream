...
TEST_P(MultipleJoinsTest, testJoins2WithDifferentSourceTumblingWindowOnCoodinator) {
    ...
    TestUtils::JoinParams joinParams({windowSchema, window2Schema, window3Schema}, {"id", "id2", "id3"});
    TestUtils::CsvFileParams csvFileParams({"window.csv", "window2.csv", "window4.csv"}, "");

    // Expected output
    const auto expectedOutput = "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 4, 4, 1001\n"
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceTumblingWindowOnCoodinatorSequential) {
    ...
    TestUtils::JoinParams joinParams({windowSchema, window2Schema, window3Schema, window4Schema}, {"id", "id2", "id3", "id4"});
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceTumblingWindowOnCoodinatorNested) {
    ...
    // Expected output
    const auto expectedOutput =
        "1000, 2000, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 12, 1, 1300, 12, 1, 1300\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "3000, 4000, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 3000, 4000, 11, 11, 9, 3000, 11, 9, 3000\n"
        "12000, 13000, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000\n"
        "13000, 14000, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000\n"
        "14000, 15000, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000\n"
        "15000, 16000, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000\n";
...
TEST_P(MultipleJoinsTest, testJoins2WithDifferentSourceSlidingWindowOnCoodinator) {
    ...
    // Expected output
    const auto expectedOutput = "500, 1500, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 12, 1, 1300\n"
                                "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 4, 4, 1001\n"
                                "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 4, 4, 1001\n"
                                "500, 1500, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 12, 1, 1300\n"
                                "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 4, 4, 1001\n"
                                "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 4, 4, 1001\n"
                                "1000, 2000, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 12, 1, 1300\n"
                                "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 4, 4, 1001\n"
                                "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 4, 4, 1001\n"
                                "1000, 2000, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 12, 1, 1300\n"
                                "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 4, 4, 1001\n"
                                "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 4, 4, 1001\n"
                                "2500, 3500, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 11, 9, 3000\n"
                                "2500, 3500, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 11, 9, 3000\n"
                                "3000, 4000, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 11, 9, 3000\n"
                                "3000, 4000, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 11, 9, 3000\n"
                                "11500, 12500, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000\n"
                                "11500, 12500, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000\n"
                                "12000, 13000, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000\n"
                                "12000, 13000, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 1, 12, 12000\n"
                                "12500, 13500, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 1, 13, 13000\n"
                                "12500, 13500, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 1, 13, 13000\n"
                                "13000, 14000, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 1, 13, 13000\n"
                                "13000, 14000, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 1, 13, 13000\n"
                                "13500, 14500, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 1, 14, 14000\n"
                                "13500, 14500, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 1, 14, 14000\n"
                                "14000, 15000, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 1, 14, 14000\n"
                                "14000, 15000, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 1, 14, 14000\n"
                                "14500, 15500, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 1, 15, 15000\n"
                                "14500, 15500, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 1, 15, 15000\n"
                                "15000, 16000, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 1, 15, 15000\n"
                                "15000, 16000, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 1, 15, 15000\n";
...
TEST_P(MultipleJoinsTest, testJoin3WithDifferentSourceSlidingWindowOnCoodinatorNested) {
    ...
    // Expected output
    const auto expectedOutput =
        "500, 1500, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 500, 1500, 12, 12, 1, 1300, 12, 1, 1300\n"
        "500, 1500, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 12, 1, 1300, 12, 1, 1300\n"
        "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 500, 1500, 12, 12, 1, 1300, 12, 1, 1300\n"
        "500, 1500, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 12, 1, 1300, 12, 1, 1300\n"
        "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "500, 1500, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 500, 1500, 12, 12, 1, 1300, 12, 1, 1300\n"
        "1000, 2000, 12, 500, 1500, 12, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 12, 1, 1300, 12, 1, 1300\n"
        "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1102, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 500, 1500, 4, 4, 1, 1002, 4, 3, 1112, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 500, 1500, 12, 12, 1, 1300, 12, 1, 1300\n"
        "1000, 2000, 12, 1000, 2000, 12, 12, 1, 1001, 12, 5, 1011, 1000, 2000, 12, 12, 1, 1300, 12, 1, 1300\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1102, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 500, 1500, 4, 4, 4, 1001, 4, 4, 1001\n"
        "1000, 2000, 4, 1000, 2000, 4, 4, 1, 1002, 4, 3, 1112, 1000, 2000, 4, 4, 4, 1001, 4, 4, 1001\n"
        "2500, 3500, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 2500, 3500, 11, 11, 9, 3000, 11, 9, 3000\n"
        "2500, 3500, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 3000, 4000, 11, 11, 9, 3000, 11, 9, 3000\n"
        "2500, 3500, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 2500, 3500, 11, 11, 9, 3000, 11, 9, 3000\n"
        "2500, 3500, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 3000, 4000, 11, 11, 9, 3000, 11, 9, 3000\n"
        "3000, 4000, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 2500, 3500, 11, 11, 9, 3000, 11, 9, 3000\n"
        "3000, 4000, 11, 2500, 3500, 11, 11, 3, 3001, 11, 3, 3001, 3000, 4000, 11, 11, 9, 3000, 11, 9, 3000\n"
        "3000, 4000, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 2500, 3500, 11, 11, 9, 3000, 11, 9, 3000\n"
        "3000, 4000, 11, 3000, 4000, 11, 11, 3, 3001, 11, 3, 3001, 3000, 4000, 11, 11, 9, 3000, 11, 9, 3000\n"
        "11500, 12500, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000\n"
        "11500, 12500, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000\n"
        "11500, 12500, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000\n"
        "11500, 12500, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000\n"
        "12000, 13000, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000\n"
        "12000, 13000, 1, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000\n"
        "12000, 13000, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 11500, 12500, 1, 1, 12, 12000, 1, 12, 12000\n"
        "12000, 13000, 1, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000, 12000, 13000, 1, 1, 12, 12000, 1, 12, 12000\n"
        "12500, 13500, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000\n"
        "12500, 13500, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000\n"
        "12500, 13500, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000\n"
        "12500, 13500, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000\n"
        "13000, 14000, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000\n"
        "13000, 14000, 1, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000\n"
        "13000, 14000, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 12500, 13500, 1, 1, 13, 13000, 1, 13, 13000\n"
        "13000, 14000, 1, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000, 13000, 14000, 1, 1, 13, 13000, 1, 13, 13000\n"
        "13500, 14500, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000\n"
        "13500, 14500, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000\n"
        "13500, 14500, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000\n"
        "13500, 14500, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000\n"
        "14000, 15000, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000\n"
        "14000, 15000, 1, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000\n"
        "14000, 15000, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 13500, 14500, 1, 1, 14, 14000, 1, 14, 14000\n"
        "14000, 15000, 1, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000, 14000, 15000, 1, 1, 14, 14000, 1, 14, 14000\n"
        "14500, 15500, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000\n"
        "14500, 15500, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000\n"
        "14500, 15500, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000\n"
        "14500, 15500, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000\n"
        "15000, 16000, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000\n"
        "15000, 16000, 1, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000\n"
        "15000, 16000, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 14500, 15500, 1, 1, 15, 15000, 1, 15, 15000\n"
        "15000, 16000, 1, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000, 15000, 16000, 1, 1, 15, 15000, 1, 15, 15000\n";
...
TEST_P(MultipleJoinsTest, testMapNotKeyWithDifferentSourceTumblingWindow) {
    ...
    // Expected output
    const auto expectedOutput = "1000, 2000, 12, 1000, 2000, 12, 12, 1, 1001, 1, 12, 5, 1011, 1, 12, 1, 1300, 1\n";
...
TEST_P(MultipleJoinsTest, testMapsAsKeysWithDifferentSourceTumblingWindow) {
    ...
    // Expected output
    const auto expectedOutput = "1000, 2000, 1, 1000, 2000, 1, 12, 1, 1001, 1, 12, 5, 1011, 1, 12, 1, 1300, 1\n";
