...
TEST_F(ConnectivityControllerTest, testCORSRequest) {
  ...
  EXPECT_NO_THROW(corsOriginHeader =
                      r.header.at("Access-Control-Allow-Origin"));
  EXPECT_EQ(corsOriginHeader, corsOrigin);
  std::string corsMethodHeader;
  EXPECT_NO_THROW(corsMethodHeader =
                      r.header.at("Access-Control-Allow-Methods"));
  EXPECT_EQ(corsMethodHeader, "GET, POST, OPTIONS");
  std::string corsAllowedHeaders;
  EXPECT_NO_THROW(corsAllowedHeaders =
                      r.header.at("Access-Control-Allow-Headers"));
