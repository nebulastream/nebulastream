...
TEST_F(SourceCatalogControllerTest, testGetPhysicalSource)
{
    ...
    cpr::AsyncResponse future = cpr::GetAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/sourceCatalog/allPhysicalSource"},
...
TEST_F(SourceCatalogControllerTest, testGetSchema)
{
    ...
    cpr::AsyncResponse future = cpr::GetAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/sourceCatalog/schema"},
...
TEST_F(SourceCatalogControllerTest, testPostLogicalSource)
{
    ...
    cpr::AsyncResponse future = cpr::PostAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/sourceCatalog/addLogicalSource"},
...
TEST_F(SourceCatalogControllerTest, testUpdateLogicalSource)
{
    ...
    cpr::AsyncResponse future = cpr::PostAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/sourceCatalog/updateLogicalSource"},
        cpr::Header{{"Content-Type", "application/json"}},
        cpr::Body{request.dump()});
    future.wait();
    cpr::Response r = future.get();
...
TEST_F(SourceCatalogControllerTest, testDeleteLogicalSource)
{
    ...
    cpr::AsyncResponse future = cpr::DeleteAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/sourceCatalog/deleteLogicalSource"},
        cpr::Parameters{{"logicalSourceName", "test_stream"}});
    future.wait();
    cpr::Response r = future.get();
    ASSERT_EQ(r.status_code, 200l);
