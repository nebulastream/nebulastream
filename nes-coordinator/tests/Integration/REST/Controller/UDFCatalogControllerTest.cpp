...
public:
        ...
        const google::protobuf::RepeatedPtrField<JavaUdfDescriptorMessage_JavaUdfClassDefinition>& expected)
    {
        ...
        {
            auto actualByteCode = std::find_if(
                actual.cbegin(), actual.cend(), [&](const jni::JavaClassDefinition& c) { return c.first == classDefinition.class_name(); });
...
TEST_F(UDFCatalogControllerTest, getUdfDescriptorReturnsUdf)
{
    ...
    auto future = cpr::GetAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/getUdfDescriptor"}, cpr::Parameters{{"udfName", udfName}});
    future.wait();
...
TEST_F(UDFCatalogControllerTest, testErrorIfUnknownEndpointIsUsed)
{
    ...
    auto future = cpr::PostAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/SUPER_SECRET_URL"},
...
TEST_F(UDFCatalogControllerTest, testIfRegisterEndpointHandlesExceptionsWithoutReturningAStackTrace)
{
    ...
    auto future = cpr::PostAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/registerJavaUdf"},
        cpr::Header{{"Content-Type", "text/plain"}},
...
TEST_F(UDFCatalogControllerTest, testRemoveUdfEndpoint)
{
    ...
    auto future = cpr::DeleteAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/removeUdf"}, cpr::Parameters{{"udfName", udfName}});
    future.wait();
    auto response = future.get();
...
TEST_F(UDFCatalogControllerTest, testRemoveUdfEndpointIfUdfDoesNotExist)
{
    ...
    auto future = cpr::DeleteAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/removeUdf"}, cpr::Parameters{{"udfName", "my_udf"}});
    future.wait();
    auto response = future.get();
...
TEST_F(UDFCatalogControllerTest, testIfRemoveUdfEndpointHandlesExtraQueryParametersCorrectly)
{
    ...
    auto future = cpr::DeleteAsync(
        cpr::Url{BASE_URL + std::to_string(*restPort) + "/v1/nes/udfCatalog/removeUdf"},
