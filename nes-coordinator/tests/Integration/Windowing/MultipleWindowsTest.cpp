...
public:
  static void SetUpTestCase() {
    NES::Logger::setupLogging("MultipleWindowsTest.log",
...
TEST_F(MultipleWindowsTest, testTwoCentralTumblingWindows) {
  ...
  CSVSourceTypePtr csvSourceType1 =
      CSVSourceType::create("window", "test_stream");
...
TEST_F(MultipleWindowsTest, testTwoCentralSlidingWindowEventTime) {
  ...
  string query =
      "Query::from(\"window\")"
      ".window(SlidingWindow::of(EventTime(Attribute(\"timestamp\")),Seconds(5)"
      ",Seconds(5)))"
      ".byKey(Attribute(\"id\")).apply(Sum(Attribute(\"value\")))"
      ".assignWatermark(EventTimeWatermarkStrategyDescriptor::create(Attribute("
      "\"start\"), Milliseconds(0), Milliseconds()))"
      ".window(SlidingWindow::of(EventTime(Attribute(\"start\")),Seconds(10),"
      "Seconds(5))) "
      ".byKey(Attribute(\"id\")).apply(Sum(Attribute(\"value\")))"
      ".sink(FileSinkDescriptor::create(\"" +
      outputFilePath + R"(","CSV_FORMAT", "APPEND"));)";
...
TEST_F(MultipleWindowsTest, testTwoDistributedSlidingWindowEventTime) {
  ...
  string query = "Query::from(\"window\")"
                 ...
                 ",Seconds(5),Seconds(5))).byKey(Attribute(\"id\")"
                 ").apply(Sum(Attribute(\"value\")))"
                 ".window(SlidingWindow::of(EventTime(Attribute(\"end\")),"
                 "Seconds(10),Seconds(5))).byKey(Attribute(\"id\")). "
                 "apply(Sum(Attribute(\"value\")))"
                 ".sink(FileSinkDescriptor::create(\"" +
                 outputFilePath + R"(","CSV_FORMAT", "APPEND"));)";
...
TEST_F(MultipleWindowsTest, testThreeDifferentWindows) {
  ...
  string expectedContent =
      "window$start:INTEGER(64 bits),window$end:INTEGER(64 "
      "bits),window$value:INTEGER(64 bits)\n"
      "0,2000,4\n"
      "2000,4000,24\n"
      "4000,6000,20\n"
      "6000,8000,28\n"
...
TEST_F(MultipleWindowsTest, DISABLED_testSeparatedWindow) {
  /**
   * @Ankit this should lso not happen, node 2 has a slot count of 3 but 5
...
|  |  |        SOURCE(8,window)
  ...
  CSVSourceTypePtr csvSourceType3 =
      CSVSourceType::create("window", "test_stream");
...
|  |  |        SOURCE(10,window)
  ...
  string expectedContent =
      "window1window2window3$start:INTEGER,window1window2window3$end:INTEGER,"
      "window1window2window3$key:INTEGER,window1window2$"
      "start:INTEGER,window1window2$end:INTEGER,window1window2$key:INTEGER,"
      "window1$win1:INTEGER,window1$id1:INTEGER,window1$"
      "timestamp:INTEGER,window2$win2:INTEGER,window2$id2:INTEGER,window2$"
      "timestamp:INTEGER,window3$win3:INTEGER,window3$id3:"
