 ...
 * window
 */
class KeyedSlidingWindowTests : public Testing::BaseIntegrationTest,
                                public ::testing::WithParamInterface<int> {
public:
  WorkerConfigurationPtr workerConfiguration;
  static void SetUpTestCase() {
    NES::Logger::setupLogging("KeyedSlidingWindowTests.log",
...
TEST_F(KeyedSlidingWindowTests, testMultipleSlidingWindowMultiBuffer) {
  ...
  for (uint64_t windowStart = 0; windowStart <= 16000;
       windowStart = windowStart + 100) {
    expectedOutput << windowStart << ", " << (windowStart + 1000)
                   << ", 1, 1000\n";
  }
...
TEST_F(KeyedSlidingWindowTests, testMultipleSldingWindowIrigularSlide) {
  ...
  for (uint64_t windowStart = 300; windowStart <= 16000;
       windowStart = windowStart + 300) {
    expectedOutput << windowStart << ", " << (windowStart + 1000)
                   << ", 1, 1000\n";
  }
