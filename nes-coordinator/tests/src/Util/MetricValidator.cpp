...
bool MetricValidator::isValid(
  ...
  if (reader->getReaderType() == SystemResourcesReaderType::AbstractReader) {
    NES_WARNING(
        "MetricValidator: AbstractReader used for RuntimeMetrics. Returning "
        "true");
    return true;
  }
...
bool MetricValidator::isValid(
  ...
  if (reader->getReaderType() == SystemResourcesReaderType::AbstractReader) {
    NES_WARNING(
        "MetricValidator: AbstractReader used for NodeRegistrationMetrics. "
        "Returning true");
    return true;
  }
...
bool MetricValidator::isValid(
  ...
  if (reader->getReaderType() == SystemResourcesReaderType::AbstractReader) {
    NES_WARNING(
        "MetricValidator: AbstractReader used for CpuMetricsWrapper. Returning "
        "true");
    return true;
  }
...
bool MetricValidator::isValid(
  ...
  if (reader->getReaderType() == SystemResourcesReaderType::AbstractReader) {
    NES_WARNING(
        "MetricValidator: AbstractReader used for NetworkMetricsWrapper. "
        "Returning true");
    return true;
  }
...
bool MetricValidator::isValid(
  ...
  if (reader->getReaderType() == SystemResourcesReaderType::AbstractReader) {
    NES_WARNING(
        "MetricValidator: AbstractReader used for MemoryMetrics. Returning "
        "true");
    return true;
  }
