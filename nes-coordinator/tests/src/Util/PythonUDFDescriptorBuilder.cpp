...
PythonUDFDescriptorBuilder& PythonUDFDescriptorBuilder::setInputSchema(
    const SchemaPtr& newInputSchema) {
  this->inputSchema = newInputSchema;
  return *this;
}

PythonUDFDescriptorBuilder& PythonUDFDescriptorBuilder::setOutputSchema(
