...
TEST_F(DataTypeFactoryTests, stampModificationTest) {
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndIncreaseLowerBound(
        DataTypeFactory::createInt32(), -200.0);
    stamp =
        DataTypeFactory::copyTypeAndIncreaseLowerBound(stamp, int64_t(-100L));
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndIncreaseLowerBound(
        DataTypeFactory::createFloat(), -200.0);
    stamp =
        DataTypeFactory::copyTypeAndIncreaseLowerBound(stamp, int64_t(-100L));
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndDecreaseUpperBound(
        DataTypeFactory::createInt32(), 200.0);
    stamp =
        DataTypeFactory::copyTypeAndDecreaseUpperBound(stamp, int64_t(100L));
    ASSERT_TRUE(stamp->isInteger());
    const auto intStamp = DataType::as<Integer>(stamp);
    ASSERT_EQ(intStamp->getBits(), 32);
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndTightenBounds(
        DataTypeFactory::createInt32(), int64_t(-100), int64_t(100));
    ASSERT_TRUE(stamp->isInteger());
    const auto intStamp = DataType::as<Integer>(stamp);
    ASSERT_EQ(intStamp->getBits(), 32);
    ASSERT_EQ(intStamp->lowerBound, -100);
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndTightenBounds(
        DataTypeFactory::createInt32(), -100.0, 100.0);
    ASSERT_TRUE(stamp->isInteger());
    const auto intStamp = DataType::as<Integer>(stamp);
    ASSERT_EQ(intStamp->getBits(), 32);
    ASSERT_EQ(intStamp->lowerBound, -100);
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndTightenBounds(
        DataTypeFactory::createInt32(), -99.9, 99.9);
    ASSERT_TRUE(stamp->isInteger());
    const auto intStamp = DataType::as<Integer>(stamp);
    ASSERT_EQ(intStamp->getBits(), 32);
    ASSERT_EQ(intStamp->lowerBound, -100);
  ...
  }
  {
    ...
    ASSERT_TRUE(stamp->isInteger());
    stamp = DataTypeFactory::copyTypeAndTightenBounds(stamp, int64_t(-100),
                                                      int64_t(100));
    stamp = DataTypeFactory::copyTypeAndTightenBounds(stamp, int64_t(-200LL),
                                                      int64_t(99LL));
    stamp = DataTypeFactory::copyTypeAndTightenBounds(stamp, int64_t(-99LL),
                                                      int64_t(200LL));
    ASSERT_TRUE(stamp->isInteger());
    const auto intStamp = DataType::as<Integer>(stamp);
    ASSERT_EQ(intStamp->getBits(), 32);
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndTightenBounds(
        DataTypeFactory::createFloat(), -100.5, 100.5);
    ASSERT_TRUE(stamp->isFloat());
    const auto floatStamp = DataType::as<Float>(stamp);
    ASSERT_EQ(floatStamp->getBits(), 32);
  ...
  {
    auto stamp = DataTypeFactory::copyTypeAndTightenBounds(
        DataTypeFactory::createFloat(), int64_t(-100), int64_t(100));
    ASSERT_TRUE(stamp->isFloat());
    const auto floatStamp = DataType::as<Float>(stamp);
    ASSERT_EQ(floatStamp->getBits(), 32);
    ASSERT_EQ(floatStamp->lowerBound, -100);
  ...
  // conversion of Integer to Stamp
  {
    ...
    auto const floatStamp =
        DataType::as<Float>(DataTypeFactory::createFloatFromInteger(intStamp));
