...
class LowerLogicalToPhysicalOperatorsTest : public Testing::BaseUnitTest {
 public:
  static void SetUpTestCase() {
    NES::Logger::setupLogging("TranslateToPhysicalOperatorPhaseTest.log",
  ...
  void SetUp() override {
    ...
    sourceOp2 = LogicalOperatorFactory::createSourceOperator(
        LogicalSourceDescriptor::create("default_logical"));
    sourceOp3 = LogicalOperatorFactory::createSourceOperator(
        LogicalSourceDescriptor::create("default_logical"));
    sourceOp4 = LogicalOperatorFactory::createSourceOperator(
        LogicalSourceDescriptor::create("default_logical"));
            ...
            ->as<FieldAccessExpressionNode>());
    {
      ...
      joinOp1 = LogicalOperatorFactory::createJoinOperator(joinDef)
    ...
    sinkOp2 = LogicalOperatorFactory::createSinkOperator(
        PrintSinkDescriptor::create());
    auto windowType =
        TumblingWindow::of(EventTime(Attribute("test")), Seconds(10));
    auto windowDefinition = LogicalWindowDescriptor::create(
        {Sum(Attribute("test"))->aggregation}, windowType, 0);
    ...
    auto pythonUDFDescriptor = Catalogs::UDF::PythonUDFDescriptorBuilder::
        createDefaultPythonUDFDescriptor();
    mapPythonUDFOp = LogicalOperatorFactory::createMapUDFLogicalOperator(
        pythonUDFDescriptor);
 ...
 protected:
  ...
  LogicalOperatorPtr filterOp1, filterOp2, filterOp3, filterOp4, filterOp5,
      filterOp6, filterOp7;
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateFilterQuery) {
  ...
  auto decomposedQueryPlan = DecomposedQueryPlan::create(
      ...
      INVALID_WORKER_NODE_ID, queryPlan->getRootOperators());
  auto physicalOperatorProvider =
      QueryCompilation::DefaultPhysicalOperatorProvider::create(options);
  auto phase = QueryCompilation::LowerLogicalToPhysicalOperators::create(
      physicalOperatorProvider);
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalSinkOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalFilterOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalSourceOperator>());
}
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1 --- Physical Demultiplex Operator --- Physical Filter --
 * Physical Source 1
 *                      /
 *                     /
 * --- Physical Sink 2
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateDemultiplexFilterQuery) {
  ...
  ASSERT_TRUE((*iterator)
                  ->instanceOf<QueryCompilation::PhysicalOperators::
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1 --- Physical Filter --- Physical Multiple Operator ---
 * Physical Source 1
 *                                                                       \
 *                                                                        ---
 * Physical Source 2
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateFilterMultiplexQuery) {
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalUnionOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1  --- Physical Filter --- Physical Multiplex Operator  ---
 * Physical Source 1
 *                                                                           \
 *                                                                            ---
 * Physical Source 2
 *
 */
TEST_F(LowerLogicalToPhysicalOperatorsTest,
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1  --- Physical Join Sink --- Physical Join Build ---
 * Physical Source 1
 *                                             \
 *                                             --- Physical Join Build ---
 * Physical Source 2
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, DISABLED_translateSimpleJoinQuery) {
  ...
  auto leftSchema =
      Schema::create()->addField("left$f1", DataTypeFactory::createInt64());
  auto rightSchema =
      Schema::create()->addField("right$f2", DataTypeFactory::createInt64());
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalJoinSinkOperator>());
  ++iterator;
  ASSERT_TRUE((*iterator)
                  ->instanceOf<QueryCompilation::PhysicalOperators::
...
TEST_F(LowerLogicalToPhysicalOperatorsTest,
  ...
  {
    Join::Experimental::LogicalBatchJoinDescriptorPtr batchJoinDef =
        Join::Experimental::LogicalBatchJoinDescriptor::create(
            FieldAccessExpressionNode::create(DataTypeFactory::createInt64(),
                                              "key")
                ->as<FieldAccessExpressionNode>(),
            FieldAccessExpressionNode::create(DataTypeFactory::createInt64(),
                                              "key")
    ...
    batchJoinOp1 = LogicalOperatorFactory::createBatchJoinOperator(batchJoinDef)
 ...
 *                                             \
 *                                             --- Physical Join Build ---
 * Physical Multiplex Operator  --- Physical Source 1
 *                                                                                                      \
 *                                                                                                       ---
 * Physical Source 2
 */
 ...
 *                                             \
 *                                             --- Physical Join Build ---
 * Physical Multiplex Operator  --- Physical Source 3
 *                                                                                                      \
 *                                                                                                       ---
 * Physical Source 4
 */
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1 --- Physical Watermark Assigner -- Physical Window Pre
 * Aggregation Operator --- Physical Window Sink --- Physical Source 1
 *
 */
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateMapQuery) {
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalMapOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateMapJavaUDFQuery) {
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalMapUDFOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
 ...
 * Result Query plan:
 *
 * --- Physical Sink 1 --- Physical Map Python Udf Operator --- Physical Source
 * 1
 *
 */
...
TEST_F(LowerLogicalToPhysicalOperatorsTest, translateProjectQuery) {
  ...
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
              QueryCompilation::PhysicalOperators::PhysicalProjectOperator>());
  ++iterator;
  ASSERT_TRUE(
      (*iterator)
          ->instanceOf<
