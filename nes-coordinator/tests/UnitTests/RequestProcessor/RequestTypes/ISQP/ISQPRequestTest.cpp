...
TEST_F(ISQPRequestTest, testTopologyChangeEventNotIncremental) {
    ...
    auto addNodeEvent2 = ISQPAddNodeEvent::create(WorkerType::SENSOR, nodeId2, "localhost", 4000, 4002, 4, properties);
    int nodeId3 = 3;
    auto addNodeEvent3 = ISQPAddNodeEvent::create(WorkerType::SENSOR, nodeId3, "localhost", 4000, 4002, 0, properties);
    int nodeId4 = 4;
    auto addNodeEvent4 = ISQPAddNodeEvent::create(WorkerType::SENSOR, nodeId4, "localhost", 4000, 4002, 0, properties);
    int nodeId5 = 5;
    auto addNodeEvent5 = ISQPAddNodeEvent::create(WorkerType::SENSOR, nodeId5, "localhost", 4000, 4002, 1, properties);
    int nodeId6 = 6;
    auto addNodeEvent6 = ISQPAddNodeEvent::create(WorkerType::SENSOR, nodeId6, "localhost", 4000, 4002, 1, properties);
    ...
    auto isqpAddLink23 = ISQPAddLinkEvent::create(nodeId2, nodeId3);
    auto isqpAddLink24 = ISQPAddLinkEvent::create(nodeId2, nodeId4);
    auto isqpAddLink35 = ISQPAddLinkEvent::create(nodeId3, nodeId5);
    ...
    auto isqpAddLinkProperty35 = ISQPAddLinkPropertyEvent::create(nodeId3, nodeId5, 1, 1);
    auto isqpAddLinkProperty12 = ISQPAddLinkPropertyEvent::create(nodeId1, nodeId2, 1, 1);
    auto isqpAddLinkProperty23 = ISQPAddLinkPropertyEvent::create(nodeId2, nodeId3, 1, 1);
    ...
    isqpEventsForRequest1.emplace_back(isqpAddLink23);
    isqpEventsForRequest1.emplace_back(isqpAddLink24);
    isqpEventsForRequest1.emplace_back(isqpAddLink35);
    isqpEventsForRequest1.emplace_back(isqpAddLink46);
    isqpEventsForRequest1.emplace_back(isqpAddLinkProperty24);
    isqpEventsForRequest1.emplace_back(isqpAddLinkProperty35);
    isqpEventsForRequest1.emplace_back(isqpAddLinkProperty12);
    isqpEventsForRequest1.emplace_back(isqpAddLinkProperty23);
    ...
    sourceCatalog->addPhysicalSource(logicalSourceName, sce);
    auto sce2 = Catalogs::Source::SourceCatalogEntry::create(physicalSource, logicalSource, nodeId6);
    sourceCatalog->addPhysicalSource(logicalSourceName, sce2);
    ...
    // Prepare
    auto addLink45 = ISQPAddLinkEvent::create(nodeId4, nodeId5);
    auto removeLink35 = ISQPRemoveLinkEvent::create(nodeId3, nodeId5);
    std::vector<ISQPEventPtr> isqpEventsForRequest3;
    isqpEventsForRequest3.emplace_back(addLink45);
    isqpEventsForRequest3.emplace_back(removeLink35);
    auto isqpRequest3 = ISQPRequest::create(z3Context, isqpEventsForRequest3, ZERO_RETRIES);
    constexpr RequestId requestId3 = 3;
    isqpRequest3->setId(requestId3);
    try {
