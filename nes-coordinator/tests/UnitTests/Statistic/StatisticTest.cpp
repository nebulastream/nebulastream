...
TEST_F(StatisticTest, simpleTest) {
    ...
    statCoordinator.trackStatistic(
        DataCharacteristic::create(Selectivity::create(Attribute("f1") > 4), "car", {"car_1", "car_2", "car_3"}),
        SlidingWindow::of(IngestionTime(), Seconds(10), Seconds(1)));
    statCoordinator.trackStatistic(
        WorkloadCharacteristic::create(Selectivity::create(Attribute("f2") == 42), queryId, operatorId),
        SlidingWindow::of(IngestionTime(), Seconds(10), Seconds(1)));
    ...
    auto anotherProbeResult = statCoordinator.probeStatistic(
        WorkloadCharacteristic::create(Selectivity::create(Attribute("f1") > 4), queryId, operatorId),
        Hours(1),
        Seconds(10),
        estimationAllowed);
