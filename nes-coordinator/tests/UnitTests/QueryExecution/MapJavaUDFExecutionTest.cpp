...
public:
  static void SetUpTestCase() {
    NES::Logger::setupLogging("MapJavaUDFQueryExecutionTest.log",
                              NES::LogLevel::LOG_DEBUG);
    NES_DEBUG(
        "QueryExecutionTest: Setup MapJavaUDFQueryExecutionTest test class.");
  }
  ...
  void TearDown() override {
    ...
    NES_DEBUG("QueryExecutionTest: Tear down MapJavaUDFQueryExecutionTest test "
              "case.");
  ...
  static void TearDownTestCase() {
    NES_DEBUG("MapJavaUDFQueryExecutionTest: Tear down QueryExecutionTest test "
              "class.");
  }
