...
public:
  static void SetUpTestCase() {
    NES::Logger::setupLogging("FlatMapJavaUDFQueryExecutionTest.log",
                              NES::LogLevel::LOG_DEBUG);
    NES_DEBUG("QueryExecutionTest: Setup FlatMapJavaUDFQueryExecutionTest test "
              "class.");
  }
  ...
  void TearDown() override {
    ...
    NES_DEBUG("QueryExecutionTest: Tear down FlatMapJavaUDFQueryExecutionTest "
              "test case.");
  ...
  static void TearDownTestCase() {
    NES_DEBUG("FlatMapJavaUDFQueryExecutionTest: Tear down QueryExecutionTest "
              "test class.");
  }
 ...
 * (IntegerMapFunction<Integer, Integer>) The UDF increments incoming tuples by
 * its current state starting from 10 and
 */
