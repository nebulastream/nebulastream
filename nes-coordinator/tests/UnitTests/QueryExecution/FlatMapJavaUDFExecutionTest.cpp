...
class FlatMapJavaUDFQueryExecutionTest : public Testing::BaseUnitTest {
 public:
  static void SetUpTestCase() {
    ...
    NES_DEBUG(
        "QueryExecutionTest: Setup FlatMapJavaUDFQueryExecutionTest test "
        "class.");
  }
  ...
  void TearDown() override {
    ...
    NES_DEBUG(
        "QueryExecutionTest: Tear down FlatMapJavaUDFQueryExecutionTest test "
        "case.");
  ...
  static void TearDownTestCase() {
    NES_DEBUG(
        "FlatMapJavaUDFQueryExecutionTest: Tear down QueryExecutionTest test "
        "class.");
  }
