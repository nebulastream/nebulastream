...
public:
  static void SetUpTestCase() {
    NES::Logger::setupLogging("LimitQueryExecutionTest.log",
                              NES::LogLevel::LOG_DEBUG);
    NES_DEBUG(
        "LimitQueryExecutionTest: Setup LimitQueryExecutionTest test class.");
  }
  ...
  void TearDown() override {
    NES_DEBUG("LimitQueryExecutionTest: Tear down LimitQueryExecutionTest test "
              "case.");
  ...
  static void fillBuffer(Runtime::MemoryLayouts::TestTupleBuffer &buf,
