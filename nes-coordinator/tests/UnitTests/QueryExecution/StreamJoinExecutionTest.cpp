...
public:
  ...
  void TearDown() override {
    NES_INFO("QueryExecutionTest: Tear down StreamJoinQueryExecutionTest test "
             "case.");
  ...
  runSingleJoinQuery(const TestUtils::CsvFileParams &csvFileParams,
                     const TestUtils::JoinParams &joinParams,
                     const WindowTypePtr &joinWindow, const std::string keyLeft,
