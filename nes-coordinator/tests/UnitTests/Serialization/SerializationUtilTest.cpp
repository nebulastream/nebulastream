...
class SerializationUtilTest : public Testing::BaseUnitTest {
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("SerializationUtilTest.log",
...
TEST_F(SerializationUtilTest, dataTypeSerialization) {
  ...
  auto serializedInt8 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createInt8(), new SerializableDataType());
  auto deserializedInt8 =
      DataTypeSerializationUtil::deserializeDataType(*serializedInt8);
  EXPECT_TRUE(DataTypeFactory::createInt8()->equals(deserializedInt8));

  // serialize and deserialize int16
  auto serializedInt16 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createInt16(), new SerializableDataType());
  auto deserializedInt16 =
      DataTypeSerializationUtil::deserializeDataType(*serializedInt16);
  EXPECT_TRUE(DataTypeFactory::createInt16()->equals(deserializedInt16));

  // serialize and deserialize int32
  auto serializedInt32 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createInt32(), new SerializableDataType());
  auto deserializedInt32 =
      DataTypeSerializationUtil::deserializeDataType(*serializedInt32);
  EXPECT_TRUE(DataTypeFactory::createInt32()->equals(deserializedInt32));

  // serialize and deserialize int64
  auto serializedInt64 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createInt64(), new SerializableDataType());
  auto deserializedInt64 =
      DataTypeSerializationUtil::deserializeDataType(*serializedInt64);
  EXPECT_TRUE(DataTypeFactory::createInt64()->equals(deserializedInt64));

  // serialize and deserialize uint8
  auto serializedUInt8 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createUInt8(), new SerializableDataType());
  auto deserializedUInt8 =
      DataTypeSerializationUtil::deserializeDataType(*serializedUInt8);
  EXPECT_TRUE(DataTypeFactory::createUInt8()->equals(deserializedUInt8));

  // serialize and deserialize uint16
  auto serializedUInt16 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createUInt16(), new SerializableDataType());
  auto deserializedUInt16 =
      DataTypeSerializationUtil::deserializeDataType(*serializedUInt16);
  EXPECT_TRUE(DataTypeFactory::createUInt16()->equals(deserializedUInt16));

  // serialize and deserialize uint32
  auto serializedUInt32 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createUInt32(), new SerializableDataType());
  auto deserializedUInt32 =
      DataTypeSerializationUtil::deserializeDataType(*serializedUInt32);
  EXPECT_TRUE(DataTypeFactory::createUInt32()->equals(deserializedUInt32));

  // serialize and deserialize uint64
  auto serializedUInt64 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createUInt64(), new SerializableDataType());
  auto deserializedUInt64 =
      DataTypeSerializationUtil::deserializeDataType(*serializedUInt64);
  EXPECT_TRUE(DataTypeFactory::createUInt64()->equals(deserializedUInt64));

  // serialize and deserialize float32
  auto serializedFloat32 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createFloat(), new SerializableDataType());
  auto deserializedFloat32 =
      DataTypeSerializationUtil::deserializeDataType(*serializedFloat32);
  EXPECT_TRUE(DataTypeFactory::createFloat()->equals(deserializedFloat32));

  // serialize and deserialize float64
  auto serializedFloat64 = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createDouble(), new SerializableDataType());
  auto deserializedFloat64 =
      DataTypeSerializationUtil::deserializeDataType(*serializedFloat64);
  ...
  auto serializedArray = DataTypeSerializationUtil::serializeDataType(
      DataTypeFactory::createArray(42, DataTypeFactory::createInt8()),
      new SerializableDataType());
  auto deserializedArray =
      DataTypeSerializationUtil::deserializeDataType(*serializedArray);
  EXPECT_TRUE(DataTypeFactory::createArray(42, DataTypeFactory::createInt8())
                  ->equals(deserializedArray));
...
TEST_F(SerializationUtilTest, schemaSerializationTest) {
  ...
  schema->addField(
      "f3", DataTypeFactory::createArray(42, DataTypeFactory::createInt8()));

  auto serializedSchema = SchemaSerializationUtil::serializeSchema(
      schema, new SerializableSchema());
  auto deserializedSchema =
      SchemaSerializationUtil::deserializeSchema(*serializedSchema);
...
TEST_F(SerializationUtilTest, schemaSerializationTestColumnLayout) {
  ...
  auto deserializedSchema =
      SchemaSerializationUtil::deserializeSchema(*serializedSchema);
  EXPECT_TRUE(deserializedSchema->equals(schema));
  EXPECT_EQ(deserializedSchema->getLayoutType(),
            NES::Schema::MemoryLayoutType::COLUMNAR_LAYOUT);
}
...
TEST_F(SerializationUtilTest, sourceDescriptorSerialization) {
...

  {
    ...
    OperatorSerializationUtil::serializeSourceDescriptor(*source,
                                                         sourceDetails);
    auto deserializedSourceDescriptor =
        OperatorSerializationUtil::deserializeSourceDescriptor(sourceDetails);
...
#if ENABLE_OPC_BUILD
  {
    ...
    auto source =
        OPCSourceDescriptor::create(schema, "localhost", nodeId, "", "");
    SerializableOperator_SourceDetails sourceDetails;
    OperatorSerializationUtil::serializeSourceDescriptor(*source,
                                                         sourceDetails);
    auto deserializedSourceDescriptor =
...

  {
    ...
    google::protobuf::util::MessageToJsonString(sourceDetails, &json_string,
                                                options);
    NES_DEBUG("{}", json_string);
  }
...

  {
    ...
    Network::NesPartition nesPartition{SharedQueryId(1), OperatorId(22),
                                       PartitionId(33), SubpartitionId(44)};
    uint16_t version = 55;
    auto uniqueId = 66;
    auto source = Network::NetworkSourceDescriptor::create(
        schema, nesPartition, nodeLocation, NSOURCE_RETRY_WAIT, NSOURCE_RETRIES,
        version, OperatorId(uniqueId));
    SerializableOperator_SourceDetails sourceDetails;
    OperatorSerializationUtil::serializeSourceDescriptor(*source,
                                                         sourceDetails);
    auto deserializedSourceDescriptor =
...

  {
    ...
    SerializableOperator_SourceDetails sourceDetails;
    OperatorSerializationUtil::serializeSourceDescriptor(*tcpSource,
                                                         sourceDetails);
    auto deserializedSourceDescriptor =
        OperatorSerializationUtil::deserializeSourceDescriptor(sourceDetails);
...
TEST_F(SerializationUtilTest, sinkDescriptorSerialization) {
  {
    ...
    auto deserializedSourceDescriptor =
        OperatorSerializationUtil::deserializeSinkDescriptor(sinkDetails);
...
#if ENABLE_OPC_BUILD
  {
    ...
    OperatorSerializationUtil::serializeSinkDescriptor(*sink, sinkDescriptor,
                                                       0);
    auto deserializedSourceDescriptor =
        OperatorSerializationUtil::deserializeSinkDescriptor(sinkDescriptor);
    EXPECT_TRUE(sink->equal(deserializedSourceDescriptor));
  }
#endif
  ...
  {
    auto sink = KafkaSinkDescriptor::create("CSV_FORMAT", "test-topic",
                                            "localhost:9092", 1234);
    SerializableOperator_SinkDetails sinkDetails;
    OperatorSerializationUtil::serializeSinkDescriptor(*sink, sinkDetails, 0);
    auto deserializedSinkDescriptor =
        OperatorSerializationUtil::deserializeSinkDescriptor(sinkDetails);
...

  {
    ...
    auto sink = Network::NetworkSinkDescriptor::create(
        nodeLocation, nesPartition, std::chrono::seconds(1), retryTimes,
        version, numberOfOrigins, uniqueId);
    SerializableOperator_SinkDetails sinkDescriptor;
    OperatorSerializationUtil::serializeSinkDescriptor(*sink, sinkDescriptor,
                                                       0);
    auto deserializedSourceDescriptor =
  ...
  {
    // Testing for all StatisticSinkFormatType, if we can serialize a statistic
    // sink
    constexpr auto numberOfOrigins = 42;  // just some arbitrary number
    for (auto sinkFormatType :
         magic_enum::enum_values<Statistic::StatisticSynopsisType>()) {
      for (auto sinkDataCodec :
           magic_enum::enum_values<Statistic::StatisticDataCodec>()) {
        auto sink = Statistic::StatisticSinkDescriptor::create(
            sinkFormatType, sinkDataCodec, numberOfOrigins);
        SerializableOperator_SinkDetails sinkDescriptor;
        OperatorSerializationUtil::serializeSinkDescriptor(
            *sink, sinkDescriptor, numberOfOrigins);
        auto deserializedSinkDescriptor =
            OperatorSerializationUtil::deserializeSinkDescriptor(
                sinkDescriptor);
        EXPECT_TRUE(sink->equal(deserializedSinkDescriptor));
      }
    }
...
TEST_F(SerializationUtilTest, expressionSerialization) {
  {
    auto fieldAccess =
        FieldAccessExpressionNode::create(DataTypeFactory::createInt32(), "f1");
    auto serializedExpression =
        ExpressionSerializationUtil::serializeExpression(
            fieldAccess, new SerializableExpression());
    auto deserializedExpression =
  ...
  auto f1 =
      FieldAccessExpressionNode::create(DataTypeFactory::createInt32(), "f1");
  auto f2 =
      FieldAccessExpressionNode::create(DataTypeFactory::createInt32(), "f2");
...
TEST_F(SerializationUtilTest, functionExpressionSerialization) {
  auto argument1 = ConstantValueExpressionNode::create(
      DataTypeFactory::createBasicValue(DataTypeFactory::createUInt64(), "1"));
  auto expression =
      FunctionExpression::create(argument1->getStamp(), "ln", {argument1});
  auto* serializedExpression = ExpressionSerializationUtil::serializeExpression(
      expression, new SerializableExpression());
  auto deserializedExpression =
      ExpressionSerializationUtil::deserializeExpression(*serializedExpression);
  EXPECT_TRUE(expression->equal(deserializedExpression));
}

TEST_F(SerializationUtilTest, operatorSerialization) {
  {
    auto javaUDFDescriptor = NES::Catalogs::UDF::JavaUDFDescriptorBuilder::
        createDefaultJavaUDFDescriptor();
    auto javaUDFMap =
        LogicalOperatorFactory::createMapUDFLogicalOperator(javaUDFDescriptor);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(javaUDFMap);
    auto deserializedOperator =
...

  {
    auto javaUDFDescriptor = NES::Catalogs::UDF::JavaUDFDescriptorBuilder::
        createDefaultJavaUDFDescriptor();
    auto javaUDFMap = LogicalOperatorFactory::createFlatMapUDFLogicalOperator(
        javaUDFDescriptor);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(javaUDFMap);
    auto deserializedOperator =
  ...
  {
    auto rename =
        LogicalOperatorFactory::createRenameSourceOperator("newSourceName");
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(rename);
    auto renameOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    auto source = LogicalOperatorFactory::createSourceOperator(
        LogicalSourceDescriptor::create("testStream"));
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(source);
    auto sourceOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
...
#ifdef TFDEF
  {
    auto f1_in = std::make_shared<ExpressionItem>(
        Attribute("f1", NES::BasicType::FLOAT32));
    auto f2_in = std::make_shared<ExpressionItem>(
        Attribute("f2", NES::BasicType::FLOAT32));
    auto f1_out = std::make_shared<ExpressionItem>(
        Attribute("f1_out", NES::BasicType::FLOAT32));
    auto f2_out = std::make_shared<ExpressionItem>(
        Attribute("f2_out", NES::BasicType::FLOAT32));
    auto f3_out = std::make_shared<ExpressionItem>(
        Attribute("f3_out", NES::BasicType::FLOAT32));

    auto inferModel = LogicalOperatorFactory::createInferModelOperator(
        "test.file", {f1_in->getExpressionNode(), f2_in->getExpressionNode()},
        {f1_out->getExpressionNode(), f2_out->getExpressionNode(),
         f3_out->getExpressionNode()});
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(inferModel);
    auto inferModelOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    auto filter =
        LogicalOperatorFactory::createFilterOperator(Attribute("f1") == 10);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(filter);
    auto filterOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    auto map = LogicalOperatorFactory::createMapOperator(
        Attribute("f3") = MOD(2, Attribute("f3")));
    auto serializedOperator = OperatorSerializationUtil::serializeOperator(map);
    auto mapOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
    EXPECT_TRUE(map->equal(mapOperator));
  ...
  {
    auto map = LogicalOperatorFactory::createMapOperator(
        Attribute("f3") = POWER(2, Attribute("f3")));
    auto serializedOperator = OperatorSerializationUtil::serializeOperator(map);
    auto mapOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
    EXPECT_TRUE(map->equal(mapOperator));
  ...
  {
    auto sink = LogicalOperatorFactory::createSinkOperator(
        PrintSinkDescriptor::create());
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(sink);
    auto sinkOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
...

  {
    ...
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(unionOp);
    auto unionOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
...

  {
    auto joinExpression = EqualsExpressionNode::create(
        FieldAccessExpressionNode::create(DataTypeFactory::createInt64(), "key")
            ->as<FieldAccessExpressionNode>(),
        FieldAccessExpressionNode::create(DataTypeFactory::createInt64(), "key")
            ->as<FieldAccessExpressionNode>());

    Join::LogicalJoinDescriptorPtr joinDef =
        Join::LogicalJoinDescriptor::create(
            joinExpression,
            Windowing::TumblingWindow::of(
                Windowing::TimeCharacteristic::createIngestionTime(),
                API::Milliseconds(10)),
            1, 1, NES::Join::LogicalJoinDescriptor::JoinType::INNER_JOIN);

    auto join = LogicalOperatorFactory::createJoinOperator(joinDef)
                    ->as<LogicalJoinOperator>();
    join->setOriginId(OriginId(42));
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(join);
    auto joinOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    auto windowType =
        Windowing::TumblingWindow::of(EventTime(Attribute("ts")), Seconds(10));
    auto timeBasedWindowType = windowType->as<Windowing::TimeBasedWindowType>();
    auto watermarkAssignerDescriptor =
        Windowing::EventTimeWatermarkStrategyDescriptor::create(
            Attribute(timeBasedWindowType->getTimeCharacteristic()
                          ->getField()
                          ->getName())
                .getExpressionNode(),
            API::Milliseconds(0),
    ...
    auto watermarkAssignerOperator =
        LogicalOperatorFactory::createWatermarkAssignerOperator(
            watermarkAssignerDescriptor);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(watermarkAssignerOperator);
    auto deserializedOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
...

  {
    auto windowType =
        Windowing::TumblingWindow::of(EventTime(Attribute("ts")), Seconds(10));
    auto windowDefinition = Windowing::LogicalWindowDescriptor::create(
        {API::Sum(Attribute("test"))->aggregation}, windowType, 0);
    auto tumblingWindow =
        LogicalOperatorFactory::createWindowOperator(windowDefinition);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(tumblingWindow);
    auto deserializedOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    auto windowType = Windowing::SlidingWindow::of(EventTime(Attribute("ts")),
                                                   Seconds(10), Hours(200));
    auto windowDefinition = Windowing::LogicalWindowDescriptor::create(
        {API::Sum(Attribute("test"))->aggregation}, windowType, 0);
    auto slidingWindow =
        LogicalOperatorFactory::createWindowOperator(windowDefinition);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(slidingWindow);
    auto deserializedOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  // threshold window operator
  {
    ...
    auto thresholdWindow =
        LogicalOperatorFactory::createWindowOperator(windowDefinition);
    auto serializedOperator =
        OperatorSerializationUtil::serializeOperator(thresholdWindow);
    auto deserializedOperator =
        OperatorSerializationUtil::deserializeOperator(serializedOperator);
  ...
  {
    // Testing for all possible combinations of sending policies and trigger
    // conditions, if we can serialize a statistic build operator correctly
    ...
    for (auto sendingPolicy : allPossibleSendingPolicies) {
      for (auto triggerCondition : allPossibleTriggerCondition) {
        ...
        auto statisticDescriptor =
            Statistic::CountMinDescriptor::create(metric->getField());
        auto windowType = Windowing::TumblingWindow::of(
            EventTime(Attribute("ts")), Seconds(10));
        auto statisticBuildOperator =
            LogicalOperatorFactory::createStatisticBuildOperator(
                windowType, statisticDescriptor, metric->hash(), sendingPolicy,
                triggerCondition);
        statisticBuildOperator->setStatisticId(getNextStatisticId());
        auto serializedOperator = OperatorSerializationUtil::serializeOperator(
            statisticBuildOperator);
        auto deserializedOperator =
            OperatorSerializationUtil::deserializeOperator(serializedOperator);
...
TEST_F(SerializationUtilTest, queryPlanSerDeSerialization) {
  ...
  map->addChild(filter);
  auto sink =
      LogicalOperatorFactory::createSinkOperator(PrintSinkDescriptor::create());
  sink->addChild(map);

  auto queryPlan = QueryPlan::create(QueryId(1), {sink});

  auto serializedQueryPlan = new SerializableQueryPlan();
  QueryPlanSerializationUtil::serializeQueryPlan(queryPlan,
                                                 serializedQueryPlan);
  auto deserializedQueryPlan =
      QueryPlanSerializationUtil::deserializeQueryPlan(serializedQueryPlan);

  EXPECT_TRUE(deserializedQueryPlan->getQueryId() == queryPlan->getQueryId());
  EXPECT_TRUE(deserializedQueryPlan->getRootOperators()[0]->equal(
      queryPlan->getRootOperators()[0]));
}
...
TEST_F(SerializationUtilTest, queryPlanSerDeSerializationMultipleFilters) {
  ...
  auto filter1 =
      LogicalOperatorFactory::createFilterOperator(Attribute("f1") == 10);
  auto filter2 =
      LogicalOperatorFactory::createFilterOperator(Attribute("f2") == 20);
  auto filter3 =
      LogicalOperatorFactory::createFilterOperator(Attribute("f3") == 30);
  auto sink =
      LogicalOperatorFactory::createSinkOperator(PrintSinkDescriptor::create());
...
TEST_F(SerializationUtilTest, queryPlanWithOPCSerDeSerialization) {
  ...
  map->addChild(filter);
  auto sink = LogicalOperatorFactory::createSinkOperator(
      OPCSinkDescriptor::create("localhost", nodeId, "", ""));
  sink->addChild(map);
  ...
  EXPECT_TRUE(deserializedQueryPlan->getQueryId() == queryPlan->getQueryId());
  EXPECT_TRUE(deserializedQueryPlan->getQuerySubPlanId() ==
...
TEST_F(SerializationUtilTest, queryPlanWithMultipleRootSerDeSerialization) {
  ...
  std::vector<OperatorPtr> actualRootOperators =
      deserializedQueryPlan->getRootOperators();
...
TEST_F(SerializationUtilTest, queryPlanWithMultipleSourceSerDeSerialization) {
  auto source1 = LogicalOperatorFactory::createSourceOperator(
      LogicalSourceDescriptor::create("testStream"));
  auto source2 = LogicalOperatorFactory::createSourceOperator(
      LogicalSourceDescriptor::create("testStream"));
  auto filter =
      LogicalOperatorFactory::createFilterOperator(Attribute("f1") == 10);
  ...
  EXPECT_TRUE(actualRootOperators[0]->getChildren()[0].get() ==
              actualRootOperators[1]->getChildren()[0].get());
  std::vector<NodePtr> sourceOperatorsForRoot1 =
      actualRootOperators[0]->getAllLeafNodes();
  std::vector<NodePtr> sourceOperatorsForRoot2 =
      actualRootOperators[1]->getAllLeafNodes();
...
TEST_F(SerializationUtilTest,
  ...
  auto query =
      Query::from("default_logical").sink(PrintSinkDescriptor::create());
  ...
  // Expect that the root operator from the original and deserialized query plan
  // are the same
  EXPECT_TRUE(deserializedQueryPlan->getRootOperators()[0]->equal(
      queryPlan->getRootOperators()[0]));

  // Expect that the child of the root operator from the original and
  // deserialized query plan are the same i.e., the source operator from
  // original and deserialized query plan are the same
  EXPECT_TRUE(
      deserializedQueryPlan->getRootOperators()[0]->getChildren()[0]->equal(
          queryPlan->getRootOperators()[0]->getChildren()[0]));

  // Expect that the id of operators in the deserialized query plan are
  // different to the original query plan, because the initial IDs are
  // client-generated and NES should provide its own IDs
  EXPECT_FALSE(queryPlan->getRootOperators()[0]->getId() ==
               deserializedQueryPlan->getRootOperators()[0]->getId());
  EXPECT_FALSE(queryPlan->getRootOperators()[0]
                   ->getChildren()[0]
                   ->as<LogicalOperator>()
                   ->getId() == deserializedQueryPlan->getRootOperators()[0]
                                    ->getChildren()[0]
                                    ->as<LogicalOperator>()
                                    ->getId());
}
