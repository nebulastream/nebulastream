...
class GlobalQueryPlanUpdatePhaseTest : public Testing::BaseUnitTest {
  public:
    ...
    void SetUp() override {
        ...
        auto sourceCatalogEntry1 = Catalogs::Source::SourceCatalogEntry::create(physicalSource1, logicalSource1, sourceNode1);

        //Physical source2
        auto physicalSource2 = PhysicalSource::create(DefaultSourceType::create("source2", "physicalSource2"));
        auto sourceCatalogEntry2 = Catalogs::Source::SourceCatalogEntry::create(physicalSource1, logicalSource2, sourceNode2);
...
TEST_F(GlobalQueryPlanUpdatePhaseTest, queryMergerPhaseForSingleComplexQueryPlan) {
    ...
    auto sourceCatalogEntry1 = Catalogs::Source::SourceCatalogEntry::create(physicalSource, logicalSource, node);
