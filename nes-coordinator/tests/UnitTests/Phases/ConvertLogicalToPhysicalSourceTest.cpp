...
TEST_F(ConvertLogicalToPhysicalSourceTest, testConvertingCsvFileLogicalToPhysicalSource)
{
    ...
    DataSourcePtr csvFileSource = ConvertLogicalToPhysicalSource::createDataSource(
        OperatorId(1), INVALID_ORIGIN_ID, INVALID_STATISTIC_ID, sourceDescriptor, engine, 12);
...
TEST_F(ConvertLogicalToPhysicalSourceTest, testConvertingBinaryFileLogicalToPhysicalSource)
{
    ...
    DataSourcePtr binaryFileSource = ConvertLogicalToPhysicalSource::createDataSource(
        OperatorId(1), INVALID_ORIGIN_ID, INVALID_STATISTIC_ID, sourceDescriptor, engine, 12);
...
TEST_F(ConvertLogicalToPhysicalSourceTest, testConvertingZMQLogicalToPhysicalSource)
{
    ...
    DataSourcePtr zqmSource
        = ConvertLogicalToPhysicalSource::createDataSource(OperatorId(1), OriginId(0), INVALID_STATISTIC_ID, sourceDescriptor, engine, 12);
...
TEST_F(ConvertLogicalToPhysicalSourceTest, testConvertingNetworkLogicalToPhysicalSource)
{
    ...
    auto uniqueId = 55;
    SourceDescriptorPtr sourceDescriptor = Network::NetworkSourceDescriptor::create(
        schema, nesPartition, nodeLocation, NSOURCE_RETRY_WAIT, NSOURCE_RETRIES, version, OperatorId(uniqueId));
    DataSourcePtr networkSource = ConvertLogicalToPhysicalSource::createDataSource(
        OperatorId(1), INVALID_ORIGIN_ID, INVALID_STATISTIC_ID, sourceDescriptor, engine, 12);
