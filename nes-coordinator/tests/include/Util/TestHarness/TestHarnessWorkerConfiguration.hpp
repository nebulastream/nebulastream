...
using TestHarnessWorkerConfigurationPtr =
    std::shared_ptr<TestHarnessWorkerConfiguration>;
...
public:
  ...
  static TestHarnessWorkerConfigurationPtr
  create(WorkerConfigurationPtr workerConfiguration, WorkerId workerId);

  static TestHarnessWorkerConfigurationPtr
  create(WorkerConfigurationPtr workerConfiguration,
