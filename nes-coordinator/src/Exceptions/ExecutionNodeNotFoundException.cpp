...
ExecutionNodeNotFoundException::ExecutionNodeNotFoundException(const std::string& message, uint64_t id)
...
uint64_t ExecutionNodeNotFoundException::getExecutionNodeId() const { return id; }
}// namespace NES::Exceptions
