...
Optimizer::GlobalExecutionPlanPtr StorageHandler::getGlobalExecutionPlanHandle(RequestId)
{
    NES_NOT_IMPLEMENTED();
}
...
Catalogs::Source::SourceCatalogPtr StorageHandler::getSourceCatalogHandle(RequestId)
{
    NES_NOT_IMPLEMENTED();
}
...
Configurations::CoordinatorConfigurationPtr StorageHandler::getCoordinatorConfiguration(RequestId)
{
    NES_NOT_IMPLEMENTED();
}

Statistic::StatisticProbeHandlerPtr StorageHandler::getStatisticProbeHandler(RequestId)
{
    NES_NOT_IMPLEMENTED();
}
