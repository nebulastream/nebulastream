...
Catalogs::UDF::UDFCatalogPtr TwoPhaseLockingStorageHandler::getUDFCatalogHandle(
    const RequestId requestId) {
...
TicketId TwoPhaseLockingStorageHandler::getCurrentTicket(
    ResourceType resource) {
  return getHolder(resource).currentTicket;
}

TicketId TwoPhaseLockingStorageHandler::getNextAvailableTicket(
    ResourceType resource) {
