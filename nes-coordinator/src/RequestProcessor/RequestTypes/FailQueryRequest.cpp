...
FailQueryRequestPtr
FailQueryRequest::create(SharedQueryId sharedQueryId,
...
FailQueryRequest::rollBack(std::exception_ptr ex, const StorageHandlerPtr &) {
...
std::vector<AbstractRequestPtr>
FailQueryRequest::executeRequestLogic(const StorageHandlerPtr &storageHandle) {
