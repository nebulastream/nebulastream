...
NES::RequestProcessor::RemoveLogicalSourceEvent::RemoveLogicalSourceEvent(std::string logicalSourceName)
    : logicalSourceName(logicalSourceName) {}

std::string NES::RequestProcessor::RemoveLogicalSourceEvent::getLogicalSourceName() const {
