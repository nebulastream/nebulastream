...
Status CoordinatorRPCServer::RegisterLogicalSource(
    ServerContext *, const RegisterLogicalSourceRequest * request, RegisterLogicalSourceReply * reply)
{
...
Status
CoordinatorRPCServer::RequestSoftStop(::grpc::ServerContext *, const ::RequestSoftStopMessage * request, ::StopRequestReply * response)
{
    auto sharedQueryId = SharedQueryId(request->queryid());
    auto decomposedQueryPlanId = DecomposedQueryPlanId(request->subqueryid());
