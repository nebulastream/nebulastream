...
bool WorkerRPCClient::registerQuery(
  ...
  NES_DEBUG(
      "WorkerRPCClient::registerQuery address={} sharedQueryId={} "
...
void WorkerRPCClient::registerQueryAsync(
  ...
  NES_DEBUG(
      "WorkerRPCClient::registerQueryAsync address={} sharedQueryId={} "
      "decomposedQueryPlanId = {}",
      address, sharedQueryId, decomposedQueryPlanId);
...
bool WorkerRPCClient::startQuery(const std::string& address,
                                 ...
                                 DecomposedQueryPlanId decomposedQueryPlanId) {
  NES_DEBUG(
      "WorkerRPCClient::startQuery address={} shared queryId={} decomposed "
      "query plan {}",
      address, sharedQueryId, decomposedQueryPlanId);
...
void WorkerRPCClient::startQueryAsync(
  ...
  NES_DEBUG(
      "WorkerRPCClient::startQueryAsync address={} shared queryId={} "
      "decomposed queryId={}",
      address, sharedQueryId, decomposedQueryPlanId);
...
Spatial::DataTypes::Experimental::Waypoint WorkerRPCClient::getWaypoint(
    const std::string& address) {
