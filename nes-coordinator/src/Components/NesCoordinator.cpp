...
extern void
Exceptions::installGlobalErrorListener(std::shared_ptr<ErrorListener> const &);
...
NesCoordinator::getStatisticProbeHandler() const {
...
std::vector<Runtime::QueryStatisticsPtr>
NesCoordinator::getQueryStatistics(QueryId queryId) {
...
NesCoordinator::getGlobalExecutionPlan() const {
