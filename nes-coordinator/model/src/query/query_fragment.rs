...
impl ActiveModelBehavior for ActiveModel {
        ...
        C: ConnectionTrait,
    {
        ...
        match state {
            QueryFragmentState::Pending | QueryFragmentState::Registered => {}
...
impl ActiveModel {
    pub fn apply_transition(&mut self, transition: QueryFragmentTransition) {
        match transition {
            ...
            QueryFragmentTransition::Registered => {
                self.current_state = Set(QueryFragmentState::Registered);
            }
...
#[cfg_attr(any(test, feature = "testing"), derive(DeriveArbitrary))]
#[derive(
...
impl TryFrom<i32> for QueryFragmentState {
    ...
    fn try_from(value: i32) -> Result<Self, Self::Error> {
        match value {
            0 => Ok(QueryFragmentState::Registered),
...
mod tests {
    ...
    async fn stop_hooks(mut req: CreateQueryWithRefs) {
        ...
        update.current_state = Set(QueryFragmentState::Registered);
