...
impl FragmentTransition {
    ...
    pub fn state(&self) -> FragmentState {
        match self {
            Self::Pending => FragmentState::Pending,
            Self::Registered => FragmentState::Registered,
            Self::Running { .. } => FragmentState::Running,
            Self::Completed { .. } => FragmentState::Completed,
            Self::Stopped { .. } => FragmentState::Stopped,
            Self::Failed { .. } => FragmentState::Failed,
        }
    }
}
