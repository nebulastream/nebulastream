...
use crate::config::{RPC_ATTEMPT_TIMEOUT, RPC_MAX_RETRIES, RPC_RETRY_INIT, RPC_TOTAL_TIMEOUT};
...
const fn query_id(id: i64) -> worker_rpc_service::nes::SerializableQueryId {
...
impl Client for QueryFragmentClient {
    ...
    async fn register(&self, id: QueryFragmentId, plan: &[u8]) -> Outcome {
        ...
        match self
            ...
            .await
        {
            Ok(_) => Outcome::Transition(QueryFragmentTransition::Registered),
