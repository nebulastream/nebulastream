...
impl Retryable for WorkerError {
    fn retryable(&self) -> bool {
        match self {
            ...
            Self::ClientError(WorkerTaskError::Embedded { .. }) => false,
...
impl From<WorkerError> for FragmentError {
    fn from(e: WorkerError) -> Self {
        match e {
            ...
            WorkerError::ClientError(WorkerTaskError::Embedded {
                code, msg, trace,
            }) => FragmentError::WorkerInternal { code: code as u64, msg, trace },
        }
    }
}
