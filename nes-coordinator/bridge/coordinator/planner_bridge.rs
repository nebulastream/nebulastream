...
pub(crate) struct FfiSqlPlanner {
    ...
    /// Host substituted for statements that omit their HOST clause. Empty means such
    /// statements are rejected; a non-empty address is used for embedded deployments.
