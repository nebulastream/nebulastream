...
/// The build report of the worker this binary would start.
/// Answered without starting one, because every worker embedded here is the build this binary was linked with.
