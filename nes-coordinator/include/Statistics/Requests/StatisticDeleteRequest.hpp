...
class StatisticDeleteRequest : public StatisticRequest {
  public:
    /**
     * @brief the constructor of the StatisticDeleteRequest that contains all necessary information to stop a statistic query and delete the according StatisticCollectorFormats
