...
class NesCEPListener : public antlr4::tree::ParseTreeListener {
 public:
  ...
  virtual void enterTimeConstraints(
      NesCEPParser::TimeConstraintsContext* ctx) = 0;
  ...
  virtual void enterOutputExpression(
      NesCEPParser::OutputExpressionContext* ctx) = 0;
  ...
  virtual void enterConsecutiveOption(
      NesCEPParser::ConsecutiveOptionContext* ctx) = 0;
  ...
  virtual void enterLogicalExpression(
      NesCEPParser::LogicalExpressionContext* ctx) = 0;
  virtual void exitLogicalExpression(
      NesCEPParser::LogicalExpressionContext* ctx) = 0;

  virtual void enterPredicateExpression(
      NesCEPParser::PredicateExpressionContext* ctx) = 0;
  ...
  virtual void enterIsNullPredicate(
      NesCEPParser::IsNullPredicateContext* ctx) = 0;
  virtual void exitIsNullPredicate(
      NesCEPParser::IsNullPredicateContext* ctx) = 0;

  virtual void enterUnaryExpressionAtom(
      NesCEPParser::UnaryExpressionAtomContext* ctx) = 0;
  ...
  virtual void enterComparisonOperator(
      NesCEPParser::ComparisonOperatorContext* ctx) = 0;
  virtual void exitComparisonOperator(
      NesCEPParser::ComparisonOperatorContext* ctx) = 0;

  virtual void enterLogicalOperator(
      NesCEPParser::LogicalOperatorContext* ctx) = 0;
