...
public:
  ...
  virtual void enterCompositeEventExpressions(
      NesCEPParser::CompositeEventExpressionsContext *ctx) = 0;
  ...
  virtual void
  enterTimeConstraints(NesCEPParser::TimeConstraintsContext *ctx) = 0;
  virtual void
  exitTimeConstraints(NesCEPParser::TimeConstraintsContext *ctx) = 0;
  ...
  virtual void
  enterOutputExpression(NesCEPParser::OutputExpressionContext *ctx) = 0;
  virtual void
  exitOutputExpression(NesCEPParser::OutputExpressionContext *ctx) = 0;
  ...
  virtual void
  enterConsecutiveOption(NesCEPParser::ConsecutiveOptionContext *ctx) = 0;
  virtual void
  exitConsecutiveOption(NesCEPParser::ConsecutiveOptionContext *ctx) = 0;
  ...
  virtual void
  enterLogicalExpression(NesCEPParser::LogicalExpressionContext *ctx) = 0;
  virtual void
  exitLogicalExpression(NesCEPParser::LogicalExpressionContext *ctx) = 0;

  virtual void
  enterPredicateExpression(NesCEPParser::PredicateExpressionContext *ctx) = 0;
  virtual void
  exitPredicateExpression(NesCEPParser::PredicateExpressionContext *ctx) = 0;

  virtual void enterExpressionAtomPredicate(
      NesCEPParser::ExpressionAtomPredicateContext *ctx) = 0;
  ...
  virtual void enterBinaryComparisonPredicate(
      NesCEPParser::BinaryComparasionPredicateContext *ctx) = 0;
  virtual void exitBinaryComparisonPredicate(
      NesCEPParser::BinaryComparasionPredicateContext *ctx) = 0;

  virtual void
  enterIsNullPredicate(NesCEPParser::IsNullPredicateContext *ctx) = 0;
  virtual void
  exitIsNullPredicate(NesCEPParser::IsNullPredicateContext *ctx) = 0;

  virtual void
  enterUnaryExpressionAtom(NesCEPParser::UnaryExpressionAtomContext *ctx) = 0;
  virtual void
  exitUnaryExpressionAtom(NesCEPParser::UnaryExpressionAtomContext *ctx) = 0;
  ...
  virtual void enterConstantExpressionAtom(
      NesCEPParser::ConstantExpressionAtomContext *ctx) = 0;
  virtual void exitConstantExpressionAtom(
      NesCEPParser::ConstantExpressionAtomContext *ctx) = 0;

  virtual void
  enterBinaryExpressionAtom(NesCEPParser::BinaryExpressionAtomContext *ctx) = 0;
  virtual void
  exitBinaryExpressionAtom(NesCEPParser::BinaryExpressionAtomContext *ctx) = 0;

  virtual void
  enterBitExpressionAtom(NesCEPParser::BitExpressionAtomContext *ctx) = 0;
  virtual void
  exitBitExpressionAtom(NesCEPParser::BitExpressionAtomContext *ctx) = 0;

  virtual void
  enterNestedExpressionAtom(NesCEPParser::NestedExpressionAtomContext *ctx) = 0;
  virtual void
  exitNestedExpressionAtom(NesCEPParser::NestedExpressionAtomContext *ctx) = 0;

  virtual void
  enterMathExpressionAtom(NesCEPParser::MathExpressionAtomContext *ctx) = 0;
  virtual void
  exitMathExpressionAtom(NesCEPParser::MathExpressionAtomContext *ctx) = 0;

  virtual void
  enterEventAttribute(NesCEPParser::EventAttributeContext *ctx) = 0;
  virtual void exitEventAttribute(NesCEPParser::EventAttributeContext *ctx) = 0;

  virtual void
  enterEventIteration(NesCEPParser::EventIterationContext *ctx) = 0;
  virtual void exitEventIteration(NesCEPParser::EventIterationContext *ctx) = 0;

  virtual void
  enterMathExpression(NesCEPParser::MathExpressionContext *ctx) = 0;
  ...
  virtual void
  enterComparisonOperator(NesCEPParser::ComparisonOperatorContext *ctx) = 0;
  virtual void
  exitComparisonOperator(NesCEPParser::ComparisonOperatorContext *ctx) = 0;

  virtual void
  enterLogicalOperator(NesCEPParser::LogicalOperatorContext *ctx) = 0;
  virtual void
  exitLogicalOperator(NesCEPParser::LogicalOperatorContext *ctx) = 0;
