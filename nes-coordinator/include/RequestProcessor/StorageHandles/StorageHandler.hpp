...
public:
   ...
   */
  virtual Optimizer::GlobalExecutionPlanPtr
  getGlobalExecutionPlanHandle(RequestId requestId);
   ...
   */
  virtual Catalogs::Source::SourceCatalogPtr
  getSourceCatalogHandle(RequestId requestId);
   ...
   */
  virtual Statistic::StatisticProbeHandlerPtr
  getStatisticProbeHandler(RequestId requestId);
