...
struct ExplainResponse : public AbstractRequestResponse {
  explicit ExplainResponse(nlohmann::json jsonResponse)
...
protected:
   ...
   * @param storageHandler: a handle to access the coordinators data structures
...
private:
   ...
   */
  void
  addOpenCLAccelerationCode(const std::string &accelerationServiceURL,
...
private:
  ...
  const std::string DEVICE_INFO_AVAILABLE_PROCESSORS_KEY =
      "availableProcessors";
};
} // namespace RequestProcessor
} // namespace NES
