...
class SourceCatalogController : public oatpp::web::server::api::ApiController {
 public:
   ...
   * @return
   */
  static std::shared_ptr<SourceCatalogController> create(
  ...
  ENDPOINT("GET", "/allPhysicalSource", getPhysicalSource,
    ...
    try {
      ...
      NES_ERROR(
          "SourceCatalogController: get allPhysicalSource: Exception occurred "
          "while building the query plan for user "
          "request.");
  ...
  ENDPOINT("GET", "/schema", getSchema,
    ...
    try {
      ...
      NES_ERROR(
          "SourceCatalogController: get schema: Exception occurred while "
  ...
  ENDPOINT("POST", "/addLogicalSource", addLogicalSource,
    ...
    NES_DEBUG(
        "SourceCatalogController: addLogicalSource: REST received request to "
        "add new Logical Source.");
    try {
      ...
      NES_DEBUG(
          "SourceCatalogController: addLogicalSource: Try to add new Logical "
          "Source {} and {}",
      ...
      NES_DEBUG(
          "SourceCatalogController: addLogicalSource: Successfully added new "
          "logical Source ? {}",
          added);
      ...
      NES_ERROR(
          "SourceCatalogController: addLogicalSource: Exception occurred while "
          "trying to add new "
          "logical source {}",
          exc.what());
      return errorHandler->handleError(Status::CODE_500, exc.what());
  ...
  ENDPOINT("POST", "/addLogicalSource-ex", addLogicalSourceEx,
    ...
    try {
      ...
      if (!protobufMessage->ParseFromArray(req.data(), req.size())) {
        NES_DEBUG(
            "SourceCatalogController: handlePost -addLogicalSource: invalid "
            "Protobuf message");
      ...
      NES_DEBUG(
          "SourceCatalogController: handlePost -addLogicalSource: Start trying "
          "to add new logical source");
      ...
      NES_DEBUG(
          "SourceCatalogController: handlePost -addLogicalSource: Successfully "
          "added new logical Source ? {}",
          added);
      ...
      NES_ERROR(
          "SourceCatalogController: addLogicalSource-ex: Exception occurred "
  ...
  ENDPOINT("POST", "/updateLogicalSource", updateLogicalSource,
           BODY_STRING(String, request)) {
    NES_DEBUG(
        "SourceCatalogController: updateLogicalSource: REST received request "
        "to update the given Logical Source.");
    try {
      std::string req = request.getValue("{}");
      // check if json is valid
      if (!nlohmann::json::accept(req)) {
      ...
      auto schemaString = reqJson["schema"];
      NES_DEBUG(
          "SourceCatalogController: updateLogicalSource: Try to update  "
      ...
      if (updated) {
        ...
        NES_DEBUG(
            "SourceCatalogController: updateLogicalSource: unable to find "
            "given source");
        return errorHandler->handleError(Status::CODE_400,
      ...
      NES_ERROR(
          "SourceCatalogController: updateLogicalSource: Exception occurred "
          "while updating "
          "Logical Source {}",
          exc.what());
      return errorHandler->handleError(Status::CODE_500, exc.what());
  ...
  ENDPOINT("POST", "/updateLogicalSource-ex", updateLogicalSourceEx,
    ...
    try {
      ...
      if (!protobufMessage->ParseFromArray(req.data(), req.size())) {
        NES_DEBUG(
            "SourceCatalogController: handlePost -updateLogicalSource-ex: "
      ...
      NES_DEBUG(
          "SourceCatalogController: handlePost -updateLogicalSource: Start "
          "trying to update logical source");
      // decode protobuf message into c++ obj repr
      auto deserializedSchema =
          SchemaSerializationUtil::deserializeSchema(protobufMessage->schema());
      auto sourceName = protobufMessage->sourcename();
  ...
  ENDPOINT("DELETE", "/deleteLogicalSource", deleteLogicalSource,
           QUERY(String, logicalSourceName, "logicalSourceName")) {
    NES_DEBUG(
        "SourceCatalogController: deleteLogicalSource: REST received request "
        "to delete the given Logical Source.");
    try {
      bool deleted =
          sourceCatalogService->unregisterLogicalSource(logicalSourceName);
      NES_DEBUG(
          "SourceCatalogController: deleteLogicalSource: Successfully deleted "
          "the given logical Source: {}",
          deleted);
      // Prepare the response
      if (deleted) {
        nlohmann::json success;
        ...
        NES_DEBUG(
            "SourceCatalogController: deleteLogicalSource: unable to find "
            "given source");
        return errorHandler->handleError(
            Status::CODE_400,
      ...
      NES_ERROR(
          "SourceCatalogController: deleteLogicalSource: Exception occurred "
          "while building the query plan for user "
          "request.");
      return errorHandler->handleError(Status::CODE_500, exc.what());
    } catch (...) {
  ...
  ENDPOINT("POST", "/addSourceStatistics", addSourceStatistics,
           BODY_STRING(String, request)) {
    NES_DEBUG(
        "SourceCatalogController: addSourceStatistics: REST received request "
        "to add source statistics.");
    try {
      std::string req = request.getValue("{}");
      // check if json is valid
      if (!nlohmann::json::accept(req)) {
