...
public:
     ...
     * @return success
     */
    Status RegisterLogicalSource(
        ServerContext * context, const RegisterLogicalSourceRequest * request, RegisterLogicalSourceReply * reply) override;
     ...
     */
    Status
    RequestSoftStop(::grpc::ServerContext * context, const ::RequestSoftStopMessage * request, ::StopRequestReply * response) override;
