...
*/
#ifndef NES_COORDINATOR_INCLUDE_EXCEPTIONS_INVALIDCOORDINATEFORMATEXCEPTION_HPP_
...
/**
 * @brief an exception indicating that the entered string is not of the format
 * "<double>, <double>"
 */
