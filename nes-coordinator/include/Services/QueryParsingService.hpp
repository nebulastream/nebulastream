...
public:
  explicit QueryParsingService(
      std::shared_ptr<Compiler::JITCompiler> jitCompiler);
  static std::shared_ptr<QueryParsingService>
      create(std::shared_ptr<Compiler::JITCompiler>);

  /**
   *  @brief this function **executes** the C++ code provided by the user and
   * returns an Query Object
   *  @caution: this function will replace the source name "xyz" provided by the
   * user with the source generated by the system and fetched from the catalog
  ...
  /**
   *  @brief this function parses the declarative pattern string provided by the
   * user and returns an Query Object
   *  @caution: this function will replace the source name "xyz" provided by the
   * user with the source generated by the system and fetched from the catalog
   *  @param query as a string
   *  @return Smart pointer to InputQuery object of the query
  ...
  /**
   *  @brief this function **executes** the code provided by the user and
   * returns an schema Object
   *  @param query as a string
   *  @return Smart pointer to InputQuery object of the query
   *
   */
