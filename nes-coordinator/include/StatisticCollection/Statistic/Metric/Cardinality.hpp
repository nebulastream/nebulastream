...
class Cardinality : public Metric {
  public:
     ...
     * @return MetricPtr
     */
    static MetricPtr create(const std::string& fieldName);
    ...
    /**
     * @brief Getter for the fieldName
     * @return Const reference std::string
     */
  ...
  private:
     ...
     * @param fieldName
     */
    explicit Cardinality(const std::string& fieldName);
...
#endif//NES_NES_COORDINATOR_INCLUDE_STATISTICCOLLECTION_STATISTIC_CARDINALITY_HPP_
