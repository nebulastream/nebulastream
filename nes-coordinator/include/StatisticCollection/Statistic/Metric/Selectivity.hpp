...
class Selectivity : public Metric {
  public:
     ...
     * @return MetricPtr
     */
    static MetricPtr create(const ExpressionNodePtr& expressionNode);
    ...
    /**
     * @brief Gets the ExpressionNode
     * @return Const reference to ExpressionNodePtr
     */
    const ExpressionNodePtr& getExpressionNode() const;
  ...
  private:
     ...
     * @param expressionNode
     */
    explicit Selectivity(const ExpressionNodePtr& expressionNode);
