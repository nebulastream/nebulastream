...
using AbstractStatisticCachePtr = std::shared_ptr<AbstractStatisticCache>;
...
#endif//NES_NES_COORDINATOR_INCLUDE_STATISTICCOLLECTION_STATISTICCACHE_ABSTRACTSTATISTICCACHE_HPP_
