...
struct SwizzleClogConfig {
    ...
    #[serde(default = "default_swizzle_rate")]
    swizzle_rate: f64,
    #[serde(default)]
...
impl SwizzleClogWorkload {
    ...
    pub fn from_options(options: &HashMap<String, toml::Value>) -> Self {
        let c: SwizzleClogConfig = parse_required(options);
        Self {
    ...
    pub fn for_injection() -> Self {
        Self {
            ...
            swizzle_rate: config::SWIZZLE_RATE,
...
inventory::submit! {
    FailureInjectorFactory {
        ...
        create: || Box::new(SwizzleClogWorkload::for_injection()),
    }
}
