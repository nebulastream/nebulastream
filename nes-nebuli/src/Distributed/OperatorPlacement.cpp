...
OperatorPlacer::OperatorPlacer(const TopologyGraph& topology, WorkerCatalog& nodeCatalog)
    : topology{topology}, nodeCatalog{nodeCatalog}
{
}

OperatorPlacer OperatorPlacer::from(const TopologyGraph& topology, WorkerCatalog& nodeCatalog)
{
