...
int main(int argc, char** argv)
{
    CPPTRACE_TRY
    {
        ...
        else
        {
            ...
            auto singleNodeWorkerConfig = NES::loadConfiguration<NES::SingleNodeWorkerConfiguration>(
            ...
            #else
            NES_ERROR("No server address given. Please use the -s option to specify the server address or use nebuli-embedded to start a single node worker.")
            return 1;
            #endif
        }
        bool handled = false;
