...
BottomUpOperatorPlacer::BottomUpOperatorPlacer(QueryPlanningContext& context) : context{context}
{
}
...
PlanStage::PlacedLogicalPlan BottomUpOperatorPlacer::place(PlanStage::OptimizedLogicalPlan&& inputPlan) &&
{
    ...
    const auto placement = solvePlacement(inputPlan.plan, topology, capacity);
