...
std::unordered_map<NES::WorkerId, std::vector<NES::Exception>> NES::DistributedQueryStatus::getExceptions() const
{
    std::unordered_map<WorkerId, std::vector<Exception>> exceptions;
...
NES::DistributedQuery::DistributedQuery(std::unordered_map<WorkerId, std::vector<QueryId>> localQueries)
