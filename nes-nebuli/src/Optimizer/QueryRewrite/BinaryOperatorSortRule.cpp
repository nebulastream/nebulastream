...
std::shared_ptr<QueryPlan> BinaryOperatorSortRule::apply(std::shared_ptr<QueryPlan> queryPlan)
{
    ...
    auto joinOperators = queryPlan->getOperatorByType<JoinLogicalOperator>();
...
void BinaryOperatorSortRule::sortChildren(const std::shared_ptr<BinaryLogicalOperator>& binaryOperator)
{
