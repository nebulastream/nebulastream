...
void FilterPushDownRule::pushDownFilter(
    std::shared_ptr<SelectionLogicalOperator> filterOperator,
    std::shared_ptr<LogicalOperator> curOperator,
    std::shared_ptr<LogicalOperator> parOperator)
...
void FilterPushDownRule::pushFilterBelowJoin(
    std::shared_ptr<SelectionLogicalOperator> filterOperator,
    std::shared_ptr<JoinLogicalOperator> joinOperator,
    std::shared_ptr<LogicalOperator> parentOperator)
{
...
bool FilterPushDownRule::pushFilterBelowJoinSpecialCase(
    std::shared_ptr<SelectionLogicalOperator> filterOperator, std::shared_ptr<JoinLogicalOperator> joinOperator)
{
    std::vector<std::string> predicateFields = filterOperator->getFieldNamesUsedByFilterPredicate();
...
void FilterPushDownRule::pushFilterBelowMap(
    std::shared_ptr<SelectionLogicalOperator> filterOperator, std::shared_ptr<MapLogicalOperator> mapOperator)
{
...
void FilterPushDownRule::pushFilterBelowUnion(
    std::shared_ptr<SelectionLogicalOperator> filterOperator, std::shared_ptr<LogicalOperator> unionOperator)
{
...
void FilterPushDownRule::pushFilterBelowWindowAggregation(
    std::shared_ptr<SelectionLogicalOperator> filterOperator,
    std::shared_ptr<LogicalOperator> windowOperator,
    std::shared_ptr<LogicalOperator> parOperator)
{
...
void FilterPushDownRule::pushBelowProjection(
    std::shared_ptr<SelectionLogicalOperator> filterOperator, std::shared_ptr<LogicalOperator> projectionOperator)
{
