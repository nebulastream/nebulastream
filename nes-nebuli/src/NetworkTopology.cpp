...
{
    const auto paths1 = findPaths(dest, src1, reverse(direction)); /// NOLINT(readability-suspicious-call-argument). Intentionally reversed
    const auto paths2 = findPaths(dest, src2, reverse(direction)); /// NOLINT(readability-suspicious-call-argument)
