...
NES::GRPCClient::GRPCClient(std::shared_ptr<grpc::Channel> channel) : stub(WorkerRPCService::NewStub(channel))
{
}

size_t NES::GRPCClient::registerQuery(const NES::DecomposedQueryPlan& plan) const
{
...
void NES::GRPCClient::stop(size_t queryId) const
{
    grpc::ClientContext context;
...
void NES::GRPCClient::status(size_t queryId) const
{
    grpc::ClientContext context;
...
void NES::GRPCClient::start(size_t queryId) const
{
    grpc::ClientContext context;
...
void NES::GRPCClient::unregister(size_t queryId) const
{
    grpc::ClientContext context;
