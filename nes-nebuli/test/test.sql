...
CREATE SINK someSink(ENDLESS.TS UINT64) TYPE File SET('/home/ls/dima/nebulastream-public/cmake-build-debug/nes-systests/working-dir/out.csv' as `SINK`.FILE_PATH, 'CSV' as `SINK`.INPUT_FORMAT);
SHOW QUERIES;
