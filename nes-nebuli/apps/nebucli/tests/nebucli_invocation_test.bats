...
# TODO #????: Improve error reporting for lost local queries
...
# request to find that local query id 1 is not registered on worker-1, currently this is falsely reported as a ConnectionError.
