...
@test "basic test" {
  ...
  assert_json_equal '[{"query_id":1}]' "${lines[4]}"
  assert_json_contains '[{"global":1,"query_status":"Running"}, {"global": 1, "local": 1, "query_status": "Running"}]' "${lines[5]}"
  assert_json_equal '[{"query_id":1}]' "${lines[6]}"
  assert_json_contains '[{"global":1,"query_status":"Stopped"}, {"global": 1, "local": 1, "query_status": "Stopped"}]' "${lines[7]}"
}
