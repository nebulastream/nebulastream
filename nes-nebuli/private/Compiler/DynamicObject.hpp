...
*/
#ifndef NES_NEBULI_PRIVATE_COMPILER_DYNAMICOBJECT_HPP_
#define NES_NEBULI_PRIVATE_COMPILER_DYNAMICOBJECT_HPP_
#include <string>
#include <utility>
...
#endif /// NES_NEBULI_PRIVATE_COMPILER_DYNAMICOBJECT_HPP_
