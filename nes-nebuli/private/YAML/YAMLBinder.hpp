...
public:
    explicit YAMLBinder(std::shared_ptr<SourceCatalog> sourceCatalog, std::shared_ptr<SinkCatalog> sinkCatalog, std::shared_ptr<Nebuli::Inference::ModelCatalog> modelCatalog)
