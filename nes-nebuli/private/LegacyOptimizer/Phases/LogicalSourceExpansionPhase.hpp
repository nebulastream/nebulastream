...
class LogicalSourceExpansionPhase
{
public:
    LogicalSourceExpansionPhase() = delete;
    ~LogicalSourceExpansionPhase() = default;
    LogicalSourceExpansionPhase(const LogicalSourceExpansionPhase&&) = delete;
    LogicalSourceExpansionPhase& operator=(const LogicalSourceExpansionPhase&&) = delete;
    LogicalSourceExpansionPhase(const LogicalSourceExpansionPhase&) = delete;
    LogicalSourceExpansionPhase& operator=(const LogicalSourceExpansionPhase&) = delete;

    static LogicalPlan apply(LogicalPlan&& inputPlan, std::shared_ptr<const SourceCatalog> sourceCatalog);
};
}
