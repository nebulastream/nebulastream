...
{
public:
    OriginIdInferencePhase() = delete;
    ~OriginIdInferencePhase() = default;
    OriginIdInferencePhase(const OriginIdInferencePhase&) = delete;
    OriginIdInferencePhase(OriginIdInferencePhase&&) = delete;
    OriginIdInferencePhase& operator=(const OriginIdInferencePhase&) = delete;
    OriginIdInferencePhase& operator=(OriginIdInferencePhase&&) = delete;
    OriginIdInferencePhase(const OriginIdInferencePhase&&) = delete;
