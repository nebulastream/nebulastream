...
public:
  ...
  virtual void enterThresholdBasedWindow(NebulaSQLParser::ThresholdBasedWindowContext *ctx) = 0;
  virtual void exitThresholdBasedWindow(NebulaSQLParser::ThresholdBasedWindowContext *ctx) = 0;
  ...
  virtual void enterThresholdWindow(NebulaSQLParser::ThresholdWindowContext *ctx) = 0;
  virtual void exitThresholdWindow(NebulaSQLParser::ThresholdWindowContext *ctx) = 0;

  virtual void enterConditionParameter(NebulaSQLParser::ConditionParameterContext *ctx) = 0;
  virtual void exitConditionParameter(NebulaSQLParser::ConditionParameterContext *ctx) = 0;

  virtual void enterThresholdMinSizeParameter(NebulaSQLParser::ThresholdMinSizeParameterContext *ctx) = 0;
  virtual void exitThresholdMinSizeParameter(NebulaSQLParser::ThresholdMinSizeParameterContext *ctx) = 0;
