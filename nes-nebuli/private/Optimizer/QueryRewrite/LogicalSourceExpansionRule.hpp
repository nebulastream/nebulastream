...
private:
    ...
    void removeConnectedBlockingOperators(const std::shared_ptr<Operator>& operatorNode);
    ...
    static void addBlockingDownStreamOperator(const std::shared_ptr<Operator>& operatorNode, OperatorId downStreamOperatorId);
    ...
    static bool isBlockingOperator(const std::shared_ptr<Operator>& operatorNode);
