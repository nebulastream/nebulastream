...
private:
    ...
    void pushDownFilter(
        ...
        std::shared_ptr<Operator> curOperator,
        std::shared_ptr<Operator> parOperator);
    ...
    static void insertFilterIntoNewPosition(
        std::shared_ptr<SelectionLogicalOperator> filterOperator,
        std::shared_ptr<Operator> childOperator,
        std::shared_ptr<Operator> parOperator);
    ...
    void pushFilterBelowJoin(
        ...
        std::shared_ptr<Operator> parentOperator);
    ...
    void pushFilterBelowWindowAggregation(
        std::shared_ptr<SelectionLogicalOperator> filterOperator,
        std::shared_ptr<Operator> windowOperator,
        std::shared_ptr<Operator> parOperator);
    ...
    static void renameFilterAttributesByLogicalFunctions(
        ...
        const std::vector<std::shared_ptr<LogicalFunction>>& expressionNodes);
