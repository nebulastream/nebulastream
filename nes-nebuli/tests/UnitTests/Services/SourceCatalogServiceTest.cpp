...
TEST_F(SourceCatalogServiceTest, testRegisterUnregisterPhysicalSource)
{
    ...
    bool successRegisterPhysicalSource
        = sourceCatalogService->registerPhysicalSource(physicalSource->getPhysicalSourceName(), physicalSource->getLogicalSourceName())
              .first;
    ...
    bool successUnregisterNotExistingPhysicalSource
        = sourceCatalogService->unregisterPhysicalSource("asd", physicalSource->getLogicalSourceName());
    ...
    bool successUnregisterNotExistingLogicalSource
        = sourceCatalogService->unregisterPhysicalSource(physicalSource->getPhysicalSourceName(), "asd");
    EXPECT_TRUE(!successUnregisterNotExistingLogicalSource);

    //test unregister existing node
    bool successUnregisterExistingPhysicalSource
        = sourceCatalogService->unregisterPhysicalSource(physicalSource->getPhysicalSourceName(), physicalSource->getLogicalSourceName());
