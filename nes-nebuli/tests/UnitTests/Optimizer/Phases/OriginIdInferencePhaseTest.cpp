...
public:
    ...
    void setupTopologyNodeAndSourceCatalog(const Catalogs::Source::SourceCatalogPtr& sourceCatalog)
    {
        ...
        auto sceA1 = Catalogs::Source::SourceCatalogEntry::create(physicalSourceA1, logicalSourceA);
        ...
        auto sceA2 = Catalogs::Source::SourceCatalogEntry::create(physicalSourceA2, logicalSourceA);
        ...
        auto sceB1 = Catalogs::Source::SourceCatalogEntry::create(physicalSourceB1, logicalSourceB);
