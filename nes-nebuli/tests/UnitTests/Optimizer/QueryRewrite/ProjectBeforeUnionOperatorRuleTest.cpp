...
public:
    ...
    void setupSensorNodeAndSourceCatalog(const Catalogs::Source::SourceCatalogPtr& sourceCatalog) const
    {
        ...
        auto sce1 = Catalogs::Source::SourceCatalogEntry::create(physicalSource1, logicalSource1);
        auto sce2 = Catalogs::Source::SourceCatalogEntry::create(physicalSource1, logicalSource2);
