...
#ifndef NES_NEBULI_TESTS_INCLUDE_UTIL_PROTOBUFMESSAGEFACTORY_HPP_
#define NES_NEBULI_TESTS_INCLUDE_UTIL_PROTOBUFMESSAGEFACTORY_HPP_
...
#endif /// NES_NEBULI_TESTS_INCLUDE_UTIL_PROTOBUFMESSAGEFACTORY_HPP_
