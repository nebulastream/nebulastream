...
TEST_F(DistributedQueryTest, ConstructorWithLocalQueries)
{
    const std::unordered_map<WorkerId, std::vector<QueryId>> localQueries
        = {{WorkerId("worker-1:8080"), {QueryId(LocalQueryId(generateUUID())), QueryId(LocalQueryId(generateUUID()))}},
           {WorkerId("worker-2:8080"), {QueryId(LocalQueryId(generateUUID()))}}};
...
{
    auto qid1 = QueryId(LocalQueryId(generateUUID()));
    auto qid2 = QueryId(LocalQueryId(generateUUID()));
    auto qid3 = QueryId(LocalQueryId(generateUUID()));
    auto qid4 = QueryId(LocalQueryId(generateUUID()));
    const std::unordered_map<WorkerId, std::vector<QueryId>> localQueries
...
TEST_F(DistributedQueryTest, DistributedQueryStatusGlobalStateAllRegistered)
{
    ...
    status.localStatusSnapshots[WorkerId("worker-1:8080")][QueryId(qid1)]
        = LocalQueryStatus{.queryId = QueryId(qid1), .state = QueryState::Registered, .metrics = {}};
    status.localStatusSnapshots[WorkerId("worker-2:8080")][QueryId(qid1)]
...
TEST_F(DistributedQueryTest, DistributedQueryStatusGlobalStateAllRunning)
{
    ...
    status.localStatusSnapshots[WorkerId("worker-2:8080")][QueryId(qid2)]
...
TEST_F(DistributedQueryTest, DistributedQueryStatusGlobalStateUnreachable)
{
    ...
    status.localStatusSnapshots[WorkerId("worker-1:8080")][QueryId(qid1)]
        = LocalQueryStatus{.queryId = QueryId(qid1), .state = QueryState::Running, .metrics = {}};
    status.localStatusSnapshots[WorkerId("worker-2:8080")][QueryId(qid1)] = std::unexpected(QueryStatusFailed("Connection error"));
...
TEST_F(DistributedQueryTest, DistributedQueryStatusGetExceptionsFromExpected)
{
    ...
    DistributedQueryStatus status;
    status.queryId = DistributedQueryId("test-distributed-query-1");
    status.localStatusSnapshots[WorkerId("worker-1:8080")][QueryId(qid1)] = std::unexpected(QueryStatusFailed("Communication error"));
...
TEST_F(DistributedQueryTest, DistributedQueryStatusCoalesceExceptionMultiple)
{
    ...
    status.localStatusSnapshots[WorkerId("worker-3:8080")][QueryId(qid1)]
