...
TEST_F(QueryManagerTest, BasicPlacementTwoNodes)
{
    ...
    const auto sinkNodePlan = plan["sink-node:8080"].front();
...
TEST_F(QueryManagerTest, JoinPlacementWithOneSelection)
{
    ...
    const auto sourceNode1Plan = plan["source-node1:8080"].front();
...
TEST_F(QueryManagerTest, PlacementWithThreeNodes)
{
    ...
    const auto plan1 = plan["source-node0:8080"].front();
    ...
    const auto plan2 = plan["source-node1:8080"].front();
...
TEST_F(QueryManagerTest, JoinPlacementWithLimitedCapacityOnTwoNodes)
{
    ...
    const auto sourcePlan2 = plan["source-node:8080"][1];
...
TEST_F(QueryManagerTest, BridgePlacement)
{
    ...
    const auto intermediatePlan = plan["intermediate-node:8080"].front();
...
TEST_F(QueryManagerTest, LongBridgePlacement)
{
    ...
    const auto intermediatePlan0 = plan["intermediate-node0:8080"].front();
    ...
    const auto intermediatePlan1 = plan["intermediate-node1:8080"].front();
...
TEST_F(QueryManagerTest, BridgePlacementJoin)
{
    ...
    const auto intermediatePlan1 = plan["intermediate-node:8080"][0];
    EXPECT_EQ(flatten(intermediatePlan1).size(), 2);
    EXPECT_EQ(getOperatorByType<SourceDescriptorLogicalOperator>(intermediatePlan1).size(), 1);
    EXPECT_EQ(getOperatorByType<SourceDescriptorLogicalOperator>(intermediatePlan1)[0].getSourceDescriptor().getSourceType(), "Network");
    EXPECT_EQ(getOperatorByType<SinkLogicalOperator>(intermediatePlan1).size(), 1);
    ...
    const auto intermediatePlan2 = plan["intermediate-node:8080"][1];
...
TEST_F(QueryManagerTest, ComplexJoinQuery)
{
    ...
    const auto sourceNode2Plan = plan["source-node2:8080"].front();
    ...
    const auto intermediateNode0Plan = plan["intermediate-node0:8080"].front();
    ...
    const auto intermediateNode1Plan = plan["intermediate-node1:8080"].front();
