...
namespace NES
{
class EmbeddedQueryManager final : public QueryManager
{
public:
    explicit EmbeddedQueryManager(const Configuration::SingleNodeWorkerConfiguration& configuration);
    ...
    [[nodiscard]] std::optional<QuerySummary> status(QueryId queryId) const override;
