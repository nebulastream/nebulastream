...
template <>
struct adl_serializer<NES::Configurations::EnumWrapper>
{
    ///NOLINTNEXTLINE(readability-identifier-naming)
    static void to_json(json& jsonOutput, const NES::Configurations::EnumWrapper& enumWrapper) { jsonOutput = enumWrapper.getValue(); }
};
}
...
inline void to_json(nlohmann::json& jsonOutput, const NES::Configurations::DescriptorConfig::Config& config)
{
