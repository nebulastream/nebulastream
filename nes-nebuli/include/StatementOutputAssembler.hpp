...
using LogicalSourceOutputRowType = std::tuple<Identifier, UnboundSchema>;
constexpr std::array<std::string_view, 2> logicalSourceOutputColumns{"source_name", "schema"};

using SourceDescriptorOutputRowType
    = std::tuple<PhysicalSourceId, Identifier, UnboundSchema, std::string, ParserConfig, NES::DescriptorConfig::Config>;
...
using SinkDescriptorOutputRowType = std::tuple<Identifier, UnboundSchema, std::string, NES::DescriptorConfig::Config>;
