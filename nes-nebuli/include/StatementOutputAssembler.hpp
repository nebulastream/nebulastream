...
using SourceDescriptorOutputRowType
    = std::tuple<uint64_t, std::string, Schema, std::string, ParserConfig, NES::Configurations::DescriptorConfig::Config>;
...
using SinkDescriptorOutputRowType = std::tuple<std::string, Schema, std::string, NES::Configurations::DescriptorConfig::Config>;
