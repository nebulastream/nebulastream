...
- [x] **Phase 3: Physical Operator Tests** - Write the full physical operator test suite covering lifecycle, correctness, errors, and edge cases (completed 2026-03-12)
