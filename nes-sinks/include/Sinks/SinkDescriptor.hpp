...
public:
    ...
    [[nodiscard]] SinkId getSinkId() const;
...
public:
    ...
    static std::optional<SinkDescriptor> createNamed(
        SinkId id,
        Identifier name,
    ...
    static std::optional<SinkDescriptor> createAnonymous(
        SinkId id,
        const Identifier& sinkType,
