...
public:
    ...
    explicit CSVFormat(const Schema<UnqualifiedUnboundField, Ordered>& schema);
    explicit CSVFormat(const Schema<UnqualifiedUnboundField, Ordered>& schema, bool escapeStrings);
