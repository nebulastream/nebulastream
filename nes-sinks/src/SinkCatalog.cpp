    ...
    std::unordered_map<std::string, std::string> config)
{
    ...
    auto sinkDescriptor = SinkDescriptor{sinkName, schema, sinkType, std::move(host), std::move(descriptorConfigOpt.value())};
...
SinkCatalog::getInlineSink(const Schema& schema, std::string_view sinkType, std::unordered_map<std::string, std::string> config) const
{
    ...
    auto sinkDescriptor = SinkDescriptor{inlineSinkId.getRawValue(), schema, sinkType, host, std::move(descriptorConfigOpt.value())};
