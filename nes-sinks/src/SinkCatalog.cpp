    ...
    const std::unordered_map<std::string, std::string>& formatConfig)
{
    ...
    {
        return std::unexpected{InvalidConfigParameter("Invalid sink configuration for sink '{}' of type '{}'", sinkName, sinkType)};
    }
    ...
    lockedSinks->insert_or_assign(upperName, sinkDescriptor);
