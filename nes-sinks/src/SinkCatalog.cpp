    ...
    std::unordered_map<Identifier, std::string> config)
{
    ...
    auto sinkDescriptor = SinkDescriptor{NamedSinkDescriptor{sinkName, schema, sinkType.asCanonicalString(), std::move(descriptorConfigOpt.value())}};
    ...
    std::unordered_map<Identifier, std::string> config) const
{
    ...
    auto sinkDescriptor
        = SinkDescriptor{InlineSinkDescriptor{inlineSinkId.getRawValue(), schema, sinkType.asCanonicalString(), std::move(descriptorConfigOpt.value())}};
