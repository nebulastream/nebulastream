...
std::optional<SinkDescriptor> SinkCatalog::addSinkDescriptor(
    Identifier sinkName, const UnboundOrderedSchema& schema, const std::string_view sinkType, std::unordered_map<std::string, std::string> config)
{
...
SinkCatalog::getInlineSink(const UnboundOrderedSchema& schema, std::string_view sinkType, std::unordered_map<std::string, std::string> config) const
{
    auto descriptorConfigOpt = SinkDescriptor::validateAndFormatConfig(sinkType, std::move(config));
