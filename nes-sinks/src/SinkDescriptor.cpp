...
SinkDescriptor::SinkDescriptor(std::string sinkType, NES::Configurations::DescriptorConfig::Config&& config, const std::string& workerId, bool addTimestamp)
    : Descriptor(std::move(config)), sinkType(std::move(sinkType)), workerId(workerId), addTimestamp(addTimestamp)
{
}
