...
namespace NES
{
CSVFormat::CSVFormat(const UnboundOrderedSchema& schema) : CSVFormat(schema, false)
{
}

CSVFormat::CSVFormat(const UnboundOrderedSchema& pSchema, const bool escapeStrings) : Format(pSchema), escapeStrings(escapeStrings)
{
