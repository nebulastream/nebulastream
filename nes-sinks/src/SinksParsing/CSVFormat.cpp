...
namespace NES
{
CSVFormat::CSVFormat(const SchemaBase<UnboundFieldBase<1>, true>& schema) : CSVFormat(schema, false)
{
}

CSVFormat::CSVFormat(const SchemaBase<UnboundFieldBase<1>, true>& pSchema, const bool escapeStrings) : Format(pSchema), escapeStrings(escapeStrings)
{
