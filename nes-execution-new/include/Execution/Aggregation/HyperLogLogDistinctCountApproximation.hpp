...
#ifndef NES_EXECUTION_INCLUDE_EXECUTION_AGGREGATION_HYPERLOGLOGDISTINCTCOUNTAPPROXIMATION_HPP_
#define NES_EXECUTION_INCLUDE_EXECUTION_AGGREGATION_HYPERLOGLOGDISTINCTCOUNTAPPROXIMATION_HPP_
...
class HyperLogLogDistinctCountApproximation : public AggregationFunction {
  ...
  public:
    ...
    void lift(Nautilus::MemRef memref, Nautilus::Record& record) override;
    void combine(Nautilus::MemRef memref1, Nautilus::MemRef memref2) override;
    void lower(Nautilus::MemRef memref, Nautilus::Record& record) override;
    void reset(Nautilus::MemRef memref) override;
