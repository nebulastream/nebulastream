...
TEST_F(ReadSNCB, testF2) {
    ...
    try {
        ...
        const auto expectedOutput = "1,1722540000,0.000000,2.130000,1.785000,1.863000,2.130000,0.078000\n"
                                    ...
                                    "5,172540000,1.875000,5.040000,3.648000,3.663000,3.165000,0.015000\n"
        ...
        for (const auto& buffer : actualBuffers) {
            ...
            for (size_t i = 0; i < numTuples; ++i) {
                ...
                NES_INFO(" Result - id: {}, timestamp: {}, PCFA_bar: {}, PCFF_bar: {}, PCF1_bar: {}, PCF2_bar: {}, T1_bar: {}, T2_bar: {}, Code1: {}, Code2: {}, time: {}",
