...
VarVal FastINT8InputParser::parseLazyToVarVal(
    const bool& nullable,
    ...
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<int8_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
    const nautilus::val<int8_t> result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<int8_t, false>, fieldAddress, fieldSize);
    return VarVal{result, false, false};
}

VarVal FastINT16InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<int16_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastINT32InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<int32_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastINT64InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<int64_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastUINT8InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<uint8_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastUINT16InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<uint16_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastUINT32InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<uint32_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
...
VarVal FastUINT64InputParser::parseLazyToVarVal(
    const bool& nullable,
    const nautilus::val<bool>& isNull,
    const nautilus::val<int8_t*>& fieldAddress,
    const nautilus::val<uint64_t>& fieldSize) const
{
    if (nullable)
    {
        ...
        if (!isNull)
        {
            result = NAUTILUS_TAGGED_INVOKE("parse_not_null", parseWithFastInt<uint64_t, false>, fieldAddress, fieldSize);
        }
        return VarVal{result, true, isNull};
    }
