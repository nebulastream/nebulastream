...
namespace NES::Sinks
{
    ...
    class RustFileSinkCBG final : public Sink
    {
    public:
        static constexpr std::string_view NAME = "RustFileSinkCBG";
        explicit RustFileSinkCBG(const SinkDescriptor& sinkDescriptor);
        ~RustFileSinkCBG() override = default;

        RustFileSinkCBG(const RustFileSinkCBG&) = delete;
        RustFileSinkCBG& operator=(const RustFileSinkCBG&) = delete;
        RustFileSinkCBG(RustFileSinkCBG&&) = delete;
        RustFileSinkCBG& operator=(RustFileSinkCBG&&) = delete;
...
{
template <>
struct formatter<NES::Sinks::RustFileSinkCBG> : ostream_formatter
{
};
}
