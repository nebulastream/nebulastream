...
IREEInferenceOperatorHandler::IREEInferenceOperatorHandler(Inference::Model model) : model(std::move(model))
{
}
...
const Inference::Model& IREEInferenceOperatorHandler::getModel() const
{
    return model;
}
