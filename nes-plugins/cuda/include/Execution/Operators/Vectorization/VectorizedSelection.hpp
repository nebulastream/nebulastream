...
*/
#ifndef NES_PLUGINS_CUDA_INCLUDE_EXECUTION_OPERATORS_VECTORIZATION_VECTORIZEDSELECTION_HPP_
#define NES_PLUGINS_CUDA_INCLUDE_EXECUTION_OPERATORS_VECTORIZATION_VECTORIZEDSELECTION_HPP_
...
/**
 * @brief The vectorized selection operator that applies the kernel programming
 * model to a single-record selection operator.
 */
