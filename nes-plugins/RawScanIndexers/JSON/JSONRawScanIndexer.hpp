...
class JSONRawScanIndexer final : public RawScanIndexer<JSONRawScanIndexer>
{
public:
    ...
    friend std::ostream& operator<<(std::ostream& os, const JSONRawScanIndexer& jsonRawScanIndexer);
};
