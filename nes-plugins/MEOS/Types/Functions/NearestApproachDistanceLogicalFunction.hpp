...
{
public:
    static constexpr std::string_view NAME = "NEAREST_APPROACH_DISTANCE";

    explicit NearestApproachDistanceLogicalFunction(const LogicalFunction& leftChild, const LogicalFunction& rightChild);
