...
std::vector<std::shared_ptr<arrow::Array>> ArrowFormat::getArrowArrays(
  ...
  auto layout = Runtime::MemoryLayouts::RowLayout::create(
      schema, inputBuffer.getBufferSize());
  auto testTupleBuffer =
      Runtime::MemoryLayouts::TestTupleBuffer(layout, inputBuffer);
  ...
  for (uint64_t columnIndex = 0; columnIndex < numberOfFields; ++columnIndex) {
    ...
    try {
      if (physicalType->isBasicType()) {
        ...
        switch (basicPhysicalType->nativeType) {
          case NES::BasicPhysicalType::NativeType::INT_8: {
            ...
            // iterate over all values in the column and add values to the
            // builder
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              int8_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<int8_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert INT_8 field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::INT_16: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              int16_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<int16_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert INT_16 field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::INT_32: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              int32_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<int32_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert INT_32 field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::INT_64: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              int64_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<int64_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert INT_64 field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::UINT_8: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              uint8_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<uint8_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert UINT_8 field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::UINT_16: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              uint16_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<uint16_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert UINT_16 "
                  "field to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::UINT_32: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              uint32_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<uint32_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert UINT_32 "
                  "field to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::UINT_64: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              uint64_t value =
                  testTupleBuffer[rowIndex][columnIndex].read<uint64_t>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert UINT_64 "
                  "field to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::FLOAT: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              float value =
                  testTupleBuffer[rowIndex][columnIndex].read<float>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert FLOAT field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::DOUBLE: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              double value =
                  testTupleBuffer[rowIndex][columnIndex].read<double>();
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert DOUBLE field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::TEXT: {
            ...
            for (uint64_t rowIndex = 0; rowIndex < numberOfTuples; ++rowIndex) {
              ...
              auto indexInBuffer =
                  buffer + offset + rowIndex * schema->getSchemaSizeInBytes();
              ...
              // retrieve the size of the variable-length field from the child
              // buffer
              uint32_t sizeOfTextField =
                  *(childTupleBuffer.getBuffer<uint32_t>());
              ...
              if (sizeOfTextField > 0) {
                ...
                NES_WARNING(
                    "ArrowFormat::getArrowArrays: Variable-length field could "
                    "not be read."
                    "Invalid size in the variable-length TEXT field. Adding an "
                    "empty string.")
              }
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert TEXT field "
                  "to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::BOOLEAN: {
            ...
            if (!buildArray.ok()) {
              NES_FATAL_ERROR(
                  "ArrowFormat::getArrowArrays: could not convert BOOLEAN "
                  "field to arrow array.");
            }
          ...
          case NES::BasicPhysicalType::NativeType::CHAR: {
            NES_FATAL_ERROR(
                "ArrowFormat::getArrowArrays: type CHAR not supported by "
                "Arrow.");
          ...
          case NES::BasicPhysicalType::NativeType::UNDEFINED: {
            NES_FATAL_ERROR(
                "ArrowFormat::getArrowArrays: Field Type UNDEFINED");
            break;
          }
        }
      }
      ...
      NES_ERROR(
          "ArrowFormat::getArrowArrays: Failed to convert the arrowArray to "
          "desired NES data type. "
          "Error: {}",
          e.what());
    }
    offset += fieldSize;
    ...
    try {
      if (physicalType->isBasicType()) {
        ...
        switch (basicPhysicalType->nativeType) {
          ...
          case NES::BasicPhysicalType::NativeType::CHAR: {
            NES_FATAL_ERROR(
                "ArrowFormat::getArrowSchema: type CHAR not supported by "
                "Arrow.");
            throw std::invalid_argument("Arrow does not support CHAR");
            break;
          }
          case NES::BasicPhysicalType::NativeType::UNDEFINED: {
            NES_FATAL_ERROR(
                "ArrowFormat::getArrowSchema: Field Type UNDEFINED");
            break;
          }
        }
      }
