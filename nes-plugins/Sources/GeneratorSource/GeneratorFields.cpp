...
void WordListField::validate(std::string_view rawSchemaLine)
{
    ...
    {
        throw InvalidConfigParameter("Invalid WORDLIST schema! Path {} does not exist! Schema<Field, Unordered> line: {}", path, rawSchemaLine);
    }
...
RandomStrField::RandomStrField(std::string_view rawSchemaLine)
{
    ...
    INVARIANT(
        ...
        "Invalid RANDOMSTR parameters MINLENGTH: {} > MAXLENGTH: {}! The MINLENGTH can not be longer than the MAXLENGTH! Schema<Field, Unordered> line: "
        "{}",
        parsedMinLength,
        parsedMaxLength,
        rawSchemaLine);
...
void RandomStrField::validate(std::string_view rawSchemaLine)
{
    ...
    {
        throw InvalidConfigParameter("Invalid RANDOMSTR parameter MINLENGTH! Cannot parse MINLENGTH! Schema<Field, Unordered> line: {}", rawSchemaLine);
    }
    if (not parsedMaxLength)
    {
        throw InvalidConfigParameter("Invalid RANDOMSTR parameter MAXLENGTH! Cannot parse MAXLENGTH! Schema<Field, Unordered> line: {}", rawSchemaLine);
    }
