...
class ODBCLabValSource : public Source
{
...
public:
    static constexpr std::string_view NAME = "ODBCLabVal";

    explicit ODBCLabValSource(const SourceDescriptor& sourceDescriptor);
    ~ODBCLabValSource() override;

    ODBCLabValSource(const ODBCLabValSource&) = delete;
    ODBCLabValSource& operator=(const ODBCLabValSource&) = delete;
    ODBCLabValSource(ODBCLabValSource&&) = delete;
    ODBCLabValSource& operator=(ODBCLabValSource&&) = delete;
...
struct ConfigParametersODBCLabVal
{
