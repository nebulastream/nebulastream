...
size_t MQTTSource::fillTupleBuffer(TupleBuffer& tupleBuffer, AbstractBufferProvider&, const std::stop_token& stopToken)
{
    size_t tbOffset = 0;
...
RegisterMQTTSourceValidation(SourceValidationRegistryArguments sourceConfig)
{
