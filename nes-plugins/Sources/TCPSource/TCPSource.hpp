...
/// StrongType with unique ownership over a file descriptor. To ensure the descriptor is closed exactly once.
...
struct Socket
{
    ...
    std::expected<void, std::string> setNonBlock();
    std::expected<void, std::string> setBlock();
