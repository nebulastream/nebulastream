...
constexpr bool isValidCType(SQLSMALLINT v)
{
    switch (v)
    {
        case SQL_C_CHAR:
...
static std::unordered_map<std::pair<SQLSMALLINT, DataType::Type>, Translation> conversions = {
...
constexpr std::string_view sqlTypeName(SQLSMALLINT t) noexcept
{
    switch (t)
    {
        // Character types
