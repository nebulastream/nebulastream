...
class TensorflowPipelineTest : public Testing::BaseUnitTest,
 ...
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("TensorflowPipelineTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down TensorflowPipelineTest test class.");
  }
};
...
TEST_P(TensorflowPipelineTest, thresholdWindowWithSum) {
  ...
  auto inferModelOperator =
      std::make_shared<Operators::TensorflowInferenceOperator>(0, inputFields,
                                                               outputFields);
  ...
  auto handler =
      std::make_shared<Operators::TensorflowInferenceOperatorHandler>(
...
INSTANTIATE_TEST_CASE_P(
    testIfCompilation, TensorflowPipelineTest,
