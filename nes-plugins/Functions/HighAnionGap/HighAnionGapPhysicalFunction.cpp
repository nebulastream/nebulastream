...
{
    PRECONDITION(
        physicalFunctionRegistryArguments.childFunctions.size() == 1, "HighAnionGap function must have exactly one child function");
    return HighAnionGapPhysicalFunction(physicalFunctionRegistryArguments.childFunctions[0]);
}
}