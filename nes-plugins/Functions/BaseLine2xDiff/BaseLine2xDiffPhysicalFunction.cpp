...
{
    PRECONDITION(
        physicalFunctionRegistryArguments.childFunctions.size() == 1, "BaseLine2xDiff function must have exactly one child function");
    return BaseLine2xDiffPhysicalFunction(physicalFunctionRegistryArguments.childFunctions[0]);
}
}