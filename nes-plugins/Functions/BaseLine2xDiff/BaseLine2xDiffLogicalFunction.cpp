...
BaseLine2xDiffLogicalFunction::BaseLine2xDiffLogicalFunction(const LogicalFunction& child) : dataType(DataTypeProvider::provideDataType(DataType::Type::VARSIZED)), child(child)
