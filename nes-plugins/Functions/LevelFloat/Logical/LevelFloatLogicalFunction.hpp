...
class LevelFloatLogicalFunction final : public LogicalFunctionConcept
{
public:
    static constexpr std::string_view NAME = "LevelFloat";

    LevelFloatLogicalFunction(const LogicalFunction& child);
...
FMT_OSTREAM(NES::LevelFloatLogicalFunction);
