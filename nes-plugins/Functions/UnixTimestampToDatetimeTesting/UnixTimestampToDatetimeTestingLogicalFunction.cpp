...
UnixTimestampToDatetimeTestingLogicalFunction::UnixTimestampToDatetimeTestingLogicalFunction(const LogicalFunction& child) : dataType(DataTypeProvider::provideDataType(DataType::Type::VARSIZED)), child(child)
{
}
