...
public:
    ...
    static LogicalFunctionRegistryReturnType createFMT(LogicalFunctionRegistryArguments arguments);
...
{
    Reflected operator()(const FmtLogicalFunction& function, const ReflectionContext& context) const;
};

template <>
struct Unreflector<FmtLogicalFunction>
{
    FmtLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
