...
{
    Reflected operator()(const RustAnswerLogicalFunction& function, const ReflectionContext& context) const;
};

template <>
struct Unreflector<RustAnswerLogicalFunction>
{
    RustAnswerLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
