...
class DepseudonymizePhysicalFunction final
{
public:
    explicit DepseudonymizePhysicalFunction(PhysicalFunction childPhysicalFunction);
...
static_assert(PhysicalFunctionConcept<DepseudonymizePhysicalFunction>);
