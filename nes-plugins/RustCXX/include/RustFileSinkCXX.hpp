...
namespace NES::Sinks
{
    ...
    class RustFileSinkCXX final : public Sink
    {
    public:
        static constexpr std::string_view NAME = "RustFileSinkCXX";
        explicit RustFileSinkCXX(const SinkDescriptor& sinkDescriptor);
        ~RustFileSinkCXX() override = default;

        RustFileSinkCXX(const RustFileSinkCXX&) = delete;
        RustFileSinkCXX& operator=(const RustFileSinkCXX&) = delete;
        RustFileSinkCXX(RustFileSinkCXX&&) = delete;
        RustFileSinkCXX& operator=(RustFileSinkCXX&&) = delete;
    ...
    private:
        rust::Box<Rust::FileSinkImpl> impl;
...
{
template <>
struct formatter<NES::Sinks::RustFileSinkCXX> : ostream_formatter
{
};
}
