...
#ifndef NES_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_INFERMODEL_INFERMODELOPERATOR_HPP_
#define NES_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_INFERMODEL_INFERMODELOPERATOR_HPP_
...
/**
 * @brief this is the nautilus implementation of infer model operator. This operator allows for inferring (currently only ONNX) machine learning model over incoming data stream.
 */
...
#endif// NES_RUNTIME_INCLUDE_EXECUTION_OPERATORS_STREAMING_INFERMODEL_INFERMODELOPERATOR_HPP_
