...
use nes_source_runtime::plugin::{SourcePluginEntry, SOURCE_PLUGINS};
...
fn spawn_tcp_source(
    ...
    source_id: u64,
    buffer_provider: nes_source_runtime::buffer::BufferProviderHandle,
    inflight_limit: u32,
    ...
    let source = create_tcp_source(config)?;
    Ok(nes_source_runtime::source::spawn_source(
...
static TCP_SOURCE_PLUGIN: SourcePluginEntry = SourcePluginEntry {
    name: "TokioTcp",
    schema: CONFIG_SCHEMA,
    spawn: spawn_tcp_source,
};
