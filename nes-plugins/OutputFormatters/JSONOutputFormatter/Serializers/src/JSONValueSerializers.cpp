    ...
    const DataType& valueType) const
{
    ...
    throw UnknownValueSerializerType(
        "No serializer configured for VECTOR element-type {}.", magic_enum::enum_name(castedVal.getElementType().type));
}
...
ValueSerializerRegistryReturnType ValueSerializerGeneratedRegistrar::RegisterJSONVECTORValueSerializer(ValueSerializerRegistryArguments)
{
