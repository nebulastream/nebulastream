...
if(ENABLE_INTEL_CPU)
    ...
    # introduce ODR violations, and we force openvino to use the xbyak from VCPKG. For arm however vcpkg does not depend
    # on xbyak so there will not be any ODR violations.
    if (VCPKG_TARGET_ARCHITECTURE MATCHES "x86|x64")
        file(REMOVE_RECURSE "${DEP_SOURCE_PATH}/third_party/xbyak")
    endif ()
