...
# These are x86/x86_64-specific and invalid for aarch64/ARM64.
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    file(GLOB_RECURSE _tbb_cmake_files
        "${SOURCE_PATH}/CMakeLists.txt"
        "${SOURCE_PATH}/cmake/*.cmake"
    )

    foreach(_file IN LISTS _tbb_cmake_files)
        file(READ "${_file}" _contents)
        string(REPLACE "-fcf-protection=full" "" _contents "${_contents}")
        string(REPLACE "-fcf-protection=branch" "" _contents "${_contents}")
        string(REPLACE "-fcf-protection=return" "" _contents "${_contents}")
        string(REPLACE "-fcf-protection=none" "" _contents "${_contents}")
