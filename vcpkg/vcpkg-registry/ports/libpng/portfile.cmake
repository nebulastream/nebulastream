...
vcpkg_list(SET LIBPNG_SYSTEM_PROCESSOR_OPTION)
if(VCPKG_TARGET_ARCHITECTURE STREQUAL "arm64")
    # libpng enables NEON only when CMake identifies the target as aarch64.
    vcpkg_list(APPEND LIBPNG_SYSTEM_PROCESSOR_OPTION "-DCMAKE_SYSTEM_PROCESSOR=aarch64")
endif()
...
vcpkg_cmake_configure(
    ...
    OPTIONS
        ...
        ${LIBPNG_SYSTEM_PROCESSOR_OPTION}
