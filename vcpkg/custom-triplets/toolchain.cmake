...
if (NOT _NES_TOOLCHAIN_FILE)
    ...
    find_program(CLANGXX_EXECUTABLE NAMES clang++-$ENV{LLVM_VERSION} clang++-$ENV{LLVM_VERSION})
    find_program(CLANG_EXECUTABLE NAMES clang-$ENV{LLVM_VERSION} clang-$ENV{LLVM_VERSION})
