if (NOT _VCPKG_LINUX_CLANG_TOOLCHAIN)
    ...
    if (NOT _CMAKE_IN_TRY_COMPILE)
        ...
        string(APPEND CMAKE_CXX_FLAGS_INIT "-std=c++20 -stdlib=libc++ -fPIC ${VCPKG_CXX_FLAGS} ")
        string(APPEND CMAKE_C_FLAGS_DEBUG_INIT "${VCPKG_C_FLAGS_DEBUG} ")
        string(APPEND CMAKE_CXX_FLAGS_DEBUG_INIT "${VCPKG_CXX_FLAGS_DEBUG} ")
        string(APPEND CMAKE_C_FLAGS_RELEASE_INIT "${VCPKG_C_FLAGS_RELEASE} ")
        string(APPEND CMAKE_CXX_FLAGS_RELEASE_INIT "${VCPKG_CXX_FLAGS_RELEASE} ")

        string(APPEND CMAKE_MODULE_LINKER_FLAGS_INIT "-lc++ ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS} ")
        string(APPEND CMAKE_SHARED_LINKER_FLAGS_INIT "-lc++ ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS} ")
        string(APPEND CMAKE_EXE_LINKER_FLAGS_INIT "-lc++ ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS} ")
