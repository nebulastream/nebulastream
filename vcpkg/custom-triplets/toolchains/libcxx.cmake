...
if (NOT _NES_TOOLCHAIN_FILE)
    ...
    find_program(CLANGXX_EXECUTABLE REQUIRED NAMES clang++ clang++-$ENV{LLVM_TOOLCHAIN_VERSION})
    find_program(CLANG_EXECUTABLE REQUIRED NAMES clang clang-$ENV{LLVM_TOOLCHAIN_VERSION})
