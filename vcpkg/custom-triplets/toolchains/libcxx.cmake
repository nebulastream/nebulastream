...
if (NOT _NES_TOOLCHAIN_FILE)
    ...
    set(LIBCXX_COMPILER_FLAG "-nostdinc++ -isystem $ENV{USE_CPP_STDLIB_LIBCXX_PATH}/include/c++/v1")
    set(LIBCXX_LINKER_FLAG "-L$ENV{USE_CPP_STDLIB_LIBCXX_PATH}/lib -lc++ -rpath $ENV{USE_CPP_STDLIB_LIBCXX_PATH}/lib")
    ...
    if (NOT _CMAKE_IN_TRY_COMPILE)
        ...
        string(APPEND CMAKE_MODULE_LINKER_FLAGS_DEBUG_INIT   "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_DEBUG} ")
        string(APPEND CMAKE_SHARED_LINKER_FLAGS_DEBUG_INIT   "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_DEBUG} ")
        string(APPEND CMAKE_EXE_LINKER_FLAGS_DEBUG_INIT      "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_DEBUG} ")
        string(APPEND CMAKE_MODULE_LINKER_FLAGS_RELEASE_INIT "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_RELEASE} ")
        string(APPEND CMAKE_SHARED_LINKER_FLAGS_RELEASE_INIT "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_RELEASE} ")
        string(APPEND CMAKE_EXE_LINKER_FLAGS_RELEASE_INIT    "${LIBCXX_LINKER_FLAG} ${LINK_WITH_MOLD} ${VCPKG_LINKER_FLAGS_RELEASE} ")
