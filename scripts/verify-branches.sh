...
CHECKS=(
    # ── casewhen-0: logical stubs ──
    "tutorial-casewhen-0           | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 13 | 16"

    # ── casewhen-0-reference: logical validation filled in, physical still stub ──
    "tutorial-casewhen-0-reference | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"

    # ── casewhen-1: same as casewhen-0-reference ──
    "tutorial-casewhen-1           | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"

    # ── casewhen-1-reference: physical execution filled in ──
    "tutorial-casewhen-1-reference | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    "tutorial-casewhen-1-reference | systest                          | systest | nes-systests/function/CaseWhen.test                          |  2 |  2"

    # ── delta-0: all delta stubs ──
    "tutorial-delta-0              | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    "tutorial-delta-0              | delta-logical-operator-test       | gtest   | nes-logical-operators/tests/delta-logical-operator-test       |  3 | 12"
    "tutorial-delta-0              | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        |  0 | 10"
    ...
    "tutorial-delta-0-reference    | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    ...
    "tutorial-delta-0-reference    | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        |  0 | 10"
    ...
    "tutorial-delta-1              | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    "tutorial-delta-1              | delta-logical-operator-test       | gtest   | nes-logical-operators/tests/delta-logical-operator-test       | 12 | 12"
    "tutorial-delta-1              | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        |  0 | 10"
    ...
    "tutorial-delta-1-reference    | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    ...
    "tutorial-delta-1-reference    | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        | 10 | 10"
    ...
    "tutorial-delta-2              | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    "tutorial-delta-2              | delta-logical-operator-test       | gtest   | nes-logical-operators/tests/delta-logical-operator-test       | 12 | 12"
    "tutorial-delta-2              | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        | 10 | 14"
    ...
    "tutorial-delta-2-reference    | conditional-logical-function-test | gtest   | nes-logical-operators/tests/conditional-logical-function-test | 16 | 16"
    ...
    "tutorial-delta-2-reference    | DeltaPhysicalOperatorTest         | gtest   | nes-physical-operators/tests/DeltaPhysicalOperatorTest        | 14 | 14"
