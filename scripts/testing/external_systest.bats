...
# needed; CMake's add_systest_with_profile() points every profile at this
# same .bats and parameterises it via PROFILE_DIR + PROFILE_GROUP env vars.
#
...
@test "external-systest profile=${PROFILE_GROUP}" {
