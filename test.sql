...
CREATE SINK someSink(ENDLESS.TS UINT64) TYPE File SET('/data/lukas-ldap/nebulastream/build/nes-systests/working-dir/out.csv' as `SINK`.FILE_PATH, 'CSV' as `SINK`.INPUT_FORMAT);
SHOW QUERIES;
