...
QueryPlanPtr QueryPlanBuilder::addFilter(
    ExpressionNodePtr const& filterExpression, QueryPlanPtr queryPlan) {
  ...
  if (!filterExpression->getNodesByType<FieldRenameExpressionNode>().empty()) {
    NES_THROW_RUNTIME_ERROR(
        "QueryPlanBuilder: Filter predicate cannot have a "
...
QueryPlanPtr QueryPlanBuilder::addMapUDF(
...
QueryPlanPtr QueryPlanBuilder::addMap(
...
QueryPlanPtr QueryPlanBuilder::addBinaryOperatorAndUpdateSource(
  ...
  NES_DEBUG(
      "QueryPlanBuilder: addBinaryOperatorAndUpdateSource: update the source "
      "names");
...
std::shared_ptr<FieldAccessExpressionNode> QueryPlanBuilder::checkExpression(
