...
void DecomposedQueryPlanSerializationUtil::serializeDecomposedQueryPlan(
  ...
  NES_DEBUG(
      "QueryPlanSerializationUtil: serializing the operator chain for each "
      "root operator independently");
  ...
  NES_TRACE(
      "QueryPlanSerializationUtil: serializing the Query sub plan id and query "
      "id");
