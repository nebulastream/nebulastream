...
SinkDescriptorPtr FileSinkDescriptor::create(
    std::string_view fileName, std::string_view sinkFormat, std::string_view append, bool addTimestamp, uint64_t numberOfOrigins)
{
...
SinkDescriptorPtr FileSinkDescriptor::create(const std::string& fileName, const std::string& sinkFormat, const std::string& append)
{
    return create(fileName, sinkFormat, append, false, 1);
}

FileSinkDescriptor::FileSinkDescriptor(
...
bool FileSinkDescriptor::getAppend() const
{
    return append;
}

std::string FileSinkDescriptor::getSinkFormatAsString() const
{
    return sinkFormat;
}
