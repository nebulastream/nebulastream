...
std::string MQTTSinkDescriptor::getAddress() const
{
    return address;
}

std::string MQTTSinkDescriptor::getClientId() const
{
    return clientId;
}

std::string MQTTSinkDescriptor::getTopic() const
{
    return topic;
}

std::string MQTTSinkDescriptor::getUser() const
{
    return user;
}
...
uint64_t MQTTSinkDescriptor::getMsgDelay() const
{
    return messageDelay;
}

MQTTSinkDescriptor::ServiceQualities MQTTSinkDescriptor::getQualityOfService() const
{
...
bool MQTTSinkDescriptor::equal(SinkDescriptorPtr const& other)
{
    ...
    return address == otherSinkDescriptor->address && clientId == otherSinkDescriptor->clientId && topic == otherSinkDescriptor->topic
