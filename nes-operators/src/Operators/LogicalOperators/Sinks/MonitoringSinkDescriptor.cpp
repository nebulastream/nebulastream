...
MonitoringSinkDescriptor::MonitoringSinkDescriptor(
...
SinkDescriptorPtr
MonitoringSinkDescriptor::create(Monitoring::MetricCollectorType collectorType,
...
MonitoringSinkDescriptor::getCollectorType() const {
  return collectorType;
}

void MonitoringSinkDescriptor::setCollectorType(
