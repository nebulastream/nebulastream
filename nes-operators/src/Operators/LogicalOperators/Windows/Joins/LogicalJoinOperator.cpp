...
bool LogicalJoinOperator::inferSchema()
{
    ...
    const auto& sourceNameLeft = leftInputSchema.getSourceNameQualifier();
    const auto& sourceNameRight = rightInputSchema.getSourceNameQualifier();
