...
WindowAggregationDescriptor::WindowAggregationDescriptor(
    const ExpressionNodePtr &onField, const ExpressionNodePtr &asField)
    : onField(onField), asField(asField) {}

WindowAggregationDescriptorPtr
WindowAggregationDescriptor::as(const ExpressionNodePtr &asField) {
...
bool WindowAggregationDescriptor::equal(
