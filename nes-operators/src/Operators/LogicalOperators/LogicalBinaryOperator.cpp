...
LogicalBinaryOperator::LogicalBinaryOperator(OperatorId id)
    : OperatorNode(id), LogicalOperator(id), BinaryOperatorNode(id) {}
...
std::vector<OperatorNodePtr> LogicalBinaryOperator::getOperatorsBySchema(const SchemaPtr& schema) {
...
std::vector<OperatorNodePtr> LogicalBinaryOperator::getLeftOperators() { return getOperatorsBySchema(getLeftInputSchema()); }

std::vector<OperatorNodePtr> LogicalBinaryOperator::getRightOperators() {
