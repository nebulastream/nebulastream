...
bool StaticDataSourceDescriptor::equal(SourceDescriptorPtr const& other) const
{
    ...
    return schema == otherTableDescr->schema && pathTableFile == otherTableDescr->pathTableFile && lateStart == otherTableDescr->lateStart;
}
...
bool StaticDataSourceDescriptor::getLateStart() const
{
    return lateStart;
};
