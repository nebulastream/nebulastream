...
SourceDescriptorPtr OPCSourceDescriptor::create(SchemaPtr schema, std::string url, UA_NodeId nodeId, std::string user, std::string password)
{
    ...
    SchemaPtr schema, std::string logicalSourceName, std::string url, UA_NodeId nodeId, std::string user, std::string password)
{
    return std::make_shared<OPCSourceDescriptor>(OPCSourceDescriptor(
        std::move(schema), std::move(logicalSourceName), std::move(url), std::move(nodeId), std::move(user), std::move(password)));
}

OPCSourceDescriptor::OPCSourceDescriptor(SchemaPtr schema, std::string url, UA_NodeId nodeId, std::string user, std::string password)
...
OPCSourceDescriptor::OPCSourceDescriptor(
    SchemaPtr schema, std::string logicalSourceName, std::string url, UA_NodeId nodeId, std::string user, std::string password)
