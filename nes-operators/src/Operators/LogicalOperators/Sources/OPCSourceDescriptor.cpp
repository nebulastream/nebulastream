...
SourceDescriptorPtr OPCSourceDescriptor::create(
    SchemaPtr schema, std::string logicalSourceName, std::string url,
...
bool OPCSourceDescriptor::equal(SourceDescriptorPtr const& other) const {
  if (!other->instanceOf<OPCSourceDescriptor>()) return false;
