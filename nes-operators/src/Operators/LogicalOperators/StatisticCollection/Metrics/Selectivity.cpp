...
MetricPtr Selectivity::create(
    const FieldAccessExpressionNodePtr& expressionNode) {
...
Selectivity::Selectivity(const FieldAccessExpressionNodePtr& expressionNode)
    : StatisticMetric(expressionNode) {}
}  // namespace NES::Statistic
