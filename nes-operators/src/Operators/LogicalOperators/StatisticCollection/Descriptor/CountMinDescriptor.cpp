...
WindowStatisticDescriptorPtr CountMinDescriptor::create(
...
WindowStatisticDescriptorPtr CountMinDescriptor::create(
    FieldAccessExpressionNodePtr field, double error, double probability) {
...
WindowStatisticDescriptorPtr CountMinDescriptor::create(
    FieldAccessExpressionNodePtr field, uint64_t width, uint64_t depth) {
