...
WindowStatisticDescriptorPtr HyperLogLogDescriptor::create(
    FieldAccessExpressionNodePtr field) {
  return create(std::move(field), DEFAULT_RELATIVE_ERROR);
}

WindowStatisticDescriptorPtr HyperLogLogDescriptor::create(
    FieldAccessExpressionNodePtr field, double error) {
...
WindowStatisticDescriptorPtr HyperLogLogDescriptor::create(
    FieldAccessExpressionNodePtr field, uint64_t width) {
