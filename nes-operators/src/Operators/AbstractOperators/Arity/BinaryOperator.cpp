...
void BinaryOperator::setLeftInputOriginIds(
...
void BinaryOperator::setRightInputOriginIds(
    const std::vector<OriginId> &originIds) {
...
std::vector<OriginId> BinaryOperator::getOutputOriginIds() const {
  ...
  outputOriginIds.insert(outputOriginIds.end(), rightInputOriginIds.begin(),
