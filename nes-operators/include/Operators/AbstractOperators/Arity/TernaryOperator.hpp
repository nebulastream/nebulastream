...
#ifndef NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_TERNARYOPERATOR_HPP_
#define NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_TERNARYOPERATOR_HPP_
...
/**
 * @brief A Ternary operator with more the none input operator, thus it has a left, middle and a right input schema.
 */
class TernaryOperator : public virtual Operator {
  public:
    explicit TernaryOperator(OperatorId id);
...
#endif// NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_TERNARYOPERATOR_HPP_
