...
#ifndef NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_QUARTEROPERATOR_HPP_
#define NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_QUARTEROPERATOR_HPP_
...
/**
 * @brief A Quarter operator with more the none input operator, thus it has a left, middle and a right input schema.
 */
class QuaternaryOperator : public virtual Operator {
  public:
    explicit QuaternaryOperator(OperatorId id);
   ...
   */
    ...
    */
    ...
    /**
   * @brief get the input schema of this operator from the middle
   * @return SchemaPtr
   */
    SchemaPtr getMiddleInputSchema() const;

    /**
    * @brief set the input schema of this operator for the middle
     * @param inputSchema
    */
    void setMiddleInputSchema(SchemaPtr inputSchema);

    /**
    * @brief get the input schema of this operator from the right side
    * @return SchemaPtr
    */
    ...
    */
    ...
    /**
     * @brief Set the input origin ids for the middle input stream.
     * @param originIds
     */
    void setMiddleInputOriginIds(const std::vector<OriginId>& originIds);

    /**
     * @brief Gets the input origin ids for the middle input stream
     * @return std::vector<OriginId>
     */
    virtual std::vector<OriginId> getMiddleInputOriginIds();
...
#endif// NES_OPERATORS_INCLUDE_OPERATORS_ABSTRACTOPERATORS_ARITY_QUARTEROPERATOR_HPP_
