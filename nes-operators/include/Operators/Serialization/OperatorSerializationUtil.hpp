...
public:
   ...
   */
  static SerializableOperator
  serializeOperator(const OperatorPtr &operatorNode,
   ...
   */
  static OperatorPtr
  deserializeOperator(SerializableOperator serializedOperator);
   ...
   */
  static void
  serializeSourceOperator(const SourceLogicalOperator &sourceOperator,
   ...
   */
  static void
  serializeFilterOperator(const LogicalFilterOperator &filterOperator,
                          SerializableOperator &serializedOperator);
  ...
  deserializeSinkOperator(const SerializableOperator_SinkDetails &sinkDetails);
   ...
   */
  static LogicalUnaryOperatorPtr
  deserializeMapOperator(const SerializableOperator_MapDetails &mapDetails);
   ...
   */
  static LogicalJoinOperatorPtr
  deserializeJoinOperator(const SerializableOperator_JoinDetails &joinDetails,
                          OperatorId operatorId);
   ...
   */
  static void
  serializeSourceDescriptor(const SourceDescriptor &sourceDescriptor,
   ...
   */
  static void
  serializeSinkDescriptor(const SinkDescriptor &sinkDescriptor,
   ...
   */
  static void
  serializeLimitOperator(const LogicalLimitOperator &limitLogicalOperator,
                         SerializableOperator &serializedOperator);
   ...
   */
  static void
  deserializeInputSchema(LogicalOperatorPtr operatorNode,
  ...
  static void
  serializeJavaUDFOperator(const T &mapJavaUDFOperator,
                           SerializableOperator &serializedOperator);
