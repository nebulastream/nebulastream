...
/**
 * @brief The OperatorSerializationUtil offers functionality to serialize and
 * deserialize logical operator trees to a corresponding protobuffer object.
 */
class OperatorSerializationUtil {
 public:
  /**
   * @brief Serializes an operator node and all its children to a
   * SerializableOperator object.
   * @param operatorNode The operator node. Usually the root of the operator
   * graph.
   * @param serializedParent The corresponding protobuf object, which is used to
   ...
   */
  static SerializableOperator serializeOperator(
      const OperatorPtr& operatorNode, bool isClientOriginated = false);
   ...
   * @return OperatorPtr
   */
  static OperatorPtr deserializeOperator(
      SerializableOperator serializedOperator);

  /**
   * @brief Serializes an source operator and all its properties to a
   * SerializableOperator_SourceDetails object.
   * @param sourceOperator The source operator node.
   * @param isClientOriginated Indicate if the source operator is originated
   * from a client.
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeSourceOperator(
      const SourceLogicalOperator& sourceOperator,
      SerializableOperator& serializedOperator,
      bool isClientOriginated = false);

  /**
   * @brief Deserializes a source logical operator and all its properties to a
   ...
   */
  static LogicalUnaryOperatorPtr deserializeSourceOperator(
      const SerializableOperator_SourceDetails& sourceDetails);

  /**
   * @brief Serializes a filter operator node and all its properties to a
   * SerializableOperator_FilterDetails object.
   * @param filterOperator the LogicalFilterOperator
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeFilterOperator(
      const LogicalFilterOperator& filterOperator,
      SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes a SerializableOperator_FilterDetails and all its
   * properties to a LogicalFilterOperator
   * @param filterDetails The serialized filterDetails
   * @return LogicalFilterOperator of type LogicalUnaryOperator
   */
  static LogicalUnaryOperatorPtr deserializeFilterOperator(
      const SerializableOperator_FilterDetails& filterDetails);

  /**
   * @brief Serializes a projection operator node and all its properties to a
   * SerializableOperator_ProjectionDetails
   * @param projectionOperator the LogicalProjectionOperator
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeProjectionOperator(
      const LogicalProjectionOperator& projectionOperator,
      SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes a projection operator node and all its properties to a
   * LogicalProjectionOperatorPtr
   * @param projectionDetails the serialized projectionDetails
   * @return LogicalProjectionOperator of type LogicalUnaryOperator
   */
  static LogicalUnaryOperatorPtr deserializeProjectionOperator(
      const SerializableOperator_ProjectionDetails& projectionDetails);

  /**
   * @brief Serializes an sink operator and all its properties to a
   * SerializableOperator_SinkDetails object.
   * @param sinkOperator The sink operator node.
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeSinkOperator(const SinkLogicalOperator& sinkOperator,
                                    SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes the SerializableOperator_SinkDetails and all its
   * properties back to a sink operatorNodePtr
   * @param sinkDetails The serialized sink operator details.
   * @return SinkLogicalOperatorPtr of type LogicalUnaryOperator
   */
  static LogicalUnaryOperatorPtr deserializeSinkOperator(
      const SerializableOperator_SinkDetails& sinkDetails);

  /**
   * @brief Serializes a map operator and all its properties to a
   * SerializableOperator_MapDetails
   * @param mapOperator the map operator
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeMapOperator(const LogicalMapOperator& mapOperator,
                                   SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes a map operator and all its properties back to a
   * LogicalMapOperator
   ...
   */
  static LogicalUnaryOperatorPtr deserializeMapOperator(
      const SerializableOperator_MapDetails& mapDetails);

  /**
   * @brief Serializes an all window operator and all its properties to a
   * SerializableOperator_WindowDetails object.
   ...
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeWindowOperator(const WindowOperator& windowOperator,
                                      SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes the SerializableOperator_WindowDetails and all its
   * properties back to a central window operatorNodePtr
   ...
   */
  static LogicalUnaryOperatorPtr deserializeWindowOperator(
      const SerializableOperator_WindowDetails& windowDetails,
      OperatorId operatorId);

  /**
   * @brief Serializes an all join operator and all its properties to a
   * SerializableOperator_JoinDetails object.
   * @param LogicalJoinOperatorPtr The window operator node.
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeJoinOperator(const LogicalJoinOperator& joinOperator,
                                    SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes the SerializableOperator_JoinDetails and all its
   * properties back to a join operatorNodePtr
   * @param sinkDetails The serialized sink operator details.
   * @param operatorId: id of the operator to be deserialized
   * @return LogicalJoinOperator of type LogicalUnaryOperator
   */
  static LogicalJoinOperatorPtr deserializeJoinOperator(
      const SerializableOperator_JoinDetails& joinDetails,
      OperatorId operatorId);

  /**
   * @brief Serializes an batch join operator and all its properties to a
   * SerializableOperator_JoinDetails object.
   * @param LogicalBatchJoinOperatorPtr The window operator node.
   * @param batchJoinDetails the serialized
   * SerializableOperator_BatchJoinDetails.
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeBatchJoinOperator(
      const Experimental::LogicalBatchJoinOperator& joinOperator,
      SerializableOperator& serializedOperator);

  /**
   * @brief Deserializes the SerializableOperator_BatchJoinDetails and all its
   * properties back to a join operatorNodePtr
   * @param sinkDetails The serialized sink operator details.
   * @param operatorId: id of the operator to be deserialized
   * @return LogicalBatchJoinOperator of type LogicalUnaryOperator
   */
  static Experimental::LogicalBatchJoinOperatorPtr deserializeBatchJoinOperator(
      const SerializableOperator_BatchJoinDetails& joinDetails,
      OperatorId operatorId);

  /**
   * @brief Serializes an source descriptor and all its properties to a
   * SerializableOperator_SourceDetails object.
  ...
  /**
   * @brief Deserializes the SerializableOperator_SourceDetails and all its
   * properties back to a sink SourceDescriptorPtr.
   * @param sourceDetails The serialized source operator details.
   * @return SourceDescriptorPtr
   */
  static SourceDescriptorPtr deserializeSourceDescriptor(
      const SerializableOperator_SourceDetails& sourceDetails);

  /**
   * @brief Serializes an sink descriptor and all its properties to a
   * SerializableOperator_SinkDetails object.
  ...
  /**
   * @brief Deserializes the SerializableOperator_SinkDetails and all its
   * properties back to a sink SinkDescriptorPtr.
   * @param sinkDetails The serialized sink operator details.
   * @return OperatorPtr
   */
  static SinkDescriptorPtr deserializeSinkDescriptor(
      const SerializableOperator_SinkDetails& sinkDetails);
   ...
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeLimitOperator(
      const LogicalLimitOperator& limitLogicalOperator,
      SerializableOperator& serializedOperator);
   ...
   */
  static LogicalUnaryOperatorPtr deserializeLimitOperator(
   ...
   */
  static LogicalUnaryOperatorPtr deserializeWatermarkAssignerOperator(
  ...
  deserializeWatermarkStrategyDescriptor(
      const SerializableOperator_WatermarkStrategyDetails&
          watermarkStrategyDetails);
   ...
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeInputSchema(const OperatorPtr& operatorNode,
                                   SerializableOperator& serializedOperator);
   ...
   */
  static void deserializeInputSchema(
   ...
   * @param serializedOperator serialized instance of the operator
   */
  static void serializeInferModelOperator(
      const InferModel::LogicalInferModelOperator& inferModel,
      SerializableOperator& serializedOperator);
   ...
   */
  static LogicalUnaryOperatorPtr deserializeInferModelOperator(
   ...
   * @param serializedOperator serialized instance of the operator
   * @tparam T The LogicalOperator (either MapJavaUDFLogicalOperator or
   * FlatMapJavaUDFLogicalOperator)
   * @tparam D The GRPC SerializeOperator details message (either
   * SerializableOperator_MapJavaUdfDetails or
   * SerializableOperator_FlatMapJavaUdfDetails)
   */
  template <typename T, typename D>
  static void serializeJavaUDFOperator(
      const T& mapJavaUDFOperator, SerializableOperator& serializedOperator);
   ...
   */
  static LogicalUnaryOperatorPtr deserializeMapJavaUDFOperator(
   ...
   * @return MapJavaUdfLogicalOperatorPtr
   */
  static LogicalUnaryOperatorPtr deserializeFlatMapJavaUDFOperator(
   ...
   */
  static void serializeOpenCLOperator(
      const NES::LogicalOpenCLOperator& openCLLogicalOperator,
      SerializableOperator& serializedOperator);
   ...
   */
  static LogicalUnaryOperatorPtr deserializeOpenCLOperator(
   ...
   */
  static LogicalUnaryOperatorPtr deserializeStatisticWindowOperator(
      const SerializableOperator_StatisticWindowDetails&
          statisticWindowDetails);
};
}  // namespace NES
