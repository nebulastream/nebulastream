...
public:
   ...
   * @param addTimestamp flat to indicate if timestamp shall be add when writing
   * to file
  ...
  static SinkDescriptorPtr create(std::string_view fileName,
                                  ...
                                  std::string_view append, bool addTimestamp,
   ...
   * @return descriptor for file sink
   */
  static SinkDescriptorPtr create(const std::string &fileName,
