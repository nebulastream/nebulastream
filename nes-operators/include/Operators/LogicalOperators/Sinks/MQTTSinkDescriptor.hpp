...
class MQTTSinkDescriptor : public SinkDescriptor {
 public:
   ...
   */
  static SinkDescriptorPtr create(std::string&& address, std::string&& topic,
                                  std::string&& user, uint64_t maxBufferedMSGs,
                                  TimeUnits timeUnit, uint64_t messageDelay,
   ...
   * @return MQTT sink
   */
  explicit MQTTSinkDescriptor(std::string&& address, std::string&& clientId,
                              std::string&& topic, std::string&& user,
                              uint64_t maxBufferedMSGs, TimeUnits timeUnit,
