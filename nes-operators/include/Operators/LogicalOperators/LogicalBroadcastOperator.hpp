 ...
 */
class LogicalBroadcastOperator : public ExchangeOperatorNode, public LogicalOperator {
  public:
    explicit LogicalBroadcastOperator(OperatorId id);
    ~LogicalBroadcastOperator() override = default;
