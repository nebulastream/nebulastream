...
public:
  ...
  createFilterOperator(ExpressionNodePtr const &predicate,
   ...
   */
  static LogicalUnaryOperatorPtr
  createRenameSourceOperator(std::string const &newSourceName,
                             OperatorId id = getNextOperatorId());
   ...
   */
  static LogicalUnaryOperatorPtr
  createLimitOperator(const uint64_t limit,
                      OperatorId id = getNextOperatorId());
   ...
   */
  static LogicalUnaryOperatorPtr
  createProjectionOperator(const std::vector<ExpressionNodePtr> &expressions,
                           OperatorId id = getNextOperatorId());
   ...
   */
  static LogicalUnaryOperatorPtr
  createSinkOperator(SinkDescriptorPtr const &sinkDescriptor,
   ...
   */
  static LogicalUnaryOperatorPtr
  createMapOperator(FieldAssignmentExpressionNodePtr const &mapExpression,
                    OperatorId id = getNextOperatorId());
   ...
   */
  static LogicalUnaryOperatorPtr
  createInferModelOperator(std::string model,
   ...
   */
  static LogicalUnaryOperatorPtr
  createSourceOperator(SourceDescriptorPtr const &sourceDescriptor,
                       OperatorId id = getNextOperatorId(),
  ...
  createUnionOperator(OperatorId id = getNextOperatorId());
   ...
   */
  static LogicalBinaryOperatorPtr
  createJoinOperator(const Join::LogicalJoinDescriptorPtr &joinDefinition,
                     OperatorId id = getNextOperatorId());
