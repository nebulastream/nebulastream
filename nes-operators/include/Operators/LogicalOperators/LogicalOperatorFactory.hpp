...
public:
    ...
    createFilterOperator(const std::shared_ptr<LogicalFunction>& predicate, OperatorId id = getNextOperatorId());
     ...
     */
    static std::shared_ptr<LogicalUnaryOperator>
    createRenameSourceOperator(const std::string& newSourceName, OperatorId id = getNextOperatorId());
    ...
    */
    ...
    static std::shared_ptr<LogicalUnaryOperator>
    createSinkOperator(WorkerId workerId = INVALID_WORKER_NODE_ID, OperatorId id = getNextOperatorId());
     ...
     */
    static std::shared_ptr<LogicalUnaryOperator>
    createMapOperator(const std::shared_ptr<FieldAssignmentBinaryLogicalFunction>& mapFunction, OperatorId id = getNextOperatorId());
    ...
    */
    static std::shared_ptr<LogicalUnaryOperator> createWatermarkAssignerOperator(
        const std::shared_ptr<Windowing::WatermarkStrategyDescriptor>& watermarkStrategyDescriptor, OperatorId id = getNextOperatorId());
    /**
     ...
     */
    static std::shared_ptr<LogicalUnaryOperator>
    createWindowOperator(const std::shared_ptr<Windowing::LogicalWindowDescriptor>& windowDefinition, OperatorId id = getNextOperatorId());
