...
class JoinDescriptor {
  ...
  public:
    ...
    explicit JoinDescriptor(FieldAccessExpressionNodePtr leftJoinKeyType,
   ...
   */
    ...
    */
     ...
     * @param other: JoinDescriptor that we want to check if they are equal
     * @return Boolean
     */
    bool equals(const JoinDescriptor& other) const;
