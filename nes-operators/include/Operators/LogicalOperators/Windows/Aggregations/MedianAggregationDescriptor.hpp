...
/**
 * @brief
 * The MedianAggregationDescriptor aggregation calculates the median over the
 * window.
 */
class MedianAggregationDescriptor : public WindowAggregationDescriptor {
public:
  /**
   * @brief Factory method to creates a median aggregation on a particular
   * field.
   ...
   * field.
   * @param onField field on which the aggregation should be performed
   * @param asField expression describing how the aggregated field should be
   * called
   */
...
private:
   ...
   * called
   */
  MedianAggregationDescriptor(ExpressionNodePtr onField,
