...
#ifndef NES_OPERATORS_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_SOURCELOGICALOPERATORNODE_HPP_
#define NES_OPERATORS_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_SOURCELOGICALOPERATORNODE_HPP_
 ...
 */
class LogicalSourceOperator : public LogicalUnaryOperator, public OriginIdAssignmentOperator {
  public:
    explicit LogicalSourceOperator(SourceDescriptorPtr const& sourceDescriptor, OperatorId id);
    explicit LogicalSourceOperator(SourceDescriptorPtr const& sourceDescriptor, OperatorId id, OriginId originId);
...
#endif  // NES_OPERATORS_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_SOURCELOGICALOPERATORNODE_HPP_
