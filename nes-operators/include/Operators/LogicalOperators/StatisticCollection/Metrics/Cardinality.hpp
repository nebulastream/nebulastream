...
/**
 * @brief Collectes the cardinality for the fieldName. In a database context,
 * cardinality refers to the number of unique values in a relational table
 * column relative to the total number of rows in the table.
 */
