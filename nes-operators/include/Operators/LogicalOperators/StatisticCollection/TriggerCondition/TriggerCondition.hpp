...
public:
  ...
  shallTrigger(const ExpressionNode &triggerExpression) = 0;
   ...
   */
  template <class TriggerCondition> bool instanceOf() {
   ...
   * @return bool true if node is of TriggerCondition
   */
  template <class TriggerCondition> bool instanceOf() const {
