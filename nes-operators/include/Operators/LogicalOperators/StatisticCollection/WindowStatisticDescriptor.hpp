...
class WindowStatisticDescriptor : public std::enable_shared_from_this<WindowStatisticDescriptor> {
  public:
     ...
     */
    virtual void addDescriptorFields(Schema& inputSchema, Schema& outputSchema, const std::string& qualifierNameWithSeparator) = 0;
...
#endif//NES_NES_OPERATORS_INCLUDE_OPERATORS_LOGICALOPERATORS_STATISTICCOLLECTION_SYNOPSES_WINDOWSTATISTICDESCRIPTOR_HPP_
