 ...
 */
class LogicalUDFOperator : public LogicalUnaryOperator {

  public:
    /**
     * Construct a LogicalUDFOperator.
     * @param udfDescriptor The descriptor of the UDF used in the map operation.
     * @param id The ID of the operator.
     */
    LogicalUDFOperator(const Catalogs::UDF::UDFDescriptorPtr udfDescriptor, OperatorId id);
