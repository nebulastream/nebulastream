...
public:
   ...
   */
  static QueryPlanPtr
  addProjection(const std::vector<ExpressionNodePtr> &expressions,
   ...
   */
  static QueryPlanPtr
  addMap(FieldAssignmentExpressionNodePtr const &mapExpression,
         QueryPlanPtr queryPlan);
   ...
   */
  static QueryPlanPtr
  addMapUDF(Catalogs::UDF::UDFDescriptorPtr const &descriptor,
            QueryPlanPtr queryPlan);
   ...
   */
  static QueryPlanPtr
  addFlatMapUDF(Catalogs::UDF::UDFDescriptorPtr const &descriptor,
                QueryPlanPtr queryPlan);
   ...
   */
  static QueryPlanPtr
  assignWatermark(QueryPlanPtr queryPlan,
   ...
   */
  static QueryPlanPtr
  checkAndAddWatermarkAssignment(QueryPlanPtr queryPlan,
                                 const Windowing::WindowTypePtr windowType);
...
private:
   ...
   */
  static std::shared_ptr<FieldAccessExpressionNode>
  checkExpression(ExpressionNodePtr expression, std::string side);
   ...
   */
  static QueryPlanPtr
  addBinaryOperatorAndUpdateSource(OperatorPtr operatorNode,
