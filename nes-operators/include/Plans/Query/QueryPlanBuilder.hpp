...
private:
    /**
     * @brief This method checks if an FunctionNode is instance Of NodeFunctionFieldAccess for Join and BatchJoin
     ...
     * @return functionNode as NodeFunctionFieldAccess
     */
