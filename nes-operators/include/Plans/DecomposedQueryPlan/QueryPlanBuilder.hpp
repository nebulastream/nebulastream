...
public:
    ...
    static QueryPlan addProjection(std::vector<std::unique_ptr<LogicalFunction>> functions, QueryPlan queryPlan);
    ...
    /// @return the updated queryPlan
    static QueryPlan addSelection(std::unique_ptr<LogicalFunction> selectionFunction, QueryPlan queryPlan);
    ...
    static QueryPlan addMap(std::unique_ptr<FieldAssignmentLogicalFunction> mapFunction, QueryPlan queryPlan);
...
private:
    ...
    /// @return the updated queryPlan
    static QueryPlan
    addBinaryOperatorAndUpdateSource(std::unique_ptr<Operator> operatorNode, QueryPlan leftQueryPlan, QueryPlan rightQueryPlan);
};
}
