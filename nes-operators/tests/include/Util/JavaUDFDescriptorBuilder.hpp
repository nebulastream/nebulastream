...
class JavaUDFDescriptorBuilder {
 public:
   ...
   * @return The JavaUDFDescriptorBuilder instance.
   */
  JavaUDFDescriptorBuilder& setInstance(
   ...
   * @return The JavaUDFDescriptorBuilder instance.
   */
  JavaUDFDescriptorBuilder& setByteCodeList(
   ...
   * @return The JavaUDFDescriptorBuilder instance.
   */
  JavaUDFDescriptorBuilder& setInputClassName(
   ...
   * @return The JavaUDFDescriptorBuilder instance.
   */
  JavaUDFDescriptorBuilder& setOutputClassName(
