...
public:
    ...
    {
        /// NOLINTBEGIN(performance-no-int-to-ptr, cppcoreguidelines-pro-type-reinterpret-cast, hicpp-signed-bitwise, readability-magic-numbers) - intentional tagged pointer manipulation
        return reinterpret_cast<void*>(data & ((1ULL << 48) - 1));
        /// NOLINTEND(performance-no-int-to-ptr, cppcoreguidelines-pro-type-reinterpret-cast, hicpp-signed-bitwise, readability-magic-numbers) - intentional tagged pointer manipulation
    }
