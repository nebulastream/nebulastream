...
impl TupleBufferHandle {
    ...
    pub fn as_raw_ptr(&mut self) -> *mut ffi::TupleBuffer {
...
impl BufferProviderHandle {
    ...
    pub fn as_raw_ptr(&self) -> *mut ffi::AbstractBufferProvider {
        self.ptr
    }
}
...
pub static BUFFER_NOTIFY: LazyLock<Notify> = LazyLock::new(Notify::new);
