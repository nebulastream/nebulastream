...
void TupleBuffer::setWatermark(const Runtime::Timestamp value) const noexcept
{
...
void TupleBuffer::setCreationTimestampInMS(const Runtime::Timestamp value) const noexcept
{
