...
NAUT_INLINE uint64_t BufferControlBlock::getNumberOfTuples() const noexcept
{
    return numberOfTuples;
}

NAUT_INLINE void BufferControlBlock::setNumberOfTuples(const uint64_t numberOfTuples)
{
    this->numberOfTuples = numberOfTuples;
}

NAUT_INLINE Timestamp BufferControlBlock::getWatermark() const noexcept
{
    return watermark;
}

NAUT_INLINE void BufferControlBlock::setWatermark(const Timestamp watermark)
{
    this->watermark = watermark;
}

NAUT_INLINE SequenceNumber BufferControlBlock::getSequenceNumber() const noexcept
{
    return sequenceNumber;
}

NAUT_INLINE void BufferControlBlock::setSequenceNumber(const SequenceNumber sequenceNumber)
{
    this->sequenceNumber = sequenceNumber;
}

NAUT_INLINE ChunkNumber BufferControlBlock::getChunkNumber() const noexcept
{
    return chunkNumber;
}

NAUT_INLINE void BufferControlBlock::setChunkNumber(const ChunkNumber chunkNumber)
{
    this->chunkNumber = chunkNumber;
}

NAUT_INLINE bool BufferControlBlock::isLastChunk() const noexcept
{
    return lastChunk;
}

NAUT_INLINE void BufferControlBlock::setLastChunk(const bool lastChunk)
{
    this->lastChunk = lastChunk;
}

NAUT_INLINE void BufferControlBlock::setCreationTimestamp(const Timestamp timestamp)
{
    this->creationTimestamp = timestamp;
}

NAUT_INLINE Timestamp BufferControlBlock::getCreationTimestamp() const noexcept
{
    return creationTimestamp;
}

NAUT_INLINE OriginId BufferControlBlock::getOriginId() const noexcept
{
    return originId;
}

NAUT_INLINE void BufferControlBlock::setOriginId(const OriginId originId)
{
