...
#ifndef NES_MEMORY_INCLUDE_RUNTIME_TUPLEBUFFER_HPP_
#define NES_MEMORY_INCLUDE_RUNTIME_TUPLEBUFFER_HPP_
...
class TupleBuffer {
  ...
  public:
    ...
    static constexpr uint64_t INITIAL_SEQUENCE_NUMBER = 1;
    ...
    static constexpr uint64_t INITIAL_CHUNK_NUMBER = 1;
    ...
    uint8_t* getBuffer() noexcept { return getBuffer<uint8_t>(); }
...
#endif// NES_MEMORY_INCLUDE_RUNTIME_TUPLEBUFFER_HPP_
