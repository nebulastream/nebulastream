...
#ifndef NES_INCLUDE_SOURCES_PARSERS_CSVTENSORPARSER_HPP_
#define NES_INCLUDE_SOURCES_PARSERS_CSVTENSORPARSER_HPP_
...
*/
    CSVTensorParser(std::vector<NES::PhysicalTypePtr> physicalTypes, std::string delimiter);
...
*/
    bool writeInputTupleToTensor(std::ifstream input,
                                 uint64_t tupleCount,
...
#endif// NES_INCLUDE_SOURCES_PARSERS_CSVTENSORPARSER_HPP_
