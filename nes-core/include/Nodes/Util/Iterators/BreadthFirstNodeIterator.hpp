...
#ifndef NES_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
#define NES_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
#include <memory>
#include <queue>
namespace NES {
...
#endif  // NES_INCLUDE_NODES_UTIL_ITERATORS_BREADTHFIRSTNODEITERATOR_HPP_
