...
#ifndef NES_CORE_INCLUDE_UTIL_DUMPHANDLER_DUMPCONTEXT_HPP_
#define NES_CORE_INCLUDE_UTIL_DUMPHANDLER_DUMPCONTEXT_HPP_
...
#endif// NES_CORE_INCLUDE_UTIL_DUMPHANDLER_DUMPCONTEXT_HPP_
