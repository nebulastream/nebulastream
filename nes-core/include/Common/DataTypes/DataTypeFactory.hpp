...
class DataTypeFactory {
  ...
  public:
    ...
    */
    ...
    /**
     * @brief constructs a new Tensor data type
     ...
     */
    static DataTypePtr createTensor(const std::vector<std::size_t> shape, const std::string component, const std::string tensorType);
     ...
     * @param tensorMemoryFormat the type of underlying data structure for saving in memory, the tensor should use
     */
    static DataTypePtr createTensor(const std::vector<std::size_t> shape, const DataTypePtr component, const TensorMemoryFormat tensorType);
