...
#ifndef NES_INCLUDE_COMMON_PHYSICALTYPES_ARRAYPHYSICALTYPE_HPP_
#define NES_INCLUDE_COMMON_PHYSICALTYPES_ARRAYPHYSICALTYPE_HPP_
...
#endif  // NES_INCLUDE_COMMON_PHYSICALTYPES_ARRAYPHYSICALTYPE_HPP_
