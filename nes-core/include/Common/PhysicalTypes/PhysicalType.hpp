...
#ifndef NES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
#define NES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
...
#endif  // NES_INCLUDE_COMMON_PHYSICALTYPES_PHYSICALTYPE_HPP_
