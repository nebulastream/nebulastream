...
#ifndef NES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_
#define NES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_
...
class BasicPhysicalType final : public PhysicalType {
  public:
    enum NativeType { UINT_8, UINT_16, UINT_32, UINT_64, INT_8, INT_16, INT_32, INT_64, FLOAT, DOUBLE, CHAR, BOOLEAN, TEXT };
...
#endif// NES_INCLUDE_COMMON_PHYSICALTYPES_BASICPHYSICALTYPE_HPP_
