...
class  NesCEPParser : public antlr4::Parser {
  public:
    ...
    enum {
        RuleQuery = 0, RuleCepPattern = 1, RuleInputStreams = 2, RuleInputStream = 3,
        RuleCompositeEventExpressions = 4, RuleWhereExp = 5, RuleTimeConstraints = 6,
        RuleInterval = 7, RuleIntervalType = 8, RuleOption = 9, RuleOutputExpression = 10,
        RuleOutAttribute = 11, RuleSinkList = 12, RuleSink = 13, RuleListEvents = 14,
        RuleEventElem = 15, RuleEvent = 16, RuleQuantifiers = 17, RuleIterMax = 18,
        RuleIterMin = 19, RuleConsecutiveOption = 20, RuleOperatorRule = 21,
        RuleSequence = 22, RuleContiguity = 23, RuleSinkType = 24, RuleNullNotnull = 25,
        RuleConstant = 26, RuleExpressions = 27, RuleExpression = 28, RulePredicate = 29,
        RuleExpressionAtom = 30, RuleEventAttribute = 31, RuleEventIteration = 32,
        RuleMathExpression = 33, RuleAggregation = 34, RuleAttribute = 35, RuleAttVal = 36,
        RuleBoolRule = 37, RuleCondition = 38, RuleUnaryOperator = 39, RuleComparisonOperator = 40,
        RuleLogicalOperator = 41, RuleBitOperator = 42, RuleMathOperator = 43
    };
