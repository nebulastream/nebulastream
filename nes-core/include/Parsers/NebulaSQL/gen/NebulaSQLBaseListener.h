...
public:
  ...
  virtual void enterThresholdBasedWindow(NebulaSQLParser::ThresholdBasedWindowContext * /*ctx*/) override { }
  virtual void exitThresholdBasedWindow(NebulaSQLParser::ThresholdBasedWindowContext * /*ctx*/) override { }
  ...
  virtual void enterThresholdWindow(NebulaSQLParser::ThresholdWindowContext * /*ctx*/) override { }
  virtual void exitThresholdWindow(NebulaSQLParser::ThresholdWindowContext * /*ctx*/) override { }

  virtual void enterConditionParameter(NebulaSQLParser::ConditionParameterContext * /*ctx*/) override { }
  virtual void exitConditionParameter(NebulaSQLParser::ConditionParameterContext * /*ctx*/) override { }

  virtual void enterThresholdMinSizeParameter(NebulaSQLParser::ThresholdMinSizeParameterContext * /*ctx*/) override { }
  virtual void exitThresholdMinSizeParameter(NebulaSQLParser::ThresholdMinSizeParameterContext * /*ctx*/) override { }
