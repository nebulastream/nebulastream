...
*/
#ifndef NES_INCLUDE_QUERYCOMPILER_PHASES_TRANSLATIONS_DEFAULTGENERATABLEOPERATORPROVIDER_HPP_
#define NES_INCLUDE_QUERYCOMPILER_PHASES_TRANSLATIONS_DEFAULTGENERATABLEOPERATORPROVIDER_HPP_
