...
*/
#ifndef NES_INCLUDE_QUERY_COMPILER_PHASES_TRANSLATIONS_DEFAULT_GENERATABLE_OPERATOR_PROVIDER_HPP_
#define NES_INCLUDE_QUERY_COMPILER_PHASES_TRANSLATIONS_DEFAULT_GENERATABLE_OPERATOR_PROVIDER_HPP_
