...
*/
#ifndef NES_INCLUDE_QUERYCOMPILER_OPERATORS_OPERATORPIPELINE_HPP_
#define NES_INCLUDE_QUERYCOMPILER_OPERATORS_OPERATORPIPELINE_HPP_
...
#endif  // NES_INCLUDE_QUERYCOMPILER_OPERATORS_OPERATORPIPELINE_HPP_
