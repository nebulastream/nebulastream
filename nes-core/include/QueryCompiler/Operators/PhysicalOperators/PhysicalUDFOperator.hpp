...
#ifndef NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_PHYSICALUDFOPERATOR_HPP_
#define NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_PHYSICALUDFOPERATOR_HPP_
...
/**
 * @brief Physical UDF operator.
 */
class PhysicalUDFOperator : public PhysicalUnaryOperator {
  public:
    /**
     * @brief Constructor for PhysicalUDFOperator
     ...
     */
    PhysicalUDFOperator(OperatorId id,
...
#endif// NES_CORE_INCLUDE_QUERYCOMPILER_OPERATORS_PHYSICALOPERATORS_PHYSICALUDFOPERATOR_HPP_
