...
*/
#ifndef NES_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_TENSORGENERATABLETYPE_HPP_
#define NES_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_TENSORGENERATABLETYPE_HPP_
 ...
 */
class TensorGeneratableType final : public GeneratableDataType {
  public:
    TensorGeneratableType(TensorPhysicalTypePtr type, GeneratableDataTypePtr component);
  ...
  private:
    TensorPhysicalTypePtr type;
    GeneratableDataTypePtr component;
};
}// namespace QueryCompilation
}// namespace NES

#endif//NES_INCLUDE_QUERYCOMPILER_GENERATABLETYPES_TENSORGENERATABLETYPE_HPP_
