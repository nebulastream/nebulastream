...
*/
#ifndef NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_LOGICAL_BINARY_OPERATOR_NODE_HPP_
#define NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_LOGICAL_BINARY_OPERATOR_NODE_HPP_
