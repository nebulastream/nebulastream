...
class MQTTSourceDescriptor : public SourceDescriptor {
   ...
   * @param sourceConfig all needed physicalStreams for MQTT passed with object
   ...
   */
    ...
    create(SchemaPtr schema, Configurations::MQTTSourceTypeConfigPtr sourceConfig, SourceDescriptor::InputFormat inputFormat);

    /**
     * @brief get MQTT server address
     * @return serverAddress
     */
    Configurations::MQTTSourceTypeConfigPtr getSourceConfigPtr() const;
