...
#ifndef NES_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_MQTTSOURCEDESCRIPTOR_HPP_
#define NES_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_MQTTSOURCEDESCRIPTOR_HPP_
...
class MQTTSourceDescriptor : public SourceDescriptor {
   ...
   */
    ...
    create(SchemaPtr schema, MQTTSourceTypePtr sourceConfig, SourceDescriptor::InputFormat inputFormat);
  ...
  private:
     ...
     */
    explicit MQTTSourceDescriptor(SchemaPtr schema, MQTTSourceTypePtr mqttSourceType, SourceDescriptor::InputFormat inputFormat);
...
#endif
#endif  // NES_INCLUDE_OPERATORS_LOGICALOPERATORS_SOURCES_MQTTSOURCEDESCRIPTOR_HPP_
