...
#ifndef NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_DEFAULT_SOURCE_DESCRIPTOR_HPP_
#define NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_DEFAULT_SOURCE_DESCRIPTOR_HPP_
...
class DefaultSourceDescriptor : public SourceDescriptor {
  ...
  public:
    ...
    create(SchemaPtr schema, std::string streamName, uint64_t numbersOfBufferToProduce, uint64_t frequency);
...
#endif// NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_DEFAULT_SOURCE_DESCRIPTOR_HPP_
