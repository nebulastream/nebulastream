...
#ifndef NES_INCLUDE_WORKQUEUES_REQUESTTYPES_STOPQUERYREQUEST_HPP_
#define NES_INCLUDE_WORKQUEUES_REQUESTTYPES_STOPQUERYREQUEST_HPP_
...
class StopQueryRequest : public Request {
  ...
  public:
    ...
    StopQueryRequest(const StopQueryRequest&) = default;
    StopQueryRequest(StopQueryRequest&&) = default;
    StopQueryRequest& operator=(const StopQueryRequest&) = default;
    StopQueryRequest& operator=(StopQueryRequest&&) = default;
...
#endif  // NES_INCLUDE_WORKQUEUES_REQUESTTYPES_STOPQUERYREQUEST_HPP_
