...
class AbstractRequest {
  public:
     ...
     * request
     */
    void execute(const StorageHandlerPtr& storageHandle);
     ...
     */
    virtual void rollBack(std::exception& ex, StorageHandlerPtr storageHandle) = 0;
     ...
     * @param storageHandle: The storage access handle that was used by the request to modify the system state.
     */
    void handleError(std::exception ex, const StorageHandlerPtr& storageHandle);
  ...
  protected:
     ...
     */
    virtual void preRollbackHandle(std::exception ex, StorageHandlerPtr storageHandle) = 0;
     ...
     * @param storageHandle: The storage access handle used by the request
     */
    virtual void postRollbackHandle(std::exception ex, StorageHandlerPtr storageHandle) = 0;
     ...
     * request
     */
    virtual void executeRequestLogic(StorageHandlerPtr storageHandle) = 0;
