...
class FailQueryRequest : public AbstractRequest {
  ...
  protected:
     ...
     */
    void preRollbackHandle(BaseRequestExecutionException& ex, StorageHandler& storageHandler) override;
     ...
     * @param storageHandle: The storage access handle used by the request
     */
    void postRollbackHandle(BaseRequestExecutionException& ex, StorageHandler& storageHandler) override;
