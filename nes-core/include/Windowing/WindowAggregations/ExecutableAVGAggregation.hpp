...
#ifndef NES_INCLUDE_WINDOWING_WINDOW_AGGREGATIONS_EXECUTABLE_AVG_AGGREGATION_HPP_
#define NES_INCLUDE_WINDOWING_WINDOW_AGGREGATIONS_EXECUTABLE_AVG_AGGREGATION_HPP_
