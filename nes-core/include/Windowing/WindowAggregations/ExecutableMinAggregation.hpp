...
#ifndef NES_INCLUDE_WINDOWING_WINDOW_AGGREGATIONS_EXECUTABLE_MIN_AGGREGATION_HPP_
#define NES_INCLUDE_WINDOWING_WINDOW_AGGREGATIONS_EXECUTABLE_MIN_AGGREGATION_HPP_
