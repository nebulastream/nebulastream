...
#ifndef NES_INCLUDE_WINDOWING_WINDOW_POLICIES_ON_RECORD_TRIGGER_POLICY_DESCRIPTION_HPP_
#define NES_INCLUDE_WINDOWING_WINDOW_POLICIES_ON_RECORD_TRIGGER_POLICY_DESCRIPTION_HPP_
