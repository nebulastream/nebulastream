...
#ifndef NES_INCLUDE_WINDOWING_WATERMARK_INGESTIONTIMEWATERMARKSTRATEGYDESCRIPTOR_HPP_
...
class IngestionTimeWatermarkStrategyDescriptor : public WatermarkStrategyDescriptor {
  public:
     ...
     */
    bool inferStamp(const Optimizer::TypeInferencePhaseContext& ctx, SchemaPtr schema) override;
...
#endif// NES_INCLUDE_WINDOWING_WATERMARK_INGESTIONTIMEWATERMARKSTRATEGYDESCRIPTOR_HPP_
