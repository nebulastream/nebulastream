...
#ifndef NES_INCLUDE_WINDOWING_WATERMARK_WATERMARKSTRATEGYDESCRIPTOR_HPP_
...
class WatermarkStrategyDescriptor : public std::enable_shared_from_this<WatermarkStrategyDescriptor> {
  public:
    ...
    */
    ...
    virtual bool inferStamp(const Optimizer::TypeInferencePhaseContext& ctx, SchemaPtr schema) = 0;
};
}// namespace NES::Windowing

#endif// NES_INCLUDE_WINDOWING_WATERMARK_WATERMARKSTRATEGYDESCRIPTOR_HPP_
