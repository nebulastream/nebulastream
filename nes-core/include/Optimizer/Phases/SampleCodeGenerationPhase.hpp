...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_PHASES_SAMPLECODEGENERATIONPHASE_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_PHASES_SAMPLECODEGENERATIONPHASE_HPP_
...
#endif // NES_CORE_INCLUDE_OPTIMIZER_PHASES_SAMPLECODEGENERATIONPHASE_HPP_
