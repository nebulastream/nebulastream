...
#ifndef NES_INCLUDE_OPTIMIZER_QUERYMERGER_FaultToleranceBasedQueryMergerRule_HPP_
#define NES_INCLUDE_OPTIMIZER_QUERYMERGER_FaultToleranceBasedQueryMergerRule_HPP_
...
class FaultToleranceBasedQueryMergerRule;
using FaultToleranceBasedQueryMergerRulePtr = std::shared_ptr<FaultToleranceBasedQueryMergerRule>;
 ...
 *
 */
class FaultToleranceBasedQueryMergerRule final : public BaseQueryMergerRule {

  public:
    static FaultToleranceBasedQueryMergerRulePtr create();
...
#endif// NES_INCLUDE_OPTIMIZER_QUERYMERGER_FaultToleranceBasedQueryMergerRule_HPP_
