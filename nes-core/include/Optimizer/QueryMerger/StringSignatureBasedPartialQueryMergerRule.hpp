...
#ifndef NES_INCLUDE_OPTIMIZER_QUERY_MERGER_STRING_SIGNATURE_BASED_PARTIAL_QUERY_MERGER_RULE_HPP_
#define NES_INCLUDE_OPTIMIZER_QUERY_MERGER_STRING_SIGNATURE_BASED_PARTIAL_QUERY_MERGER_RULE_HPP_
...
/**
 * @brief StringSignatureBasedPartialQueryMergerRule is responsible for merging together all the equivalent chains of Global Query Nodes
 ...
 *
 *
 * After running the StringSignatureBasedPartialQueryMergerRule, the resulting Global Query Plan will look as follow:
 *
 *                                                         GQPRoot
 *                                                         /     \
 *                                                        /       \
...
#endif// NES_INCLUDE_OPTIMIZER_QUERY_MERGER_STRING_SIGNATURE_BASED_PARTIAL_QUERY_MERGER_RULE_HPP_
