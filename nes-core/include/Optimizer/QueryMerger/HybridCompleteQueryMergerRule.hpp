...
#ifndef NES_INCLUDE_OPTIMIZER_QUERY_MERGER_HYBRID_COMPLETE_QUERY_MERGER_RULE_HPP_
#define NES_INCLUDE_OPTIMIZER_QUERY_MERGER_HYBRID_COMPLETE_QUERY_MERGER_RULE_HPP_
