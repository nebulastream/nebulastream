...
#ifndef NES_CORE_INCLUDE_OPTIMIZER_QUERYMERGER_Z3SIGNATUREBASEDCONTAINMENTBASEDQUERYMERGERRULE_HPP_
#define NES_CORE_INCLUDE_OPTIMIZER_QUERYMERGER_Z3SIGNATUREBASEDCONTAINMENTBASEDQUERYMERGERRULE_HPP_
...
class Z3SignatureBasedContainmentBasedQueryMergerRule;
using Z3SignatureBasedContainmentBasedQueryMergerRulePtr = std::shared_ptr<Z3SignatureBasedContainmentBasedQueryMergerRule>;
 ...
 *
 */
class Z3SignatureBasedContainmentBasedQueryMergerRule final : public BaseQueryMergerRule {

  public:
    static Z3SignatureBasedContainmentBasedQueryMergerRulePtr create(z3::ContextPtr context, z3::ContextPtr contextSQPContainment);
    ~Z3SignatureBasedContainmentBasedQueryMergerRule() noexcept final = default;

    bool apply(GlobalQueryPlanPtr globalQueryPlan) override;

  private:
    explicit Z3SignatureBasedContainmentBasedQueryMergerRule(z3::ContextPtr context, z3::ContextPtr contextSQPContainment);
    /**
     ...
     */
    std::map<LogicalOperatorNodePtr, LogicalOperatorNodePtr> areQueryPlansContained(const QueryPlanPtr& targetQueryPlan,
     ...
     */
    std::map<LogicalOperatorNodePtr, LogicalOperatorNodePtr> isOperatorContained(const LogicalOperatorNodePtr& targetOperator,
                                                                              const LogicalOperatorNodePtr& hostOperator);
    SignatureContainmentUtilPtr signatureContainmentUtil;
};
}// namespace NES::Optimizer

#endif// NES_CORE_INCLUDE_OPTIMIZER_QUERYMERGER_Z3SIGNATUREBASEDCONTAINMENTBASEDQUERYMERGERRULE_HPP_
