 ...
 */
        ...
        static float getNetworkConnectivity(const TopologyPtr& topology, const ExecutionNodePtr& upstreamNode);
        ...
        static int getDelayToRoot(const ExecutionNodePtr& executionNode, const TopologyPtr& topology);
