...
#ifndef NES_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
#define NES_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
...
class MinimumEnergyConsumptionStrategy : public BasePlacementStrategy {
  ...
  public:
    ...
    GlobalExecutionPlanPtr initializeExecutionPlan(QueryPtr inputQuery, Catalogs::SourceCatalogPtr sourceCatalog);
...
#endif// NES_INCLUDE_OPTIMIZER_QUERYPLACEMENT_MINIMUMENERGYCONSUMPTIONSTRATEGY_HPP_
