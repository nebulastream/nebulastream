...
#ifndef NES_INCLUDE_OPTIMIZER_QUERYREWRITE_BINARYOPERATORSORTRULE_HPP_
#define NES_INCLUDE_OPTIMIZER_QUERYREWRITE_BINARYOPERATORSORTRULE_HPP_
...
#endif  // NES_INCLUDE_OPTIMIZER_QUERYREWRITE_BINARYOPERATORSORTRULE_HPP_
