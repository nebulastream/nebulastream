...
#ifndef NES_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_PHYSICALSOURCETYPE_HPP_
#define NES_INCLUDE_CATALOGS_SOURCE_PHYSICALSOURCETYPES_PHYSICALSOURCETYPE_HPP_
...
static std::map<std::string, SourceType> stringToSourceType{
    ...
    {Configurations::PARQUET_SOURCE_CONFIG, PARQUET_SOURCE}};
...
static std::map<SourceType, std::string> sourceTypeToString{
    ...
    {PARQUET_SOURCE, Configurations::PARQUET_SOURCE_CONFIG}};
