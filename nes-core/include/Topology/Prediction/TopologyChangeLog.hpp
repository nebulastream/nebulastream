 ...
 */
     ...
     */
        static void removeEdgesFromMap(std::unordered_map<TopologyNodeId, std::vector<TopologyNodeId>>& map,
     ...
     * callere has to ensure that this does not contain any edges that are already present at the target
