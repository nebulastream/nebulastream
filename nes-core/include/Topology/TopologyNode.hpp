 ...
 */
            ...
            /**
 * @brief method to get the used cpu capacity of the node
 * @return
 */
            uint16_t getUsedResources() const;

            /**
 * @brief method to get the overall resource capacity of the node
 * @return
 */
 ...
 */
            ...
            void setAvailableBandwidth(double bandwidth);

            double getAvailableBandwidth();

            void increaseUsedBandwidth(double usedBandwidth);

            double getUsedBandwidth();

            double getBandwidthRatio();
