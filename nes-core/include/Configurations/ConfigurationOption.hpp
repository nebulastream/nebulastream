...
const std::string MEMORY_CAPACITY = "memoryCapacity";
const std::string MTBF_VALUE = "mtbfValue";
const std::string LAUNCH_TIME = "launchTime";
const std::string INGESTION_RATE = "ingestionRate";
const std::string NETWORK_CAPACITY = "networkCapacity";
