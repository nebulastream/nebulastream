...
#ifndef NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_DDSKETCH_DDSKETCHPROBEPARAMOBJ_HPP_
#define NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_DDSKETCH_DDSKETCHPROBEPARAMOBJ_HPP_
...
namespace NES {
	...
	namespace Experimental::Statistics {
		...
		public:
			DDSketchProbeParamObj(const std::string& logicalSourceName,
					...
					: SketchProbeParamObj(logicalSourceName, physicalSourceName, fieldName, statCollectorType, expression,
...
#endif //NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_DDSKETCH_DDSKETCHPROBEPARAMOBJ_HPP_
