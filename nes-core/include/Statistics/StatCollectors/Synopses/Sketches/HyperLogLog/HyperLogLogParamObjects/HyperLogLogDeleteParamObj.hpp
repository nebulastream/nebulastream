...
#ifndef NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGDeletePARAMOBJ_HPP_
#define NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGDeletePARAMOBJ_HPP_
...
namespace NES {
	...
	namespace Experimental::Statistics {
		...
		class HyperLogLogDeleteParamObj : public SketchDeleteParamObj {

		public:
			HyperLogLogDeleteParamObj(const std::string& logicalSourceName,
					...
					: SketchDeleteParamObj(logicalSourceName, physicalSourceName, fieldName, statCollectorType, 1, calculateRegisters(error), windowSize),
...
#endif //NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGDeletePARAMOBJ_HPP_
