...
#ifndef NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGPROBEPARAMOBJ_HPP_
#define NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGPROBEPARAMOBJ_HPP_
...
namespace NES {
	...
	namespace Experimental::Statistics {
		...
		class HyperLogLogProbeParamObj : public SketchProbeParamObj {

		public:
			HyperLogLogProbeParamObj(const std::string& logicalSourceName,
					...
					: SketchProbeParamObj(logicalSourceName, physicalSourceName, fieldName, statCollectorType, expression, 1, calculateRegisters(error), windowSize),
			...
			/**
			 * @brief calculates the width/number of registers of the hyperLogLog Sketch that is to be probed
			...
			/**
			 * @return returns the error of the hyperLogLog sketch that is to be probed/queried
			 */
			...
			/**
			 * @return returns the number of bits that divides the hash of the HyperLogLog sketch that is to be probed/queried
			 */
			uint32_t getB() const {
				return b;
			}
			...
			/**
			 * @return returns the bias correction constant of the hyperLogLog sketch that is to be probed/queried
			 */
...
#endif //NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_HYPERLOGLOG_HYPERLOGLOGPROBEPARAMOBJ_HPP_
