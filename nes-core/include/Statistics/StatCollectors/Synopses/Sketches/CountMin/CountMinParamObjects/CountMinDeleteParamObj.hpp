...
#ifndef NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_COUNTMIN_COUNTMINPARAMOBJECTS_COUNTMINDELETEPARAMOBJ_HPP_
#define NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_COUNTMIN_COUNTMINPARAMOBJECTS_COUNTMINDELETEPARAMOBJ_HPP_
...
namespace NES {
	...
	namespace Experimental::Statistics {
		...
		public:
			CountMinDeleteParamObj(const std::string& logicalSourceName,
...
#endif //NES_NES_CORE_INCLUDE_STATISTICS_STATCOLLECTORS_SYNOPSES_SKETCHES_COUNTMIN_COUNTMINPARAMOBJECTS_COUNTMINDELETEPARAMOBJ_HPP_
