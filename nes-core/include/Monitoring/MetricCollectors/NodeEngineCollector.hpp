...
/**
* The NodeEngineCollector class enables measuring and writing statistics of class NodeEngine into a TupleBuffer.
*/
class NodeEngineCollector : public MetricCollector {
  public:
    explicit NodeEngineCollector();
    ...
    */
    ...
    /**
    * @brief Read the Statistic metrics based on the underlying utility systems reader and return the metrics.
...
using NodeEngineCollectorPtr = std::shared_ptr<NodeEngineCollector>;
