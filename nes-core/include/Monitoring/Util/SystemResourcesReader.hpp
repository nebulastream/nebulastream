...
#ifndef NES_INCLUDE_MONITORING_UTIL_SYSTEMRESOURCESREADER_HPP_
#define NES_INCLUDE_MONITORING_UTIL_SYSTEMRESOURCESREADER_HPP_
...
class SystemResourcesReader {
  public:
     ...
     */
    static uint64_t getWallTimeInNs();
...
#endif  // NES_INCLUDE_MONITORING_UTIL_SYSTEMRESOURCESREADER_HPP_
