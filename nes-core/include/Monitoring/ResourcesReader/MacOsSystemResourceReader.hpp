...
#ifndef NES_INCLUDE_MONITORING_UTIL_MAC_SYSTEM_RESOURCES_READER_HPP_
#define NES_INCLUDE_MONITORING_UTIL_MAC_SYSTEM_RESOURCES_READER_HPP_
...
/**
* @brief This is a static utility class to collect basic system information on a MacOS operating System
*/
class MacOsSystemResourcesReader : public AbstractSystemResourcesReader {
    public:
        MacOsSystemResourcesReader();
...
#endif//NES_INCLUDE_MONITORING_UTIL_MAC_SYSTEM_RESOURCES_READER_HPP_