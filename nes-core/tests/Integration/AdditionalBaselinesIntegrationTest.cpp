        ...
        class AdditionalBaselinesIntegrationTest : public Testing::BaseIntegrationTest {
          public:
            ...
            std::list<std::string> sources = {
                "100_ms", "13_ms", "24_ms", "47_ms", "54_ms", "62_ms", "67_ms", "74_ms", "98_ms", "105_ms",
                "14_ms", "28_ms", "49_ms", "57_ms", "63_ms", "68_ms", "75_ms", "99_ms", "106_ms", "16_ms",
                "38_ms", "4_ms", "58_ms", "64_ms", "69_ms", "88_ms", "10_ms", "19_ms", "40_ms", "52_ms",
                "59_ms", "65_ms", "71_ms", "8_ms", "12_ms", "23_ms", "44_ms", "53_ms", "61_ms", "66_ms", "73_ms", "97_ms"
            };
                        ...
                        for (uint64_t j = 0; j < nodeCnt; j++) {
                            ...
                            if (layers == 11) {
                                if (i >= 4) {
                                    ...
                                    auto csvSource = createCSVSourceType(std::string(TEST_DATA_DIRECTORY) + "debs13_readings/"
                                                                         + elem + ".csv");
