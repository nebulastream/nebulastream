...
//
//    testHarness.attachWorkerWithMemorySourceToCoordinator("testAnkit", testSchema, "test1");                        //idx=0
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=1
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=2
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=3
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=4
//
...
//    std::string query = R"(Query::from("test"))";
//    TestHarness testHarness = TestHarness(query, {});
//    testHarness.attachWorkerWithMemorySourceToCoordinator("test", testSchema, "test1");                             // idx=0
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=1
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=2
//    testHarness.attachWorkerWithMemorySourceToCoordinator("test", testSchema, "test1");                             //idx=3
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(3));//idx=4
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(3));//idx=5
//
//    TopologyPtr topology = testHarness.getTopology();
//    NES_DEBUG("TestHarness: topology:\n" << topology->toString());
...
TEST_F(DeepHierarchyTopologyTest, testOutputAndNoSensors) {
    ...
    //    testHarness.attachWorkerWithMemorySourceToCoordinator("test", testSchema, "test1");  //idx=2
    //    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(0));                  // idx=3
    //    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=4
    //    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=5
    //    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));//idx=6
...
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));// idx = 1
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(0));// idx = 2
//    testHarness.attachWorkerToCoordinator();                                                                        // idx = 3
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(3));// idx = 4
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(3));// idx = 5
//
//    TopologyPtr topology = testHarness.getTopology();
...
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(0));// idx = 2
//    testHarness.attachWorkerToCoordinator();                           // idx = 3
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(3));// idx = 4
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(3));// idx = 5
//    // Sensors
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(1));// idx = 6
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(2));// idx = 7
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(4));// idx = 8
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("test", testSchema, "test1", testHarness.getWorkerId(5));// idx = 9
//
//    TopologyPtr topology = testHarness.getTopology();
//    NES_DEBUG("TestHarness: topology:\n" << topology->toString());
//    ASSERT_EQ(topology->getRoot()->getChildren().size(), 2U);
...
//
//    // Workers
//    testHarness.attachWorkerToCoordinator();                           // id=0
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(0));// id=1
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(0));// id=2
//    testHarness.attachWorkerToCoordinator();                           // id=3
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(3));// id=4
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(3));// id=5
//    // Sensors
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(1));// id=6
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(2));// id=7
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(4));// id=8
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(5));// id=9
//
//    TopologyPtr topology = testHarness.getTopology();
//    NES_DEBUG("TestHarness: topology:\n" << topology->toString());
//    ASSERT_EQ(topology->getRoot()->getChildren().size(), 2U);
...
//    testHarness.attachWorkerToWorkerWithId(testHarness.getWorkerId(3));// idx=5
//    // Sensors
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("truck",
//                                                           testSchema,
//                                                           "physical_truck",
//                                                           testHarness.getWorkerId(1));                                   // idx=6
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("car", testSchema, "physical_car", testHarness.getWorkerId(2));// idx=7
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("truck",
//                                                           testSchema,
//                                                           "physical_truck",
//                                                           testHarness.getWorkerId(4));                                   // idx=8
//    testHarness.attachWorkerWithMemorySourceToWorkerWithId("car", testSchema, "physical_car", testHarness.getWorkerId(5));// idx=9
//
//    TopologyPtr topology = testHarness.getTopology();
//    NES_DEBUG("TestHarness: topology:\n" << topology->toString());
//    ASSERT_EQ(topology->getRoot()->getChildren().size(), 2U);
...
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(0));
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(0));
//    testHarness.attachWorkerToCoordinator();
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(3));
//    testHarness.attachWorkerWithCSVSourceToWorkerWithId(conf, testSchema, testHarness.getWorkerId(3));
//
//    TopologyPtr topology = testHarness.getTopology();
//    NES_DEBUG("TestHarness: topology:\n" << topology->toString());
