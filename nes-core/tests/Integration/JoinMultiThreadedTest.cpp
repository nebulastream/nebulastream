...
namespace NES {
class JoinMultiThreadedTest : public Testing::BaseIntegrationTest,
  ...
  public:
    ...
    void SetUp() override {
        ...
        const auto joinStrategy = std::get<0>(this->GetParam());
        const auto windowingStrategy = std::get<1>(this->GetParam());
        const uint64_t numberOfWorkerThreads = std::get<2>(this->GetParam());
