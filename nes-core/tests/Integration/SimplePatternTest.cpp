...
TEST_F(SimplePatternTest, DISABLED_testPatternWithTestStreamSingleOutput) {
    ...
    srcConf->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short.csv");
...
TEST_F(SimplePatternTest, testPatternWithIterationOperator) {
    ...
    srcConf->setSourceType("CSVSource");
    srcConf->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short_intID.csv");
    srcConf->setNumberOfTuplesToProducePerBuffer(0);
    srcConf->setPhysicalStreamName("test_stream");
    srcConf->setLogicalStreamName("QnV");
    //register physical stream
...
TEST_F(SimplePatternTest, testAndPattern) {
    ...
    srcConf->setSourceType("CSVSource");
    srcConf->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short_R2000070.csv");
    srcConf->setNumberOfTuplesToProducePerBuffer(0);
...
TEST_F(SimplePatternTest, testSeqPattern) {
    ...
    srcConf2->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short_R2000073.csv");
...
TEST_F(SimplePatternTest, DISABLED_testMultiAndPattern) {
    ...
    srcConf1->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short_R2000070.csv");
...
TEST_F(SimplePatternTest, testOrPattern) {
    ...
    srcConf1->setSourceType("CSVSource");
    srcConf1->setFilePath(std::string(TEST_DATA_DIRECTORY) + "QnV_short_R2000073.csv");
