...
////    out.close();
//
//    // Todo how to do this, remove?
//    //  - in harness we perform 'addLogicalSource'
...
////    srcConf->setPhysicalStreamName("test_stream1");
////    srcConf->setLogicalStreamName("Win1");
//
////    PhysicalSourcePtr windowStream = PhysicalSourceType::create(srcConf);
//    auto windowStream = PhysicalSource::create("Win1", "test_stream1", srcConf);
//
