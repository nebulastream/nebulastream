...
class Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry {

  public:
    Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(const std::string& testType,
...
class Z3SignatureBasedPartialQueryContainmentMergerRuleTest
    : public Testing::TestWithErrorHandling,
      public testing::WithParamInterface<std::vector<Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry>> {
  ...
  public:
    ...
    static auto createEqualityCases() {
        return std::
            vector<Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry>{
                ...
                Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                    ...
                    "    SOURCE(91,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                    "    SOURCE(92,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"),
                Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry("TestEquality",
                                                                           ...
                                                                           "        "
                                                                           "SOURCE(104,households,LogicalSourceDescriptor("
                                                                           "households, "
                                                                           "))\n"
    ...
    static auto createMixedContainmentCases() {
        return std::
            vector<Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry>{Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "      FILTER(159)\n"
                                                                                   "        SOURCE(165,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "    WATERMARKASSIGNER(172)\n"
                                                                                   "      SOURCE(171,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "      WINDOW AGGREGATION(OP-181, Sum;)\n"
                                                                                   "        WATERMARKASSIGNER(180)\n"
                                                                                   "          "
                                                                                   "SOURCE(179,windTurbines,"
                                                                                   "LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry("TestMixedContainmentCases",
                                                                                                                                          ...
                                                                                                                                          "              SOURCE(195,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "    WATERMARKASSIGNER(204)\n"
                                                                                   "      unionWith(203)\n"
                                                                                   "        SOURCE(201,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "        SOURCE(202,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "            unionWith(222)\n"
                                                                                   "              "
                                                                                   "SOURCE(220,windTurbines,"
                                                                                   "LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "              "
                                                                                   "SOURCE(221,solarPanels,"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "        unionWith(228)\n"
                                                                                   "          SOURCE(226,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "          SOURCE(227,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "        FILTER(271)\n"
                                                                                   "          SOURCE(279,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "        FILTER(291)\n"
                                                                                   "          unionWith(290)\n"
                                                                                   "            SOURCE(288,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "            SOURCE(289,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                                   "    WATERMARKASSIGNER(296)\n"
                                                                                   "      PROJECTION(294, schema=households$value:INTEGER households$id:INTEGER households$value1:(Float) households$ts:INTEGER )\n"
                                                                                   "        SOURCE(293,households,LogicalSourceDescriptor(households, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry("TestMixedContainmentCases",
                                                                                                                                          ...
                                                                                                                                          "      FILTER(312)\n"
                                                                                                                                          "        unionWith(320)\n"
                                                                                                                                          "          SOURCE(318,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                                                                          "          SOURCE(319,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                                                                                          "    WATERMARKASSIGNER(315)\n"
                                                                                                                                          "      SOURCE(313,households,LogicalSourceDescriptor(households, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "        WATERMARKASSIGNER(333)\n"
                                                                                   "          SOURCE(331,households,LogicalSourceDescriptor(households, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry("TestMixedContainmentCases",
                                                                                                                                          ...
                                                                                                                                          "        unionWith(360)\n"
                                                                                                                                          "          SOURCE(358,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                                                                          "          SOURCE(359,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                                                                                          "      WATERMARKASSIGNER(363)\n"
                                                                                                                                          "        SOURCE(361,households,LogicalSourceDescriptor(households, ))\n"
                                                                                                                                          "SINK(366: {PrintSinkDescriptor()})\n"
                                                                                                                                          "  PROJECTION(365, schema=windTurbines$value:INTEGER )\n"
                                                                                                                                          "    Join(364)\n"
                                                                                                                                          "      WATERMARKASSIGNER(362)\n"
                                                                                                                                          "        unionWith(360)\n"
                                                                                                                                          "          SOURCE(358,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "    FILTER(368)\n"
                                                                                   "      FILTER(374)\n"
                                                                                   "        SOURCE(373,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "    FILTER(370)\n"
                                                                                   "      FILTER(376)\n"
                                                                                   "        SOURCE(375,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "      FILTER(382)\n"
                                                                                   "        unionWith(390)\n"
                                                                                   "          SOURCE(388,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "          SOURCE(389,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "  Join(403)\n"
                                                                                   "    WATERMARKASSIGNER(401)\n"
                                                                                   "      unionWith(399)\n"
                                                                                   "        SOURCE(397,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "        SOURCE(398,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                                   "    WATERMARKASSIGNER(402)\n"
                                                                                   "      SOURCE(400,households,LogicalSourceDescriptor(households, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "  unionWith(417)\n"
                                                                                   "    "
                                                                                   "SOURCE(415,windTurbines,"
                                                                                   "LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "    "
                                                                                   "SOURCE(416,solarPanels,"
                                                                                   "LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "      unionWith(427)\n"
                                                                                   "        "
                                                                                   "SOURCE(425,windTurbines,"
                                                                                   "LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "        "
                                                                                   "SOURCE(426,solarPanels,"
                                                                                   "LogicalSourceDescriptor(solarPanels, ))\n"
                                                                               ...
                                                                               Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                                                                                   ...
                                                                                   "          unionWith(447)\n"
                                                                                   "            SOURCE(445,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                                                                                   "            SOURCE(446,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
    ...
    static auto createProjectionContainmentCases() {
        return std::vector<Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry>{
            Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                ...
                R"(Query::from("windTurbines").map(Attribute("value") = 40).sink(PrintSinkDescriptor::create());)",
                "SINK(471: {PrintSinkDescriptor()})\n"
                "  PROJECTION(470, schema=windTurbines$newValue:INTEGER )\n"
                "    MAP(469)\n"
                "      SOURCE(468,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "SINK(474: {PrintSinkDescriptor()})\n"
                "  MAP(469)\n"
                "    SOURCE(468,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"),
            Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                "TestProjectionContainment",
                ...
                "        FILTER(478)\n"
                "          unionWith(477)\n"
                "            SOURCE(475,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "            SOURCE(476,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                "    WATERMARKASSIGNER(483)\n"
                "      PROJECTION(481, schema=households$value:INTEGER households$id:INTEGER households$value1:(Float) households$ts:INTEGER )\n"
            ...
            Z3SignatureBasedPartialQueryContainmentMergerRuleTestEntry(
                ...
                "  Join(502)\n"
                "    WATERMARKASSIGNER(500)\n"
                "      unionWith(498)\n"
                "        SOURCE(496,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "        SOURCE(497,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                "    WATERMARKASSIGNER(501)\n"
                "      SOURCE(499,households,LogicalSourceDescriptor(households, ))\n"
                "SINK(512: {PrintSinkDescriptor()})\n"
                "  PROJECTION(511, schema=windTurbines$value:INTEGER )\n"
                "    Join(502)\n"
                "      WATERMARKASSIGNER(500)\n"
                "        unionWith(498)\n"
                "          SOURCE(496,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
...
INSTANTIATE_TEST_CASE_P(
    ...
    Z3SignatureBasedPartialQueryContainmentMergerRuleTest,
    ::testing::Values(Z3SignatureBasedPartialQueryContainmentMergerRuleTest::createEqualityCases(),
                      Z3SignatureBasedPartialQueryContainmentMergerRuleTest::createMixedContainmentCases(),
                      Z3SignatureBasedPartialQueryContainmentMergerRuleTest::createProjectionContainmentCases()),
    [](const testing::TestParamInfo<Z3SignatureBasedPartialQueryContainmentMergerRuleTest::ParamType>& info) {
