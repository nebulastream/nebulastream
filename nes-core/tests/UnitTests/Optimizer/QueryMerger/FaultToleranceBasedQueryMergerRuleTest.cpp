...
class FaultToleranceBasedQueryMergerRuleTest : public Testing::TestWithErrorHandling<testing::Test> {
  ...
  public:
    ...
    static void SetUpTestCase() {
        NES::Logger::setupLogging("FaultToleranceBasedQueryMergerRuleTest.log", NES::LogLevel::LOG_DEBUG);
        NES_INFO("Setup FaultToleranceBasedQueryMergerRuleTest test case.");
    }
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingEqualQueriesWithMultipleSameSources) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentSources) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
    ...
    //execute
    auto signatureBasedEqualQueryMergerRule = Optimizer::FaultToleranceBasedQueryMergerRule::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithUnionOperators) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithUnionOperatorChildrenOrder) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithUnionOperatorsWithDifferentChildren) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentFilters) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with different filters
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentFiltersField) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentMapAttribute) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with different map
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentMapValue) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentWindowTypes) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with different window operators
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentWindowAggregations) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithSameWindows) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with same window operators
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithSameWindowsButDifferentOperatorOrder) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithSameProjectOperator) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithSameProjectOperatorButDifferentOrder) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentProjectOperatorOrder) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithSameWatermarkOperator) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithDifferentWatermarkOperator) {
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithUnionOperatorsAndTwoIdenticalWatermarkAssigner) {
    // Prepare
    SinkDescriptorPtr printSinkDescriptor = PrintSinkDescriptor::create();
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest,
 ...
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithJoinOperator) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with same join operators.
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithJoinOperatorWithDifferentSourceOrder) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with same join operators.
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithJoinOperatorWithDifferentButEqualWindows) {
 ...
 * @brief Test applying SignatureBasedEqualQueryMergerRule on Global query plan with two queryIdAndCatalogEntryMapping with same join operators.
 */
TEST_F(FaultToleranceBasedQueryMergerRuleTest, testMergingQueriesWithJoinOperatorWithDifferentWindows) {
