    ...
    static auto createNoContainmentCases() {
        return std::vector<Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry>{
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      SOURCE(166,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      SOURCE(175,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      unionWith(209)\n"
                "        SOURCE(207,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "        SOURCE(208,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "          SOURCE(235,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      unionWith(251)\n"
                "        FILTER(249)\n"
                "          SOURCE(248,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "        SOURCE(250,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      FILTER(258)\n"
                "        unionWith(265)\n"
                "          SOURCE(263,windTurbines,LogicalSourceDescriptor(windTurbines, ))\n"
                "          SOURCE(264,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry("TestNoContainment",
                                                                  ...
                                                                  "        SOURCE(280,solarPanels,LogicalSourceDescriptor(solarPanels, ))\n"
                                                                  "    WATERMARKASSIGNER(284)\n"
                                                                  "      SOURCE(282,households,LogicalSourceDescriptor(households, ))\n"
            ...
            Z3SignatureBasedBottomUpQueryContainmentRuleTestEntry(
                ...
                "      SOURCE(321,households,LogicalSourceDescriptor(households, ))\n"
