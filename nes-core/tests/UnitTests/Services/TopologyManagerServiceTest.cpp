...
TEST_F(TopologyManagerServiceTest, testRegisterUnregisterNode) {
    ...
    uint64_t nodeId3 = topologyManagerService->registerWorker(INVALID_TOPOLOGY_NODE_ID, ip, publish_port + 6, 5000, 6, properties);
    EXPECT_EQ(nodeId3, 3u);
