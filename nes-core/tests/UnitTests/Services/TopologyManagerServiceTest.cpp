...
TEST_F(TopologyManagerServiceTest, testRegisterUnregisterNode) {
    ...
    uint64_t nodeId =
        topologyManagerService->registerNode(ip, publish_port, 5000, 6, NES::Spatial::Index::Experimental::NodeType::NO_LOCATION, NES::Spatial::Index::Experimental::Location());
    EXPECT_NE(nodeId, 0u);

    uint64_t nodeId1 =
        topologyManagerService->registerNode(ip, publish_port + 2, 5000, 6, NES::Spatial::Index::Experimental::NodeType::NO_LOCATION, NES::Spatial::Index::Experimental::Location());
