...
namespace NES {
        ...
        TEST_F(SpatialExpressionNodeTest, testPolygonExpressionNode) {
            ...
            auto polygonShapeExpressionNode = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274});
            ...
            EXPECT_EQ(polygonExpressionNode->toString(), "POLYGON(52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274)");
            ...
            auto PolygonShapeExpressionNode1 = PolygonExpressionNode::create({52.5156, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode2 = PolygonExpressionNode::create({52.5155, 13.3263, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode3 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5146, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode4 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3266, 52.5138, 13.3267, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode5 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3264, 52.5134, 13.3267, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode6 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3268, 52.5148, 13.3274});
            auto PolygonShapeExpressionNode7 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5143, 13.3274});
            auto PolygonShapeExpressionNode8 = PolygonExpressionNode::create({52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3271});
            ...
            auto polygonShapeExpressionNode9 = std::make_shared<PolygonExpressionNode>(PolygonExpressionNode({52.5155, 13.3262, 52.5145, 13.3264, 52.5138, 13.3267, 52.5148, 13.3274}));
        ...
        TEST_F(SpatialExpressionNodeTest, testRectangleExpressionNode) {
            ...
            EXPECT_EQ(rectangleExpressionNode->toString(), "RECTANGLE(lat_low: 52.5138, lon_low: 13.3265, lat_high: 52.5157, lon_high: 13.3284)");
            ...
            auto rectangleShapeExpressionNode4 = std::make_shared<RectangleExpressionNode>(RectangleExpressionNode(52.5138, 13.3265, 52.5157, 13.3284));
