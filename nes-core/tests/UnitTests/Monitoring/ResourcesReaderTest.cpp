...
TEST_F(ResourcesReaderTest, testRuntimeNesMetrics) {
    ...
    NES_DEBUG2("ResourcesReaderTest: Runtime metrics={}", runtimeMetrics.toJson().dump());
...
TEST_F(ResourcesReaderTest, testStaticNesMetrics) {
    ...
    NES_DEBUG2("ResourcesReaderTest: Static metrics={}", staticMetrics.toJson().dump());
...
TEST_F(ResourcesReaderTest, testCPUStats) {
    ...
    NES_DEBUG2("ResourcesReaderTest: CPU metrics={}", cpuMetrics.toJson().dump());
...
TEST_F(ResourcesReaderTest, testMemoryStats) {
    ...
    NES_DEBUG2("ResourcesReaderTest: Static metrics={}", memMetrics.toJson().dump());
...
TEST_F(ResourcesReaderTest, testDiskStats) {
    ...
    NES_DEBUG2("ResourcesReaderTest: Static metrics={}", diskMetrics.toJson().dump());
...
TEST_F(ResourcesReaderTest, testNetworkStats) {
    ...
    NES_DEBUG2("ResourcesReaderTest: Static metrics={}", networkMetrics.toJson().dump());
