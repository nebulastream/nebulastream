...
class KeyedEventTimeWindowHandlerTest : public testing::Test {
  public:
    ...
    static void SetUpTestCase() { NES_DEBUG2("Setup KeyedEventTimeWindowHandlerTest test class."); }

    /* Will be called before a test is executed. */
    void SetUp() override {
        NES::Logger::setupLogging("KeyedEventTimeWindowHandlerTest.log", NES::LogLevel::LOG_DEBUG);
        NES_DEBUG2("Setup KeyedEventTimeWindowHandlerTest test case.");
        size_t keySize = 8;
        size_t valueSize = 8;
    ...
    /* Will be called before a test is executed. */
    void TearDown() override { NES_DEBUG2("Tear down KeyedEventTimeWindowHandlerTest test case."); }
