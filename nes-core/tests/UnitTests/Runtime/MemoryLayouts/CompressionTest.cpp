...
// Full Buffer
// ===================================
TEST_F(CompressionTest, compressDecompressFsstFullBufferRowLayoutSingleColumnUint8){
    FAIL();
    // TODO
}

TEST_F(CompressionTest, compressDecompressFsstFullBufferColumnLayoutSingleColumnUint8){
    FAIL();
    // TODO
}

TEST_F(CompressionTest, compressDecompressFsstFullBufferRowLayoutMultiColumnUint8){
    FAIL();
    // TODO
}

TEST_F(CompressionTest, compressDecompressFsstFullBufferColumnLayoutMultiColumnUint8) {
    FAIL();
    // TODO
}
...
// Column wise
// ===================================
TEST_F(CompressionTest, compressDecompressFsstColumnWiseRowLayoutSingleColumnUint8) {
    int NUMBER_OF_TUPLES_IN_BUFFER = 10;
    SchemaPtr schema = Schema::create()->addField("t1", BasicType::UINT8);
...
TEST_F(CompressionTest, compressDecompressFsstColumnWiseColumnLayoutSingleColumnUint8) {
    int NUMBER_OF_TUPLES_IN_BUFFER = 10;
    SchemaPtr schema = Schema::create()->addField("t1", BasicType::UINT8);
...
TEST_F(CompressionTest, compressDecompressFsstColumnWiseRowLayoutMultiColumnUint8) {
    int NUMBER_OF_TUPLES_IN_BUFFER = 10;
    SchemaPtr schema =
        Schema::create()->addField("t1", BasicType::UINT8)->addField("t2", BasicType::UINT8)->addField("t3", BasicType::UINT8);
...
TEST_F(CompressionTest, compressDecompressFsstColumnWiseColumnLayoutMultiColumnUint8) {
    int NUMBER_OF_TUPLES_IN_BUFFER = 10;
    SchemaPtr schema =
        Schema::create()->addField("t1", BasicType::UINT8)->addField("t2", BasicType::UINT8)->addField("t3", BasicType::UINT8);
...
TEST_F(CompressionTest, fsstDummy){
    int NUMBER_OF_TUPLES_IN_BUFFER = 10;
    SchemaPtr schema = Schema::create()->addField("t1", BasicType::UINT8);
