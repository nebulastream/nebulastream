...
TEST_F(TrajectoryPredictorTest, testFindPathCoverage) {
   ...
   std::pair<S2Point, S1Angle> resultOnLinePoint = NES::Spatial::Mobility::Experimental::TrajectoryPredictor::findPathCoverage(path, coveringPointOnLine, coverage);
   ...
   auto resultCovaway = NES::Spatial::Mobility::Experimental::TrajectoryPredictor::findPathCoverage(path, coveringPointCovAwayFromLine, coverage);
   ...
   for (int i = 1; i < 100; ++i) {
      ...
      auto result = NES::Spatial::Mobility::Experimental::TrajectoryPredictor::findPathCoverage(path, coveringPointAwayFromPath, coverage);
