...
class MapQueryExecutionTest : public Testing::TestWithErrorHandling,
  ...
  public:
    ...
    void TearDown() override {
        NES_DEBUG2("QueryExecutionTest: Tear down MapQueryExecutionTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::TestWithErrorHandling::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_DEBUG2("MapQueryExecutionTest: Tear down QueryExecutionTest test class."); }
