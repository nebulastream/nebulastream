...
class FilterQueryExecutionTest : public Testing::TestWithErrorHandling,
  ...
  public:
    static void SetUpTestCase() {
        ...
        NES_DEBUG2("QueryExecutionTest: Setup FilterQueryExecutionTest test class.");
    }
    ...
    void TearDown() override {
        NES_DEBUG2("QueryExecutionTest: Tear down FilterQueryExecutionTest test case.");
        ASSERT_TRUE(executionEngine->stop());
        Testing::TestWithErrorHandling::TearDown();
    }

    /* Will be called after all tests in this class are finished. */
    static void TearDownTestCase() { NES_DEBUG2("QueryExecutionTest: Tear down FilterQueryExecutionTest test class."); }
