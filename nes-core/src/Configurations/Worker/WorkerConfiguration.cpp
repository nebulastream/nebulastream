...
WorkerConfiguration::WorkerConfiguration() : physicalSources() {
    ...
    rpcPort = ConfigurationOption<uint32_t>::create(RPC_PORT_CONFIG, 0, "RPC server port of the NES Worker.");
    dataPort = ConfigurationOption<uint32_t>::create(DATA_PORT_CONFIG, 0, "Data port of the NES Worker.");
