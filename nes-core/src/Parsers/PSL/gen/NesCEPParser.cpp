...
NesCEPParser::~NesCEPParser() {
    delete _interpreter;
}

std::string NesCEPParser::getGrammarFileName() const {
    return "NesCEP.g4";
}

const std::vector<std::string>& NesCEPParser::getRuleNames() const {
    return _ruleNames;
}

dfa::Vocabulary& NesCEPParser::getVocabulary() const {
    return _vocabulary;
}
...
tree::TerminalNode* NesCEPParser::QueryContext::EOF() {
    return getToken(NesCEPParser::EOF, 0);
}
...
size_t NesCEPParser::QueryContext::getRuleIndex() const {
    return NesCEPParser::RuleQuery;
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::PATTERN() {
    return getToken(NesCEPParser::PATTERN, 0);
}

tree::TerminalNode* NesCEPParser::CepPatternContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}

tree::TerminalNode* NesCEPParser::CepPatternContext::SEP() {
    return getToken(NesCEPParser::SEP, 0);
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::FROM() {
    return getToken(NesCEPParser::FROM, 0);
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::INTO() {
    return getToken(NesCEPParser::INTO, 0);
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::WHERE() {
    return getToken(NesCEPParser::WHERE, 0);
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::WITHIN() {
    return getToken(NesCEPParser::WITHIN, 0);
}
...
tree::TerminalNode* NesCEPParser::CepPatternContext::CONSUMING() {
    return getToken(NesCEPParser::CONSUMING, 0);
}

NesCEPParser::OptionContext* NesCEPParser::CepPatternContext::option() {
    return getRuleContext<NesCEPParser::OptionContext>(0);
}

tree::TerminalNode* NesCEPParser::CepPatternContext::RETURN() {
    return getToken(NesCEPParser::RETURN, 0);
}
...
size_t NesCEPParser::CepPatternContext::getRuleIndex() const {
    return NesCEPParser::RuleCepPattern;
}
...
std::vector<tree::TerminalNode *> NesCEPParser::InputStreamsContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::InputStreamsContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}


size_t NesCEPParser::InputStreamsContext::getRuleIndex() const {
    return NesCEPParser::RuleInputStreams;
}
...
std::vector<tree::TerminalNode *> NesCEPParser::InputStreamContext::NAME() {
    return getTokens(NesCEPParser::NAME);
}

tree::TerminalNode* NesCEPParser::InputStreamContext::NAME(size_t i) {
    return getToken(NesCEPParser::NAME, i);
}

tree::TerminalNode* NesCEPParser::InputStreamContext::AS() {
    return getToken(NesCEPParser::AS, 0);
}


size_t NesCEPParser::InputStreamContext::getRuleIndex() const {
    return NesCEPParser::RuleInputStream;
}
...
size_t NesCEPParser::WhereExpContext::getRuleIndex() const {
    return NesCEPParser::RuleWhereExp;
}
...
tree::TerminalNode* NesCEPParser::TimeConstraintsContext::LBRACKET() {
    return getToken(NesCEPParser::LBRACKET, 0);
}
...
tree::TerminalNode* NesCEPParser::TimeConstraintsContext::RBRACKET() {
    return getToken(NesCEPParser::RBRACKET, 0);
}


size_t NesCEPParser::TimeConstraintsContext::getRuleIndex() const {
    return NesCEPParser::RuleTimeConstraints;
}
...
tree::TerminalNode* NesCEPParser::IntervalContext::INT() {
    return getToken(NesCEPParser::INT, 0);
}
...
size_t NesCEPParser::IntervalContext::getRuleIndex() const {
    return NesCEPParser::RuleInterval;
}
...
tree::TerminalNode* NesCEPParser::IntervalTypeContext::QUARTER() {
    return getToken(NesCEPParser::QUARTER, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::MONTH() {
    return getToken(NesCEPParser::MONTH, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::DAY() {
    return getToken(NesCEPParser::DAY, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::HOUR() {
    return getToken(NesCEPParser::HOUR, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::MINUTE() {
    return getToken(NesCEPParser::MINUTE, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::WEEK() {
    return getToken(NesCEPParser::WEEK, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::SECOND() {
    return getToken(NesCEPParser::SECOND, 0);
}

tree::TerminalNode* NesCEPParser::IntervalTypeContext::MICROSECOND() {
    return getToken(NesCEPParser::MICROSECOND, 0);
}


size_t NesCEPParser::IntervalTypeContext::getRuleIndex() const {
    return NesCEPParser::RuleIntervalType;
}
...
NesCEPParser::IntervalTypeContext* NesCEPParser::intervalType() {
    ...
    try {
        ...
        _la = _input->LA(1);
        if (!((((_la & ~ 0x3fULL) == 0) &&
               ((1ULL << _la) & ((1ULL << NesCEPParser::QUARTER)
                                 | (1ULL << NesCEPParser::MONTH)
                                 | (1ULL << NesCEPParser::DAY)
                                 | (1ULL << NesCEPParser::HOUR)
                                 | (1ULL << NesCEPParser::MINUTE)
                                 | (1ULL << NesCEPParser::WEEK)
                                 | (1ULL << NesCEPParser::SECOND)
                                 | (1ULL << NesCEPParser::MICROSECOND))) != 0))) {
...
tree::TerminalNode* NesCEPParser::OptionContext::ALL() {
    return getToken(NesCEPParser::ALL, 0);
}

tree::TerminalNode* NesCEPParser::OptionContext::NONE() {
    return getToken(NesCEPParser::NONE, 0);
}


size_t NesCEPParser::OptionContext::getRuleIndex() const {
    return NesCEPParser::RuleOption;
}
...
tree::TerminalNode* NesCEPParser::OutputExpressionContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}

tree::TerminalNode* NesCEPParser::OutputExpressionContext::SEP() {
    return getToken(NesCEPParser::SEP, 0);
}

tree::TerminalNode* NesCEPParser::OutputExpressionContext::LBRACKET() {
    return getToken(NesCEPParser::LBRACKET, 0);
}
...
tree::TerminalNode* NesCEPParser::OutputExpressionContext::RBRACKET() {
    return getToken(NesCEPParser::RBRACKET, 0);
}

std::vector<tree::TerminalNode *> NesCEPParser::OutputExpressionContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::OutputExpressionContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}


size_t NesCEPParser::OutputExpressionContext::getRuleIndex() const {
    return NesCEPParser::RuleOutputExpression;
}
...
tree::TerminalNode* NesCEPParser::OutAttributeContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}

tree::TerminalNode* NesCEPParser::OutAttributeContext::EQUAL() {
    return getToken(NesCEPParser::EQUAL, 0);
}
...
size_t NesCEPParser::OutAttributeContext::getRuleIndex() const {
    return NesCEPParser::RuleOutAttribute;
}
...
NesCEPParser::SinkContext* NesCEPParser::SinkListContext::sink(size_t i) {
    return getRuleContext<NesCEPParser::SinkContext>(i);
}

std::vector<tree::TerminalNode *> NesCEPParser::SinkListContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::SinkListContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}


size_t NesCEPParser::SinkListContext::getRuleIndex() const {
    return NesCEPParser::RuleSinkList;
}
...
NesCEPParser::SinkTypeContext* NesCEPParser::SinkContext::sinkType() {
    return getRuleContext<NesCEPParser::SinkTypeContext>(0);
}

tree::TerminalNode* NesCEPParser::SinkContext::SINKSEP() {
    return getToken(NesCEPParser::SINKSEP, 0);
}

tree::TerminalNode* NesCEPParser::SinkContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}


size_t NesCEPParser::SinkContext::getRuleIndex() const {
    return NesCEPParser::RuleSink;
}
...
size_t NesCEPParser::ListEventsContext::getRuleIndex() const {
    return NesCEPParser::RuleListEvents;
}
...
NesCEPParser::ListEventsContext* NesCEPParser::listEvents() {
    ...
    try {
        ...
        _la = _input->LA(1);
        while ((((_la & ~ 0x3fULL) == 0) &&
                ((1ULL << _la) & ((1ULL << NesCEPParser::ANY)
                                  | (1ULL << NesCEPParser::SEQ)
                                  | (1ULL << NesCEPParser::NEXT)
                                  | (1ULL << NesCEPParser::AND)
                                  | (1ULL << NesCEPParser::OR))) != 0)) {
            setState(180);
            operatorRule();
            setState(181);
            eventElem();
...
NesCEPParser::EventContext* NesCEPParser::EventElemContext::event() {
    return getRuleContext<NesCEPParser::EventContext>(0);
}

tree::TerminalNode* NesCEPParser::EventElemContext::NOT() {
    return getToken(NesCEPParser::NOT, 0);
}

tree::TerminalNode* NesCEPParser::EventElemContext::LPARENTHESIS() {
    return getToken(NesCEPParser::LPARENTHESIS, 0);
}
...
tree::TerminalNode* NesCEPParser::EventElemContext::RPARENTHESIS() {
    return getToken(NesCEPParser::RPARENTHESIS, 0);
}


size_t NesCEPParser::EventElemContext::getRuleIndex() const {
    return NesCEPParser::RuleEventElem;
}
...
tree::TerminalNode* NesCEPParser::EventContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}
...
size_t NesCEPParser::EventContext::getRuleIndex() const {
    return NesCEPParser::RuleEvent;
}
...
NesCEPParser::EventContext* NesCEPParser::event() {
    ...
    try {
        ...
        _la = _input->LA(1);
        if ((((_la & ~ 0x3fULL) == 0) &&
             ((1ULL << _la) & ((1ULL << NesCEPParser::STAR)
                               | (1ULL << NesCEPParser::PLUS)
                               | (1ULL << NesCEPParser::LBRACKET))) != 0)) {
            setState(202);
            quantifiers();
        }
...
tree::TerminalNode* NesCEPParser::QuantifiersContext::STAR() {
    return getToken(NesCEPParser::STAR, 0);
}

tree::TerminalNode* NesCEPParser::QuantifiersContext::PLUS() {
    return getToken(NesCEPParser::PLUS, 0);
}

tree::TerminalNode* NesCEPParser::QuantifiersContext::LBRACKET() {
    return getToken(NesCEPParser::LBRACKET, 0);
}

tree::TerminalNode* NesCEPParser::QuantifiersContext::INT() {
    return getToken(NesCEPParser::INT, 0);
}

tree::TerminalNode* NesCEPParser::QuantifiersContext::RBRACKET() {
    return getToken(NesCEPParser::RBRACKET, 0);
}
...
tree::TerminalNode* NesCEPParser::QuantifiersContext::D_POINTS() {
    return getToken(NesCEPParser::D_POINTS, 0);
}
...
size_t NesCEPParser::QuantifiersContext::getRuleIndex() const {
    return NesCEPParser::RuleQuantifiers;
}
...
tree::TerminalNode* NesCEPParser::IterMaxContext::INT() {
    return getToken(NesCEPParser::INT, 0);
}


size_t NesCEPParser::IterMaxContext::getRuleIndex() const {
    return NesCEPParser::RuleIterMax;
}
...
tree::TerminalNode* NesCEPParser::IterMinContext::INT() {
    return getToken(NesCEPParser::INT, 0);
}


size_t NesCEPParser::IterMinContext::getRuleIndex() const {
    return NesCEPParser::RuleIterMin;
}
...
tree::TerminalNode* NesCEPParser::ConsecutiveOptionContext::NEXT() {
    return getToken(NesCEPParser::NEXT, 0);
}

tree::TerminalNode* NesCEPParser::ConsecutiveOptionContext::ANY() {
    return getToken(NesCEPParser::ANY, 0);
}


size_t NesCEPParser::ConsecutiveOptionContext::getRuleIndex() const {
    return NesCEPParser::RuleConsecutiveOption;
}
...
tree::TerminalNode* NesCEPParser::OperatorRuleContext::AND() {
    return getToken(NesCEPParser::AND, 0);
}

tree::TerminalNode* NesCEPParser::OperatorRuleContext::OR() {
    return getToken(NesCEPParser::OR, 0);
}
...
size_t NesCEPParser::OperatorRuleContext::getRuleIndex() const {
    return NesCEPParser::RuleOperatorRule;
}
...
tree::TerminalNode* NesCEPParser::SequenceContext::SEQ() {
    return getToken(NesCEPParser::SEQ, 0);
}
...
size_t NesCEPParser::SequenceContext::getRuleIndex() const {
    return NesCEPParser::RuleSequence;
}
...
tree::TerminalNode* NesCEPParser::ContiguityContext::NEXT() {
    return getToken(NesCEPParser::NEXT, 0);
}

tree::TerminalNode* NesCEPParser::ContiguityContext::ANY() {
    return getToken(NesCEPParser::ANY, 0);
}


size_t NesCEPParser::ContiguityContext::getRuleIndex() const {
    return NesCEPParser::RuleContiguity;
}
...
tree::TerminalNode* NesCEPParser::SinkTypeContext::KAFKA() {
    return getToken(NesCEPParser::KAFKA, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::FILE() {
    return getToken(NesCEPParser::FILE, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::MQTT() {
    return getToken(NesCEPParser::MQTT, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::NETWORK() {
    return getToken(NesCEPParser::NETWORK, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::NULLOUTPUT() {
    return getToken(NesCEPParser::NULLOUTPUT, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::OPC() {
    return getToken(NesCEPParser::OPC, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::PRINT() {
    return getToken(NesCEPParser::PRINT, 0);
}

tree::TerminalNode* NesCEPParser::SinkTypeContext::ZMQ() {
    return getToken(NesCEPParser::ZMQ, 0);
}


size_t NesCEPParser::SinkTypeContext::getRuleIndex() const {
    return NesCEPParser::RuleSinkType;
}
...
NesCEPParser::SinkTypeContext* NesCEPParser::sinkType() {
    ...
    try {
        ...
        _la = _input->LA(1);
        if (!((((_la & ~ 0x3fULL) == 0) &&
               ((1ULL << _la) & ((1ULL << NesCEPParser::KAFKA)
                                 | (1ULL << NesCEPParser::FILE)
                                 | (1ULL << NesCEPParser::MQTT)
                                 | (1ULL << NesCEPParser::NETWORK)
                                 | (1ULL << NesCEPParser::NULLOUTPUT)
                                 | (1ULL << NesCEPParser::OPC)
                                 | (1ULL << NesCEPParser::PRINT)
                                 | (1ULL << NesCEPParser::ZMQ))) != 0))) {
            _errHandler->recoverInline(this);
        }
        else {
            _errHandler->reportMatch(this);
...
tree::TerminalNode* NesCEPParser::NullNotnullContext::NULLTOKEN() {
    return getToken(NesCEPParser::NULLTOKEN, 0);
}

tree::TerminalNode* NesCEPParser::NullNotnullContext::NOT() {
    return getToken(NesCEPParser::NOT, 0);
}


size_t NesCEPParser::NullNotnullContext::getRuleIndex() const {
    return NesCEPParser::RuleNullNotnull;
}
...
std::vector<tree::TerminalNode *> NesCEPParser::ConstantContext::QUOTE() {
    return getTokens(NesCEPParser::QUOTE);
}

tree::TerminalNode* NesCEPParser::ConstantContext::QUOTE(size_t i) {
    return getToken(NesCEPParser::QUOTE, i);
}

tree::TerminalNode* NesCEPParser::ConstantContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}

tree::TerminalNode* NesCEPParser::ConstantContext::INT() {
    return getToken(NesCEPParser::INT, 0);
}


size_t NesCEPParser::ConstantContext::getRuleIndex() const {
    return NesCEPParser::RuleConstant;
}
...
std::vector<tree::TerminalNode *> NesCEPParser::ExpressionsContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::ExpressionsContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}


size_t NesCEPParser::ExpressionsContext::getRuleIndex() const {
    return NesCEPParser::RuleExpressions;
}
...
size_t NesCEPParser::ExpressionContext::getRuleIndex() const {
    return NesCEPParser::RuleExpression;
}

void NesCEPParser::ExpressionContext::copyFrom(ExpressionContext *ctx) {
...
tree::TerminalNode* NesCEPParser::IsExpressionContext::IS() {
    return getToken(NesCEPParser::IS, 0);
}

tree::TerminalNode* NesCEPParser::IsExpressionContext::TRUE() {
    return getToken(NesCEPParser::TRUE, 0);
}

tree::TerminalNode* NesCEPParser::IsExpressionContext::FALSE() {
    return getToken(NesCEPParser::FALSE, 0);
}

tree::TerminalNode* NesCEPParser::IsExpressionContext::UNKNOWN() {
    return getToken(NesCEPParser::UNKNOWN, 0);
}

tree::TerminalNode* NesCEPParser::IsExpressionContext::NOT() {
    return getToken(NesCEPParser::NOT, 0);
}
...
tree::TerminalNode* NesCEPParser::NotExpressionContext::NOT_OP() {
    return getToken(NesCEPParser::NOT_OP, 0);
}
...
NesCEPParser::ExpressionContext* NesCEPParser::expression() {
    return expression(0);
}
    ...
    try {
        ...
        switch (getInterpreter<atn::ParserATNSimulator>()->adaptivePredict(_input, 26, _ctx)) {
            ...
            case 2: {
                ...
                _la = _input->LA(1);
                if (!((((_la & ~ 0x3fULL) == 0) &&
                       ((1ULL << _la) & ((1ULL << NesCEPParser::TRUE)
                                         | (1ULL << NesCEPParser::FALSE)
                                         | (1ULL << NesCEPParser::UNKNOWN))) != 0))) {
...
size_t NesCEPParser::PredicateContext::getRuleIndex() const {
    return NesCEPParser::RulePredicate;
}

void NesCEPParser::PredicateContext::copyFrom(PredicateContext *ctx) {
    ParserRuleContext::copyFrom(ctx);
}
...
tree::TerminalNode* NesCEPParser::InPredicateContext::IN() {
    return getToken(NesCEPParser::IN, 0);
}

tree::TerminalNode* NesCEPParser::InPredicateContext::LPARENTHESIS() {
    return getToken(NesCEPParser::LPARENTHESIS, 0);
}
...
tree::TerminalNode* NesCEPParser::InPredicateContext::RPARENTHESIS() {
    return getToken(NesCEPParser::RPARENTHESIS, 0);
}

tree::TerminalNode* NesCEPParser::InPredicateContext::NOT() {
    return getToken(NesCEPParser::NOT, 0);
}
...
tree::TerminalNode* NesCEPParser::IsNullPredicateContext::IS() {
    return getToken(NesCEPParser::IS, 0);
}
...
NesCEPParser::PredicateContext* NesCEPParser::predicate() {
    return predicate(0);
}
...
size_t NesCEPParser::ExpressionAtomContext::getRuleIndex() const {
    return NesCEPParser::RuleExpressionAtom;
}

void NesCEPParser::ExpressionAtomContext::copyFrom(ExpressionAtomContext *ctx) {
    ParserRuleContext::copyFrom(ctx);
}
...
tree::TerminalNode* NesCEPParser::BinaryExpressionAtomContext::BINARY() {
    return getToken(NesCEPParser::BINARY, 0);
}
...
tree::TerminalNode* NesCEPParser::NestedExpressionAtomContext::LPARENTHESIS() {
    return getToken(NesCEPParser::LPARENTHESIS, 0);
}
...
tree::TerminalNode* NesCEPParser::NestedExpressionAtomContext::RPARENTHESIS() {
    return getToken(NesCEPParser::RPARENTHESIS, 0);
}

std::vector<tree::TerminalNode *> NesCEPParser::NestedExpressionAtomContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::NestedExpressionAtomContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}
...
NesCEPParser::ExpressionAtomContext* NesCEPParser::expressionAtom() {
...
tree::TerminalNode* NesCEPParser::EventAttributeContext::LPARENTHESIS() {
    return getToken(NesCEPParser::LPARENTHESIS, 0);
}
...
tree::TerminalNode* NesCEPParser::EventAttributeContext::RPARENTHESIS() {
    return getToken(NesCEPParser::RPARENTHESIS, 0);
}
...
tree::TerminalNode* NesCEPParser::EventAttributeContext::POINT() {
    return getToken(NesCEPParser::POINT, 0);
}
...
tree::TerminalNode* NesCEPParser::EventAttributeContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}


size_t NesCEPParser::EventAttributeContext::getRuleIndex() const {
    return NesCEPParser::RuleEventAttribute;
}
...
tree::TerminalNode* NesCEPParser::EventIterationContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}

tree::TerminalNode* NesCEPParser::EventIterationContext::LBRACKET() {
    return getToken(NesCEPParser::LBRACKET, 0);
}

tree::TerminalNode* NesCEPParser::EventIterationContext::RBRACKET() {
    return getToken(NesCEPParser::RBRACKET, 0);
}
...
size_t NesCEPParser::EventIterationContext::getRuleIndex() const {
    return NesCEPParser::RuleEventIteration;
}
...
NesCEPParser::EventIterationContext* NesCEPParser::eventIteration() {
    ...
    try {
        ...
        _la = _input->LA(1);
        if ((((_la & ~ 0x3fULL) == 0) &&
             ((1ULL << _la) & ((1ULL << NesCEPParser::T__0)
                               | (1ULL << NesCEPParser::LPARENTHESIS)
                               | (1ULL << NesCEPParser::NOT)
                               | (1ULL << NesCEPParser::PLUS)
                               | (1ULL << NesCEPParser::BINARY)
                               | (1ULL << NesCEPParser::QUOTE))) != 0) || ((((_la - 64) & ~ 0x3fULL) == 0) &&
                ((1ULL << (_la - 64)) & ((1ULL << (NesCEPParser::AVG - 64))
                                         | (1ULL << (NesCEPParser::SUM - 64))
                                         | (1ULL << (NesCEPParser::MIN - 64))
                                         | (1ULL << (NesCEPParser::MAX - 64))
                                         | (1ULL << (NesCEPParser::COUNT - 64))
                                         | (1ULL << (NesCEPParser::INT - 64))
                                         | (1ULL << (NesCEPParser::NAME - 64)))) != 0)) {
            setState(369);
            mathExpression();
        }
        setState(372);
...
tree::TerminalNode* NesCEPParser::MathExpressionContext::D_POINTS() {
    return getToken(NesCEPParser::D_POINTS, 0);
}


size_t NesCEPParser::MathExpressionContext::getRuleIndex() const {
    return NesCEPParser::RuleMathExpression;
}
...
tree::TerminalNode* NesCEPParser::AggregationContext::AVG() {
    return getToken(NesCEPParser::AVG, 0);
}

tree::TerminalNode* NesCEPParser::AggregationContext::SUM() {
    return getToken(NesCEPParser::SUM, 0);
}

tree::TerminalNode* NesCEPParser::AggregationContext::MIN() {
    return getToken(NesCEPParser::MIN, 0);
}

tree::TerminalNode* NesCEPParser::AggregationContext::MAX() {
    return getToken(NesCEPParser::MAX, 0);
}

tree::TerminalNode* NesCEPParser::AggregationContext::COUNT() {
    return getToken(NesCEPParser::COUNT, 0);
}


size_t NesCEPParser::AggregationContext::getRuleIndex() const {
    return NesCEPParser::RuleAggregation;
}
...
tree::TerminalNode* NesCEPParser::AttributeContext::NAME() {
    return getToken(NesCEPParser::NAME, 0);
}


size_t NesCEPParser::AttributeContext::getRuleIndex() const {
    return NesCEPParser::RuleAttribute;
}
...
tree::TerminalNode* NesCEPParser::AttValContext::IF() {
    return getToken(NesCEPParser::IF, 0);
}
...
NesCEPParser::EventContext* NesCEPParser::AttValContext::event() {
    return getRuleContext<NesCEPParser::EventContext>(0);
}
...
size_t NesCEPParser::AttValContext::getRuleIndex() const {
    return NesCEPParser::RuleAttVal;
}
...
tree::TerminalNode* NesCEPParser::BoolRuleContext::TRUE() {
    return getToken(NesCEPParser::TRUE, 0);
}

tree::TerminalNode* NesCEPParser::BoolRuleContext::FALSE() {
    return getToken(NesCEPParser::FALSE, 0);
}


size_t NesCEPParser::BoolRuleContext::getRuleIndex() const {
    return NesCEPParser::RuleBoolRule;
}
...
tree::TerminalNode* NesCEPParser::ConditionContext::LPARENTHESIS() {
    return getToken(NesCEPParser::LPARENTHESIS, 0);
}
...
std::vector<tree::TerminalNode *> NesCEPParser::ConditionContext::COMMA() {
    return getTokens(NesCEPParser::COMMA);
}

tree::TerminalNode* NesCEPParser::ConditionContext::COMMA(size_t i) {
    return getToken(NesCEPParser::COMMA, i);
}
...
tree::TerminalNode* NesCEPParser::ConditionContext::RPARENTHESIS() {
    return getToken(NesCEPParser::RPARENTHESIS, 0);
}


size_t NesCEPParser::ConditionContext::getRuleIndex() const {
    return NesCEPParser::RuleCondition;
}
...
tree::TerminalNode* NesCEPParser::UnaryOperatorContext::PLUS() {
    return getToken(NesCEPParser::PLUS, 0);
}

tree::TerminalNode* NesCEPParser::UnaryOperatorContext::NOT() {
    return getToken(NesCEPParser::NOT, 0);
}


size_t NesCEPParser::UnaryOperatorContext::getRuleIndex() const {
    return NesCEPParser::RuleUnaryOperator;
}
...
std::vector<tree::TerminalNode *> NesCEPParser::ComparisonOperatorContext::EQUAL() {
    return getTokens(NesCEPParser::EQUAL);
}

tree::TerminalNode* NesCEPParser::ComparisonOperatorContext::EQUAL(size_t i) {
    return getToken(NesCEPParser::EQUAL, i);
}

tree::TerminalNode* NesCEPParser::ComparisonOperatorContext::NOT_OP() {
    return getToken(NesCEPParser::NOT_OP, 0);
}


size_t NesCEPParser::ComparisonOperatorContext::getRuleIndex() const {
    return NesCEPParser::RuleComparisonOperator;
}
...
tree::TerminalNode* NesCEPParser::LogicalOperatorContext::LOGAND() {
    return getToken(NesCEPParser::LOGAND, 0);
}

tree::TerminalNode* NesCEPParser::LogicalOperatorContext::LOGXOR() {
    return getToken(NesCEPParser::LOGXOR, 0);
}

tree::TerminalNode* NesCEPParser::LogicalOperatorContext::LOGOR() {
    return getToken(NesCEPParser::LOGOR, 0);
}


size_t NesCEPParser::LogicalOperatorContext::getRuleIndex() const {
    return NesCEPParser::RuleLogicalOperator;
}
...
NesCEPParser::LogicalOperatorContext* NesCEPParser::logicalOperator() {
    ...
    try {
        ...
        _la = _input->LA(1);
        if (!(((((_la - 70) & ~ 0x3fULL) == 0) &&
               ((1ULL << (_la - 70)) & ((1ULL << (NesCEPParser::LOGOR - 70))
                                        | (1ULL << (NesCEPParser::LOGAND - 70))
                                        | (1ULL << (NesCEPParser::LOGXOR - 70)))) != 0))) {
            _errHandler->recoverInline(this);
        }
        else {
            _errHandler->reportMatch(this);
...
tree::TerminalNode* NesCEPParser::BitOperatorContext::LOGXOR() {
    return getToken(NesCEPParser::LOGXOR, 0);
}


size_t NesCEPParser::BitOperatorContext::getRuleIndex() const {
    return NesCEPParser::RuleBitOperator;
}
...
tree::TerminalNode* NesCEPParser::MathOperatorContext::STAR() {
    return getToken(NesCEPParser::STAR, 0);
}

tree::TerminalNode* NesCEPParser::MathOperatorContext::PLUS() {
    return getToken(NesCEPParser::PLUS, 0);
}


size_t NesCEPParser::MathOperatorContext::getRuleIndex() const {
    return NesCEPParser::RuleMathOperator;
}
...
NesCEPParser::MathOperatorContext* NesCEPParser::mathOperator() {
    ...
    try {
        ...
        if (!((((_la & ~ 0x3fULL) == 0) &&
               ((1ULL << _la) & ((1ULL << NesCEPParser::T__0)
                                 | (1ULL << NesCEPParser::T__5)
                                 | (1ULL << NesCEPParser::T__6)
                                 | (1ULL << NesCEPParser::T__7)
                                 | (1ULL << NesCEPParser::STAR)
                                 | (1ULL << NesCEPParser::PLUS))) != 0))) {
            _errHandler->recoverInline(this);
        }
        else {
...
std::vector<std::string> NesCEPParser::_ruleNames = {
    "query", "cepPattern", "inputStreams", "inputStream", "compositeEventExpressions",
    "whereExp", "timeConstraints", "interval", "intervalType", "option", "outputExpression",
    "outAttribute", "sinkList", "sink", "listEvents", "eventElem", "event",
    "quantifiers", "iterMax", "iterMin", "consecutiveOption", "operatorRule",
    "sequence", "contiguity", "sinkType", "nullNotnull", "constant", "expressions",
    "expression", "predicate", "expressionAtom", "eventAttribute", "eventIteration",
    "mathExpression", "aggregation", "attribute", "attVal", "boolRule", "condition",
...
std::vector<std::string> NesCEPParser::_literalNames = {
    "", "'-'", "'>'", "'<'", "'&'", "'|'", "'/'", "'%'", "'--'", "", "'FROM'",
    "'PATTERN'", "'WHERE'", "'WITHIN'", "'CONSUMING'", "'RETURN'", "'INTO'",
    "'ALL'", "'ANY'", "':='", "','", "'('", "')'", "'NOT'", "'!'", "'SEQ'",
    "'NEXT'", "'AND'", "'OR'", "'*'", "'+'", "':'", "'['", "']'", "'XOR'",
    "'IN'", "'IS'", "'NULL'", "'BETWEEN'", "'BINARY'", "'TRUE'", "'FALSE'",
    "'UNKNOWN'", "'QUARTER'", "'MONTH'", "'DAY'", "'HOUR'", "'MINUTE'", "'WEEK'",
    "'SECOND'", "'MICROSECOND'", "'AS'", "'='", "'::'", "'Kafka'", "'File'",
    "'MQTT'", "'Network'", "'NullOutput'", "'OPC'", "'Print'", "'ZMQ'", "'.'",
    "'\"'", "'AVG'", "'SUM'", "'MIN'", "'MAX'", "'COUNT'", "'IF'", "'||'",
    "'&&'", "'^'", "'NONE'"
};

std::vector<std::string> NesCEPParser::_symbolicNames = {
    "", "", "", "", "", "", "", "", "", "WS", "FROM", "PATTERN", "WHERE",
    "WITHIN", "CONSUMING", "RETURN", "INTO", "ALL", "ANY", "SEP", "COMMA",
    "LPARENTHESIS", "RPARENTHESIS", "NOT", "NOT_OP", "SEQ", "NEXT", "AND",
    "OR", "STAR", "PLUS", "D_POINTS", "LBRACKET", "RBRACKET", "XOR", "IN",
    "IS", "NULLTOKEN", "BETWEEN", "BINARY", "TRUE", "FALSE", "UNKNOWN", "QUARTER",
    "MONTH", "DAY", "HOUR", "MINUTE", "WEEK", "SECOND", "MICROSECOND", "AS",
    "EQUAL", "SINKSEP", "KAFKA", "FILE", "MQTT", "NETWORK", "NULLOUTPUT",
    "OPC", "PRINT", "ZMQ", "POINT", "QUOTE", "AVG", "SUM", "MIN", "MAX", "COUNT",
    "IF", "LOGOR", "LOGAND", "LOGXOR", "NONE", "INT", "NAME", "ID"
};
...
NesCEPParser::Initializer::Initializer() {
    ...
    static const uint16_t serializedATNSegment0[] = {
        ...
        0x3, 0x4e, 0x1c1, 0x4, 0x2, 0x9, 0x2, 0x4, 0x3, 0x9, 0x3, 0x4, 0x4,
        ...
        0x9, 0x2c, 0x4, 0x2d, 0x9, 0x2d, 0x3, 0x2, 0x6, 0x2, 0x5c, 0xa, 0x2,
        0xd, 0x2, 0xe, 0x2, 0x5d, 0x3, 0x2, 0x3, 0x2, 0x3, 0x3, 0x3, 0x3,
        0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x5,
        0x3, 0x6a, 0xa, 0x3, 0x3, 0x3, 0x3, 0x3, 0x5, 0x3, 0x6e, 0xa, 0x3,
        0x3, 0x3, 0x3, 0x3, 0x5, 0x3, 0x72, 0xa, 0x3, 0x3, 0x3, 0x3, 0x3,
        0x5, 0x3, 0x76, 0xa, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x3, 0x4,
        0x3, 0x4, 0x3, 0x4, 0x7, 0x4, 0x7e, 0xa, 0x4, 0xc, 0x4, 0xe, 0x4,
        0x81, 0xb, 0x4, 0x3, 0x5, 0x3, 0x5, 0x3, 0x5, 0x5, 0x5, 0x86, 0xa,
        ...
        0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xc, 0x7, 0xc, 0x9f, 0xa, 0xc,
        0xc, 0xc, 0xe, 0xc, 0xa2, 0xb, 0xc, 0x3, 0xc, 0x3, 0xc, 0x3, 0xd,
        0x3, 0xd, 0x3, 0xd, 0x3, 0xd, 0x3, 0xe, 0x3, 0xe, 0x3, 0xe, 0x7,
        0xe, 0xad, 0xa, 0xe, 0xc, 0xe, 0xe, 0xe, 0xb0, 0xb, 0xe, 0x3, 0xf,
        0x3, 0xf, 0x3, 0xf, 0x3, 0xf, 0x3, 0x10, 0x3, 0x10, 0x3, 0x10, 0x3,
        0x10, 0x7, 0x10, 0xba, 0xa, 0x10, 0xc, 0x10, 0xe, 0x10, 0xbd, 0xb,
        0x10, 0x3, 0x11, 0x5, 0x11, 0xc0, 0xa, 0x11, 0x3, 0x11, 0x3, 0x11,
        0x5, 0x11, 0xc4, 0xa, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3, 0x11, 0x3,
