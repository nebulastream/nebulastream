...
void QueryStatistics::incTasksPerPipeline(uint64_t pipeId) { this->pipeLineToTaskThroughputMap[pipeId]++; }
...
std::map<uint64_t, uint64_t>& QueryStatistics::getPipelineToTaskMap(){return pipeLineToTaskThroughputMap;};
