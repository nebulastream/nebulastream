...
WorkerContext::WorkerContext(uint32_t workerId,
    ...
    propagationFile << "time,originTime,difference\n";
    storageFile << "time,size\n";
}
...
void WorkerContext::updateNetworkChannel(Network::OperatorId ownerId, Network::NetworkChannelPtr&& channel) {
