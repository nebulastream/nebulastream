...
namespace NES::Runtime {
        ...
        NodeEnginePtr NodeEngineFactory::createNodeEngine(const std::string& hostname,
                                                          ...
                                                          const std::string& ,//windowingStrategy,
            ...
            try {
                ...
                if (queryManagerMode == "NumaAware") {
                    ...
                    //                                                                             hardwareManager->getNumaAllactor(i)));
                    //                }
                    //            } else {
                    //                bufferManagers.push_back(std::make_shared<BufferManager>(bufferSize,
                    ...
                    //            }
                } else if (queryManagerMode == "Static") {
                    NES_ASSERT(enableNumaAwareness == NumaAwarenessFlag::DISABLED, "Static and numa is not supported");
                ...
                } else if (queryManagerMode == "Dynamic") {
                    NES_ASSERT(enableNumaAwareness == NumaAwarenessFlag::DISABLED, "Dynamic and numa is not supported");
                    //In dynamic mode we only have one buffer manager
                    bufferManagers.push_back(std::make_shared<BufferManager>(bufferSize,
