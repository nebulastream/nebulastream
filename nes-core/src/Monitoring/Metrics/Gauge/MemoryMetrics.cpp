...
MemoryMetrics::MemoryMetrics()
    : timestamp(0), nodeId(0),
      TOTAL_RAM(0), TOTAL_SWAP(0), FREE_RAM(0), SHARED_RAM(0), BUFFER_RAM(0), FREE_SWAP(0), TOTAL_HIGH(0), FREE_HIGH(0), PROCS(0),
      MEM_UNIT(0), LOADS_1MIN(0), LOADS_5MIN(0), LOADS_15MIN(0) {}
...
bool MemoryMetrics::operator==(const MemoryMetrics& rhs) const {
    return timestamp == rhs.timestamp && nodeId == rhs.nodeId && TOTAL_RAM == rhs.TOTAL_RAM && TOTAL_SWAP == rhs.TOTAL_SWAP
