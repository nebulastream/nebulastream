...
namespace NES {
        ...
        void TopologyNode::setAvailableBandwidth(double bandwidth) { this->availableBandwidth = bandwidth; }
        double TopologyNode::getAvailableBandwidth() {return this->availableBandwidth; }
        void TopologyNode::increaseUsedBandwidth(double usedBandwidth) { this->usedBandwidth += usedBandwidth; this->availableBandwidth -= usedBandwidth; }
        double TopologyNode::getUsedBandwidth() { return this->usedBandwidth; }
        double TopologyNode::getBandwidthRatio() { return (this->usedBandwidth / this->availableBandwidth); }
