...
ExtractContainedOperatorsUtil::createContainedWindowOperator(const LogicalOperatorNodePtr& containedOperator,
...
std::vector<LogicalOperatorNodePtr>
ExtractContainedOperatorsUtil::createContainedFilterOperators(const LogicalOperatorNodePtr& container,
...
bool ExtractContainedOperatorsUtil::isMapTransformationAppliedToPredicate(
    FilterLogicalOperatorNodePtr const& filterOperator,
