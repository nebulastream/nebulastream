...
namespace NES {
    ...
    JavaUdfLogicalOperator::JavaUdfLogicalOperator(const Catalogs::UDF::JavaUdfDescriptorPtr javaUdfDescriptor,
                                                   OperatorId id) : OperatorNode(id), LogicalUnaryOperatorNode(id),
    ...
    Catalogs::UDF::JavaUdfDescriptorPtr JavaUdfLogicalOperator::getJavaUdfDescriptor() const {
