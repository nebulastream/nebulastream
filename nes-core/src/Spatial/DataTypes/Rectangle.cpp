...
Rectangle::Rectangle(double latitudeLow,
                     double longitudeLow,
                     double latitudeHigh,
    ...
    if(low.getLongitude() > high.getLongitude()) isInverted = true;
}
...
Point Rectangle::getLow() {
    return low;
}

Point Rectangle::getHigh() {
    return high;
}
...
bool Rectangle::contains(const Point& point) {
    ...
    if(isInverted) {
        ...
        return ((low.getLatitude() <= point.getLatitude() &&
                high.getLatitude() >= point.getLatitude()) &&
                (low.getLongitude() <= point.getLongitude() ||
                 high.getLongitude() >= point.getLongitude())
                );
    }
...
bool Rectangle::contains(const double latitude, const double longitude) {
    ...
    if(isInverted) {
        ...
        return ((low.getLatitude() <= latitude &&
                 high.getLatitude() >= latitude) &&
                (low.getLongitude() <= longitude ||
...
bool Rectangle::contains(const Rectangle& other) {
    ...
    if(isInverted) {
        ...
        if(other.isRectangleInverted()) {
            return ((low.getLatitude() <= other.getLatitudeLow() &&
                     high.getLatitude() >= other.getLatitudeHigh()) &&
                    (low.getLongitude() <= other.getLongitudeLow() &&
                     high.getLongitude() >= other.getLongitudeHigh())
                    );
        }
        else {
            return ((low.getLatitude() <= other.getLatitudeLow() &&
        ...
        // rectangle
        if(other.isRectangleInverted()) return false;
...
bool Rectangle::intersects(const Rectangle& other) {
    ...
    return !(other.getLatitudeLow() > high.getLatitude() ||
             other.getLatitudeHigh() < low.getLatitude() ||
             other.getLongitudeLow() > high.getLongitude() ||
             other.getLongitudeHigh() < low.getLongitude());
}
