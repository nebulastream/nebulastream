...
QueryCompilerOptionsPtr QueryCompilerOptions::createDefaultOptions() {
    ...
    options.setStreamJoinStratgy(NES::Runtime::Execution::DEFAULT_JOIN_STRATEGY);
...
void QueryCompilerOptions::setStreamJoinStratgy(Runtime::Execution::StreamJoinStrategy strategy) { this->joinStrategy = strategy; }

Runtime::Execution::StreamJoinStrategy QueryCompilerOptions::getStreamJoinStratgy() const { return joinStrategy; }
