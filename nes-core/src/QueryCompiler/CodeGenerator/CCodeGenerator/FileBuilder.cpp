...
FileBuilder FileBuilder::create(const std::string&) {
    ...
    builder.declations
        << "#include <cstdint>\n"
           ...
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalSliceMergingOperatorHandler.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalSlidingWindowSinkOperatorHandler.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalThreadLocalSliceStore.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalThreadLocalPreAggregationOperatorHandler.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalWindowGlobalSliceStoreAppendOperatorHandler.hpp>\n"
           "#include <Windowing/Experimental/KeyedTimeWindow/KeyedSliceStaging.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalSlice.hpp>\n"
           "#include <Windowing/Experimental/NonKeyedTimeWindow/GlobalSliceStaging.hpp>\n"
