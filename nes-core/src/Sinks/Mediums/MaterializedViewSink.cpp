...
MaterializedViewSink::MaterializedViewSink(MaterializedViewPtr view, SinkFormatPtr format, Runtime::QueryManagerPtr queryManager, QuerySubPlanId parentPlanId, ReplicationServicePtr replicationService)
                                           : SinkMedium(std::move(format), queryManager, parentPlanId, std::move(replicationService)), view(std::move(view)) {};
