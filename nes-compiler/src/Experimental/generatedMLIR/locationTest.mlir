module {
  ...
  func @execute(%arg0: i32) -> i32 attributes {llvm.emit_c_interface} {
    ...
    %2 = scf.for %arg1 = %c0 to %c3 step %c1 iter_args(%arg2 = %c0_i32) -> (i32) {
      ...
      %8 = llvm.getelementptr %5[%0, %arg2, 0] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i8>
      %9 = llvm.getelementptr %6[%0, %arg2, 0] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i8>
      ...
      %14 = llvm.getelementptr %5[%0, %arg2, 1] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i32>
      %15 = llvm.getelementptr %6[%0, %arg2, 1] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i32>
      ...
      %20 = llvm.getelementptr %5[%0, %arg2, 2] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i1>
      %21 = llvm.getelementptr %6[%0, %arg2, 2] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i1>
      ...
      %26 = llvm.getelementptr %5[%0, %arg2, 3] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<f32>
      %27 = llvm.getelementptr %6[%0, %arg2, 3] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<f32>
      ...
      %32 = llvm.getelementptr %5[%0, %arg2, 4] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i8>
      %33 = llvm.getelementptr %6[%0, %arg2, 4] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<i8>
      ...
      %38 = llvm.getelementptr %5[%0, %arg2, 5] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<f64>
      %39 = llvm.getelementptr %6[%0, %arg2, 5] : (!llvm.ptr<array<6 x struct<packed (i8, i32, i1, f32, i8, f64)>>>, i32, i32) -> !llvm.ptr<f64>
