...
class CPPCompilerFlags : public CompilerFlags {
 public:
  ...
  //    inline static const std::string LOGGING_FATAL_FLAG =
  //    "-DNES_LOGGING_FATAL_ERROR_LEVEL=1"; inline static const std::string
  //    LOGGING_FATAL_FLAG = "-DNES_LOGGING_TRACE_LEVEL=1";
