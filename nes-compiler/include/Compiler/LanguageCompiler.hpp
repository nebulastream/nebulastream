 ...
 * A language specific compiler, receives compilation requests and returns
 * compilation results. All methods are expected to be thread safe.
 */
class LanguageCompiler {
 public:
   ...
   */
  [[nodiscard]] virtual CompilationResult compile(
      std::shared_ptr<const CompilationRequest> request) const = 0;
