...
public:
   ...
   */
  [[nodiscard]] std::future<CompilationResult>
  compile(std::shared_ptr<const CompilationRequest> request);
...
private:
   ...
   */
  [[nodiscard]] std::future<CompilationResult>
  handleRequest(std::shared_ptr<const CompilationRequest> request);
