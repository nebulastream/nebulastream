...
#ifndef MLIR_APPROACH_MLIRJIT_HPP
#define MLIR_APPROACH_MLIRJIT_HPP
...
/// A simple object cache following Lang's LLJITWithObjectCache example.
    class SimpleObjectCacheCopy : public llvm::ObjectCache {
    public:
...
/// be used to invoke the JIT-compiled function.
    class ExecutionEngineCopy {
    public:
        ExecutionEngineCopy(bool enableObjectCache, bool enableGDBNotificationListener,
        ...
        static llvm::Expected<std::unique_ptr<ExecutionEngineCopy>>
        create(ModuleOp m,
        ...
        /// Register symbols with this ExecutionEngineCopy.
    ...
    private:
        ...
        /// Underlying cache.
        std::unique_ptr<SimpleObjectCacheCopy> cache;
...
#endif //MLIR_APPROACH_MLIRJIT_HPP
