...
Experimental::SpatialType
SpatialTypeUtility::stringToNodeType(const std::string spatialTypeString) {
...
std::string
SpatialTypeUtility::toString(const Experimental::SpatialType spatialType) {
  switch (spatialType) {
...
NES::Spatial::Protobuf::SpatialType
SpatialTypeUtility::toProtobufEnum(Experimental::SpatialType spatialType) {
  switch (spatialType) {
  case Experimental::SpatialType::NO_LOCATION:
