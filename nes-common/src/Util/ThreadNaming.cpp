...
void setThreadName(std::string_view threadName)
{
    ...
    std::array<char, PTHREAD_NAME_LENGTH + 1> truncatedStringName{};
    std::copy_n(threadName.begin(), std::min(PTHREAD_NAME_LENGTH, threadName.size()), truncatedStringName.begin());
