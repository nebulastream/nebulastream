...
static detail::LoggerHolder
    helper; /// NOLINT(cppcoreguidelines-avoid-non-const-global-variables, misc-use-anonymous-namespace) - required for singleton logger access
