...
BreadthFirstNodeIterator::BreadthFirstNodeIterator(NodePtr start)
...
bool BreadthFirstNodeIterator::iterator::operator!=(
...
BreadthFirstNodeIterator::iterator &
BreadthFirstNodeIterator::iterator::operator++() {
  if (workQueue.empty()) {
    NES_DEBUG("BF Iterator: we reached the end of this iterator and will not "
              "do anything.");
  } else {
