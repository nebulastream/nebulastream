...
TEST(SnakeToCamelCaseTest, EmptyString)
{
    EXPECT_EQ(snakeToCamelCase(""), "");
}

TEST(SnakeToCamelCaseTest, NoUnderscores)
{
    EXPECT_EQ(snakeToCamelCase("helloworld"), "helloworld");
    EXPECT_EQ(snakeToCamelCase("HelloWorld"), "helloworld");
}

TEST(SnakeToCamelCaseTest, SingleUnderscore)
{
    EXPECT_EQ(snakeToCamelCase("hello_world"), "helloWorld");
}

TEST(SnakeToCamelCaseTest, MultipleUnderscores)
{
    EXPECT_EQ(snakeToCamelCase("one_two_three"), "oneTwoThree");
}

TEST(SnakeToCamelCaseTest, LeadingUnderscore)
{
    EXPECT_EQ(snakeToCamelCase("_hello_world"), "HelloWorld");
}

TEST(SnakeToCamelCaseTest, TrailingUnderscore)
{
    EXPECT_EQ(snakeToCamelCase("hello_world_"), "helloWorld");
}

TEST(SnakeToCamelCaseTest, ConsecutiveUnderscores)
{
    EXPECT_EQ(snakeToCamelCase("hello__world"), "helloWorld");
}

TEST(SnakeToCamelCaseTest, MixedCaseInput)
{
    EXPECT_EQ(snakeToCamelCase("HELLO_WORLD"), "helloWorld");
    EXPECT_EQ(snakeToCamelCase("hELLo_wORLd"), "helloWorld");
}

TEST(SnakeToCamelCaseTest, NumbersInString)
{
    EXPECT_EQ(snakeToCamelCase("test_123_abc"), "test123Abc");
}
