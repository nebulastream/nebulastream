...
/// NebuLI
EXCEPTION(CouldNotReadQueryDescription, 2200, "Could not read query description")
EXCEPTION(CouldNotParseQueryDescription, 2201, "Could not parse query description")
EXCEPTION(InvalidQuery, 2202, "Query is invalid")
