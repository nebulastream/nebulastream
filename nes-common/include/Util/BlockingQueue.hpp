  ...
  public:
    ...
    inline void reset() {
        ...
        while (!bufferQueue.empty()) {
            NES_TRACE2("reset pop={}", bufferQueue.front())
            bufferQueue.pop();
        }
    ...
    inline void push(const T& elem) {
        {
            ...
            NES_TRACE2("BlockingQueue: pushing element {}", elem)
    ...
    inline const T pop() {
        {
            ...
            //      NES_DEBUG2("BlockingQueue: popping element {}", bufferQueue.front());
            bufferQueue.pop();
    ...
    inline const std::optional<T> popTimeout(uint64_t timeout_ms) {
        {
            ...
            T retVal = bufferQueue.front();
            //        NES_DEBUG2("BlockingQueue: popping element timeout {}", bufferQueue.front());
            bufferQueue.pop();
