...
public:
    ...
    /// Check the iword array of the passed stream for the set `VerbosityLevel` using the allocated index (private to this class).
    static VerbosityLevel getVerbosityLevel(std::ostream& os);
    /// Set the iword array of the passed stream to the passed `VerbosityLevel` using the allocated index (private to this class).
    static void setVerbosityLevel(std::ostream& os, const LogVerbosity::VerbosityLevel& level);
...
inline std::ostream& operator<<(std::ostream& os, const LogVerbosity::VerbosityLevel& level)
{
    LogVerbosity::setVerbosityLevel(os, level);
    return os;
}
}
