...
const std::string UPSTREAM_NON_SYSTEM_OPERATOR_ID = "UPSTREAM_NON_SYSTEM_OPERATOR_ID"; // Property containing the id of the next upstream non system operator of a system generated operator
const std::string DOWNSTREAM_NON_SYSTEM_OPERATOR_ID = "DOWNSTREAM_NON_SYSTEM_OPERATOR_ID"; // Property containing the id of the next downstream non system operator of a system generated operator
}// namespace NES::Optimizer
