...
consteval HelperStructLiterals<int16_t> operator""_s16(
    unsigned long long value) {
  return HelperStructLiterals<int16_t>(value);
}
consteval HelperStructLiterals<int32_t> operator""_s32(
    unsigned long long value) {
  return HelperStructLiterals<int32_t>(value);
}
consteval HelperStructLiterals<int64_t> operator""_s64(
    unsigned long long value) {
