...
#ifndef NES_COMMON_INCLUDE_UTIL_LATENCY_RECONNECTCOORDINATE_HPP_
#define NES_COMMON_INCLUDE_UTIL_LATENCY_RECONNECTCOORDINATE_HPP_
...
namespace NES {
        ...
        namespace Spatial::Latency::Experimental {
...
*/
        struct ReconnectPoint {
            NES::Synthetic::DataTypes::Experimental::NetworkCoordinate pointNetworkCoordinate;
            uint64_t newParentId;
            Timestamp expectedTime;
        };
        }// namespace Synthetic::Latency::Experimental
    }// namespace NES
#endif// NES_COMMON_INCLUDE_UTIL_LATENCY_RECONNECTCOORDINATE_HPP_
