...
using SinkId = NESStrongType<uint64_t, struct SinkId_, 0, 1>;
...
static constexpr SinkId INVALID_SINK_ID = INVALID<SinkId>;
static constexpr SinkId INITIAL_SINK_ID = INITIAL<SinkId>;
