...
/// Global Identifieres: These Identifierers are unique to the SingleNodeWorkers entire lifetime.
...
/// Local Identifiers: These Identifiers are unique in a local scope. E.g. the PipelineId is unique with regards to single query plan.
