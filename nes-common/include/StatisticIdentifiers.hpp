...
/* Names for the field an infrastructure data source is writing the value into.
 * As we could have multiple infrastructure metrics per node, we must have
 * unique identifying field names.
 */
static const std::string INGESTION_RATE_FIELD_NAME =
    "INGESTION_RATE_FIELD_NAME";
static const std::string BUFFER_RATE_FIELD_NAME = "BUFFER_RATE_FIELD_NAME";
static const std::string INFRASTRUCTURE_BASE_LOGICAL_SOURCE_NAME =
    "INFRASTRUCTURE_LOGICAL_SOURCE_NAME_";

/** Names for the fields of the StatisticWindowOperatorNode*/
static const std::string OBSERVED_TUPLES_FIELD_NAME =
    "OBSERVED_TUPLES_SYNOPSIS_FIELD_NAME";
...
static const std::string STATISTIC_HASH_FIELD_NAME =
    "STATISTIC_HASH_FIELD_NAME";
static const std::string STATISTIC_DATA_FIELD_NAME =
    "STATISTIC_DATA_FIELD_NAME";
static const std::string STATISTIC_TYPE_FIELD_NAME =
