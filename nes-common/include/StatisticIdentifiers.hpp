...
enum class StatisticSynopsisType : uint8_t { COUNT_MIN, HLL, RESERVOIR_SAMPLE, EQUI_WIDTH_HISTOGRAM, DD_SKETCH };
enum class StatisticDataCodec : uint8_t { DEFAULT, RUN_LENGTH_ENCODED };
...
static const std::string NUMBER_OF_BINS = "NUMBER_OF_BINS";
static const std::string GAMMA_FIELD_NAME = "GAMMA_FIELD_NAME";
}// namespace NES::Statistic
