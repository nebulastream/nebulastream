...
/**
 * @brief calls to this function will pass the signal to all system-wide error
 * listeners
...
/**
 * @brief calls to this function will pass an exception to all system-wide error
 * listeners
 * @param exception which indicates the error
 * @param stacktrace the stacktrace of where the error was raised
 */
[[noreturn]] void invokeErrorHandlers(std::shared_ptr<std::exception> exception,
                                      std::string&& stacktrace);

/**
 * @brief calls to this function will create a RuntimeException that is passed
 * to all system-wide error listeners
 * @param buffer the message of the exception
 * @param stacktrace the stacktrace of where the error was raised
 */
[[noreturn]] void invokeErrorHandlers(const std::string& buffer,
                                      std::string&& stacktrace);
