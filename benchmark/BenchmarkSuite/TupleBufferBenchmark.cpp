...
struct TupleI8  { int8_t key; int8_t value; };
struct TupleI16 { int16_t key; int16_t value; };
struct TupleI32 { int32_t key; int32_t value; };
struct TupleI64 { int64_t key; int64_t value; };
