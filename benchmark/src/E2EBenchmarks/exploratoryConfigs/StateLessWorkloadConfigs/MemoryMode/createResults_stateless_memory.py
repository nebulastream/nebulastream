...
df_changingThreadsAndSourceLowSelectivity = pd.read_csv(folder + 'changingThreadsAndSourceLowSelectivityMemoryMode.csv')

df_changingThreadsAndSourceProjectionOneOut = pd.read_csv(folder + 'changingThreadsAndSourceProjectionOneOutMemoryMode.csv')
df_changingThreadsAndSourceProjectionTwoOut = pd.read_csv(folder + 'changingThreadsAndSourceProjectionTwoOutMemoryMode.csv')

df_changingThreadsAndSourceMapOneField = pd.read_csv(folder + 'changingThreadsAndSourceMapOneFieldMemoryMode.csv')
df_changingThreadsAndSourceMapTwoField = pd.read_csv(folder + 'changingThreadsAndSourceMapTwoFieldMemoryMode.csv')
...
fig.add_trace(
    go.Scatter(x=df_changingThreadsAndSourceProjectionOneOut['src'],
               y=df_changingThreadsAndSourceProjectionOneOut['AvgLatencyInMs'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df_changingThreadsAndSourceProjectionTwoOut['src'],
               y=df_changingThreadsAndSourceProjectionTwoOut['AvgLatencyInMs'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df_changingThreadsAndSourceMapOneField['src'],
               y=df_changingThreadsAndSourceMapOneField['AvgLatencyInMs'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
...
fig.add_trace(
    go.Scatter(x=df_changingThreadsAndSourceMapTwoField['src'],
               y=df_changingThreadsAndSourceMapTwoField['AvgLatencyInMs'],
               hoverinfo='x+y',
               mode='markers+lines',
               line=dict(color='green',
                         width=2),
