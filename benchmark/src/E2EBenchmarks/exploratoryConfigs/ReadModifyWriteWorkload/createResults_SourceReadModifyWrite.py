...
folder = "./"
df_changingBufferSize = pd.read_csv(folder + 'changingBufferSizeReadModifyWrite.csv')
df_changingGlobalBufferCnt = pd.read_csv(folder + 'changingGlobalBufferCntReadModifyWrite.csv')
df_changingLocalBufferSize = pd.read_csv(folder + 'changingLocalBufferSizeReadModifyWrite.csv')

df_changingSourceCnt = pd.read_csv(folder + 'changingSourceCntReadModifyWrite.csv')
df_chaningWorkerCnt = pd.read_csv(folder + 'changingWorkerCntReadModifyWrite.csv')
df_changingThreadsAndSourceNoProc = pd.read_csv(folder + 'changingThreadsAndSourceNoProcReadModifyWrite.csv')
df_scalingLarge = pd.read_csv(folder + 'scalingLargeReadModifyWrite.csv')
...
fig.update_layout(
    title={
        'text': "<b>NebulaStream Performance Numbers -- MemoryMode -- ReadModifyWriteWorkload </b><br>"
                ...
                "LocalBufferPool=1024, BufferSize=4MB, Threads=1, Source=1, TupleSize=24Byte, Query::from(input).map(Attribute(value) = Attribute(value) + 1).sink(NullOutputSinkDescriptor::create());"
                "<br>",
        'y': 0.98,
        'x': 0.5,
        'xanchor': 'center',
