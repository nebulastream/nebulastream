...
#pragma omp parallel for
        ...
        //        queryObjects[0] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("id") * Attribute("val") * Attribute("X"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y10") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 2 > Attribute("X") - 2)
        //                .unionWith(&(Query::from("example1")
        //                                 .map(Attribute("id") = Attribute("Y") * Attribute("id") * Attribute("val") * Attribute("X"))
        //                                 .map(Attribute("X") = Attribute("X") + 6)
        //                                 .map(Attribute("val") = Attribute("val") * 5)
        //                                 .map(Attribute("NEW_Y10") = Attribute("id") * Attribute("val"))
        //                                 .filter(Attribute("Y") - 2 > Attribute("X") - 2)))
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[1] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("val") * Attribute("id") * Attribute("Y") * Attribute("X"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 1 > Attribute("X") - 1)
        //                .unionWith(&(Query::from("example1")
        //                                 .map(Attribute("id") = Attribute("val") * Attribute("id") * Attribute("Y") * Attribute("X"))
        //                                 .map(Attribute("val") = Attribute("val") * 5)
        //                                 .map(Attribute("X") = Attribute("X") + 6)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[2] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("id") * Attribute("val") * Attribute("X"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 10 > Attribute("X") - 10)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("Y") * Attribute("id") * Attribute("val") * Attribute("X"))
        //                                .map(Attribute("X") = Attribute("X") + 6)
        //                                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[3] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("id") * Attribute("X") * Attribute("val") * Attribute("Y"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 3 > Attribute("X") - 3)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("id") * Attribute("X") * Attribute("val") * Attribute("Y"))
        //                                .map(Attribute("X") = Attribute("X") + 6)
        //                                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[4] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("id") * Attribute("val") * Attribute("Y") * Attribute("X"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 1 > Attribute("X") - 1)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("id") * Attribute("val") * Attribute("Y") * Attribute("X"))
        //                                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[5] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("id") * Attribute("X") * Attribute("val"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 10 > Attribute("X") - 10)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[6] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("X") * Attribute("Y") * Attribute("id") * Attribute("val"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 3 > Attribute("X") - 3)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[7] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("X") * Attribute("val") * Attribute("id"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 2 > Attribute("X") - 2)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[8] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("X") * Attribute("val") * Attribute("Y") * Attribute("id"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 1 > Attribute("X") - 1)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[9] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("X") * Attribute("val") * Attribute("id") * Attribute("Y"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 1 > Attribute("X") - 1)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[10] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("id") * Attribute("val") * Attribute("X") * Attribute("Y"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y7") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 5 > Attribute("X") - 5)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("id") * Attribute("val") * Attribute("X") * Attribute("Y"))
        //                                .map(Attribute("val") = Attribute("val") * 5)
        //                                .map(Attribute("X") = Attribute("X") + 6)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[11] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("val") * Attribute("Y") * Attribute("X") * Attribute("id"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 10 > Attribute("X") - 10)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[12] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("val") * Attribute("id") * Attribute("Y") * Attribute("X"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y9") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 2 > Attribute("X") - 2)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("val") * Attribute("id") * Attribute("Y") * Attribute("X"))
        //                                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[13] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("id") * Attribute("Y") * Attribute("X") * Attribute("val"))
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("NEW_Y4") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 3 > Attribute("X") - 3)
        //                .unionWith(&Query::from("example1")
        //                                .map(Attribute("id") = Attribute("id") * Attribute("Y") * Attribute("X") * Attribute("val"))
        //                                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[14] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("X") * Attribute("id") * Attribute("val"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 3 > Attribute("X") - 3)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[15] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("val") * Attribute("X") * Attribute("id") * Attribute("Y"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 2 > Attribute("X") - 2)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[16] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("X") * Attribute("Y") * Attribute("val") * Attribute("id"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y2") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 1 > Attribute("X") - 1)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[17] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("val") * Attribute("X") * Attribute("id") * Attribute("Y"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[18] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("X") * Attribute("val") * Attribute("id") * Attribute("Y"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        ...
        //                .map(Attribute("val") = 7081 - Attribute("Y"))
        //                .sink(NullOutputSinkDescriptor::create()));
        //        queryObjects[19] = std::make_shared<Query>(
        //            Query::from("example1")
        //                .map(Attribute("id") = Attribute("Y") * Attribute("val") * Attribute("id") * Attribute("X"))
        //                .map(Attribute("X") = Attribute("X") + 6)
        //                .map(Attribute("val") = Attribute("val") * 5)
        //                .map(Attribute("NEW_Y10") = Attribute("id") * Attribute("val"))
        //                .filter(Attribute("Y") - 10 > Attribute("X") - 10)
