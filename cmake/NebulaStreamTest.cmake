...
function(add_compiler_unit_test)
    add_executable(${ARGN})
    set(TARGET_NAME ${ARGV0})
    target_link_libraries(${TARGET_NAME} nes-compiler nes-test-util)
    if (NES_ENABLE_PRECOMPILED_HEADERS)
        target_precompile_headers(${TARGET_NAME} REUSE_FROM nes-common)
    endif ()
    if (CODE_COVERAGE)
...
function(add_nes_integration_test)
    ...
    target_link_libraries(${TARGET_NAME} nes-core-test-util)
    add_test(NAME ${TARGET_NAME} COMMAND ${TARGET_NAME})
    message(STATUS "Added integration test ${TARGET_NAME}")
endfunction()
