...
function(instrument_codebase)
    if (CODE_COVERAGE)
        ...
        target_code_coverage(nes-execution PUBLIC AUTO)
        target_code_coverage(nes-functions PUBLIC AUTO)
        target_code_coverage(nes-memory PUBLIC AUTO)
        target_code_coverage(nes-nautilus PUBLIC AUTO)
        target_code_coverage(nes-operators PUBLIC AUTO)
        target_code_coverage(nes-runtime PUBLIC AUTO)
        target_code_coverage(nes-single-node-worker-lib PUBLIC AUTO)
        target_code_coverage(nes-sources PUBLIC AUTO)
        target_code_coverage(nes-window-types PUBLIC AUTO)
        target_code_coverage(nes-window-types PUBLIC AUTO)
    endif ()
endfunction()
