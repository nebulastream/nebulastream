...
function(instrument_codebase)
    if (CODE_COVERAGE)
        ...
        target_code_coverage(nes-worker PUBLIC AUTO)
        target_code_coverage(nes-coordinator PUBLIC AUTO)
        ...
        target_code_coverage(nes-expressions PUBLIC AUTO)
        target_code_coverage(nes-statistics PUBLIC AUTO)
