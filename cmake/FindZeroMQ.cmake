...
set(DETECTED_ZeroMQ_VERSION "${ZeroMQ_VERSION_MAJOR}.${ZeroMQ_VERSION_MINOR}.${ZeroMQ_VERSION_PATCH}")
if (NOT ${DETECTED_ZeroMQ_VERSION} STREQUAL ${ZMQ_RELEASE})
  message(WARNING "Mismatching ZeroMQ version got: " ${DETECTED_ZeroMQ_VERSION} " but expected: " ${ZMQ_RELEASE})
endif()
