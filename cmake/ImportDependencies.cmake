...
if (NES_SELF_HOSTING)
    ...
    if (${VCPKG_TARGET_TRIPLET} STREQUAL "x64-linux-nes")
        ...
        set(CLANG_COMPRESSED_BINARY_NAME nes-clang-${VCPKG_BINARY_VERSION}-x64-linux-ubuntu-${LSB_RELEASE_VERSION_SHORT}-nes)
    else ()
        message(FATAL_ERROR "Currently we only provide pre-build dependencies for Ubuntu: ${NES_SUPPORTED_UBUNTU_VERSIONS}. If you use a different linux please provide an own clang installation.")
    endif ()

    IF (NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_BINARY_NAME})
        message(STATUS "NES Clang binaries do not exist!")
        download_file(https://github.com/nebulastream/clang-binaries/releases/download/v26/nes-clang-15-ubuntu-22.04-X64.7z
                ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_BINARY_NAME}.7z)
        file(ARCHIVE_EXTRACT INPUT ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_BINARY_NAME}.7z DESTINATION ${CMAKE_CURRENT_BINARY_DIR})
    endif ()
    ...
    set(CMAKE_C_COMPILER "${CMAKE_CURRENT_BINARY_DIR}/clang/bin/clang")
    set(CMAKE_CXX_COMPILER "${CMAKE_CURRENT_BINARY_DIR}/clang/bin/clang++")

    # Setup cmake configuration to include libs
    set(LLVM_DIR "/home/pgrulich/Downloads/clang/lib/cmake/llvm")
    set(MLIR_DIR "/home/pgrulich/Downloads/clang/lib/cmake/mlir")
else ()
