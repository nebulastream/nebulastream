...
elseif (DEFINED ENV{NES_USE_LIBCXX} AND NOT "$ENV{NES_USE_LIBCXX}" STREQUAL "")
    string(STRIP "$ENV{NES_USE_LIBCXX}" _nes_use_libcxx_choice)
...
option(USE_LIBCXX "Use Libc++ if supported by the system" ${_nes_use_libcxx_default})
