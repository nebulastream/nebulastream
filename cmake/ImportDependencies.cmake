...
#        set(CLANG_COMPRESSED_BINARY_NAME nes-clang-${LLVM_VERSION}-ubuntu-${LSB_RELEASE_VERSION_SHORT}-${NES_HOST_PROCESSOR})
        # Hardcoding the LLVM Binary version so that we can find the correct url
        set(CLANG_COMPRESSED_BINARY_NAME nes-clang-18-ubuntu-${LSB_RELEASE_VERSION_SHORT}-${NES_HOST_PROCESSOR})
    elseif (NES_HOST_NAME STREQUAL "osx")
