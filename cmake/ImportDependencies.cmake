...
elseif (DEFINED CMAKE_TOOLCHAIN_FILE)
    ...
    message(WARNING "Neither VCPKG_ROOT Environment nor CMAKE_TOOLCHAIN_FILE was supplied: Creating new internal vcpkg-repository and building dependencies. This might take a while. If possible, use the development container, check the docs.")
...
# - Cross compilation is no possible, target and host triplets are always identical
...
if (NOT VCPKG_HOST_OS MATCHES "Linux")
    message(FATAL_ERROR "Only linux is supported. Use the nebulastream/nes-development:latest docker image, check the docs")
endif ()
