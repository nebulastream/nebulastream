...
# 1. Depending on the Sanitizers we choose different toolchains variants to build vcpkg dependencies
# 2. The system architecture is normally set in CMAKE_HOST_SYSTEM_PROCESSOR,
...
# 3. Currently only linux is supported.
# 4. Cross compilation is no possible, target and host triplets are always identical
...
if (NOT VCPKG_HOST_OS MATCHES "Linux")
    message(FATAL_ERROR "Only linux is supported. Use the nebulastream/nes-development:latest docker image")
endif ()
