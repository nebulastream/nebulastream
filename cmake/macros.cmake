...
macro(project_enable_clang_format)
    ...
    elseif (CLANG_FORMAT_EXECUTABLE)
        ...
        add_custom_target(format-check COMMAND python3 ${CMAKE_SOURCE_DIR}/scripts/run_clang_format.py ${CLANG_FORMAT_EXECUTABLE} --exclude_globs ${CMAKE_SOURCE_DIR}/clang_suppressions.txt --source_dirs ${NES_FOLDER_NAMES_COMMA_SEPARATED} USES_TERMINAL)
    else ()
