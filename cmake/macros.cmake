...
function(download_file url filename)
    ...
    if (NOT EXISTS ${filename})
        set(I "0")
        while(I LESS "3")
            file(DOWNLOAD ${url} ${filename} SHOW_PROGRESS TIMEOUT 0 INACTIVITY_TIMEOUT 5 STATUS DOWNLOAD_STATUS)
            ...
            if(${STATUS_CODE} EQUAL 0)
                ...
                message(STATUS "Retry attempt ${I}/3")
                file(REMOVE ${filename})
            endif()
        endwhile()
        if(I EQUAL "3")
            message(FATAL_ERROR "Aborting: retry attempts exceeded while downloading ${url}")
        endif()
    endif ()
