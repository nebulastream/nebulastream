...
function(create_registry_for_component_specific registry_component)
    set(registries_library ${registry_component}-registry)
    create_plugin_registry_library(${registries_library} ${registry_component})
    target_link_libraries(${registry_component} PRIVATE ${registries_library})
    generate_plugin_registrars(${registry_component} ${ARGN})
endfunction()
