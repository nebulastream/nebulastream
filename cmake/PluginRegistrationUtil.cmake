...
function(generate_plugin_registrar plugin_registry plugin_registry_component)
    ...
    foreach (reg_func IN LISTS plugin_registry_plugin_names_final)
        if ("${plugin_registry}" STREQUAL "ExecutablePipelineProvider")
            list(APPEND REGISTER_FUNCTION_DECLARATIONS "std::unique_ptr<${plugin_registry}RegistryReturnType> Register${reg_func}${plugin_registry}()")
        else ()
