# ExternalPlugins/PluginsConfig.cmake

# Initialize the list of plugins
#set(PLUGIN_REGISTRATIONS "")

# enables/disables an external plugin; if enabled, the path to the plugin becomes part of the build
function(add_external_plugin plugin_path plugin_option)
    if(${plugin_option})
        message(STATUS "Adding external plugin: ${plugin_path} (and all of its dependencies).")
        add_subdirectory(${plugin_path})
    else()
        message(STATUS "Skipping external plugin: ${plugin_path}.")
    endif()
endfunction()
...
# iterate over all plugins, collect all plugins with given name, inject plugins into registrar
