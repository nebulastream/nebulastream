...
if (NES_SELF_HOSTING)
    ...
    IF (NOT EXISTS ${CMAKE_CURRENT_BINARY_DIR}/${LLVM_FOLDER_NAME})
        ...
        download_file(https://github.com/nebulastream/clang-binaries/releases/download/${LLVM_BINARY_VERSION}/${CLANG_COMPRESSED_BINARY_NAME}.7z
                ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_COMPRESSED_BINARY_NAME}_${LLVM_BINARY_VERSION}.7z)
        file(ARCHIVE_EXTRACT INPUT ${CMAKE_CURRENT_BINARY_DIR}/${CLANG_COMPRESSED_BINARY_NAME}_${LLVM_BINARY_VERSION}.7z DESTINATION ${CMAKE_CURRENT_BINARY_DIR}/${LLVM_FOLDER_NAME} PATTERNS clang)
    endif ()
