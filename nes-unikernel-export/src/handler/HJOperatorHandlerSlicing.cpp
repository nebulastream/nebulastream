...
HJOperatorHandlerSlicing::HJOperatorHandlerSlicing(const std::vector<OriginId>& inputOrigins,
    ...
    : StreamJoinOperatorHandler(inputOrigins, outputOriginId, windowSize, windowSlide, sizeOfRecordLeft, sizeOfRecordRight),
      ...
      StreamJoinOperatorHandlerSlicing(inputOrigins,
                                       ...
                                       sizeOfRecordLeft,
                                       sizeOfRecordRight) {
    TRACE_OPERATOR_HANDLER("NES::Runtime::Execution::Operators::HJOperatorHandlerSlicing",
                           "Execution/Operators/Streaming/Join/HashJoin/Slicing/HJOperatorHandlerSlicing.hpp",
                           inputOrigins,
                           outputOriginId,
                           windowSize,
                           windowSlide,
