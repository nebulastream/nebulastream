...
#ifndef NES_IMPL_NODES_OPERATORS_LOGICALOPERATORS_SINKS_HDFSFILESINKDESCRIPTOR_HPP_
#define NES_IMPL_NODES_OPERATORS_LOGICALOPERATORS_SINKS_HDFSFILESINKDESCRIPTOR_HPP_
 ...
 */
class HdfsFileSinkDescriptor : public SinkDescriptor {
  public:
    /**
  ...
  private:
    explicit HdfsFileSinkDescriptor(std::string fileName, std::string sinkFormat, bool append);
    std::string fileName;
    std::string sinkFormat;
    bool append;
};

typedef std::shared_ptr<HdfsFileSinkDescriptor> HdfsFileSinkDescriptorPtr;
}// namespace NES

#endif//NES_IMPL_NODES_OPERATORS_LOGICALOPERATORS_SINKS_HDFSFILESINKDESCRIPTOR_HPP_
