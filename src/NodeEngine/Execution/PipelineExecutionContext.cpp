...
PipelineExecutionContext::PipelineExecutionContext(QuerySubPlanId queryId, QueryManagerPtr queryManager, BufferManagerPtr bufferManager,
    ...
    : queryId(queryId), queryManager(queryManager), localBufferPool(bufferManager->createLocalBufferManager(NUM_BUFFERS_PER_PIPELINE)),
