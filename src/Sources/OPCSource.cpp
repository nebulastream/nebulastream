...
OPCSource::OPCSource(SchemaPtr schema, NodeEngine::BufferManagerPtr bufferManager, NodeEngine::QueryManagerPtr queryManager,
                     std::string url, UA_NodeId nodeId, std::string password, std::string user, OperatorId operatorId, size_t numSourceLocalBuffers)
    : DataSource(schema, bufferManager, queryManager, operatorId, numSourceLocalBuffers), url(url), nodeId(nodeId), retval(UA_STATUSCODE_GOOD),
