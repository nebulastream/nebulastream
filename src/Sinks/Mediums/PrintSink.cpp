...
namespace NES {
PrintSink::PrintSink(SinkFormatPtr format, QuerySubPlanId parentPlanId, OperatorId operatorId, std::ostream& pOutputStream)
    : SinkMedium(format, parentPlanId, operatorId), outputStream(pOutputStream) {}
