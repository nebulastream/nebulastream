...
OPCSink::OPCSink(OperatorId logicalOperatorId,
                 ...
                 std::string password,
                 QuerySubPlanId parentPlanId)
    : SinkMedium(logicalOperatorId, std::move(format), parentPlanId), connected(false), url(url), nodeId(nodeId), user(std::move(std::move(user))),
