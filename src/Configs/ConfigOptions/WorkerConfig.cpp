...
WorkerConfig::WorkerConfig(string filePath) : filePath(filePath) {}
...
const string& WorkerConfig::getFilePath() const { return filePath; }
void WorkerConfig::setFilePath(const string& filePath) { WorkerConfig::filePath = filePath; }
}// namespace NES