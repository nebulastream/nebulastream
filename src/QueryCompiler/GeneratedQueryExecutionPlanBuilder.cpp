...
GeneratedQueryExecutionPlanBuilder& GeneratedQueryExecutionPlanBuilder::setWinDef(const LogicalWindowDefinitionPtr& winDef) {
    this->winDef = winDef;
    return *this;
}
...
LogicalWindowDefinitionPtr GeneratedQueryExecutionPlanBuilder::getWinDef() {
    return winDef;
}
