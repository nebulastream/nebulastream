...
namespace
{
TypedLogicalOperator<DeltaLogicalOperator>
makeDelta(std::vector<DeltaLogicalOperator::DeltaExpression> exprs)
{
    return TypedLogicalOperator<DeltaLogicalOperator>{std::move(exprs)};
}
}
...
protected:
    Schema inputSchema = Schema{}
                             .addField("stream$id", DataType{DataType::Type::UINT64, DataType::NULLABLE::NOT_NULLABLE})
                             .addField("stream$value", DataType{DataType::Type::UINT64, DataType::NULLABLE::NOT_NULLABLE})
                             .addField("stream$timestamp", DataType{DataType::Type::UINT64, DataType::NULLABLE::NOT_NULLABLE});
};
...
TEST_F(DeltaLogicalOperatorTest, InferSchemaFloatField)
{
    auto floatSchema = Schema{}
                           .addField("stream$temperature", DataType{DataType::Type::FLOAT64, DataType::NULLABLE::NOT_NULLABLE})
                           .addField("stream$timestamp", DataType{DataType::Type::UINT64, DataType::NULLABLE::NOT_NULLABLE});
...
TEST_F(DeltaLogicalOperatorTest, InferSchemaSmallIntegerTypes)
{
    auto smallSchema = Schema{}
                           .addField("stream$a", DataType{DataType::Type::UINT8, DataType::NULLABLE::NOT_NULLABLE})
                           .addField("stream$b", DataType{DataType::Type::UINT16, DataType::NULLABLE::NOT_NULLABLE})
                           .addField("stream$c", DataType{DataType::Type::UINT32, DataType::NULLABLE::NOT_NULLABLE})
                           .addField("stream$d", DataType{DataType::Type::INT32, DataType::NULLABLE::NOT_NULLABLE});
...
{
    auto boolSchema = Schema{}.addField("stream$flag", DataType{DataType::Type::BOOLEAN, DataType::NULLABLE::NOT_NULLABLE});

    auto deltaOp = makeDelta({
        {FieldIdentifier("delta_flag"), FieldAccessLogicalFunction("flag")},
    });

    ASSERT_EXCEPTION_ERRORCODE(static_cast<void>(deltaOp->withInferredSchema({boolSchema})),
...
TEST_F(DeltaLogicalOperatorTest, EqualityIdenticalOperators) {
    auto a = makeDelta({{FieldIdentifier("delta_value"), FieldAccessLogicalFunction("value")}});
    auto b = makeDelta({{FieldIdentifier("delta_value"), FieldAccessLogicalFunction("value")}});
...
TEST_F(DeltaLogicalOperatorTest, EqualityDifferentExpressions) {
    auto a = makeDelta({{FieldIdentifier("delta_value"), FieldAccessLogicalFunction("value")}})
                 ->withInferredSchema({inputSchema});
    auto b = makeDelta({{FieldIdentifier("delta_id"), FieldAccessLogicalFunction("id")}})
                 ->withInferredSchema({inputSchema});
...
TEST_F(DeltaLogicalOperatorTest, EqualityDifferentSchemas) {
    auto otherSchema = Schema{}.addField("stream$x", DataType{DataType::Type::UINT64, DataType::NULLABLE::NOT_NULLABLE});

    auto a = makeDelta({{FieldIdentifier("delta_value"), FieldAccessLogicalFunction("value")}})
                 ->withInferredSchema({inputSchema});
    auto b = makeDelta({{FieldIdentifier("delta_x"), FieldAccessLogicalFunction("x")}})
                 ->withInferredSchema({otherSchema});
...
TEST_F(DeltaLogicalOperatorTest, SerializeDeserializeRoundtrip) {
    auto cases = std::vector<TypedLogicalOperator<DeltaLogicalOperator>>{
        /// Single aliased expression
        makeDelta({{FieldIdentifier("delta_value"), FieldAccessLogicalFunction("value")}}),
