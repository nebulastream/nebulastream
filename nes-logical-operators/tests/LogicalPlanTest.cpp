...
TEST_F(LogicalPlanTest, AddTraits)
{
    ...
    const auto sourceWithTwoTraits = addTraits(sourceWithTrait, {OriginIdAssignerTrait{}});
    ...
    ASSERT_THAT(
        addTraits(sourceWithTwoTraits, {TestTrait{}}).getTraitSet(), ::testing::UnorderedElementsAre(OriginIdAssignerTrait{}, TestTrait{}));
}
