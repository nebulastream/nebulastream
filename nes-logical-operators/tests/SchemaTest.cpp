...
//         {
//             Schema<Field, Unordered> testSchema;
//             ASSERT_NO_THROW(testSchema = Schema<Field, Unordered>{Schema<Field, Unordered>::MemoryLayoutType::COLUMNAR_LAYOUT});
//             ASSERT_EQ(testSchema.memoryLayoutType, Schema<Field, Unordered>::MemoryLayoutType::COLUMNAR_LAYOUT);
...
//         auto testSchema = Schema<Field, Unordered>{Schema<Field, Unordered>::MemoryLayoutType::ROW_LAYOUT}
