...
using AggregationFunctionRegistryReturnType = std::shared_ptr<Logical::WindowAggregationFunction>;
struct AggregationFunctionRegistryArguments
{
    std::vector<Logical::FieldAccessFunction> fields;
};

class AggregationFunctionRegistry : public BaseRegistry<
                                              AggregationFunctionRegistry,
                                              std::string,
                                              AggregationFunctionRegistryReturnType,
                                              AggregationFunctionRegistryArguments>
{
};
}
