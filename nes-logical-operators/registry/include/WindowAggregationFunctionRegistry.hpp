...
class WindowAggregationFunctionRegistry
    : public BaseRegistry<WindowAggregationFunctionRegistry, std::string, WindowAggregationFunctionRegistryReturnType, WindowAggregationFunctionRegistryArguments>
{
};
}
