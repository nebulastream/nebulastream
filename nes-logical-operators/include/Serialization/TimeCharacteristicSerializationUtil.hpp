...
public:
    ...
    // static std::optional<Windowing::BoundTimeCharacteristic> deserializeBoundCharacteristic(const SerializableTimeCharacteristic& serializedCharacteristic, const Schema<Field, Unordered>& schema);
};
