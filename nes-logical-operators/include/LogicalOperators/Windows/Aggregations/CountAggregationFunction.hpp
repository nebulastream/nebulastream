...
public:
    ...
    static std::shared_ptr<WindowAggregationFunction> create(FieldAccessFunction onField, FieldAccessFunction asField);
    CountAggregationFunction(FieldAccessFunction onField, FieldAccessFunction asField);
    explicit CountAggregationFunction(FieldAccessFunction onField);
