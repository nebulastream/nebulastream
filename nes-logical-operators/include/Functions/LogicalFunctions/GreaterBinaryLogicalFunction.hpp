...
class GreaterBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    GreaterBinaryLogicalFunction() noexcept;
    ~GreaterBinaryLogicalFunction() override = default;
...
protected:
    explicit GreaterBinaryLogicalFunction(GreaterBinaryLogicalFunction* other);
