...
class LessEqualsBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    LessEqualsBinaryLogicalFunction();
    ~LessEqualsBinaryLogicalFunction() override = default;
...
protected:
    explicit LessEqualsBinaryLogicalFunction(LessEqualsBinaryLogicalFunction* other);
