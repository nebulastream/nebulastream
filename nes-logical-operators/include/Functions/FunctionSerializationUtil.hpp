...
public:
    ...
    /// @param LogicalFunction The root function node to serialize.
    ...
    serializeFunction(const std::shared_ptr<LogicalFunction>& LogicalFunction, SerializableFunction* serializedFunction);

    /// @brief De-serializes the SerializableFunction and all its children to a corresponding std::shared_ptr<LogicalFunction>
    /// @param serializedFunction the serialized function.
    /// @return std::shared_ptr<LogicalFunction>
