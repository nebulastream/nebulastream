...
public:
    ...
    explicit UnboundFieldAccessLogicalFunction(IdentifierList fieldName);
    UnboundFieldAccessLogicalFunction(IdentifierList fieldName, DataType dataType);
...
struct FieldAccessLogicalFunctionVariantWrapper
{
    ...
    friend bool operator==(const FieldAccessLogicalFunctionVariantWrapper& lhs, const FieldAccessLogicalFunctionVariantWrapper& rhs) = default;
