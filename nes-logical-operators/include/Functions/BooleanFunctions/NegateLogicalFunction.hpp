...
public:
    ...
    static LogicalFunctionRegistryReturnType createNegate(LogicalFunctionRegistryArguments arguments);
...
{
    NegateLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
