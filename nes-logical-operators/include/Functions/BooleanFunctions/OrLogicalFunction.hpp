...
public:
    ...
    static LogicalFunctionRegistryReturnType createOr(LogicalFunctionRegistryArguments arguments);
...
{
    OrLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
