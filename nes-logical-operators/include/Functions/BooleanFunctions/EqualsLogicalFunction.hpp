...
public:
    ...
    static LogicalFunctionRegistryReturnType createEquals(LogicalFunctionRegistryArguments arguments);
...
{
    EqualsLogicalFunction operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
