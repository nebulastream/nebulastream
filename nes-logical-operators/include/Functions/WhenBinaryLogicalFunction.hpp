...
class WhenBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit WhenBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~WhenBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit WhenBinaryLogicalFunction(WhenBinaryLogicalFunction* other);
};
