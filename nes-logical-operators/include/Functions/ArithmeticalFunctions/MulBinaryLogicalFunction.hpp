...
class MulBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit MulBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~MulBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit MulBinaryLogicalFunction(MulBinaryLogicalFunction* other);
};
