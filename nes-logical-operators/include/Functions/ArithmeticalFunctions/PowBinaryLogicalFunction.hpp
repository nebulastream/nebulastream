...
class PowBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit PowBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~PowBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit PowBinaryLogicalFunction(PowBinaryLogicalFunction* other);
};
