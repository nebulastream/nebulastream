...
class SubBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit SubBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~SubBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit SubBinaryLogicalFunction(SubBinaryLogicalFunction* other);
};
