...
class SqrtUnaryLogicalFunction final : public UnaryLogicalFunction
{
public:
    explicit SqrtUnaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~SqrtUnaryLogicalFunction() noexcept override = default;
