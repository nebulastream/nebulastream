...
class DivBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit DivBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~DivBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit DivBinaryLogicalFunction(DivBinaryLogicalFunction* other);
};
