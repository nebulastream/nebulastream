...
namespace NES
{
class AddBinaryLogicalFunction final : public BinaryLogicalFunction
{
public:
    explicit AddBinaryLogicalFunction(std::shared_ptr<DataType> stamp);
    ~AddBinaryLogicalFunction() noexcept override = default;
...
private:
    explicit AddBinaryLogicalFunction(AddBinaryLogicalFunction* other);
};
