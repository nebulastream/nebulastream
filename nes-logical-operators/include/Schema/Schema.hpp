...
//     };
//
//     Schema<Field, Unordered>(Private, std::unordered_set<Field> fields, std::unordered_map<IdentifierList, FieldRef> nameToFields) noexcept
...
//     };
//
//     Schema<Field, Unordered>() = default;
//     Schema<Field, Unordered>(const Schema<Field, Unordered>& other) = default;
//     Schema<Field, Unordered>(Schema<Field, Unordered>&& other) noexcept = default;
//     Schema<Field, Unordered>& operator=(const Schema<Field, Unordered>& other) = default;
//     Schema<Field, Unordered>& operator=(Schema<Field, Unordered>&& other) noexcept = default;
//
//     Schema<Field, Unordered>(std::initializer_list<Field> fields);
//     explicit Schema<Field, Unordered>(std::unordered_set<Field> fields);
//
...
//         && !std::same_as<Range, std::vector<Field>> && !std::same_as<Range, Schema<Field, Unordered>>)
//     explicit Schema<Field, Unordered>(Range&& input) noexcept : fields{input | std::ranges::to<std::unordered_set>()}
//     {
...
//     static std::expected<Schema<Field, Unordered>, std::unordered_map<IdentifierList, std::vector<Field>>> tryCreateCollisionFree(Range input) noexcept
//     {
...
//             | std::ranges::to<std::unordered_map<IdentifierList, FieldRef>>();
//         return Schema<Field, Unordered>(Private{}, std::move(fields), std::move(nameToField));
//     }
//
//     ~Schema<Field, Unordered>() = default;
//
//     bool operator==(const Schema<Field, Unordered>& other) const;
//     friend std::ostream& operator<<(std::ostream& os, const Schema<Field, Unordered>& schema);
//
...
//     Schema<UnqualifiedUnboundField, Unordered> unbind() const
//     {
//         return SchemaBase{*this | std::views::transform(Field::unbinder()) | std::ranges::to<std::vector>()};
//     }
//
//     static Schema<Field, Unordered> bind(LogicalOperator logicalOperator, Schema<UnqualifiedUnboundField, Unordered> unboundSchema);
//
// private:
...
// };
//
// inline size_t Schema<Field, Unordered>::size() const
// {
//     return fields.size();
// }
