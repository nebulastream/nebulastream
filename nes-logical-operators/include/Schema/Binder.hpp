...
requires(
    !std::same_as<UnboundRange, Schema<std::ranges::range_value_t<UnboundRange>, Ordered>>
...
requires(
    !std::same_as<std::remove_cvref_t<BoundRange>, Schema<std::ranges::range_value_t<BoundRange>, Ordered>>
