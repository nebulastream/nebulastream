...
{
class FloorFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Floor";

    FloorFunction(Function child);
    FloorFunction(const FloorFunction& other);
    ~FloorFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::FloorFunction);
