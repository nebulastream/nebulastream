...
{
class ModuloFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Modulo";

    ModuloFunction(Function left, Function right);
    ModuloFunction(const ModuloFunction& other);
    ~ModuloFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::ModuloFunction);
