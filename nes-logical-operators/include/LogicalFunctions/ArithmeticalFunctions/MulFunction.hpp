...
{
class MulFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Mul";

    MulFunction(Function left, Function right);
    MulFunction(const MulFunction& other);
    ~MulFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::MulFunction);
