...
{
class CeilFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Ceil";

    CeilFunction(Function child);
    CeilFunction(const CeilFunction& other);
    ~CeilFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::CeilFunction);
