...
{
class RoundFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Round";

    RoundFunction(Function child);
    RoundFunction(const RoundFunction& other);
    ~RoundFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::RoundFunction);
