...
{
class SubFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Sub";

    SubFunction(Function left, Function right);
    SubFunction(const SubFunction& other);
    ~SubFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::SubFunction);
