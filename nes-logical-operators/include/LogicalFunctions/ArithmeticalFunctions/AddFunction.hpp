...
{
class AddFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Add";

    AddFunction(Function left, Function right);
    AddFunction(const AddFunction& other);
    ~AddFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::AddFunction);
