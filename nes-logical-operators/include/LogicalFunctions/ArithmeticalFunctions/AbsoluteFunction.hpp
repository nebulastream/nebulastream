...
{
class AbsoluteFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Absolute";

    AbsoluteFunction(Function child);
    AbsoluteFunction(const AbsoluteFunction& other);
    ~AbsoluteFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::AbsoluteFunction);
