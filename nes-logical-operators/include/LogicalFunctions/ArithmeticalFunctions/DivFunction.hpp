...
{
class DivFunction final : public FunctionConcept
{
public:
    ~DivFunction() noexcept override = default;
    static constexpr std::string_view NAME = "Div";

    DivFunction(Function left, Function right);
    DivFunction(const DivFunction& other);
...
FMT_OSTREAM(NES::Logical::DivFunction);
