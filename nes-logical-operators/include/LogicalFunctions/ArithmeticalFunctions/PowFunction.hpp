...
{
class PowFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Pow";

    PowFunction(Function left, Function right);
    PowFunction(const PowFunction& other);
    ~PowFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::PowFunction);
