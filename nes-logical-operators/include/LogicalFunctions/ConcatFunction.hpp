...
class ConcatFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Concat";

    ConcatFunction(Function left, Function right);
    ConcatFunction(const ConcatFunction& other);
    ~ConcatFunction() noexcept override = default;
...
FMT_OSTREAM(NES::Logical::ConcatFunction);
