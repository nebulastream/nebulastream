...
class LessFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Less";

    LessFunction(Function left, Function right);
    LessFunction(const LessFunction& other);
...
FMT_OSTREAM(NES::Logical::LessFunction);
