...
{
class OrFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Or";

    OrFunction(Function left, Function right);
    OrFunction(const OrFunction& other);
...
FMT_OSTREAM(NES::Logical::OrFunction);
