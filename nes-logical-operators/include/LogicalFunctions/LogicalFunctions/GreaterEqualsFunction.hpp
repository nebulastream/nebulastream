...
{
class GreaterEqualsFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "GreaterEquals";

    GreaterEqualsFunction(Function left, Function right);
    GreaterEqualsFunction(const GreaterEqualsFunction& other);
    ~GreaterEqualsFunction() override = default;
...
FMT_OSTREAM(NES::Logical::GreaterEqualsFunction);
