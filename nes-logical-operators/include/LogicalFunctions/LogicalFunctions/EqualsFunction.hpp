...
class EqualsFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Equals";

    EqualsFunction(Function left, Function right);
    EqualsFunction(const EqualsFunction& other);
    ~EqualsFunction() override = default;
...
FMT_OSTREAM(NES::Logical::EqualsFunction);
