...
{
class AndFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "And";

    AndFunction(Function left, Function right);
    AndFunction(const AndFunction& other);
...
FMT_OSTREAM(NES::Logical::AndFunction);
