...
{
class GreaterFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "Greater";

    GreaterFunction(Function left, Function right);
    GreaterFunction(const GreaterFunction& other);
...
FMT_OSTREAM(NES::Logical::GreaterFunction);
