...
class LessEqualsFunction final : public FunctionConcept
{
public:
    static constexpr std::string_view NAME = "LessEquals";

    LessEqualsFunction(Function left, Function right);
    LessEqualsFunction(const LessEqualsFunction& other);
    ~LessEqualsFunction() override = default;
...
FMT_OSTREAM(NES::Logical::LessEqualsFunction);
