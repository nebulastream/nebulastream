...
public:
    ...
    explicit LogicalPlan(LocalQueryId queryId, std::vector<LogicalOperator> rootOperators);
    explicit LogicalPlan(LocalQueryId queryId, std::vector<LogicalOperator> rootOperators, std::string originalSql);
