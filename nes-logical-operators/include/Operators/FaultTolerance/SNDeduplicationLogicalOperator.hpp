...
{
    Reflected operator()(const TypedLogicalOperator<SNDeduplicationLogicalOperator>&, const ReflectionContext& context) const;
};
...
struct Unreflector<TypedLogicalOperator<SNDeduplicationLogicalOperator>>
{
    ...
    TypedLogicalOperator<SNDeduplicationLogicalOperator> operator()(const Reflected&, const ReflectionContext& context) const;
};
