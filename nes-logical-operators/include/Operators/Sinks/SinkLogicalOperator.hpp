...
struct SinkLogicalOperator final : public ManagedByOperator
{
    ...
    explicit SinkLogicalOperator(WeakLogicalOperator self, SinkDescriptor sinkDescriptor, LogicalOperator child);
    ...
    static TypedLogicalOperator<SinkLogicalOperator> create(const SinkDescriptor& sinkDescriptor, LogicalOperator child);
