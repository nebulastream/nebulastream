...
class BatchingLogicalOperator final : public LogicalOperatorConcept
{
public:
    explicit BatchingLogicalOperator(std::shared_ptr<Windowing::WindowType> windowType);
    ...
    struct ConfigParameters
    {
        ...
        static inline std::unordered_map<std::string, NES::Configurations::DescriptorConfig::ConfigParameterContainer> parameterMap
            = NES::Configurations::DescriptorConfig::createConfigParameterContainerMap(WINDOW_INFOS);
    };

private:
    static constexpr std::string_view NAME = "Batching";
