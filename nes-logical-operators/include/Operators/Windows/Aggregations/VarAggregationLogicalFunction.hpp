...
class VarAggregationLogicalFunction final : public WindowAggregationLogicalFunction
{
public:
    ...
    VarAggregationLogicalFunction(const FieldAccessLogicalFunction& onField, const FieldAccessLogicalFunction& asField);
    explicit VarAggregationLogicalFunction(const FieldAccessLogicalFunction& onField);

    void inferStamp(const Schema& schema) override;
    ~VarAggregationLogicalFunction() override = default;
