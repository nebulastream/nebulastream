...
public:
    ...
    [[nodiscard]] bool equals(const CountAggregationLogicalFunction& other) const;
    ...
    [[nodiscard]] bool operator==(const CountAggregationLogicalFunction& rhs) const;

protected:
    explicit CountAggregationLogicalFunction(
        DataType inputStamp,
