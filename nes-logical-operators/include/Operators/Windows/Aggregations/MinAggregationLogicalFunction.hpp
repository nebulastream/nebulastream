...
public:
    ...
    [[nodiscard]] bool equals(const MinAggregationLogicalFunction& other) const;
    ...
    [[nodiscard]] bool operator==(const MinAggregationLogicalFunction& rhs) const;

protected:
    explicit MinAggregationLogicalFunction(
        DataType inputStamp,
