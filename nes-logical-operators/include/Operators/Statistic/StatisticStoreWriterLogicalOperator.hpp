...
/// Expects the child schema to contain the statistic build fields and re-emits per input record:
...
public:
    ...
    create(LogicalOperator child, StatisticId statisticId, std::string typeName);
