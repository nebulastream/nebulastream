...
class DeltaLogicalOperator : public ManagedByOperator
{
public:
    ...
    explicit DeltaLogicalOperator(WeakLogicalOperator self, std::vector<DeltaExpression> deltaExpressions);
...
private:
    ...
    friend Reflector<TypedLogicalOperator<DeltaLogicalOperator>>;
};

template <>
struct Reflector<TypedLogicalOperator<DeltaLogicalOperator>>
{
    Reflected operator()(const TypedLogicalOperator<DeltaLogicalOperator>& op) const;
};

template <>
struct Unreflector<TypedLogicalOperator<DeltaLogicalOperator>>
{
    TypedLogicalOperator<DeltaLogicalOperator> operator()(const Reflected& reflected, const ReflectionContext& context) const;
};
