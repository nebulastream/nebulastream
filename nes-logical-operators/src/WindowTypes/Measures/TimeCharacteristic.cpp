...
static std::ostream& operator<<(std::ostream& os, const UnboundEventTimeCharacteristic& timeCharacteristic)
{
    return os << fmt::format(
               "UnboundEventTimeCharacteristic(field: {}, unit: {})", timeCharacteristic.field->getFieldName(), timeCharacteristic.unit);
}

static std::ostream& operator<<(std::ostream& os, const BoundEventTimeCharacteristic& timeCharacteristic)
{
    return os << fmt::format(
