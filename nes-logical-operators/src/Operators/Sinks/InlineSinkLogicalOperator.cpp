...
InlineSinkLogicalOperator::InlineSinkLogicalOperator(
    WeakLogicalOperator self, std::string sinkType, UnboundOrderedSchema schema, std::unordered_map<std::string, std::string> config)
...
UnboundOrderedSchema InlineSinkLogicalOperator::getTargetSchema() const
{
    return targetSchema;
}
