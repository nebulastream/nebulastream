...
std::optional<Sinks::SinkDescriptor> SinkLogicalOperator::getSinkDescriptor() const noexcept
{
    return sinkDescriptor;
}

/// NOLINTNEXTLINE(performance-unnecessary-value-param)
SinkLogicalOperator SinkLogicalOperator::withSinkDescriptor(Sinks::SinkDescriptor sinkDescriptor) const noexcept
{
