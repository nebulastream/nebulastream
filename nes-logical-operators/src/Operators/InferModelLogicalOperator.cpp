...
{
    auto copy = std::make_shared<InferModelLogicalOperator>(model, inputFields, outputFields);
...
{
    return *this == rhs && dynamic_cast<const InferModelLogicalOperator*>(&rhs)->id == id;
}
