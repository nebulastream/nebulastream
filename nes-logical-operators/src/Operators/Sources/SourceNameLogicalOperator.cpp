...
Reflected Reflector<SourceNameLogicalOperator>::operator()(const SourceNameLogicalOperator&) const
{
    ...
    throw CannotSerialize("no serialize for SourceNameLogicalOperator defined. Serialization happens with SourceDescriptorLogicalOperator");
}
...
SourceNameLogicalOperator Unreflector<SourceNameLogicalOperator>::operator()(const Reflected&) const
{
    ...
    throw CannotDeserialize(
        "no serialize for SourceNameLogicalOperator defined. Serialization happens with SourceDescriptorLogicalOperator");
}
