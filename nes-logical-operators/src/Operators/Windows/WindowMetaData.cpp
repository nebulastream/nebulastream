...
NES::WindowMetaData::WindowMetaData(UnqualifiedUnboundField startField, UnqualifiedUnboundField endField) : startField(std::move(startField)), endField(std::move(endField))
{
}
