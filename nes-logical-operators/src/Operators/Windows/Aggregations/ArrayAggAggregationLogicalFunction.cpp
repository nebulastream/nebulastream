...
ArrayAggAggregationLogicalFunction ArrayAggAggregationLogicalFunction::withInferredType(const Schema<Field, Unordered>& schema) const
{
    ...
    {
        throw CannotInferStamp("ARRAY_AGG requires a fixed-size input field, but got {}.", input->getDataType());
    }
    return ArrayAggAggregationLogicalFunction{input};
}
...
ArrayAggAggregationLogicalFunction::create(AggregationLogicalFunctionRegistryArguments arguments)
{
