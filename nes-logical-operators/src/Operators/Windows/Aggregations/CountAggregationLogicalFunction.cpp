...
DataType CountAggregationLogicalFunction::getAggregateType() const
{
...
size_t std::hash<NES::CountAggregationLogicalFunction>::operator()(
    const NES::CountAggregationLogicalFunction& aggregationFunction) const noexcept
{
