...
WindowAggregationLogicalFunction::WindowAggregationLogicalFunction(std::shared_ptr<DataType> inputStamp, std::shared_ptr<DataType> partialAggregateStamp, std::shared_ptr<DataType> finalAggregateStamp, LogicalFunction onField)
...
WindowAggregationLogicalFunction::WindowAggregationLogicalFunction(
    std::shared_ptr<DataType> inputStamp, std::shared_ptr<DataType> partialAggregateStamp, std::shared_ptr<DataType> finalAggregateStamp, LogicalFunction onField, LogicalFunction asField)
