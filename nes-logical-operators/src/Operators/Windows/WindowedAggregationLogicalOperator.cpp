...
bool WindowedAggregationLogicalOperator::operator==(const WindowedAggregationLogicalOperator& rhs) const
{
    ...
    if (this->getGroupingKeys().size() != rhs.getGroupingKeys().size())
    {
        return false;
    }
    ...
    {
        if (this->getGroupingKeys()[i] != rhs.getGroupingKeys()[i])
        {
            return false;
        }
    }

    if (this->getWindowAggregation().size() != rhs.getWindowAggregation().size())
    {
        return false;
    }
    ...
    {
        if (*(getWindowAggregation()[i]) != (rhs.getWindowAggregation()[i]))
        {
            return false;
        }
    }
