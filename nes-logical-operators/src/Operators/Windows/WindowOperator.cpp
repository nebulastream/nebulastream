...
WindowOperator::WindowOperator() : WindowOperator(INVALID_ORIGIN_ID)
{
}

WindowOperator::WindowOperator(const OriginId originId) : Operator(), UnaryLogicalOperator(), OriginIdAssignmentOperator(originId)
{
}
