...
bool UnionLogicalOperator::operator==(const Operator& rhs) const
{
...
std::unique_ptr<LogicalOperator> LogicalOperatorGeneratedRegistrar::RegisterUnionLogicalOperator(NES::LogicalOperatorRegistryArguments)
{
