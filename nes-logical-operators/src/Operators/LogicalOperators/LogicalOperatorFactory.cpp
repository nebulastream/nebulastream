...
std::shared_ptr<LogicalUnaryOperator> LogicalOperatorFactory::createFilterOperator(const std::shared_ptr<LogicalFunction>& predicate, OperatorId id)
{
...
std::shared_ptr<LogicalBinaryOperator> LogicalOperatorFactory::createJoinOperator(const std::shared_ptr<Join::LogicalJoinDescriptor>& joinDefinition, OperatorId id)
{
