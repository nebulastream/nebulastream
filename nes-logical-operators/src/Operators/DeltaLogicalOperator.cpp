...
DeltaLogicalOperator::DeltaLogicalOperator(WeakLogicalOperator self, std::vector<DeltaExpression> deltaExpressions)
    : ManagedByOperator(std::move(self)), deltaExpressions(std::move(deltaExpressions))
{
}
...
{
    auto nullable = DataType::NULLABLE::NOT_NULLABLE;
    if (inputType.nullable) {
        nullable = DataType::NULLABLE::IS_NULLABLE;
    }
    switch (inputType.type)
    {
        case DataType::Type::UINT8:
        case DataType::Type::INT8:
            return DataType{DataType::Type::INT8, nullable};
        case DataType::Type::UINT16:
        case DataType::Type::INT16:
            return DataType{DataType::Type::INT16, nullable};
        case DataType::Type::UINT32:
        case DataType::Type::INT32:
            return DataType{DataType::Type::INT32, nullable};
        case DataType::Type::UINT64:
        case DataType::Type::INT64:
            return DataType{DataType::Type::INT64, nullable};
        case DataType::Type::FLOAT32:
            return DataType{DataType::Type::FLOAT32, nullable};
        case DataType::Type::FLOAT64:
            return DataType{DataType::Type::FLOAT64, nullable};
        default:
...
Reflected Reflector<TypedLogicalOperator<DeltaLogicalOperator>>::operator()(const TypedLogicalOperator<DeltaLogicalOperator>& op) const
{
...
Unreflector<TypedLogicalOperator<DeltaLogicalOperator>>::operator()(const Reflected& reflected, const ReflectionContext& context) const
{
    auto [exprPairs] = context.unreflect<detail::ReflectedDeltaLogicalOperator>(reflected);
    ...
    return TypedLogicalOperator<DeltaLogicalOperator>{std::move(deltaExpressions)};
}
...
LogicalOperatorGeneratedRegistrar::RegisterDeltaLogicalOperator(LogicalOperatorRegistryArguments arguments)
{
    ...
    {
        return ReflectionContext{}.unreflect<TypedLogicalOperator<DeltaLogicalOperator>>(arguments.reflected);
    }
