...
bool MapLogicalOperator::operator==(const Operator& rhs) const
{
...
std::unique_ptr<LogicalOperator> LogicalOperatorGeneratedRegistrar::RegisterMapLogicalOperator(NES::LogicalOperatorRegistryArguments config)
{
