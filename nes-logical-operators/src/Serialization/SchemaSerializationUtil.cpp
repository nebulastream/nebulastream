...
SerializableSchema* SchemaSerializationUtil::serializeSchema(const Schema<Field, Unordered>& schema, SerializableSchema* serializedSchema)
{
...
Schema<Field, Unordered> SchemaSerializationUtil::deserializeSchema(const SerializableSchema& serializedSchema, const std::vector<LogicalOperator>& operators)
{
    ...
    return Schema<Field, Unordered>{fields};
}
}
