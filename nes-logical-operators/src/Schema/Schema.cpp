...
// }
//
// // Schema::operator SchemaBase<1, UnboundFieldBase<1>, false>() const
// // {
// //     return SchemaBase{
...
// // }
//
// Schema Schema::bind(LogicalOperator logicalOperator, SchemaBase<1, UnboundFieldBase<1>, false> unboundSchema)
// {
...
template <>
Schema bind(const LogicalOperator& logicalOperator, const SchemaBase<1, UnboundFieldBase<1>, true>& unboundSchema)
{
    return unboundSchema | std::views::transform(Field::binder(logicalOperator)) | std::ranges::to<Schema>();
}

template <>
Schema bind(const LogicalOperator& logicalOperator, const SchemaBase<1, UnboundFieldBase<1>, false>& unboundSchema)
{
    return unboundSchema | std::views::transform(Field::binder(logicalOperator)) | std::ranges::to<Schema>();
}

// template Schema bind<true>(const LogicalOperator&, const SchemaBase<1, UnboundFieldBase<1>, true>&);
// template Schema bind<false>(const LogicalOperator&, const SchemaBase<1, UnboundFieldBase<1>, false>&);
