...
{
    std::vector<LogicalOperator> joined = leftLogicalPlan.getRootOperators();
    joined.push_back(rightLogicalPlan.getRootOperators().front());
    leftLogicalPlan.setRootOperators(joined);
