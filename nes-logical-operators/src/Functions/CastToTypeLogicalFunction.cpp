...
{
    PRECONDITION(false, "CastToTypeLogicalFunction not expected to be serialized");
    throw CannotSerialize("CastToTypeLogicalFunction not expected to be serialized");
}

CastToTypeLogicalFunction Unreflector<CastToTypeLogicalFunction>::operator()(const Reflected&) const
{
    PRECONDITION(false, "CastToTypeLogicalFunction not expected to be deserialized");
    throw CannotDeserialize("CastToTypeLogicalFunction not expected to be deserialized");
}
