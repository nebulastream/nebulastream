...
std::shared_ptr<LogicalFunction> FloorLogicalFunction::create(const std::shared_ptr<LogicalFunction>& child)
{
...
bool FloorLogicalFunction::operator==(const std::shared_ptr<LogicalFunction>& rhs) const
{
