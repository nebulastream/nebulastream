...
std::shared_ptr<LogicalFunction> ExpLogicalFunction::create(const std::shared_ptr<LogicalFunction>& child)
{
...
bool ExpLogicalFunction::operator==(const std::shared_ptr<LogicalFunction>& rhs) const
{
