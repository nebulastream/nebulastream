...
Reflected Reflector<ModuloLogicalFunction>::operator()(const ModuloLogicalFunction& _) const
{
    // TODO to implement
    throw NotImplemented("Reflector");
}

ModuloLogicalFunction Unreflector<ModuloLogicalFunction>::operator()(const Reflected& _) const
{
    // TODO to implement
