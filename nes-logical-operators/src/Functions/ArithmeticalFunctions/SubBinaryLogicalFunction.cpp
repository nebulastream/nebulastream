...
bool SubBinaryLogicalFunction::equal(const std::shared_ptr<LogicalFunction>& rhs) const
{
...
std::shared_ptr<LogicalFunction> SubBinaryLogicalFunction::clone() const
{
    return SubBinaryLogicalFunction::create(
        Util::as<LogicalFunction>(children[0])->clone(), Util::as<LogicalFunction>(children[1])->clone());
}
