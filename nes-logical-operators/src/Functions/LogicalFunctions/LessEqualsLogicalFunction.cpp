...
LessEqualsLogicalFunction::LessEqualsLogicalFunction(
    const std::shared_ptr<LogicalFunction>& left, const std::shared_ptr<LogicalFunction>& right)
    : BinaryLogicalFunction(DataTypeFactory::createBoolean(), "LessEquals")
{
    this->setLeftChild(left);
    this->setRightChild(right);
}

bool LessEqualsLogicalFunction::operator==(const std::shared_ptr<LogicalFunction>& rhs) const
{
