...
GreaterEqualsBinaryLogicalFunction::GreaterEqualsBinaryLogicalFunction() noexcept : BinaryLogicalFunction(DataTypeFactory::createBoolean(), "GreaterEquals")
{
}
...
bool GreaterEqualsBinaryLogicalFunction::equal(std::shared_ptr<LogicalFunction> const& rhs) const
{
