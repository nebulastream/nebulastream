...
bool NegateUnaryLogicalFunction::equal(const std::shared_ptr<LogicalFunction>& rhs) const
{
...
std::shared_ptr<LogicalFunction> NegateUnaryLogicalFunction::create(const std::shared_ptr<LogicalFunction>& child)
{
