...
RenameLogicalFunction RenameLogicalFunction::withInferredDataType(const Schema& schema) const
{
    auto fieldName = child.withInferredDataType(schema).getFieldName();
