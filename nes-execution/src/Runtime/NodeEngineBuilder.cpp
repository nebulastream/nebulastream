...
NES::Runtime::NodeEnginePtr NodeEngineBuilder::build() {
    ...
    try {
        ...
        auto queryCompilationOptions = createQueryCompilationOptions(workerConfiguration->queryCompiler, workerConfiguration->numberOfBuffersInSourceLocalBufferPool);
