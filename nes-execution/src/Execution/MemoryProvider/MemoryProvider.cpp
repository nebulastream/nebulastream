    ...
    switch (basicType->nativeType) {
      case BasicPhysicalType::NativeType::TEXT: {
        ...
        auto childIndex = Nautilus::FunctionCall(
            "storeAssociatedTextValue", storeAssociatedTextValue,
            bufferReference, textValue->getReference());
...
MemoryProviderPtr MemoryProvider::createMemoryProvider(
    const uint64_t bufferSize, const SchemaPtr schema) {
