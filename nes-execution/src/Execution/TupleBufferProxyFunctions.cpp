...
NES__Runtime__TupleBuffer__getBuffer(void* thisPtr) {
...
// NES__Runtime__TupleBuffer__getNumberOfTuples(void *thisPtr) {
//    NES::Runtime::TupleBuffer *tupleBuffer =
//    static_cast<NES::Runtime::TupleBuffer*>(thisPtr); return
...
// extern "C" __attribute__((always_inline)) void
// NES__Runtime__TupleBuffer__setNumberOfTuples(void *thisPtr, uint64_t
// numberOfTuples) {
//    NES::Runtime::TupleBuffer *tupleBuffer =
