...
BatchAggregationHandler::State
BatchAggregationHandler::getThreadLocalState(WorkerThreadId workerThreadId) {
  auto index = workerThreadId % threadLocalStateStores.size();
  return threadLocalStateStores[index];
}

void BatchAggregationHandler::setup(
...
void BatchAggregationHandler::postReconfigurationCallback(
