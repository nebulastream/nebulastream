...
void* createStringObject(TextValue* value) {
  return jni::createString(value->strn_copy());
}

bool getBooleanObjectValue(void* object) {
  return jni::getBooleanValue((jobject)object);
}

float getFloatObjectValue(void* object) {
  return jni::getFloatValue((jobject)object);
}

double getDoubleObjectValue(void* object) {
  return jni::getDoubleValue((jobject)object);
}

int32_t getIntegerObjectValue(void* object) {
  return jni::getIntegerValue((jobject)object);
}

int64_t getLongObjectValue(void* object) {
  return jni::getLongValue((jobject)object);
}

int16_t getShortObjectValue(void* object) {
  return jni::getShortValue((jobject)object);
}

int8_t getByteObjectValue(void* object) {
  return jni::getByteValue((jobject)object);
}
...
T getField(void* state, void* classPtr, void* objectPtr, int fieldIndex,
  ...
  std::string fieldName =
      handler->getUdfOutputSchema()->fields[fieldIndex]->getName();
  jfieldID id = jni::getEnv()->GetFieldID(pojoClass, fieldName.c_str(),
                                          signature.c_str());
  jni::jniErrorCheck();
  T value;
...
TextValue* getStringField(void* state, void* classPtr, void* objectPtr,
                          int fieldIndex) {
  return getField<TextValue*>(state, classPtr, objectPtr, fieldIndex,
                              "Ljava/lang/String;");
}
...
void setField(void* state, void* classPtr, void* objectPtr, int fieldIndex,
  ...
  std::string fieldName =
      handler->getUdfInputSchema()->fields[fieldIndex]->getName();
  jfieldID id = jni::getEnv()->GetFieldID(pojoClass, fieldName.c_str(),
                                          signature.c_str());
  jni::jniErrorCheck();
...
void setStringField(void* state, void* classPtr, void* objectPtr,
                    int fieldIndex, const TextValue* value) {
  return setField(state, classPtr, objectPtr, fieldIndex, value,
                  "Ljava/lang/String;");
}
