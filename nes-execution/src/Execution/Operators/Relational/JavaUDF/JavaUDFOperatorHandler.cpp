...
const std::string JavaUDFOperatorHandler::convertToJNIName(
...
const jni::JavaUDFByteCodeList& JavaUDFOperatorHandler::getByteCodeList()
    const {
  return byteCodeList;
}
...
jni::jclass JavaUDFOperatorHandler::loadClass(
