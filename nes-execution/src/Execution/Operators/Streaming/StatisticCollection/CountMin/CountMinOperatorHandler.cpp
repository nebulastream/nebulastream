...
{
    return std::make_shared<CountMinOperatorHandler>(
        CountMinOperatorHandler(windowSize, windowSlide, sendingPolicy, width, depth, statisticFormat, inputOrigins, numberOfBitsInKey));
}
...
Statistic::StatisticPtr CountMinOperatorHandler::createInitStatistic(Windowing::TimeMeasure sliceStart, Windowing::TimeMeasure sliceEnd)
{
