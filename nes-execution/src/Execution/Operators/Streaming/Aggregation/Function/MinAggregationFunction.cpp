...
Nautilus::Record MinAggregationFunction::lower(const nautilus::val<AggregationState*> aggregationState, const PipelineMemory&)
{
...
void MinAggregationFunction::reset(const nautilus::val<AggregationState*> aggregationState, const PipelineMemory&)
{
