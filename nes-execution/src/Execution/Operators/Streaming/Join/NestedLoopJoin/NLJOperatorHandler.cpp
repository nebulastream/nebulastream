...
void NLJOperatorHandler::emitSliceIdsToProbe(
  ...
  if (sliceLeft.getNumberOfTuplesLeft() > 0 &&
    ...
    NES_INFO(
        ...
        "{} and no. right tuples {}",
        bufferMemory->leftSliceIdentifier, bufferMemory->rightSliceIdentifier,
        tupleBuffer.getWatermark(), tupleBuffer.getSequenceNumber(),
        tupleBuffer.getOriginId(), sliceLeft.getNumberOfTuplesLeft(),
...
NLJOperatorHandler::NLJOperatorHandler(
    ...
    : StreamJoinOperatorHandler(inputOrigins, outputOriginId, windowSize,
      ...
      pageSizeLeft(pageSizeLeft),
      pageSizeRight(pageSizeRight) {}
