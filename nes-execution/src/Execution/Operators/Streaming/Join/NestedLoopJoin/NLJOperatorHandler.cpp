    ...
    PipelineExecutionContext* pipelineCtx)
{
    ...
    averageNumberLockedLeft->first
        += ((int64_t)sliceLeft.getNumberOfTuplesLeft() - averageNumberLockedLeft->first) / averageNumberLockedLeft->second;
    ...
    averageNumberLockedRight->first
        += ((int64_t)sliceRight.getNumberOfTuplesRight() - averageNumberLockedRight->first) / averageNumberLockedRight->second;

    NES_WARNING("Average number of tuples left: {} right: {}", averageNumberLockedLeft->first, averageNumberLockedRight->first);
}
