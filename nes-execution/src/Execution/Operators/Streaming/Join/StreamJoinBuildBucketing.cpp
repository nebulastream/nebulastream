    ...
    void * ptrOpHandler, uint64_t ts, WorkerThreadId workerThreadId, uint64_t joinStrategyInt, uint64_t windowingStrategyInt)
{
    ...
    auto * opHandler = StreamJoinOperator::getSpecificOperatorHandler<StreamJoinOperatorHandlerBucketing>(
        ptrOpHandler, joinStrategyInt, windowingStrategyInt);
