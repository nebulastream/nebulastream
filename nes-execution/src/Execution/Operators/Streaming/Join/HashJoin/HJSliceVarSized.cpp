...
HJSliceVarSized::getHashTable(QueryCompilation::JoinBuildSideType joinBuildSide, WorkerThreadId workerThreadId) const
{
...
uint64_t HJSliceVarSized::getNumberOfTuplesOfWorker(QueryCompilation::JoinBuildSideType joinBuildSide, WorkerThreadId workerThreadId) const
{
...
HJSliceVarSized::HJSliceVarSized(
    ...
    , mergingHashTableLeftSide(Operators::MergingHashTableVarSized(numPartitions))
    , mergingHashTableRightSide(Operators::MergingHashTableVarSized(numPartitions))
