...
size_t MergingHashTable::getNumBuckets() const
{
...
MergingHashTable::MergingHashTable(size_t numBuckets) : bucketHeads(numBuckets), bucketNumItems(numBuckets), bucketNumPages(numBuckets)
{
}
