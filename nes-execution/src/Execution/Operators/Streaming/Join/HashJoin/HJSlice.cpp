...
Operators::StreamJoinHashTable* HJSlice::getHashTable(
...
HJSlice::HJSlice(size_t numberOfWorker, uint64_t sliceStart, uint64_t sliceEnd,
    ...
    : StreamSlice(sliceStart, sliceEnd),
      ...
      alreadyMergedLocalToGlobalHashTable(false),
  ...
  NES_DEBUG(
      "Create new StreamHashJoinWindow with numberOfWorkerThreads={} HTs with "
      "numPartitions={} of pageSize={} "
