...
ExecDataType EventTimeFunction::getTs(Execution::ExecutionContext& ctx, Nautilus::Record& record) {
...
ExecDataType IngestionTimeFunction::getTs(Execution::ExecutionContext& ctx, Nautilus::Record&) {
