...
Nautilus::Value<UInt64> EventTimeFunction::getTs(
    Execution::ExecutionContext& ctx, Nautilus::Record& record) {
...
Nautilus::Value<UInt64> IngestionTimeFunction::getTs(
    Execution::ExecutionContext& ctx, Nautilus::Record&) {
