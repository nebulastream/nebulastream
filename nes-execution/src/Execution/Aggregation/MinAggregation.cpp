...
template <class T>
Nautilus::Value<> callMinTyped(Nautilus::Value<> leftValue,
                               Nautilus::Value<> rightValue) {
  return FunctionCall<>("min", min<typename T::RawType>, leftValue.as<T>(),
                        rightValue.as<T>());
}

Nautilus::Value<> callMin(const Nautilus::Value<> &leftValue,
...
void MinAggregationFunction::lift(Nautilus::Value<Nautilus::MemRef> state,
...
void MinAggregationFunction::combine(Nautilus::Value<Nautilus::MemRef> state1,
...
void MinAggregationFunction::lower(Nautilus::Value<Nautilus::MemRef> state,
