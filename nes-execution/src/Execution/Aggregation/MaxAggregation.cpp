...
template <class T>
Nautilus::Value<> callMaxTyped(Nautilus::Value<> leftValue,
                               Nautilus::Value<> rightValue) {
  return FunctionCall<>("max", max<typename T::RawType>, leftValue.as<T>(),
                        rightValue.as<T>());
}

Nautilus::Value<> callMax(const Nautilus::Value<>& leftValue,
                          const Nautilus::Value<>& rightValue) {
...
void MaxAggregationFunction::lift(Nautilus::Value<Nautilus::MemRef> state,
...
void MaxAggregationFunction::combine(Nautilus::Value<Nautilus::MemRef> state1,
...
void MaxAggregationFunction::lower(Nautilus::Value<Nautilus::MemRef> state,
