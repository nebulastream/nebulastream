...
Nautilus::Value<> AggregationFunction::loadFromMemref(
    Nautilus::Value<Nautilus::MemRef> memref,
  ...
  if (physicalType->isBasicType()) {
    ...
    switch (basicType->nativeType) {
      ...
      default: {
        ...
        type << physicalType;
        NES_ERROR(
            "Aggregation Function::load: Physical Type: {} is currently not "
            "supported",
            type.str());
        NES_NOT_IMPLEMENTED();
      };
    ...
    NES_ERROR(
        "Aggregation Function::load: Physical Type: {} is not a basic type and "
...
Nautilus::Value<> AggregationFunction::createMinValue(
    const PhysicalTypePtr& physicalType) {
  if (physicalType->isBasicType()) {
    auto basicType = std::static_pointer_cast<BasicPhysicalType>(physicalType);
    switch (basicType->nativeType) {
      ...
      default: {
        ...
        type << physicalType;
        NES_ERROR(
            "Aggregation Function::createMinValue: Physical Type: {} is "
    ...
    NES_ERROR(
        "Aggregation Function::createMinValue: Physical Type: {} is not a "
        "basic type and is currently not supported",
        typeString.str());
    NES_NOT_IMPLEMENTED();
  }
}

Nautilus::Value<> AggregationFunction::createMaxValue(
    const PhysicalTypePtr& physicalType) {
  if (physicalType->isBasicType()) {
    auto basicType = std::static_pointer_cast<BasicPhysicalType>(physicalType);
    switch (basicType->nativeType) {
      ...
      default: {
        ...
        type << physicalType;
        NES_ERROR(
            "Aggregation Function::createMaxValue: Physical Type: {} is "
            "currently not supported",
            type.str());
        NES_NOT_IMPLEMENTED();
      };
    ...
    typeString << physicalType;
    NES_ERROR(
        "Aggregation Function::createMaxValue: Physical Type: {} is not a "
        "basic type and is currently not supported",
        typeString.str());
    NES_NOT_IMPLEMENTED();
  }
...
Nautilus::Value<> AggregationFunction::createConstValue(
    int64_t value, const PhysicalTypePtr& physicalType) {
  if (physicalType->isBasicType()) {
    auto basicType = std::static_pointer_cast<BasicPhysicalType>(physicalType);
    switch (basicType->nativeType) {
      case BasicPhysicalType::NativeType::INT_8: {
