...
void hlladd(void *memrefPtr, uint64_t hash) {
  ...
  HyperLogLogDistinctCountApproximationValue *obj =
      static_cast<HyperLogLogDistinctCountApproximationValue *>(memrefPtr);
  // pass the hash value
  obj->hyperLogLog.add(hash);
}

void HyperLogLogDistinctCountApproximation::lift(
  ...
  NES::Nautilus::Interface::HashFunction::HashValue hashValueNautilus =
      murMur3HashFunction.calculate(inputValue);
  FunctionCall<>("hlladd", hlladd, memref, hashValueNautilus);
}

void mergeHLL(void *memref1Ptr, void *memref2Ptr) {
  HyperLogLogDistinctCountApproximationValue *obj1 =
      static_cast<HyperLogLogDistinctCountApproximationValue *>(memref1Ptr);
  HyperLogLogDistinctCountApproximationValue *obj2 =
      static_cast<HyperLogLogDistinctCountApproximationValue *>(memref2Ptr);
  obj1->hyperLogLog.merge(obj2->hyperLogLog);
}

void HyperLogLogDistinctCountApproximation::combine(
...
void HyperLogLogDistinctCountApproximation::lower(
...
void HyperLogLogDistinctCountApproximation::reset(
