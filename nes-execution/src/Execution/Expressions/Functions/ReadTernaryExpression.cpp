...
ReadTernaryExpression::ReadTernaryExpression(const ExpressionPtr& left, const ExpressionPtr& middle, const ExpressionPtr& right)
 ...
 * @return double
 */
double readT(double x, double y, double z) {
    NES_INFO("ReadTernaryExpression called with value: {}, {}, {}", x, y, z);
    return x;
}

Value<> ReadTernaryExpression::execute(NES::Nautilus::Record& record) const {
...
static ExecutableFunctionRegistry::Add<TernaryFunctionProvider<ReadTernaryExpression>> readTernaryExpression("readT");
}// namespace NES::Runtime::Execution::Expressions
