...
TruncExpression::TruncExpression(const NES::Runtime::Execution::Expressions::ExpressionPtr& subExpression) : subExpression(subExpression)
{
}
/**
 ...
 * @return double
 */
double calculateTrunc(double x)
{
    return std::trunc(x);
}
