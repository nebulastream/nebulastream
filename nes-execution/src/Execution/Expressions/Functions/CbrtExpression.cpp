...
Value<> CbrtExpression::execute(NES::Nautilus::Record &record) const {
  ...
  // from Value to Value<Int8>. In all cases we can call the same calculateCbrt
...
static ExecutableFunctionRegistry::Add<UnaryFunctionProvider<CbrtExpression>>
    cbrtFunction("cbtr");
} // namespace NES::Runtime::Execution::Expressions
