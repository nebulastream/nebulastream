...
AbsExpression::AbsExpression(const NES::Runtime::Execution::Expressions::ExpressionPtr& subExpression) : subExpression(subExpression)
{
}
...
/**
  ...
  * @return double
  */
double calculateAbsFloat(double n)
{
    return std::abs(n);
}
double calculateAbsDouble(double n)
{
    return std::abs(n);
}
int64_t calculateAbsSignedInt64(int64_t n)
{
    return std::abs(n);
}
int32_t calculateAbsSignedInt32(int32_t n)
{
    return std::abs(n);
}
int16_t calculateAbsSignedInt16(int16_t n)
{
    return std::abs(n);
}
int8_t calculateAbsSignedInt8(int8_t n)
{
    return std::abs(n);
}
