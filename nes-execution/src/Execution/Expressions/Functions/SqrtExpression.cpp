 ...
 * This function is basically a wrapper for std::sqrt and enables us to use it
...
Value<> SqrtExpression::execute(NES::Nautilus::Record& record) const {
  ...
  // Value to Value<Int8>. In all cases we can call the same calculateSqrt
...
static ExecutableFunctionRegistry::Add<UnaryFunctionProvider<SqrtExpression>>
    sqrtFunction("sqrt");
}  // namespace NES::Runtime::Execution::Expressions
