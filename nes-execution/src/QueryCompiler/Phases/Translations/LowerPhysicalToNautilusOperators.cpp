...
PipelineQueryPlanPtr LowerPhysicalToNautilusOperators::apply(
    PipelineQueryPlanPtr pipelinedQueryPlan, size_t bufferSize) {
...
OperatorPipelinePtr LowerPhysicalToNautilusOperators::apply(
    OperatorPipelinePtr operatorPipeline, size_t bufferSize) {
      ...
      case StreamJoinStrategy::HASH_JOIN_VAR_SIZED:
        switch (buildOperator->getWindowingStrategy()) {
          ...
          case WindowingStrategy::SLICING:
            joinBuildNautilus = lowerHJSlicingVarSized(
                buildOperator, handlerIndex, std::move(timeFunction));
            break;
        }
        break;
      case StreamJoinStrategy::HASH_JOIN_LOCAL:
      ...
      case StreamJoinStrategy::HASH_JOIN_GLOBAL_LOCK_FREE: {
        switch (buildOperator->getWindowingStrategy()) {
          ...
          case WindowingStrategy::SLICING:
            ...
            break;
          case WindowingStrategy::BUCKETING:
            joinBuildNautilus = lowerHJBucketing(buildOperator, handlerIndex,
                                                 std::move(timeFunction),
      ...
      case StreamJoinStrategy::NESTED_LOOP_JOIN: {
        switch (buildOperator->getWindowingStrategy()) {
          ...
          case WindowingStrategy::SLICING:
            ...
            break;
          case WindowingStrategy::BUCKETING:
            joinBuildNautilus = lowerNLJBucketing(buildOperator, handlerIndex,
                                                  std::move(timeFunction),
                                                  windowSize, windowSlide);
            break;
        }
        ...
        switch (agg->getType()) {
          case Windowing::WindowAggregationDescriptor::Type::Avg:
            return std::make_shared<
                ...
                physicalInputType, physicalFinalType,
                aggregationInputExpression, aggregationResultFieldIdentifier);
  ...
  switch (aggregationType) {
    ...
    case Windowing::WindowAggregationDescriptor::Type::Count:
      switch (basicType->nativeType) {
        ...
        case BasicPhysicalType::NativeType::INT_16:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<int16_t>>();
        case BasicPhysicalType::NativeType::INT_32:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<int32_t>>();
        case BasicPhysicalType::NativeType::INT_64:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<int64_t>>();
        case BasicPhysicalType::NativeType::UINT_8:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<uint8_t>>();
        case BasicPhysicalType::NativeType::UINT_16:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<uint16_t>>();
        case BasicPhysicalType::NativeType::UINT_32:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<uint32_t>>();
        case BasicPhysicalType::NativeType::UINT_64:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<uint64_t>>();
        case BasicPhysicalType::NativeType::FLOAT:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<float_t>>();
        case BasicPhysicalType::NativeType::DOUBLE:
          return std::make_unique<Runtime::Execution::Aggregation::
                                      CountAggregationValue<double_t>>();
        default:
          NES_THROW_RUNTIME_ERROR("Unsupported data type");
      }
    case Windowing::WindowAggregationDescriptor::Type::Max:
