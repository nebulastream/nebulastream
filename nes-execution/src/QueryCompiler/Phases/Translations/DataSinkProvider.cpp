...
Runtime::Execution::ExecutablePipelineStagePtr DataSinkProvider::lower(
    OperatorId sinkId,
...
{
    return ConvertLogicalToPhysicalSink::createDataSink(sinkId, std::move(sinkDescriptor), std::move(schema), querySubPlan, numOfProducers);
}
