...
*/
#include <QueryCompiler/Operators/PhysicalOperators/PhysicalTernaryOperator.hpp>
#include <sstream>
#include <utility>

namespace NES::QueryCompilation::PhysicalOperators {

PhysicalTernaryOperator::PhysicalTernaryOperator(OperatorId id,
...
std::string PhysicalTernaryOperator::toString() const {
