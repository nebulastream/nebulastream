...
const std::string& PhysicalSynopsisBuildOperator::getNameOfFieldToTrack()
    const {
  return nameOfFieldToTrack;
}

Statistic::StatisticMetricHash PhysicalSynopsisBuildOperator::getMetricHash()
    const {
  return metricHash;
}

const Windowing::WindowTypePtr& PhysicalSynopsisBuildOperator::getWindowType()
    const {
  return windowType;
}
...
PhysicalSynopsisBuildOperator::PhysicalSynopsisBuildOperator(
    ...
    : nameOfFieldToTrack(nameOfFieldToTrack),
