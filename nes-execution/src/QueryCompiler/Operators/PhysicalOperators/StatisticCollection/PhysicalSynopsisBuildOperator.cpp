...
Statistic::StatisticMetricHash PhysicalSynopsisBuildOperator::getMetricHash() const
{
    return metricHash;
}

const Windowing::WindowTypePtr & PhysicalSynopsisBuildOperator::getWindowType() const
{
    return windowType;
}

const Statistic::SendingPolicyPtr & PhysicalSynopsisBuildOperator::getSendingPolicy() const
{
