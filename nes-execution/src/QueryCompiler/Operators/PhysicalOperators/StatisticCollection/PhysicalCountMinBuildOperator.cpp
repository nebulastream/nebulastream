...
PhysicalOperatorPtr PhysicalCountMinBuildOperator::create(
  ...
  return std::make_shared<PhysicalCountMinBuildOperator>(
      PhysicalCountMinBuildOperator(operatorId, statisticId, inputSchema,
                                    outputSchema, nameOfFieldToTrack, width,
                                    depth, metricHash, windowType,
                                    sendingPolicy));
}
...
PhysicalOperatorPtr PhysicalCountMinBuildOperator::create(
  ...
  return create(getNextOperatorId(), statisticId, inputSchema, outputSchema,
                nameOfFieldToTrack, width, depth, metricHash, windowType,
                sendingPolicy);
}
