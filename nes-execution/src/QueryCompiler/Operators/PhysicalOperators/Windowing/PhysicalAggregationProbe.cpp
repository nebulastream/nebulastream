...
Runtime::Execution::WindowMetaData PhysicalAggregationProbe::getWindowMetaData() const
{
    return windowMetaData;
}

PhysicalOperatorPtr PhysicalAggregationProbe::create(
    const OperatorId id,
...
{
    return std::make_shared<PhysicalAggregationProbe>(
        PhysicalAggregationProbe(id, inputSchema, outputSchema, windowDefinition, windowHandler, windowMetaData));
}
