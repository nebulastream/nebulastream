...
PhysicalOperatorPtr PhysicalJoinBuildOperator::create(
    ...
    const Join::JoinOperatorHandlerPtr &operatorHandler,
    JoinBuildSideType buildSide) {
  return std::make_shared<PhysicalJoinBuildOperator>(
      id, statisticId, inputSchema, outputSchema, operatorHandler, buildSide);
}
