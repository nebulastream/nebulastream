...
public:
  /**
   * @brief Creates a column memory provider based on a valid column memory
   * layout pointer.
   * @param Column memory layout pointer used to create the
   * ColumnMemoryProvider.
   */
  ColumnMemoryProvider(
...
private:
  ...
  calculateFieldAddress(Nautilus::Value<Nautilus::MemRef> &bufferAddress,
