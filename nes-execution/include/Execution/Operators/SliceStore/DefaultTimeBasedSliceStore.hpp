...
public:
    ...
    getTriggerableWindowSlices(Timestamp globalWatermark, PipelineId) override;
    std::map<WindowInfoAndSequenceNumber, std::vector<std::shared_ptr<Slice>>> getAllNonTriggeredSlices(PipelineId) override;
