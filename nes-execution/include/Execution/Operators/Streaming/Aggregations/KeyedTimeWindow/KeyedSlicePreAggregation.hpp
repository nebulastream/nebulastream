...
/**
 * @brief KeyedSlicePreAggregation operator that performs the pre-aggregation
 * step for a keyed window aggregation. This window operator currently only
 * supports tumbling time-based windows.
 */
