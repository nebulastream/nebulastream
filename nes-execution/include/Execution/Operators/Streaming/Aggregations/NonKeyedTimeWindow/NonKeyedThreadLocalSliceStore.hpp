...
#ifndef NES_EXECUTION_INCLUDE_EXECUTION_OPERATORS_STREAMING_AGGREGATIONS_NONKEYEDTIMEWINDOW_NONKEYEDTHREADLOCALSLICESTORE_HPP_
#define NES_EXECUTION_INCLUDE_EXECUTION_OPERATORS_STREAMING_AGGREGATIONS_NONKEYEDTIMEWINDOW_NONKEYEDTHREADLOCALSLICESTORE_HPP_
...
class NonKeyedThreadLocalSliceStore
    : public ThreadLocalSliceStore<NonKeyedSlice> {
public:
  explicit NonKeyedThreadLocalSliceStore(
