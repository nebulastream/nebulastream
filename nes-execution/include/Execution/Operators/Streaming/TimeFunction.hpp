...
class TimeFunction {
  public:
    ...
    virtual ExecDataType getTs(Execution::ExecutionContext& ctx, Record& record) = 0;
...
class EventTimeFunction final : public TimeFunction {
  public:
    ...
    ExecDataType getTs(Execution::ExecutionContext& ctx, Record& record) override;
...
class IngestionTimeFunction final : public TimeFunction {
  public:
    void open(Execution::ExecutionContext& ctx, Execution::RecordBuffer& buffer) override;
    ExecDataType getTs(Execution::ExecutionContext& ctx, Nautilus::Record& record) override;
};
