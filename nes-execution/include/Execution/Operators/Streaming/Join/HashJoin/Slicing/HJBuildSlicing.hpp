...
/**
 * @brief This class inserts record into the correct slice. It checks the
 ...
 * hashTable->insert() and returns a pointer to allocated space for the tuple.
 */
class HJBuildSlicing : public StreamJoinBuild {
 public:
   ...
   */
  HJBuildSlicing(const uint64_t operatorHandlerIndex, const SchemaPtr& schema,
