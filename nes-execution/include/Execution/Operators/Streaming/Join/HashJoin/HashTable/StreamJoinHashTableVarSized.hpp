...
class StreamJoinHashTableVarSized {
 public:
  ...
  StreamJoinHashTableVarSized& operator=(const StreamJoinHashTableVarSized&) =
      delete;
   ...
   * @return bucket
   */
  Nautilus::Interface::PagedVectorVarSizedPtr getBucketPagedVector(
      size_t bucketPos) const;
