 ...
 * multiple buckets each consisting of a PagedVectorVarSized
 */
class MergingHashTableVarSized {
public:
  /**
   * @brief Constructor for a hash table that supports simultaneous insertion
  ...
  void insertBucket(size_t bucketPos,
                    Nautilus::Interface::PagedVectorVarSizedPtr pagedVector);
...
private:
  std::vector<folly::Synchronized<Nautilus::Interface::PagedVectorVarSizedPtr>>
      bucketHeads;
