...
public:
    ...
    void insertRecordForWindow(
        Value<MemRef>& allWindowsToFill, Value<UInt64>& curIndex, ValueId<WorkerThreadId>& workerThreadId, Record& record, Value<MemRef> pipelineExecutionContext) const override;
};
} /// namespace NES::Runtime::Execution::Operators
