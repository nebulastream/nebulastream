...
/**
 * @brief This class probes the join for a triggered window. It receives a left
 * and right window/slice (via an id) and a hash bucket id. It then performs an
 * equality check for each left and right tuple.
 */
