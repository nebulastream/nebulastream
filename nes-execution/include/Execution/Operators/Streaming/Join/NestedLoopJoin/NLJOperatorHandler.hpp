...
/**
 * @brief This task models the information for a join window trigger, so what
 * left and right slice identifier to join together
 */
 ...
 */
void* getNLJPagedVectorProxy(void* ptrNljWindow, WorkerThreadId workerThreadId,
