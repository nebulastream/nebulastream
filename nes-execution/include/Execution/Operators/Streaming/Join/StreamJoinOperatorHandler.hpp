...
public:
  ...
  getSliceBySliceIdentifier(uint64_t sliceIdentifier);
  std::optional<StreamSlicePtr>
  getSliceBySliceIdentifier(const RLockedSlices &slicesLocked,
                            uint64_t sliceIdentifier);
  std::optional<StreamSlicePtr>
  getSliceBySliceIdentifier(const WLockedSlices &slicesLocked,
                            uint64_t sliceIdentifier);
   ...
   */
  uint64_t
  getNumberOfTuplesInSlice(uint64_t sliceIdentifier,
