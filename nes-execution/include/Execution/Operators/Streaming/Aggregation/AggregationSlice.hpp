...
/// If it is a global aggregation, the hashmap contains a single entry for the keyValue = 0.
...
public:
    ...
    [[nodiscard]] Nautilus::Interface::HashMapInterface* getHashMapPtr(WorkerThreadId workerThreadId) const;
...
private:
    std::vector<std::unique_ptr<Nautilus::Interface::HashMapInterface>> hashMaps;
};
