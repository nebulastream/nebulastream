...
/**
 * @brief This handler stores states of a MapJavaUDF operator during its
 * execution.
 */
...
public:
   ...
   * @param byteCodeList The byteCode containing serialized java objects to load
   * into jvm
   ...
   */
  explicit JavaUDFOperatorHandler(
      ...
      SchemaPtr udfInputSchema, SchemaPtr udfOutputSchema,
  ...
  /**
   * @brief Convert a Java class name from Java notation (e.g.,
   * java.lang.Object), to JNI notation (e.g., java/lang/Object).
  ...
  /**
   * @brief This method returns the class name of the input class name of the
   * java udf
  ...
  /**
   * @brief This method returns the class name of the input class name of the
   * Java UDF in JNI notation.
   * @return std::string input class name in JNI notation.
   */
  const std::string &getInputClassJNIName() const;

  /**
   * @brief This method returns the class name of the output class name of the
   * Java UDF in JNI notation.
