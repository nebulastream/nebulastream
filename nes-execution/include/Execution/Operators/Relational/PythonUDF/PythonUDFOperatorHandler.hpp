...
/**
 * @brief This handler stores states of a MapPythonUDF operator during its
 * execution.
 */
class PythonUDFOperatorHandler : public OperatorHandler {
 public:
  ...
  /**
   * @brief Getter function for the arguments that go into the python udf
   * function
   ...
   */
  void setPythonArguments(PyObject* pythonArguments) {
   ...
   * @param pythonArguments arguments for the udf function as a PyObject
   */
  void setPythonVariable(PyObject* pythonVariable) {
    this->pythonVariable = pythonVariable;
  }
  /**
