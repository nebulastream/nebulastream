...
/**
 * @brief This basic Scan2 operator extracts records from a base tuple buffer according to a memory layout.
 * Furthermore, it supports projection pushdown to eliminate unneeded reads.
 */
class Scan2 : public Operator
{
public:
    /**
     * @brief Constructor for the Scan2 operator that receives a memory layout and a projection vector.
