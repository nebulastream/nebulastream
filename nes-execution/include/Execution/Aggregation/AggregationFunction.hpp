...
public:
   ...
   */
  virtual void lift(Nautilus::Value<Nautilus::MemRef> memref,
                    Nautilus::Record &record) = 0;
   ...
   */
  virtual void combine(Nautilus::Value<Nautilus::MemRef> memref1,
                       Nautilus::Value<Nautilus::MemRef> memre2) = 0;

  /**
   * @brief lower returns the aggregation value
   * @param memref the derived aggregation value
   */
  virtual void lower(Nautilus::Value<Nautilus::MemRef> memref,
                     Nautilus::Record &resultRecord) = 0;
...
protected:
   ...
   * @param physicalType the intended data type to which the value should be
   * casted
   * @return value in the type of physicalType
   */
  static Nautilus::Value<>
  loadFromMemref(Nautilus::Value<Nautilus::MemRef> memref,
                 const PhysicalTypePtr &physicalType);

  static Nautilus::Value<>
  createConstValue(int64_t value, const PhysicalTypePtr &physicalTypePtr);

  static Nautilus::Value<>
  createMinValue(const PhysicalTypePtr &physicalTypePtr);

  static Nautilus::Value<>
  createMaxValue(const PhysicalTypePtr &physicalTypePtr);
};
