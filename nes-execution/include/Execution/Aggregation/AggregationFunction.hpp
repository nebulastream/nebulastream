...
class AggregationFunction {
 ...
 protected:
   ...
   */
  static Nautilus::Value<> loadFromMemref(
      Nautilus::Value<Nautilus::MemRef> memref,
      const PhysicalTypePtr& physicalType);

  static Nautilus::Value<> createConstValue(
      int64_t value, const PhysicalTypePtr& physicalTypePtr);

  static Nautilus::Value<> createMinValue(
      const PhysicalTypePtr& physicalTypePtr);

  static Nautilus::Value<> createMaxValue(
      const PhysicalTypePtr& physicalTypePtr);
};
