...
class LowerToExecutableQueryPlanPhase {
 public:
  ...
  Runtime::Execution::ExecutableQueryPlanPtr apply(
 ...
 private:
  ...
  /**
   * @brief Create Actual Source descriptor from default source descriptor and
   * Physical source properties
   ...
   */
  SourceDescriptorPtr createSourceDescriptor(
