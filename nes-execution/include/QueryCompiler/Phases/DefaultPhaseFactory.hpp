...
public:
    ...
    [[nodiscard]] std::shared_ptr<MemoryLayoutSelectionPhase>
    createMemoryLayoutSelectionPhase(Configurations::QueryCompilerConfiguration queryCompilerConfig) const override;
