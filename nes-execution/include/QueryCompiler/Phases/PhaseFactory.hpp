...
/**
 * @brief An abstract factory, which allows the query compiler to create
 * instances of particular phases, without knowledge about the concrete
 * implementations. This ensures extendability.
 */
class PhaseFactory {
public:
  /**
   ...
   */
  virtual LowerLogicalToPhysicalOperatorsPtr
  createLowerLogicalQueryPlanPhase(QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual PipeliningPhasePtr
  createPipeliningPhase(QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual AddScanAndEmitPhasePtr
  createAddScanAndEmitPhase(QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual LowerToExecutableQueryPlanPhasePtr
  createLowerToExecutableQueryPlanPhase(QueryCompilerOptionsPtr options,
   ...
   */
  virtual BufferOptimizationPhasePtr
  createBufferOptimizationPhase(QueryCompilerOptionsPtr options) = 0;
};
