...
class PhaseFactory {
 public:
   ...
   */
  virtual LowerLogicalToPhysicalOperatorsPtr createLowerLogicalQueryPlanPhase(
      QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual PipeliningPhasePtr createPipeliningPhase(
      QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual AddScanAndEmitPhasePtr createAddScanAndEmitPhase(
      QueryCompilerOptionsPtr options) = 0;
   ...
   */
  virtual BufferOptimizationPhasePtr createBufferOptimizationPhase(
      QueryCompilerOptionsPtr options) = 0;
};
