...
/**
 * @brief Physical Sequencer Operator
 */
class PhysicalSequenceOperator : public PhysicalUnaryOperator, public AbstractScanOperator
{
public:
    /**
     ...
     */
    PhysicalSequenceOperator(OperatorId id, const std::shared_ptr<Schema>& outputSchema);
