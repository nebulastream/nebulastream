 ...
 * This class represent physical operator for ThresholdWindow. It stores the
 * operator handler which later can be used in the executable operator.
 */
class PhysicalThresholdWindowOperator : public PhysicalUnaryOperator {
 public:
   ...
   * @param operatorHandler pointer to the operator handler of the threshold
   * window (of type ThresholdWindowOperatorHandler)
   */
