...
class PhysicalStatisticStoreReadOperator final : public PhysicalUnaryOperator
{
public:
    PhysicalStatisticStoreReadOperator(OperatorId id, std::shared_ptr<Schema> inputSchema, std::shared_ptr<Schema> outputSchema);
