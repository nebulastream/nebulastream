...
public:
  ...
  create(OperatorId id, StatisticId statisticId, const SchemaPtr &inputSchema,
         ...
         const Runtime::Execution::Operators::StreamJoinOperatorHandlerPtr
             &operatorHandler,
         const JoinBuildSideType buildSide, TimestampField timestampField,
         const std::string &joinFieldName,
         QueryCompilation::StreamJoinStrategy joinStrategy,
         QueryCompilation::WindowingStrategy windowingStrategy);

  /**
   * @brief creates a PhysicalStreamJoinBuildOperator that retrieves a new
   ...
   */
  static PhysicalOperatorPtr
  create(StatisticId statisticId, const SchemaPtr &inputSchema,
         const SchemaPtr &outputSchema,
         const Runtime::Execution::Operators::StreamJoinOperatorHandlerPtr
             &operatorHandler,
         const JoinBuildSideType buildSide, TimestampField timestampField,
  ...
  explicit PhysicalStreamJoinBuildOperator(
      const OperatorId id, StatisticId statisticId,
