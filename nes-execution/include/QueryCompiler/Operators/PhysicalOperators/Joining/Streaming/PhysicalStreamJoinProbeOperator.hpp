...
public:
  ...
  create(OperatorId id, StatisticId statisticId, const SchemaPtr &leftSchema,
   ...
   */
  static PhysicalOperatorPtr
  create(StatisticId statisticId, const SchemaPtr &leftSchema,
         const SchemaPtr &rightSchema, const SchemaPtr &outputSchema,
