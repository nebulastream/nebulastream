...
/**
 * @brief Defines a single pipeline, which contains of a query plan of
 * operators. Each pipeline can have N successor and predecessor pipelines.
 */
...
public:
   ...
   * Operator pipelines consist of arbitrary operators, except sources and
   * sinks.
   */
