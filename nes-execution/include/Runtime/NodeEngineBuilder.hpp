...
class NodeEngineBuilder {
 public:
   ...
   * @return NodeEngineBuilder&
   */
  NodeEngineBuilder& setQueryStatusListener(
   ...
   * @return NodeEngineBuilder&
   */
  NodeEngineBuilder& setPartitionManager(
   ...
   * @return NodeEngineBuilder&
   */
  NodeEngineBuilder& setBufferManagers(
   ...
   * @return NodeEngineBuilder&
   */
  NodeEngineBuilder& setPhaseFactory(
