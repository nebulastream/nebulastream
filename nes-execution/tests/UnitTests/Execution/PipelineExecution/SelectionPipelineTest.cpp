...
class SelectionPipelineTest : public Testing::BaseUnitTest,
...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("SelectionPipelineTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down SelectionPipelineTest test class.");
  }
};

/**
 * @brief Selection pipeline that execute a select operator and filters
 * elements.
 */
...
INSTANTIATE_TEST_CASE_P(
    testIfCompilation, SelectionPipelineTest,
