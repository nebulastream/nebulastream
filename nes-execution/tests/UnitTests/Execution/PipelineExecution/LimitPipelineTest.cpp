...
class LimitPipelineTest : public Testing::BaseUnitTest,
...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("LimitPipelineTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down LimitPipelineTest test class.");
  }
};
...
INSTANTIATE_TEST_CASE_P(
    LimitPipelineTest, LimitPipelineTest,
