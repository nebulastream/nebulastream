...
class ScanEmitPipelineTest : public Testing::BaseUnitTest,
...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("ScanEmitPipelineTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down ScanEmitPipelineTest test class.");
  }
};
...
INSTANTIATE_TEST_CASE_P(
    testIfCompilation, ScanEmitPipelineTest,
