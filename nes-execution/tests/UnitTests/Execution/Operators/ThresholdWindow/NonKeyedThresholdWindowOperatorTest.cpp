...
class NonKeyedThresholdWindowOperatorTest : public Testing::BaseUnitTest {
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("NonKeyedThresholdWindowOperatorTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down NonKeyedThresholdWindowOperatorTest test class.");
  }
};
...
TEST_F(NonKeyedThresholdWindowOperatorTest, thresholdWindowWithSumAggTest) {
  ...
  auto thresholdWindowOperator = std::make_shared<NonKeyedThresholdWindow>(
      ...
      std::vector<Record::RecordFieldIdentifier>{aggregationResultFieldName}, 0,
      aggVector, 0);
  ...
  auto handler = std::make_shared<NonKeyedThresholdWindowOperatorHandler>(
      std::move(aggValues));
  ...
  auto recordTwenty =
      Record({{"f1", +20_s64}, {"f2", +4_s64}});  // closes the window
 ...
 * @brief Tests the threshold window operator with a sum aggregation.
 */
TEST_F(NonKeyedThresholdWindowOperatorTest,
       thresholdWindowWithSumAggTestMinCountTrue) {
  auto readF1 = std::make_shared<Expressions::ReadFieldExpression>("f1");
  auto readF2 = std::make_shared<Expressions::ReadFieldExpression>("f2");
  auto fortyTwo =
      std::make_shared<Expressions::ConstantInt32ValueExpression>(42);
 ...
 */
TEST_F(NonKeyedThresholdWindowOperatorTest,
       thresholdWindowWithSumAggTestMinCountFalse) {
  auto readF1 = std::make_shared<Expressions::ReadFieldExpression>("f1");
  auto readF2 = std::make_shared<Expressions::ReadFieldExpression>("f2");
  auto fortyTwo =
      std::make_shared<Expressions::ConstantInt32ValueExpression>(42);
  ...
  auto thresholdWindowOperator = std::make_shared<NonKeyedThresholdWindow>(
      greaterThanExpression,
      std::vector<Record::RecordFieldIdentifier>{aggregationResultFieldName}, 3,
      aggVector, 0);
...
TEST_F(NonKeyedThresholdWindowOperatorTest, thresholdWindowWithAvgAggTest) {
  ...
  auto avgAggregationValue =
      std::make_unique<Aggregation::AvgAggregationValue<int64_t>>();
  ...
  auto recordTwenty =
      Record({{"f1", +20_s64}, {"f2", +6_s64}});  // closes the window
  thresholdWindowOperator->execute(ctx, recordFifty);
  thresholdWindowOperator->execute(ctx, recordNinety);
  thresholdWindowOperator->execute(ctx, recordTwenty);
  EXPECT_EQ(collector->records.size(), 1);
...
TEST_F(NonKeyedThresholdWindowOperatorTest, thresholdWindowWithCountAggTest) {
  ...
  auto countAgg = std::make_shared<Aggregation::CountAggregationFunction>(
      integerType, unsignedIntegerType, Expressions::ExpressionPtr(),
  ...
  auto countAggregationValue =
      std::make_unique<Aggregation::CountAggregationValue<uint64_t>>();
 ...
 */
TEST_F(NonKeyedThresholdWindowOperatorTest,
       thresholdWindowWithMultipleAggregations) {
  // set up
  auto readF1 = std::make_shared<Expressions::ReadFieldExpression>("f1");
  auto readF2 = std::make_shared<Expressions::ReadFieldExpression>("f2");
  ...
  PhysicalTypePtr doubleType =
      physicalTypeFactory.getPhysicalType(DataTypeFactory::createDouble());
  auto unsignedIntegerType =
      physicalTypeFactory.getPhysicalType(DataTypeFactory::createUInt64());
  auto sumAgg = std::make_shared<Aggregation::SumAggregationFunction>(
      integerType, integerType, readF2, aggregationResultFieldNameSum);
  auto maxAgg = std::make_shared<Aggregation::MaxAggregationFunction>(
      integerType, integerType, readF1, aggregationResultFieldNameMax);
  auto minAgg = std::make_shared<Aggregation::MinAggregationFunction>(
      integerType, integerType, readF3, aggregationResultFieldNameMin);
  auto avgAgg = std::make_shared<Aggregation::AvgAggregationFunction>(
      integerType, doubleType, readF4, aggregationResultFieldNameMean);
  auto countAgg = std::make_shared<Aggregation::CountAggregationFunction>(
      integerType, unsignedIntegerType, Expressions::ExpressionPtr(),
  ...
  auto thresholdWindowOperator = std::make_shared<NonKeyedThresholdWindow>(
      ...
      std::vector<Record::RecordFieldIdentifier>{
          aggregationResultFieldNameSum, aggregationResultFieldNameMax,
          aggregationResultFieldNameMin, aggregationResultFieldNameMean,
          aggregationResultFieldNameCount},
      0, aggVector, 0);
  ...
  auto recordFifty = Record(
      {{"f1", +50_s64}, {"f2", +2_s64}, {"f3", +50_s64}, {"f4", +2_s64}});
  auto recordNinety = Record(
      {{"f1", +90_s64}, {"f2", +3_s64}, {"f3", +90_s64}, {"f4", +4_s64}});
 ...
 */
TEST_F(NonKeyedThresholdWindowOperatorTest,
       thresholdWindowWithFloatPredicateTest) {
  auto readF1 = std::make_shared<Expressions::ReadFieldExpression>("f1");
  auto readF2 = std::make_shared<Expressions::ReadFieldExpression>("f2");
  auto fortyTwo =
      std::make_shared<Expressions::ConstantInt32ValueExpression>(42.5);
  auto greaterThanExpression =
      std::make_shared<Expressions::GreaterThanExpression>(readF1, fortyTwo);
  // Attribute(f1) > 42, sum(f2)
  ...
  auto recordTwenty =
      Record({{"f1", Value<>(20.85)}, {"f2", +4_s64}});  // closes the window
  thresholdWindowOperator->execute(ctx, recordFifty);
  thresholdWindowOperator->execute(ctx, recordNinety);
  thresholdWindowOperator->execute(ctx, recordTwenty);
  EXPECT_EQ(collector->records.size(), 1);
 ...
 */
TEST_F(NonKeyedThresholdWindowOperatorTest,
       thresholdWindowWithMultAggOnGenratingMultipleWindowsTest) {
  auto readF1 = std::make_shared<Expressions::ReadFieldExpression>("f1");
  auto readF2 = std::make_shared<Expressions::ReadFieldExpression>("f2");
  auto fortyTwo =
      std::make_shared<Expressions::ConstantInt32ValueExpression>(42);
  ...
  auto avgAgg = std::make_shared<Aggregation::AvgAggregationFunction>(
      integerType, doubleType, readF2, avgAggregationResultFieldName);
  ...
  auto thresholdWindowOperator = std::make_shared<NonKeyedThresholdWindow>(
      greaterThanExpression,
      std::vector<Record::RecordFieldIdentifier>{sumAggregationResultFieldName,
                                                 avgAggregationResultFieldName},
      0, aggVector, 0);
  ...
  auto recordTwelve =
      Record({{"f1", +12_s64}, {"f2", +8_s64}});  // closes the window
