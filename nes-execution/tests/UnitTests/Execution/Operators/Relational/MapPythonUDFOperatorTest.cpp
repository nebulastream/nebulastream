...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("MapPythonUdfOperatorTest.log",
...
TEST_F(MapPythonUdfOperatorTest, IntegerUDFTest) {
  ...
  auto handler = std::make_shared<PythonUDFOperatorHandler>(
      function, functionName, inputSchema, outputSchema);
 ...
 * The UDF sets the bool to false, numerics +10 and appends to strings the
 * postfix 'appended'.
 */
TEST_F(MapPythonUdfOperatorTest, ComplexMapFunction) {
  ...
  outputSchema = Schema::create()
                     ...
                     ->addField("doubleVariable", BasicType::FLOAT64)
                     ->addField("booleanVariable", BasicType::BOOLEAN);
  function = "def complex_test(byte_var, short_var, int_var, long_var, "
             "float_var, double_var, boolean_var):"
