...
class MapJavaUdfOperatorTest : public NES::Testing::BaseUnitTest {
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("MapJavaUdfOperatorTest.log",
                              NES::LogLevel::LOG_DEBUG);
  }

  auto setupAndExecuteMapUdfWithBuffer(
      Catalogs::UDF::JavaUDFDescriptorPtr javaUDFDescriptor, int8_t* buffer,
      Record record) {
    ...
    auto handler = std::make_shared<JavaUDFOperatorHandler>(
        javaUDFDescriptor->getClassName(), method,
        javaUDFDescriptor->getInputClassName(),
        javaUDFDescriptor->getOutputClassName(),
        javaUDFDescriptor->getByteCodeList(), instance,
        javaUDFDescriptor->getInputSchema(),
        javaUDFDescriptor->getOutputSchema(), classPath);
    auto map = MapJavaUDF(0, javaUDFDescriptor->getInputSchema(),
                          javaUDFDescriptor->getOutputSchema());
    auto collector = std::make_shared<CollectOperator>();
    map.setChild(collector);
    auto pipelineContext = MockedPipelineExecutionContext({handler});
    auto ctx = ExecutionContext(Value<MemRef>(buffer),
  ...
  auto setupAndExecuteMapUdf(
      Catalogs::UDF::JavaUDFDescriptorPtr javaUDFDescriptor, Record record) {
    return setupAndExecuteMapUdfWithBuffer(javaUDFDescriptor, nullptr, record);
  }
};

/**
 * @brief Test simple UDF with byte objects as input and output
 * (IntegerMapFunction<Byte, Byte>) The UDF increments incoming tuples by 10.
 */
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.ByteMapFunction"s}, {}}})
...
/**
 * @brief Test simple UDF with short objects as input and output
 * (IntegerMapFunction<Short, Short>) The UDF increments incoming tuples by 10.
 */
TEST_F(MapJavaUdfOperatorTest, ShortUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.ShortMapFunction"s}, {}}})
...
TEST_F(MapJavaUdfOperatorTest, IntegerUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.IntegerMapFunction"s}, {}}})
 ...
 * (IntegerMapFunction<Long, Long>) The UDF increments incoming tuples by 10.
 */
TEST_F(MapJavaUdfOperatorTest, LongUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.LongMapFunction"s}, {}}})
 ...
 * (FloatMapFunction<Float, Float>) The UDF increments incoming tuples by 10.
 */
TEST_F(MapJavaUdfOperatorTest, FloatUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.FloatMapFunction"s}, {}}})
 ...
 * (IntegerMapFunction<Double, Double>) The UDF increments incoming tuples
 * by 10.
 */
TEST_F(MapJavaUdfOperatorTest, DoubleUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.DoubleMapFunction"s}, {}}})
 ...
 * (BooleanMapFunction<Boolean, Boolean>) The UDF sets incoming tuples to false.
 */
TEST_F(MapJavaUdfOperatorTest, BooleanUDFTest) {
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.BooleanMapFunction"s}, {}}})
 ...
 * (StringMapFunction<String, String>) The UDF prepends the prefix 'Appended
 * String:'.
 */
TEST_F(MapJavaUdfOperatorTest, StringUDFTest) {
  auto bm = std::make_shared<Runtime::BufferManager>();
  auto wc = std::make_shared<Runtime::WorkerContext>(INVALID<WorkerThreadId>,
                                                     bm, 1024);
  ...
  auto javaUDFDescriptor =
      Catalogs::UDF::JavaUDFDescriptorBuilder()
          ...
          .setByteCodeList({{{"stream.nebula.MapFunction"}, {}},
                            {{"stream.nebula.StringMapFunction"s}, {}}})
          .setInputSchema(Schema::create()->addField("id", BasicType::TEXT))
          .setOutputSchema(Schema::create()->addField("id", BasicType::TEXT))
          .loadByteCodeFrom(JAVA_UDF_TEST_DATA)
          .build();
  auto outputRecord = setupAndExecuteMapUdfWithBuffer(
      javaUDFDescriptor, (int8_t*)&wc, inputRecord);
 ...
 * (ComplexMapFunction<ComplexPojo, ComplexPojo>) The UDF sets the bool to
 * false, numerics +10 and prepends the prefix 'Appended String:'.
 */
TEST_F(MapJavaUdfOperatorTest, ComplexPojoMapFunction) {
  ...
  auto inputSchema =
      Schema::create()
          ...
          ->addField("unsignedLongVariable",
                     BasicType::UINT64)  // UINT64 input fields are also mapped
                                         // to Java long
  ...
  auto outputSchema =
      Schema::create()
          ...
          ->addField("longVariable", BasicType::INT64)
          ->addField("unsignedLongVariable",
                     BasicType::INT64)  // Java long are always mapped to INT64
                                        // in output
          ->addField("floatVariable", BasicType::FLOAT32)
          ->addField("doubleVariable", BasicType::FLOAT64)
          ->addField("stringVariable", BasicType::TEXT)
  ...
  auto inputRecord =
      Record({{"byteVariable", Value<Int8>(initialByte)},
  ...
  EXPECT_EQ(outputRecord.read("unsignedLongVariable"),
            initialUnsignedLong + 10);
  EXPECT_EQ(outputRecord.read("floatVariable"), initialFloat + 10.0);
  EXPECT_EQ(outputRecord.read("doubleVariable"), initialDouble + 10.0);
  EXPECT_EQ(outputRecord.read("stringVariable"),
            Value<Text>("testValueAppended String:"));
  EXPECT_EQ(outputRecord.read("booleanVariable"), false);
}

/**
 * @brief Test UDF with multiple internal dependencies
 * (DummyRichMapFunction<Integer, Integer>)
 */
