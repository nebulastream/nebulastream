...
/** @brief The JaccardDistance Class provides functionality to compare two text
 * objects and return their difference */
...
TEST_F(JaccardTest, BaseTest) {
  ...
  // TODO ASSERT_NEAR does not work out of the box, dist3 is identified as
  // boolean
