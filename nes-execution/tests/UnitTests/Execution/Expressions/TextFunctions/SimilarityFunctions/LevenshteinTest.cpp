...
class LevenshteinTest : public Testing::BaseUnitTest {
 public:
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down LevenshteinTest class.");
  }
  std::shared_ptr<Runtime::BufferManager> bm;
  std::shared_ptr<Runtime::WorkerContext> wc;
};

/** @brief The LevenshteinDistance Class provides functionality to compare two
 * text objects and return their difference */
