...
class DivExpressionTest : public Testing::BaseUnitTest {
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("DivExpressionTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down DivExpressionTest test class.");
  }
};
...
TEST_F(DivExpressionTest, divIntegers) {
  ...
  {
    auto resultValue =
        expression.eval(Value<Int16>(4_s16), Value<Int16>(4_s16));
    ASSERT_EQ(resultValue, 1);
  ...
  {
    auto resultValue =
        expression.eval(Value<Int64>(4_s64), Value<Int64>(4_s64));
    ASSERT_EQ(resultValue, 1);
...
TEST_F(DivExpressionTest, divUnsignedIntegers) {
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt16>(4_u16), Value<UInt16>(4_u16));
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt64>(4_u64), Value<UInt64>(4_u64));
...
TEST_F(DivExpressionTest, divFloat) {
  ...
  {
    auto resultValue =
        expression.eval(Value<Float>((float)4), Value<Float>((float)4));
  ...
  {
    auto resultValue =
        expression.eval(Value<Double>((double)4), Value<Double>((double)4));
