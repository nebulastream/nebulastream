...
TEST_F(AddExpressionTest, addIntegers) {
  ...
  {
    auto resultValue =
        addExpression.eval(Value<Int8>(42_s8), Value<Int8>(42_s8));
  ...
  {
    auto resultValue =
        addExpression.eval(Value<Int16>(42_s16), Value<Int16>(42_s16));
    ASSERT_EQ(resultValue, 84);
  ...
  {
    auto resultValue =
        addExpression.eval(Value<Int64>(42_s64), Value<Int64>(42_s64));
    ASSERT_EQ(resultValue, 84);
...
TEST_F(AddExpressionTest, addUnsignedIntegers) {
  ...
  {
    auto resultValue =
        addExpression.eval(Value<UInt8>(42_u8), Value<UInt8>(42_u8));
  ...
  {
    auto resultValue =
        addExpression.eval(Value<UInt16>(42_u16), Value<UInt16>(42_u16));
    ASSERT_EQ(resultValue, 84_u16);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<UInt16>());
  }  // UInt32
  {
    auto resultValue =
        addExpression.eval(Value<UInt32>(42u), Value<UInt32>(42u));
    ASSERT_EQ(resultValue, 84_u32);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<UInt32>());
  }  // UInt64
  {
    auto resultValue =
        addExpression.eval(Value<UInt64>(42_u64), Value<UInt64>(42_u64));
...
TEST_F(AddExpressionTest, addFloat) {
  ...
  {
    auto resultValue =
        addExpression.eval(Value<Float>((float)42), Value<Float>((float)42));
    ASSERT_EQ(resultValue, (float)84);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Float>());
  }
  // Double
  {
    auto resultValue = addExpression.eval(Value<Double>((double)42),
                                          Value<Double>((double)42));
    ASSERT_EQ(resultValue, (float)84);
...
TEST_F(AddExpressionTest, addTimeStamps) {
  ...
  {
    auto resultValue =
        addExpression.eval(Value<TimeStamp>(TimeStamp((uint64_t)dur.count())),
                           Value<TimeStamp>(TimeStamp((uint64_t)dur.count())));
    EXPECT_EQ(resultValue.as<TimeStamp>()->getMilliSeconds(),
              3333597103488_u64);
