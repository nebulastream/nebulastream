...
class AbsExpressionTest : public Testing::BaseUnitTest {
 public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("AbsExpressionTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down SubExpressionTest test class.");
  }
};
...
TEST_F(AbsExpressionTest, evaluateAbsExpressionUnsignedInt) {
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt16>(static_cast<uint16_t>(UINT8_MAX)));
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt32>(static_cast<uint32_t>(UINT16_MAX)));
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt64>(static_cast<uint64_t>(UINT32_MAX)));
...
TEST_F(AbsExpressionTest, evaluateAbsExpressionSignedInt) {
  ...
  {
    auto resultValue =
        expression.eval(Value<Int16>(static_cast<int16_t>(-INT8_MAX)));
  ...
  {
    auto resultValue =
        expression.eval(Value<Int32>(static_cast<int32_t>(-INT16_MAX)));
  ...
  {
    auto resultValue =
        expression.eval(Value<Int64>(static_cast<int64_t>(-INT32_MAX)));
