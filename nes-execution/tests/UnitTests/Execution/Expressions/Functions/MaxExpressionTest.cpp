...
public:
  ...
  static void SetUpTestCase() {
    NES::Logger::setupLogging("MaxExpressionTest.log",
  ...
  static void TearDownTestCase() {
    NES_INFO("Tear down MaxExpressionTest test class.");
  }
};
...
TEST_F(MaxExpressionTest, evaluateMaxExpressionInteger) {
  ...
  {
    auto resultValue =
        expression.eval(Value<Int16>(17_s16), Value<Int16>(4_s16));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  ...
  {
    auto resultValue =
        expression.eval(Value<Int32>(17_s32), Value<Int32>(4_s32));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  // Int64
  {
    auto resultValue =
        expression.eval(Value<Int64>(17_s64), Value<Int64>(4_s64));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt16>(17_u16), Value<UInt16>(4_u16));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  ...
  {
    auto resultValue =
        expression.eval(Value<UInt32>(17_u32), Value<UInt32>(4_u32));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  // UInt64
  {
    auto resultValue =
        expression.eval(Value<UInt64>(17_u64), Value<UInt64>(4_u64));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
}
...
TEST_F(MaxExpressionTest, evaluateMaxExpressionFloat) {
  ...
  {
    auto resultValue =
        expression.eval(Value<Float>((float)17), Value<Float>((float)4));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
  // Double
  {
    auto resultValue =
        expression.eval(Value<Double>((double)17), Value<Double>((double)4));
    ASSERT_EQ(resultValue, (float)17);
    ASSERT_TRUE(resultValue->getTypeIdentifier()->isType<Double>());
  }
}
