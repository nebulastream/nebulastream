...
struct ConfigResolutionErrors
{
    ...
    /// The fully qualified names of the config fields with all the qualified names of the literals that resolve to it
    std::unordered_map<QualifiedIdentifier, std::vector<QualifiedIdentifier>> duplicateFields;
