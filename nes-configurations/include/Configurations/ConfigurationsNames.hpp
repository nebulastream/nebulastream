...
/**
 * @brief input format enum gives information whether a JSON or CSV was used to
 * transfer data
 */
 ...
 * TUPLE_SEPARATOR: TCP messages are send with a char acting as tuple separator
 * between them, tupleSeperator needs to be set USER_SPECIFIED_BUFFER_SIZE: User
 * specifies the buffer size beforehand, socketBufferSize needs to be set
 * BUFFER_SIZE_FROM_SOCKET: Between each message you also obtain a fixed amount
 * of bytes with the size of the next message,
...
const std::string RPC_PORT_CONFIG =
    "rpcPort";  // used to be coordinator port, renamed to uniform naming
...
const std::string NUMBER_OF_BUFFERS_IN_GLOBAL_BUFFER_MANAGER_CONFIG =
    "numberOfBuffersInGlobalBufferManager";
const std::string NUMBER_OF_BUFFERS_PER_WORKER_CONFIG =
    "numberOfBuffersPerWorker";
const std::string NUMBER_OF_BUFFERS_IN_SOURCE_LOCAL_BUFFER_POOL_CONFIG =
...
const std::string ENABLE_NEW_REQUEST_EXECUTOR_CONFIG =
...
const std::string STREAM_HASH_JOIN_NUMBER_OF_PARTITIONS_CONFIG =
    "numberOfPartitions";
const std::string STREAM_HASH_JOIN_PAGE_SIZE_CONFIG = "pageSize";
const std::string STREAM_HASH_JOIN_PREALLOC_PAGE_COUNT_CONFIG =
    "preAllocPageCnt";
const std::string STREAM_HASH_JOIN_MAX_HASH_TABLE_SIZE_CONFIG =
    "maxHashTableSize";
...
const std::string PLACEMENT_AMENDMENT_THREAD_COUNT =
    "placementAmendmentThreadCount";
const std::string DISTRIBUTED_JOIN_OPTIMIZATION_MODE_CONFIG =
    "distributedJoinOptimizationMode";
const std::string MEMORY_LAYOUT_POLICY_CONFIG = "memoryLayoutPolicy";
const std::string PERFORM_ONLY_SOURCE_OPERATOR_EXPANSION =
...
const std::string ALLOW_EXHAUSTIVE_CONTAINMENT_CHECK =
    "allowExhaustiveContainmentCheck";
const std::string PERFORM_ADVANCE_SEMANTIC_VALIDATION =
    "advanceSemanticValidation";
const std::string ENABLE_NEMO_PLACEMENT = "enableNemoPlacement";

// Elegant Configurations
const auto ELEGANT =
    "elegant"s;  // elegant configurations are initialize with this constant
const auto ACCELERATE_JAVA_UDFS =
    "accelerateJavaUDFs"s;  // accelerate java udfs supplied in Map UDF operator
const auto PLANNER_SERVICE_URL =
    "plannerServiceURL"s;  // URL for ELEGANT planner
const auto ACCELERATION_SERVICE_URL =
    "accelerationServiceURL"s;  // URL for acceleration service
const auto TRANSFER_RATE =
    "transferRate"s;  // Fake transfer rate between two workers

// Worker Configuration Names
const std::string WORKER_ID = "workerId";
const std::string COORDINATOR_PORT_CONFIG =
    "coordinatorPort";  // needs to be same as RPC Port of Coordinator
...
const std::string QUERY_COMPILER_NAUTILUS_BACKEND_CONFIG =
    "queryCompilerNautilusBackendConfig";
const std::string QUERY_COMPILER_COMPILATION_STRATEGY_CONFIG =
    "compilationStrategy";
const std::string QUERY_COMPILER_PIPELINING_STRATEGY_CONFIG =
    "pipeliningStrategy";
const std::string QUERY_COMPILER_OUTPUT_BUFFER_OPTIMIZATION_CONFIG =
    "outputBufferOptimizationLevel";
const std::string QUERY_COMPILER_WINDOWING_STRATEGY_CONFIG =
    "windowingStrategy";
...
const std::string PATH_PREDICTION_UPDATE_INTERVAL_CONFIG =
    "pathPredictionUpdateInterval";
...
const std::string NODE_INDEX_UPDATE_THRESHOLD_CONFIG =
...
const std::string SPEED_DIFFERENCE_THRESHOLD_FACTOR_CONFIG =
    "speedDifferenceThresholdFactor";
const std::string SEND_DEVICE_LOCATION_UPDATE_THRESHOLD_CONFIG =
    "sendDevicePositionUpdateThreshold";
const std::string PUSH_DEVICE_LOCATION_UPDATES_CONFIG = "pushPositionUpdates";
const std::string SEND_LOCATION_UPDATE_INTERVAL_CONFIG =
...
const std::string LOCATION_SIMULATED_START_TIME_CONFIG =
...
const std::string NUMBER_OF_BUFFERS_TO_PRODUCE_CONFIG =
    "numberOfBuffersToProduce";
const std::string NUMBER_OF_TUPLES_TO_PRODUCE_PER_BUFFER_CONFIG =
...
const std::string BYTES_USED_FOR_SOCKET_BUFFER_SIZE_TRANSFER_CONFIG =
