...
template <>
struct fmt::formatter<NES::Configurations::DescriptorConfig::ConfigType> : fmt::formatter<std::string_view>
{
    auto format(const NES::Configurations::DescriptorConfig::ConfigType& configValue, format_context& ctx) const
    {
        return std::visit(
