...
/**
 * @brief This class defines an option, which has only the member of an enum as
 * possible values.
 * @tparam T
 */
template <IsEnum T> class EnumOption : public TypedBaseOption<T> {
public:
  /**
   ...
   */
  EnumOption(const std::string &name, T defaultValue,
