...
protected:
  ...
  /**
   * @brief ParseFromYamlNode fills the content of this option with the value of
   * the YAML node.
   * @param node
   */
  ...
  /**
   * @brief ParseFromString fills the content of this option with a specific
   * string value. If this option is nested it uses the identifier to lookup the
   * particular children option.
