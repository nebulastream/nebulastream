...
ArrowSourceTypePtr
ArrowSourceType::create(const std::string& logicalSourceName, const std::string& physicalSourceName, const Yaml::Node& yamlConfig)
{
...
ArrowSourceType::ArrowSourceType(const std::string& logicalSourceName, const std::string& physicalSourceName)
    ...
    , filePath(Configurations::ConfigurationOption<std::string>::create(
          Configurations::FILE_PATH_CONFIG, "", "file path, needed for: ArrowSource."))
    ...
    : ArrowSourceType(logicalSourceName, physicalSourceName)
{
    ...
    else
    {
        NES_THROW_RUNTIME_ERROR(
            "ArrowSourceType:: no filePath defined! Please define a filePath using " << Configurations::FILE_PATH_CONFIG
                                                                                     << " configuration.");
    }
...
Configurations::IntConfigOption ArrowSourceType::getNumberOfBuffersToProduce() const
{
...
Configurations::GatheringModeConfigOption ArrowSourceType::getGatheringMode() const
{
