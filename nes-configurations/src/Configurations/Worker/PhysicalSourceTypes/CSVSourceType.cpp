...
CSVSourceType::CSVSourceType(const std::string& logicalSourceName,
    ...
    : CSVSourceType(logicalSourceName, physicalSourceName) {
  NES_INFO(
      "CSVSourceType: Init default CSV source config object with values from "
      "command line.");
...
Configurations::IntConfigOption CSVSourceType::getNumberOfBuffersToProduce()
    const {
...
Configurations::GatheringModeConfigOption CSVSourceType::getGatheringMode()
    const {
