...
{
    throw CannotSerialize("FunctionList is not expected to be serialized");
}

FunctionList Unreflector<FunctionList>::operator()(const Reflected&) const
{
    throw CannotDeserialize("FunctionList is not expected to be deserialized");
}

Reflected Reflector<AggregationFunctionList>::operator()(const AggregationFunctionList&) const
{
    throw CannotSerialize("AggregationFunctionList is not expected to be serialized");
}

AggregationFunctionList Unreflector<AggregationFunctionList>::operator()(const Reflected&) const
{
    throw CannotDeserialize("AggregationFunctionList is not expected to be deserialized");
}

Reflected Reflector<WindowInfos>::operator()(const WindowInfos&) const
{
    throw CannotSerialize("WindowInfos is not expected to be serialized");
}

WindowInfos Unreflector<WindowInfos>::operator()(const Reflected&) const
{
    throw CannotDeserialize("WindowInfos is not expected to be deserialized");
}

Reflected Reflector<ProjectionList>::operator()(const ProjectionList&) const
{
    throw CannotSerialize("ProjectionList is not expected to be serialized");
}

ProjectionList Unreflector<ProjectionList>::operator()(const Reflected&) const
{
    throw CannotDeserialize("ProjectionList is not expected to be deserialized");
}

Reflected Reflector<UInt64List>::operator()(const UInt64List&) const
{
    throw CannotSerialize("UInt64List is not expected to be serialized");
}

UInt64List Unreflector<UInt64List>::operator()(const Reflected&) const
{
    throw CannotDeserialize("UInt64List is not expected to be deserialized");
}
}
