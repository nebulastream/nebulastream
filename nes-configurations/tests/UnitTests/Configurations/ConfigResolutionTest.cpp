...
{
    EXPECT_TRUE(std::holds_alternative<int64_t>(parseConfigLiteral("42").value()));
    EXPECT_TRUE(std::holds_alternative<double>(parseConfigLiteral("3.14").value()));
    EXPECT_TRUE(std::holds_alternative<bool>(parseConfigLiteral("true").value()));
    EXPECT_TRUE(std::holds_alternative<bool>(parseConfigLiteral("FALSE").value()));
    EXPECT_TRUE(std::holds_alternative<std::string>(parseConfigLiteral("hello").value()));
    EXPECT_TRUE(std::holds_alternative<int64_t>(parseConfigLiteral("-5").value()));
}
