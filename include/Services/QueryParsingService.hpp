...
class QueryParsingService {
  public:
    ...
    */
    ...
    /**
    *  @brief this function **executes** the code provided by the user and returns an Pattern Object
    *  @caution: this function will replace the stream name "xyz" provided by the user with the stream generated by the system and fetched from the catalog
    *  @param pattern as a string
    *  @return Smart pointer to InputPattern object of the pattern
    */
    PatternPtr createPatternFromCodeString(const std::string& queryCodeSnippet);
  ...
  private:
    ...
    /**
    *  @brief this function including the standard files in the code
    *  @param type identifies files needed for either pattern or query execution
    */
    std::stringstream translateUserCodeToSharedLibrary(std::string type);
    /**
    *  @brief this function derives the streamName from the codesnippet
    */
    std::string getStreamNameFromCodeString(const std::string& basicString);
};
