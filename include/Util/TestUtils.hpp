   ...
   */
    ...
    static TopologyNodePtr registerTestNode(uint64_t id, std::string address, int cpu, NodeStats nodeProperties,
        ...
        if (type == NodeType::Sensor) {
            ...
            if (sourceType != "CSVSource" && sourceType != "DefaultSource" && sourceType != "OPCSource"
                && sourceType != "ZMQSource" && sourceType != "KafkaSource" && sourceType != "BinarySource"
                && sourceType != "SenseSource" && sourceType != "NetworkSource" && sourceType != "AdaptiveSource") {
