...
class UtilityFunctions {
   ...
   *  */
    ...
    /**
*  @brief this function **executes** the pattern provided by the user and returns an InputQuery Object
*  @caution: this function will replace the stream name "xyz" provided by the user with the stream generated by the system and fetched from the catalog
*  @param pattern as a string
*  @return Smart pointer to InputQuery object of the pattern
*  */
    static QueryPtr createPatternFromCodeString(
