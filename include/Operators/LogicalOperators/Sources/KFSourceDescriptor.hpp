...
#ifndef NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_KF_SOURCE_DESCRIPTOR_HPP_
#define NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_KF_SOURCE_DESCRIPTOR_HPP_
...
class KFSourceDescriptor : public SourceDescriptor {
  public:
    explicit KFSourceDescriptor(SchemaPtr schema,
    ...
    static std::shared_ptr<KFSourceDescriptor> create(const SchemaPtr& schema,
...
#endif//NES_INCLUDE_OPERATORS_LOGICAL_OPERATORS_SOURCES_KF_SOURCE_DESCRIPTOR_HPP_
