...
#ifndef HdfsCSVSink_HPP
#define HdfsCSVSink_HPP
 ...
 */
class HdfsCSVSink : public SinkMedium {
  public:
    /**
     ...
     */
    explicit HdfsCSVSink(SinkFormatPtr format, char* filePath, bool append, QuerySubPlanId parentPlanId);
...
typedef std::shared_ptr<HdfsCSVSink> HdfsCSVSinkPtr;
}// namespace NES

#endif// HdfsCSVSink_HPP
