...
#ifndef NES_INCLUDE_RUNTIME_MEMORY_LAYOUT_BASIC_PHYSICAL_FIELD_HPP_
#define NES_INCLUDE_RUNTIME_MEMORY_LAYOUT_BASIC_PHYSICAL_FIELD_HPP_
...
class BasicPhysicalField : public PhysicalField {
  public:
    ...
    void write(TupleBuffer& tupleBuffer, ValueType value) {
        auto* byteBuffer = tupleBuffer.getBuffer<int8_t>();
