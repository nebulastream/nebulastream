...
#ifndef NES_QUERY5_HPP
#define NES_QUERY5_HPP
 ...
 * AdHoc Query 5
 * SELECT region,
 *  SUM (total_cost_of_local_calls_this_week) as local, SUM (total_cost_of_long_distance_calls_this_week) as long_distance
...
class AdHocQuery5 : public Runtime::Execution::ExecutablePipelineStage {
public:
    //AdHocQuery5(std::shared_ptr<MV> mv) : mv(mv) {};
