...
class CSVParser : public Parser {
   ...
   */
    CSVParser(uint64_t numberOfSchemaFields, std::vector<NES::PhysicalTypePtr> physicalTypes, std::string const& delimiter);
   ...
   */
    bool writeInputTupleToTupleBuffer(std::string csvInput,
                                      uint64_t tupleCount,
