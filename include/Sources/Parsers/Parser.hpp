...
enum SinkMediumTypes { JSONPARSER, CSVPARSER };
/**
...
class Parser { //: public Runtime::Reconfigurable
 ...
 public:
    ...
    */
   virtual void writeInputTupleToTupleBuffer(std::string inputTuple, uint64_t tupleCount,
                                             NES::Runtime::TupleBuffer& tupleBuffer) = 0;
     ...
     */
    void writeFieldValueToTupleBuffer(std::string value, uint64_t schemaFieldIndex,
