...
class DefaultSource : public GeneratorSource {
  public:
    ...
    DefaultSource(SchemaPtr schema, BufferManagerPtr bufferManager, QueryManagerPtr queryManager, const uint64_t numbersOfBufferToProduce, size_t frequency, SourceId sourceId);
