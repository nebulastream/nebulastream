...
#ifndef NES_INCLUDE_CATALOGS_KF_SOURCE_STREAM_CONFIG_HPP_
#define NES_INCLUDE_CATALOGS_KF_SOURCE_STREAM_CONFIG_HPP_
...
/**
 * @brief A phy stream config for KF adaptive sources
 */
class KFSourceStreamConfig : public PhysicalStreamConfig {
  public:
    /**
     * @brief Create a KFSourceStreamConfig
     ...
     */
    explicit KFSourceStreamConfig(std::string sourceType,
    ...
    ~KFSourceStreamConfig() noexcept override = default;
...
#endif//NES_INCLUDE_CATALOGS_KF_SOURCE_STREAM_CONFIG_HPP_
