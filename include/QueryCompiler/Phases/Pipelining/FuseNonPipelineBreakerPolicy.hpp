...
*/
#ifndef NES_INCLUDE_QUERY_COMPILER_PHASES_PIPELINING_FUSE_NON_PIPELINE_BREAKER_POLICY_HPP_
#define NES_INCLUDE_QUERY_COMPILER_PHASES_PIPELINING_FUSE_NON_PIPELINE_BREAKER_POLICY_HPP_
